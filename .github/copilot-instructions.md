...
When you add code, use comments to repeat and reinforce explanations in markdown. Detailed explanations should be in the markdown text, rather than comments.
