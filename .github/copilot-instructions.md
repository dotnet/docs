...
When you add code, use comments to briefly clarify code-specific details (such as logic, parameters, or edge cases). Reserve comprehensive explanations and context for the markdown text, not for comments.
