...
- When you review a PR not created by AI:
...
- When you use an IDE with a human to guide AI:
...
1. Because code comments don't get localized, use them sparingly when you add code. You can use them to briefly clarify code-specific details (such as logic, parameters, or edge cases). Put any critical information and context in the markdown text of the referencing article.
...
When you adapt content from external sources like blog posts into documentation:
...
When you're assigned an issue or directly given a task in GitHub:
