...
- **MUST: End list items with periods if more than three words. Note that the period may be inside style marks like `*` for italic or `**` for bold. - THIS IS NON-NEGOTIABLE**
