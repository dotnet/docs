...
- *PR [#55966](https://github.com/dotnet/docs/pull/55966) is evidence only.* It remains in review for Pattern matching overview/basic patterns; don't mark it shipped, expand its scope, or use it as approval of the surrounding technique taxonomy.
