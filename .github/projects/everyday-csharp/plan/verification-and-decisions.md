...
- *Two-part Fundamentals is the active IA hypothesis, not yet an approved reorder* (Decision 13). Part 1 follows the standard for compact syntax/semantics; Part 2 contains standalone, actionable, example-rich technique guidance. Functional techniques and OOP are move candidates. Preserve the recorded Option A order and its post-Phase-G revisit history until Bill decides.
- *PR [#55966](https://github.com/dotnet/docs/pull/55966) and PR [#56113](https://github.com/dotnet/docs/pull/56113) are shipped, evidence-only.* They merged (2026-09-17 and 2026-09-25) for Pattern matching overview/basic patterns and structural patterns, respectively; being merged doesn't expand their scope or count as approval of the surrounding technique taxonomy.
- *Approval gates:* before PR 22, decide canonical Part 1 homes for lambdas, local functions, and iterators plus the Part 2 name/home for Functional guidance. Before Phase G, classify every article as construct syntax, technique/design guidance, or tutorial, and decide whether OOP remains a node or moves into Part 2.
