...
- All APIs should be referenced using an `xref` style link as described in copilot-instructions.md, at least on first mention. Later mentions should be code-fenced in single back-ticks.
