...
Read more about it in the [Delegates and lambdas](../fundamentals/delegates-lambdas.md) document.
...
For more information, see the [Generic types (Generics) overview](../fundamentals/generics.md) article.
...
To learn more about async programming in .NET, start with the [Async overview](../fundamentals/async.md).
...
To learn more and see some samples, check out [LINQ (Language Integrated Query)](../fundamentals/using-linq.md).
...
Read more about it in the [Native interoperability](../fundamentals/native-interop.md) document.
