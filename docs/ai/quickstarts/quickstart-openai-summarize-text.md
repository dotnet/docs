...
:::zone target="docs" pivot="semantic-kernel"
<!-- markdownlint-enable MD044 -->
1. From a terminal or command prompt, navigate to the `quickstarts\semantic-kernel\01-HikeBenefitsSummary` directory.
:::zone-end

<!-- markdownlint-disable MD044 -->
:::zone target="docs" pivot="azure-openai-sdk"
<!-- markdownlint-enable MD044 -->
1. From a terminal or command prompt, navigate to the `quickstarts\azure-openai-sdk\01-HikeBenefitsSummary` directory.
:::zone-end
