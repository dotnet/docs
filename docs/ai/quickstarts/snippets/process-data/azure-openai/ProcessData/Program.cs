...
IChatClient chatClient =
    azureClient.GetChatClient(Environment.GetEnvironmentVariable("AZURE_OPENAI_CHAT_DEPLOYMENT_NAME")!).AsIChatClient();
// </ConfigureChatClient>
...
IEmbeddingGenerator<string, Embedding<float>> embeddingGenerator =
    azureClient.GetEmbeddingClient(Environment.GetEnvironmentVariable("AZURE_OPENAI_EMBEDDING_DEPLOYMENT_NAME")!).AsIEmbeddingGenerator();
// </ConfigureEmbeddingGenerator>
