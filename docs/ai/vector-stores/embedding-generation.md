...
Vector store providers support multiple ways of generating [embeddings](../conceptual/embeddings.md). Embeddings can be generated by the developer and passed as part of a record when using a <xref:Microsoft.Extensions.VectorData.VectorStoreCollection`2>. Or they can be generated internally to the <xref:Microsoft.Extensions.VectorData.VectorStoreCollection`2>.
