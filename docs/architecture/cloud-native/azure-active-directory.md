...
Azure AD supports company branded sign in screens, multi-factory authentication, and cloud-based application proxies that are used to provide SSO for applications hosted on premises. It offers a variety of security reporting and alert capabilities.
