...
Figure 3-16 shows the basic form requirements in the Azure Portal to create a new Kubernetes cluster.

![Create Kubernetes cluster](media/create-kubernetes-cluster.png) \
**Figure 3-16**. Create Kubernetes cluster
...
**Figure 3-17**. Connect to Azure Dev Spaces in Visual Studio
