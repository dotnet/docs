...
You can interact with AKS using your preferred client operating system. To do so, you either need a Web Browser or Azure command-line interface(Azure CLI). For more details, see [Install the Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest)
