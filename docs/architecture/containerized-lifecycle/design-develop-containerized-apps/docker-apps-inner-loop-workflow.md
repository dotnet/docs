...
> [!TIP]
> For more information about building Docker images for .NET applications, go to [https://learn.microsoft.com/dotnet/core/docker/building-net-docker-images](/aspnet/core/host-and-deploy/docker/building-net-docker-images).
>
