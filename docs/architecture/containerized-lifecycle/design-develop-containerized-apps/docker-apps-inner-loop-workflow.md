...
> [!TIP]
> For more information about building Docker images for .NET applications, see [https://learn.microsoft.com/dotnet/core/docker/build-container](/dotnet/core/docker/build-container).
>
