...
:::image type="content" source="media/aks-traffic-manager.png" alt-text="A diagram showing the AKS and Azure Traffic Manager splitting traffic between two primary regions." border="false" :::

**Figure 9-5**. AKS and Azure Traffic Manager splitting traffic between two primary regions
