...
.NET Aspire makes it much more straightforward to implement the Azure Service Bus component. The following sections guide you through the process of implementing the .NET Aspire Azure Service Bus component in your application.
...
### Getting Started
To start using the .NET Aspire Azure Service Bus component, you need to install the necessary NuGet package. Use the following command in your .NET CLI:
...
### Example Usage
In your application, particularly in the `Program.cs` file, you will need to register a `ServiceBusClient` for use via the dependency injection container. Here's how you can do it:

```csharp
builder.AddAzureServiceBusClient("messaging");
```

To retrieve the configured `ServiceBusClient` instance using dependency injection, require it as a constructor parameter in your services. For example:
...
### App Host Usage
If you're working with an app host, you'll need to install another NuGet package:

```shell
dotnet add package Aspire.Hosting.Azure.ServiceBus
```

Then, in your app host project, you can register the Service Bus component and consume the service as follows:
