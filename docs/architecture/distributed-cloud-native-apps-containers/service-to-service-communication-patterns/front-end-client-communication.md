...
description: Cloud-native service to service communication patterns | Front-end client communication
author: 
ms.date: 04/25/2024
---
...
In a cloud-native system, front-end clients, such as mobile, web, and desktop applications, require a communication channel to interact with independent back-end microservices.
...
**Figure 6-1**. Direct client to service communication
...
**Figure 6-2**. API gateway pattern
...
**Figure 6-3**. Backend for frontend pattern
...
> [!div class="mx-imgBorder"]
> ![Application Gateway Ingress Controller diagram](media/application-gateway-ingress-controller.png)

**Figure 6-4**. Application Gateway Ingress Controller
...
> [!div class="mx-imgBorder"]
> ![Azure API Management diagram](media/azure-api-management.png)

**Figure 6-5**. Azure API Management

To start, API Management exposes a gateway server that allows controlled access to back-end services based upon configurable rules and policies. These services can be in the Azure cloud, your on-premises data center, or other public clouds. API keys and JSON Web Tokens (JWTs) determine who can do what. All traffic is logged for analytical purposes.

For developers, API Management offers a developer portal that provides access to services, documentation, and sample code for invoking them. Developers can use Swagger and Open API to inspect service endpoints and analyze their usage. The service works across the major development platforms: .NET, Java, Golang, and more.
...
Policies can affect the behavior of your cloud-native services in many ways. For example, they can:
...
- Microservices where traffic has occasional large spikes but remains low most of the time.
...
One technology developers can use to implement real-time communications is **SignalR**. SignalR is a free library for .NET and makes it easier and quicker to implement real-time communications in your code.

### Azure SignalR Service

[Azure SignalR Service](https://azure.microsoft.com/services/signalr-service/) is a fully managed Azure service that implements SignalR and simplifies real-time communication for your cloud-native applications. Technical implementation details like capacity provisioning, scaling, and persistent connections are abstracted away. They're handled for you with a 99.9% SLA. You focus on application features, not infrastructure plumbing.
...
Figure 6-6 shows a set of HTTP Clients connecting to a Cloud-native application with Azure SignalR enabled.

> [!div class="mx-imgBorder"]
> ![Azure SignalR diagram](media/azure-signalr-service.png)

**Figure 6-6**. Azure SignalR
...
If you've chosen to build your application based on .NET Aspire, it's easy to integrate with the Azure SignalR Service to implement real-time communications with clients. .NET Aspire includes an Azure SignalR Service component.
