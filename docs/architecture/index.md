...
## [Containerized Docker Application Lifecycle with the Microsoft Platform and Tools](./containerized-lifecycle/index.md)
...
## [Modernize Existing .NET Applications with Azure cloud and Windows Containers](./modernize-azure-containers/index.md)
...
## [Architect modern web applications with ASP.NET Core and Azure](modern-web-apps-azure/index.md)
...
## [Architecting Container and Microservice Based Applications](microservices/index.md)
...
## [Serverless apps: Architecture, patterns, and Azure implementation](serverless/index.md)
