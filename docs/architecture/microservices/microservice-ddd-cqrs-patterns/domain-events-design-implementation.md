...
![Diagram showing a domain event controlling data to event handlers.](./media/domain-events-design-implementation/aggregate-domain-event-handlers.png)
...
![Diagram showing a domain event dispatcher sending data to handlers.](./media/domain-events-design-implementation/domain-event-dispatcher.png)
