...
The reasoning behind this is that many bugs occur because objects are in a state they should never have been in. This [online discussion](http://codebetter.com/gregyoung/2009/05/22/always-valid/) is a good explanation from Greg Young.
