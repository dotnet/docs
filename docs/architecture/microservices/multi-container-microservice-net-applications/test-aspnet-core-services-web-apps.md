...
While unit and integration tests are contained in a test folder in each microservice, application and load tests are contained under the test folder in the solution folder, as shown in Figure 6-25.
