...
| WCF, WF, and other legacy frameworks | WCF in .NET Core (client library only) or [CoreWCF](https://www.nuget.org/profiles/corewcf) | .NET Framework <br/> WCF in .NET 7 (client library only) or [CoreWCF](https://www.nuget.org/profiles/corewcf) |
| Consumption of Azure services | .NET 7 <br/> (eventually most Azure services will provide client SDKs for .NET 7) | .NET Framework <br/> .NET 7 <br/> (eventually most Azure services will provide client SDKs for .NET 7) |
