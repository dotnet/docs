...
Some .NET Framework technologies are not available in the current version of .NET Core (version 3.1 as of this writing). Some of them will be available in later .NET Core releases, but others do not apply to the new application patterns targeted by .NET Core and might never be available.
