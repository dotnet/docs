...
The [SDK-style project](../../core/project-sdk/msbuild-props.md) for .NET Core
...
![Unload Project](media/example-migration-core/unload-project.png)
...
![Screenshot of compilation errors on Visual Studio](./media/example-migration-core/errors.png)
...
If you compile the project again and execute it, you won't see the product
