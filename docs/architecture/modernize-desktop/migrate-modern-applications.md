...
If you just want to update your application to the latest .NET version using a tool and not getting into the details of what is happening behind the scenes, feel free to skip this chapter and find a step by step instruction in [Example of migrating to .NET](example-migration.md) chapter.
