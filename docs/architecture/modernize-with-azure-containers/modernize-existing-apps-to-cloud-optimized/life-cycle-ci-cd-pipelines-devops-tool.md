...
![Screenshot of Azure DevOps Services deploying to a Kubernetes cluster.](./media/life-cycle-ci-cd-pipelines-devops-tool/deploy-mvc-app-container-kubernetes.png)
