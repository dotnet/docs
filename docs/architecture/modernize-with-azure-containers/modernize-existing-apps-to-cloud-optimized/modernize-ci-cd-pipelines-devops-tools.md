...
![Screenshot of Azure DevOps Services deploying to a Kubernetes cluster.](./media/modernize-ci-cd-pipelines-devops-tools/deploy-mvc-app-container-kubernetes.png)
