...
:::image type="content" source="../media/get-started-app-chat-template/chat-app-components-version-4.png" lightbox="../media/get-started-app-chat-template/chat-app-components-version-4.png" alt-text="Diagram showing architecture from client to backend app.":::
