...
* [Install Azure Data Studio](/sql/azure-data-studio/download-azure-data-studio) if you are working with Azure SQL. Azure Data Studio also supports other database options such as MySQL, PostgreSQL, and Azure Cosmos DB through extensions.
