...
| ![Container Apps Icon](./media/container-apps.svg) | **Azure Container Apps** | Azure Container Apps is a fully managed environment that enables you to run microservices and containerized applications on a serverless platform. Applications built on Container Apps provide scalability, resiliency and other advantages of complex contaienr orchestrators while leaving behind many of the complexities.  |
