...
- [Publish your app using Visual Studio](/azure/virtual-machines/windows/publish-web-app-from-visual-studio?utm_campaign=liftandshift&utm_medium=link&utm_source=liftandshift)
