...
[!INCLUDE [auth-create-entra-group](~/azure-dev-docs-pr/articles/includes/authentication/includes/auth-create-entra-group.md)]
...
[!INCLUDE [auth-visual-studio](~/azure-dev-docs-pr/articles/includes/authentication/includes/auth-visual-studio.md)]
