...
| [DefaultValueAttribute constructor no longer annotated with DynamicallyAccessedMembers](core-libraries/10.0/defaultvalueattribute-dynamically-accessed-members.md) | Binary/source incompatible | Preview 7 |
