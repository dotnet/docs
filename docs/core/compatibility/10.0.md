...
| Title | Type of change    |
|-------|-------------------|
| [System.Text.Json validates property names conflicting with metadata properties](serialization/10/json-validates-metadata-property-names.md) | Behavioral change |
