...
|-------------------------------------------------------------------|-------------------|
| [DateOnly and TimeOnly TryParse methods throw for invalid DateTimeStyles](core-libraries/11/dateonly-timeonly-tryparse-argumentexception.md) | Behavioral change |
