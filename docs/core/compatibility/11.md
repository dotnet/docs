...
| Title | Type of change    |
|-------|-------------------|
| [IHost.RunAsync and IHost.StopAsync throw when a BackgroundService fails](extensions/11.0/ihost-runasync-stopasync-throw-backgroundservice-failure.md) | Behavioral change |
