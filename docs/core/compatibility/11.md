...
|-------------------------------------------------------------------|-------------------|
| [DeflateStream and GZipStream encode empty payload into nonempty encoded payload](core-libraries/11/deflatestream-gzipstream-empty-payload.md) | Behavioral change |
