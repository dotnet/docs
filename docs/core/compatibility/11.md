...
| [Restore doesn't search the global packages folder for a higher package version](sdk/11/restore-global-packages-folder-version-search.md) | Source incompatible |
