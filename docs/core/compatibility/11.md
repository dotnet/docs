...
| [RSACryptoServiceProvider.Encrypt and Decrypt with fOAEP are obsolete](cryptography/11/rsacryptoserviceprovider-encrypt-decrypt-obsolete.md) | Source incompatible |
