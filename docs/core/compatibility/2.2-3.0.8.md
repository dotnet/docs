---
title: Breaking changes, version 2.2 to 3.0 Preview 8 (.NET Core)
description: Lists the breaking changes from version 2.2 to version 3.0 Preview 8 of .NET Core, ASP.NET Core, and EF Core.
ms.date: "09/10/2019"
author: "rpetrusha"
ms.author: "ronpet"
---
# Breaking changes for migration from 2.2 to 3.0 Preview 8
...
If you are migrating from version 2.2 to 3.0 Preview 8 of .NET Core, ASP.NET Core, or EF Core, review the following topics for breaking changes that may affect your app:
