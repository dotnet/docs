...
Currently, the default version of Bootstrap for IdentityUI is `UIFramework.Bootstrap3`. Starting in ASP.NET Core 3.0, the default version is `UIFramework.Bootstrap4`.
