...
If you're migrating an app to .NET 5.0, the breaking changes listed here might affect you. Changes are grouped by technology area, such as ASP.NET Core or cryptography.
...
- [Directory.Packages.props files imported by default](msbuild/5.0/directory-packages-props-imported-by-default.md)
- [NETCOREAPP3_1 preprocessor symbol not defined](msbuild/5.0/netcoreapp3_1-preprocessor-symbol-not-defined.md)
- [PublishDepsFilePath behavior change](msbuild/5.0/publishdepsfilepath-behavior-change.md)
- [TargetFramework change from netcoreapp to net](msbuild/5.0/targetframework-name-change.md)
