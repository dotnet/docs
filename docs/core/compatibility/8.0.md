...
| Title                                                                   | Type of change    | Introduced |
| ----------------------------------------------------------------------- | ----------------- | ---------- |
| [Debian container images upgraded to Debian 12](deployment/8.0/debian-container-image.md) | Binary incompatible/behavioral change | Preview 1 |
| [Host determines RID-specific assets](deployment/8.0/rid-asset-list.md) | Binary incompatible/behavioral change | Preview 5 |
| [Multi-platform container tags are Linux-only](deployment/8.0/multi-platform-container-tags.md) | Behavioral change | Preview 3 |
