...
Previously, you could set `<IncludeOpenAPIAnalyzers>true</IncludeOpenAPIAnalyzers>` in you Web SDK projects to enable MVC API analyzers without any warnings or deprecation notices.
