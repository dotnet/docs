...
This change can affect [source compatibility](../../categories.md#source-compatibility), and also [binary compatibility](../../categories.md#binary-compatibility) for libraries that were compiled against `Microsoft.OpenApi` 2.x and are loaded into an app that resolves the 3.x assembly at runtime.
