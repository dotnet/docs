...
description: Learn about the .NET 5.0 breaking change in core .NET libraries where absolute URI paths that contain non-ASCII characters now parse correctly on Unix platforms.
ms.date: 11/01/2020
---
