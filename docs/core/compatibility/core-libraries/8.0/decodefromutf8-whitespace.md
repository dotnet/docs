...
- The new <xref:System.Buffers.Text.Base64.IsValid(ReadOnlySpan{System.Char})> and <xref:System.Buffers.Text.Base64.IsValid(ReadOnlySpan{System.Byte})> methods would either need to have behavior inconsistent with each other or with their corresponding methods for UTF-16 and UTF-8 data on <xref:System.Convert> and <xref:System.Buffers.Text.Base64>.
