...
- [Floating point formatting and parsing behavior changes](#[floating-point-formatting-and-parsing-behavior-changes)
...
- [NET Core 3.0 follows Unicode best practices when replacing ill-formed UTF-8 byte sequences](#net-core-30-follows-unicode-best-practices-when-replacing-ill-utf-8-byte-sequences)
