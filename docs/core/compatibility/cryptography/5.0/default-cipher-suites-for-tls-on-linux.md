...
description: Learn about the breaking change in .NET 5.0 where .NET, on Linux, now respects the OpenSSL configuration for default cipher suites when doing TLS/SSL.
ms.date: 10/16/2020
---
