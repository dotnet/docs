---
title: Breaking changes for WPF and WinForms
description: Lists the breaking changes from .NET Framework to .NET Core for Windows Forms and Windows Presentation Foundation.
ms.date: 11/26/2019
---
# Breaking changes for WPF and Windows Forms
