...
description: Learn about the breaking change in .NET 5.0 where SendToAsync now updates the value of the local endpoint property to the socket's local address.
ms.date: 10/18/2020
---
