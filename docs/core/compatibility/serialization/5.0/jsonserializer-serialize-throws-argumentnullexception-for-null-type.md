...
description: Learn about the breaking change in .NET 5.0 where JsonSerialize serialization methods that have a Type parameter now throw an exception whenever null is passed for that parameter.
ms.date: 10/18/2020
---
