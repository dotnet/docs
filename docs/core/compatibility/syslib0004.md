...
- If you have applied a CER attribute to a method, remove the attribute. These attributes have no effect in .NET 5.0.
...
- If you are calling `RuntimeHelpers.ProbeForSufficientStack` or `RuntimeHelpers.PrepareContractedDelegate`, remove the call. These calls have no effect in .NET 5.0.
...
- If you are calling `RuntimeHelpers.PrepareConstrainedRegions`, remove the call. This call has no effect in .NET 5.0.
