...
description: Learn about the breaking change in .NET 5.0 where some APIs related to DataGridView throw an exception if the object's DataGridViewCellAccessibleObject.Owner value is null.
ms.date: 09/18/2020
---
