...
3. If a satellite assembly is loaded:
   ...
   - Then it's searched it for the requested resource. If it finds the resource in the assembly, it uses it. If it doesn't find the resource, it continues the search.
