...
The [How to use and debug assembly unloadability in .NET Core](/dotnet/standard/assembly/unloadability) article is a step-by-step tutorial. It shows how to load a .NET Core application, execute, and then unload it. The article also provides debugging tips.
