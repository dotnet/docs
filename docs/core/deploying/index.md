...
=======
ms.date: 03/14/2017
>>>>>>> a8090b7baa8d8ee56cd22ae0f457295ac275dc81
ms.topic: article
ms.prod: .net-core
ms.devlang: dotnet
...
- A framework-dependent deployment with the third-party dependencies
- A simple self-contained deployment
- A self-contained deployment with third-party dependencies
- A self-contained app with a smaller footprint
