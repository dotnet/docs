...
When publishing as a single file (for example, by setting the PublishSingleFile property in a project to true), calling the <xref:System.Reflection.Assembly.GetFile%2A> or <xref:System.Reflection.Assembly.GetFiles> method for
