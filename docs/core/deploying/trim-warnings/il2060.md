...
Call to <xref:System.Reflection.MethodInfo.MakeGenericMethod> cannot be statically analyzed by the trimmer.

## Rule description

This can either be that the method on which the <xref:System.Reflection.MethodInfo.MakeGenericMethod> is called cannot be
