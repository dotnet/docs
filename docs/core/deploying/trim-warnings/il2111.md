...
Trimmer currently can't guarantee that all requirements of the <xref:System.Diagnostics.CodeAnalysis.DynamicallyAccessedMembersAttribute> are fulfilled if the method is accessed via reflection.
