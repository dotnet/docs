---
title: "Trim Warning IL2023: Method 'method' has more than one return element specified. There can only be one return element."
description: "Learn about trim warning IL2023"
ms.date: 08/25/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2023"
---
# Trim Warning IL2023: Method 'method' has more than one return element specified. There can only be one return element.

There is more than one 'return' child element specified for method 'method'.
