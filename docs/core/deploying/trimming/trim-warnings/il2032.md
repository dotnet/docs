---
title: "Trim Warning IL2032: The value passed as the assembly name or type name to the CreateInstance method can't be statically analyzed."
description: "Learn about trim warning IL2032"
ms.date: 08/25/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2032"
---
# Trim Warning IL2032: The value passed as the assembly name or type name to the CreateInstance method can't be statically analyzed.

Unrecognized value passed to the parameter 'parameter' of method 'method'. It's not possible to guarantee the availability of the target type.
