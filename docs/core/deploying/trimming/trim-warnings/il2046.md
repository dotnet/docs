---
title: "Trim Warning IL2046: 'RequiresUnreferencedCodeAttribute' annotations must match across all interface implementations or overrides."
description: "Learn about trim warning IL2046"
ms.date: 08/27/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2046"
---
# Trim Warning IL2046: 'RequiresUnreferencedCodeAttribute' annotations must match across all interface implementations or overrides.
...
override. For all interfaces and override members, the implementation and definition must either both be annotated
with 'RequiresUnreferencedCodeAttribute', or neither be annotated.
