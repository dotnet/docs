...
description: "Learn about trim warning IL2057: Unrecognized value passed to GetType"
ms.date: 07/23/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2057"
---
# IL2057: Unrecognized value passed to the parameter of method 'System.Type.GetType(String). It's not possible to guarantee the availability of the target type.
