---
title: "Trim Warning IL2070: 'this' argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to target method. The parameter of method does not have matching annotations."
description: "Learn about trim warning IL2070"
ms.date: 10/06/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2070"
---
# Trim Warning IL2070: 'this' argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to target method. The parameter of method does not have matching annotations.

'this' argument does not satisfy satisfy in call to 'method'. The parameter 'parameter' of method 'method' does not have matching annotations. The source value must declare at least the same requirements as those declared on the target location it is assigned to.
