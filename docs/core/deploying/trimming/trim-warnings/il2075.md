---
title: "Trim Warning IL2075: 'this' argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to target method. The return value of the source method does not have matching annotations."
description: "Learn about trim warning IL2075"
ms.date: 10/06/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2075"
---
# Trim Warning IL2075: 'this' argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to target method. The return value of the source method does not have matching annotations.

'this' argument does not satisfy satisfy in call to 'method'. The return value of method 'method' does not have matching annotations. The source value must declare at least the same requirements as those declared on the target location it is assigned to.
