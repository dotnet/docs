---
title: "Trim Warning IL2077: Target parameter argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to target method. The source field does not have matching annotations."
description: "Learn about trim warning IL2077"
ms.date: 10/06/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2077"
---
# Trim Warning IL2077: Target parameter argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to target method. The source field does not have matching annotations.

'targetParameter' argument does not satisfy 'DynamicallyAccessedMembersAttribute' in call to 'method'. The field 'field' does not have matching annotations. The source value must declare at least the same requirements as those declared on the target location it is assigned to.
