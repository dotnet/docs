---
title: "Trim Warning IL2078: Target method return value does not satisfy 'DynamicallyAccessedMembersAttribute' requirements. The source field does not have matching annotations."
description: "Learn about trim warning IL2078"
ms.date: 10/06/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2078"
---
# Trim Warning IL2078: Target method return value does not satisfy 'DynamicallyAccessedMembersAttribute' requirements. The source field does not have matching annotations.

'targetMethod' method return value does not satisfy 'DynamicallyAccessedMembersAttribute' requirements. The field 'field' does not have matching annotations. The source value must declare at least the same requirements as those declared on the target location it is assigned to.
