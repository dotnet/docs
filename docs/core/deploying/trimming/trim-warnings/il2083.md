---
title: "Trim Warning IL2083: Target method return value does not satisfy 'DynamicallyAccessedMembersAttribute' requirements. The implicit 'this' argument of source method does not have matching annotations."
description: "Learn about trim warning IL2083"
ms.date: 10/06/2021
ms.topic: reference
author: mateoatr
f1_keywords:
  - "IL2083"
---
# Trim Warning IL2083: Target method return value does not satisfy 'DynamicallyAccessedMembersAttribute' requirements. The implicit 'this' argument of source method does not have matching annotations.

'method' method return value does not satisfy 'DynamicallyAccessedMembersAttribute' requirements. The implicit 'this' argument of method 'method' does not have matching annotations. The source value must declare at least the same requirements as those declared on the target location it is assigned to.
