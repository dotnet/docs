...
| `XmlResolverIsNetworkingEnabledByDefault` | When set to `false`, removes support for resolving non-file URLs in <xref:System.Xml>. Only file-system resolving is supported. |
