...
- Instantiates a new <xref:Microsoft.Extensions.DependencyInjection.ServiceCollection> instance, chaining a call to the <xref:Microsoft.Extensions.DependencyInjection.IServiceCollection AddExceptionSummarizer%2A> extension method.
