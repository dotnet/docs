---
title: Instrument Code to Create DiagnosticSource Events
description: A tutorial for instrumenting code with DiagnosticSource
ms.date: 05/02/2022
---
# Instrument Code to Create DiagnosticSource Events
...
We show how to instrument DiagnosticListener using the DiagnosticListener we made in [getting-started](/docs/core/diagnostics/diagnosticsource-getting-started).
