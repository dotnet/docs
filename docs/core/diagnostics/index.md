...
[dotnet-sos](dotnet-sos.md) is used to install the [SOS debugging extension](sos-debugging-extension.md) on Linux or MacOS (or on Windows if using [Windbg/cdb](https://docs.microsoft.com/en-us/windows-hardware/drivers/debugger/debugger-download-tools)).
