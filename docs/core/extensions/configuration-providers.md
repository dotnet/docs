...
:::image type="content" source="media/configuration-providers/launch-profiles-env-vars.png" alt-text="Launch Profiles dialog showing environment variables" lightbox="media/configuration-providers/launch-profiles-env-vars.png":::
...
:::image type="content" source="media/configuration-providers/launch-profiles-cmd-line-args.png" alt-text="Launch Profiles dialog showing command-line arguments" lightbox="media/configuration-providers/launch-profiles-cmd-line-args.png":::
