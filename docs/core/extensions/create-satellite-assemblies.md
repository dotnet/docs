...
> ```
>
> The .NET Core MSBuild task uses *csc.exe* instead of [Al.exe (Assembly Linker)](../../framework/tools/al-exe-assembly-linker.md) to generate satellite assemblies, by default. For more information, see [Make it easier to opt into "Core" satellite assembly generation](https://github.com/dotnet/msbuild/pull/2726).
