...
[Create logs in Main](#create-logs-in-main) shows how to create logs in `Main`.
...
Logs created with the [default logging providers](#logging-providers) are displayed:
