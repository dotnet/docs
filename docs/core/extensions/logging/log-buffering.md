...
:::code language="csharp" source="snippets/log-buffering/global/basic/Program.cs" range="18-19":::
...
:::code language="json" source="snippets/log-buffering/global/file-based/appsettings.json" range="1-22" highlight="7-20" :::
...
:::code language="csharp" source="snippets/log-buffering/global/file-based/Program.cs" range="21-22":::

### Inline code configuration

:::code language="csharp" source="snippets/log-buffering/global/code-based/Program.cs" range="18-28" :::
...
:::code language="cs" source="snippets/log-buffering/global/basic/myservice.cs" range="6-22" highlight="5,12" :::
...
:::code language="cs" source="snippets/log-buffering/per-request/basic/program.cs" range="16" :::

### File-based configuration

Create a configuration section in your _appsettings.json_:

:::code language="json" source="snippets/log-buffering/per-request/file-based/appsettings.json" range="1-18" highlight="8-16":::
...
:::code language="cs" source="snippets/log-buffering/per-request/file-based/program.cs" range="16" :::

### Inline code configuration

:::code language="cs" source="snippets/log-buffering/per-request/code-based/program.cs" range="16-20" :::
...
:::code language="cs" source="snippets/log-buffering/per-request/basic/homecontroller.cs" range="8-48" highlight="8,11,34" :::
...
:::code language="json" source="snippets/log-buffering/per-request/file-based/appsettings.json" range="1-19" :::

While the app is running, you can update the _appsettings.json_ with the following configuration:

:::code language="json" source="snippets/log-buffering/per-request/file-based/appsettingsUpdated.json" range="1-17" highlight="9-13" :::
