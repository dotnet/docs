...
### Options interfaces rationale

There is a common question among developers regarding options interfaces:

> Why should we use `IOptions<T>` when we can inject the configuration object directly?
