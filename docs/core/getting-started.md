...
.NET Core runs on [Windows](#windows), [Linux](#linux), and [macOS](#macos)

## Windows

.NET Core is supported by  the following versions of Windows (both 32-bit and 64-bit editions of client operating systems):
