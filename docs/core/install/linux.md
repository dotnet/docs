...
This article details how to install .NET on various Linux distributions, manually, via a package manager, or [containers](../docker/introduction.md#net-core-images).
