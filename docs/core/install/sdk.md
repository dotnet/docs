...
You can install the .NET Core SDK with many of the common Linux package managers. For more information, see [Ubuntu 19.10 Package Manager - Install .NET Core](linux-package-manager-ubuntu-1910.md).
