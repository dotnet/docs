...
> [!TIP]
> The installer returns an exit code of 0 for a success and an exit code of 3010 to indicate a reboot is required. Any other value is generally an error code.
