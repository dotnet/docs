...
description: "Learn how to upgrade your .NET applications to newer versions using GitHub Copilot modernization. This step-by-step guide covers the four-stage workflow: pre-initialization, assessment, planning, and execution."
ms.topic: how-to
ms.date: 03/23/2026
...
GitHub Copilot modernization is an AI-powered agent that upgrades .NET projects to newer versions and migrates applications to Azure. This article guides you through upgrading your .NET applications using a structured four-stage workflow: pre-initialization, assessment, planning, and execution.
