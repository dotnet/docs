...
GitHub Copilot modernization is included in Visual Studio. No separate installation is required. Enable the **GitHub Copilot** and **GitHub Copilot modernization** optional components in the **.NET desktop development** workload through the Visual Studio Installer.
