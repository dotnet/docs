...
3. Use the [API Portability Analyzer tool](https://github.com/Microsoft/dotnet-apiport/blob/master/docs/HowTo) to analyze your assemblies and develop a plan to port based on its results.
