...
In .NET 9.0 we added new persisted `AsemblyBuilder` implementation and added the <xref:System.Reflection.Emit.AssemblyBuilder.Save%2A?displayProperty=nameWithType> method back. Check [this doc](../../fundamentals/runtime-libraries/system-reflection-emit-assemblybuilder.md) to learn more about how to use the new API.
