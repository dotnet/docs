...
If you're looking to port your code to .NET Core, the first step in the porting process is to understand your third-party dependencies. You need to evaluate which of them, if any, don't yet run on .NET Core and develop a contingency plan for these.

## Prerequisites

This article assumes you're using Windows and Visual Studio, and that you have code that currently runs on the .NET Framework.
