...
You might have a dependency that isn't a NuGet package, such as a DLL in the file system. You can determine the portability of that dependency with [GitHub Copilot upgrade](github-copilot-upgrade/overview.md).
