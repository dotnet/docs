...
> [!TIP]
> You can also refer to the [UWP migration guide](/windows/apps/windows-app-sdk/migrate-to-windows-app-sdk/migrate-to-windows-app-sdk-ovw), which tells you more about the changes from UWP APIs to the new Windows App SDK-supported APIs and capabilities.  
