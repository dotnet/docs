...
## Name 
dotnet-migrate -- Migrates a Preview 2 .NET Core project to Preview 4 .NET Core project
...
## Description
The `dotnet migrate` command will migrate a valid Preview 2 `project.json` based project to a valid Preview 4 `csproj` project. 
...
As of Preview 4, the `dotnet migrate` command only supports valid Preview 2 `project.json` files. This means that you cannot 
