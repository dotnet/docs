...
3. The `dotnet` driver for running the [CLI commands](https://docs.microsoft.com/en-us/dotnet/articles/core/tools/) as well as running applications
...
the [driver section](https://docs.microsoft.com/en-us/dotnet/articles/core/tools/#driver) of .NET Core Command Line Tools topic. 
