...
> [!IMPORTANT]
> If you receive an error message similar to **Unable to locate package dotnet-runtime-3.0**, run the following commands.
>
> ```bash
> sudo dpkg --purge packages-microsoft-prod && sudo dpkg -i packages-microsoft-prod.deb
> sudo apt-get update
...
> [!IMPORTANT]
> If you receive an error message similar to **Unable to locate package aspnetcore-runtime-3.0**, run the following commands.
>
> ```bash
> sudo dpkg --purge packages-microsoft-prod && sudo dpkg -i packages-microsoft-prod.deb
> sudo apt-get update
