...
| All | Whether the repository is the MTP development repository, based on the `platformOptions:telemetry:isDevelopmentRepository` setting in *[appname].testconfig.json*. |
