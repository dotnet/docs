...
| `5` (no longer used) | Exit code `5` is no longer produced by the platform; it previously indicated that the command-line arguments passed to the test app were invalid. |
