...
Before building the library or the tests, execute [`dotnet sln add .\PrimeService.Tests\PrimeService.Tests.vbproj`](../tools/dotnet-restore.md) in the *unit-testing-using-dotnet-test* directory. 
...
[!code-vb[Sample_TestCode](../../../samples/core/getting-started/unit-testing-vb-using-dotnet-test/PrimeService.Tests/PrimeService_IsPrimeShould.vb?name=Sample_TestCode)]
