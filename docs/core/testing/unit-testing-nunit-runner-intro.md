---
title: Microsoft.Testing.Platform (MTP) support in NUnit (NUnit runner)
...
# Microsoft.Testing.Platform (MTP) support in NUnit (NUnit runner)

> [!TIP]
> Before enabling a runner, see [Test platforms overview](./test-platforms-overview.md).
...
The NUnit runner is open source, and builds on top of [MTP](./microsoft-testing-platform-intro.md). You can find `Microsoft.Testing.Platform` code in [microsoft/testfx](https://github.com/microsoft/testfx/tree/main/src/Platform/Microsoft.Testing.Platform) GitHub repository. The NUnit runner is supported in NUnit3TestAdapter version 5.0 or greater. For more information, see [NUnit and MTP](https://docs.nunit.org/articles/vs-test-adapter/NUnit-And-Microsoft-Test-Platform.html).
