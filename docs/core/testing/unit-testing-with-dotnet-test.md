...
description: Learn unit test concepts in .NET Core through an interactive experience building a sample solution step-by-step using dotnet text and xUnit.
author: ardalis
ms.author: wiwagn
ms.date: 03/21/2017
ms.topic: article
