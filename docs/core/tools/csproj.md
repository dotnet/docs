...
`IncludeAssets` attribute specifies that assets belonging to the package specified by `<PackageReference>` should be 
consumed. 

`ExcludeAssets` attribute specifies that assets belonging to the package specified by `<PackageReference>` should not 
be consumed.

`PrivateAssets` attribute specifies that assets belonging to the package specified by `<PackageReference>` should be 
