...
> [!NOTE]
> The [dotnet/templating](https://github.com/dotnet/templating/) repo is currently archived and no longer maintained. While it's a good resource for templates, examples there may not work for you.
