...
To follow a walkthrough and create a template, see the [Create a custom template for dotnet new](/dotnet/core/tutorials/cli-templates-create-item-template) tutorial.
...
- [Create a custom template for dotnet new (tutorial)](/dotnet/core/tutorials/cli-templates-create-item-template)
