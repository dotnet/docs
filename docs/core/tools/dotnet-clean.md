...
* **`-r|--runtime <RUNTIME_IDENTIFIER>`**
  ...
  Cleans the output folder of the specified runtime. This is used when a [self-contained deployment](../deploying/index.md#self-contained) was created. Option available since .NET Core 2.0 SDK.
