...
`dotnet clean [<PROJECT>] [-o|--output <OUTPUT_DIRECTORY>] [-f|--framework <FRAMEWORK>] [-c|--configuration <CONFIGURATION>] [-v|--verbosity <LEVEL>] [-h|--help]`
...
Set the verbosity level of the command. Allowed levels are q[uiet], m[inimal], n[ormal], d[etailed], and diag[nostic].
