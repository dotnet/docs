...
- **`https`**
  ...
  In .NET 10 and later, the generated ASP.NET Core development certificate includes these subject alternative names (SANs), which lets you use the certificate in container-based local development scenarios:
