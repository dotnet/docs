...
> [!NOTE]
> These variables apply to **.NET 10 and later versions**. For older versions, replace the `DOTNET_HOST_` prefix with `COREHOST_` (e.g., `COREHOST_TRACE`). The functionality and values remain identical.
