...
This command is deprecated. It is no longer available in and after .NET Core 3.x SDK. It can only migrate a Preview 2 .NET Core project to a 1.x .NET Core project which is currently out of support.
