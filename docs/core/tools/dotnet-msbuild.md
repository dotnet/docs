...
The [dotnet build](dotnet-build.md) command is equivalent to `dotnet msbuild -restore`. When you want to build the project and you have a specific target you want to run, use `dotnet build` or `dotnet msbuild` and specify the target.
