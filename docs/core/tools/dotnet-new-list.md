...
> [!WARNING]
> In order to limit the list of templates to those that are relevant, we walk up the current tree to find a .NET project to scope the list of templates. Ensure you only run dotnet new commands from trusted directories.
