...
- **`--vulnerable`**
  ...
  Available starting in **.NET SDK 9.0.300**, this option uses `<AuditSources>` property in your configuration file to specify your source of vulnerability data, which is acquired from the [VulnerabilityInfo](/nuget/api/vulnerability-info) resource.
