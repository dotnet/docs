...
```
dotnet [command] [arguments] [--additional-deps] [--additionalprobingpath] [-d|--diagnostics] [--fx-version] [--info] [--roll-forward-on-no-candidate-fx] [-v|--verbose] [--version]
dotnet [command] [-h|--help]
```
# [.NET Core 1.x](#tab/netcore1x)
```
dotnet [command] [arguments] [--additionalprobingpath] [-d|--diagnostics] [--fx-version] [--info] [-v|--verbose] [--version]
dotnet [command] [-h|--help]
```
---
