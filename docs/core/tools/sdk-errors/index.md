...
|NETSDK1089|The '{0}' and '{1}' types have the same CLSID '{2}' set in their GuidA[NETSDK1080](netsdk1080.md)ttribute. Each COMVisible class needs to have a distinct guid for their CLSID.|
