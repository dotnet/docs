...
> [!TIP]
> You can use [GitHub Copilot modernization](../../porting/github-copilot-app-upgrade/overview.md) to assess, plan, and upgrade your project to a supported version of .NET.
