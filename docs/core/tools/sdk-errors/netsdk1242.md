---
title: "NETSDK1242: Building projects with the Mono runtime is not supported in .NET 11"
...
- NETSDK1242
---
# NETSDK1242: Building projects with the Mono runtime is not supported in .NET 11
...
- Build the project with the .NET 11 SDK without selecting the Mono runtime. Remove the `UseMonoRuntime` property from the project, or set it to `false`:
