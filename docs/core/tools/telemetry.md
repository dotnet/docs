...
> 2. DATA. The software may collect information about you and your use of the software, and send that to Microsoft. Microsoft may use this information to improve our products and services. You can learn more about data collection and use in the help documentation and the privacy statement at https://www.microsoft.com/en-us/privacystatement/EnterpriseDev/default.aspx. Your use of the software operates as your consent to these practices.
