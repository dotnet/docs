...
## Use the CLI and Visual Studio Code

- [Create a console app](with-visual-studio-code.md)
- [Create a library and unit test it on macOS](using-on-macos.md)

## Use the CLI

- [1 - Create a console app and publish it](cli-create-console-app.md)
- [2 - Unit test an app](testing-with-cli.md)
