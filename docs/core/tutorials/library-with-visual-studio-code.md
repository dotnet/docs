...
1. After selecting the command, you need to choose the project template. Choose Class Library.
...
1. Select **Show all template options**, then select **.NET 10**, and finally select **Create Project**.
...
1. Alternatively, add the following to *ShowCase.csproj*:
