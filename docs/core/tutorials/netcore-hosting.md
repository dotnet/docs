...
A [sample host](https://github.com/dotnet/samples/tree/master/samples/core/hosting) demonstrating the steps outlined in this article is available in the dotnet/docs GitHub repository. Comments in the sample's *host.cpp* file clearly associate the numbered steps from this tutorial with where they're performed in the sample. For download instructions, see [Samples and Tutorials](../../samples-and-tutorials/index.md#viewing-and-downloading-samples).
...
In our [simple sample host](https://github.com/dotnet/samples/tree/master/samples/core/hosting), these properties are set up as follows:
