...
[//]: # "Need review: is this step necessary ?"
...
8. Choose "nuget.org" as the **Package source**, and choose the **Browse** tab. Check the **Include prerelease** checkbox, and then browse for **MSTest.TestFramework** version 1.0.1-preview or newer, and then click **Install**. 

9. Browse for **dotnet-test-mstest** version 1.1.1-preview or newer, and then click **Install**.
...
11. Edit `project.json` to add `"testRunner": "mstest",` after the `"version"` section.
