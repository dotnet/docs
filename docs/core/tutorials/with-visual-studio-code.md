...
1. In the **Do you trust the authors of the files in this folder?** dialog, select **Yes, I trust the authors** since the project folder has files generated by .NET.
