...
2. The [.NET 5.0 SDK](https://dotnet.microsoft.com/download). If you install the .NET 6 SDK, install the .NET 5.0 SDK also, or some of the tutorial instructions won't work. For more information, see [New C# templates generate top-level statements](top-level-templates.md).
