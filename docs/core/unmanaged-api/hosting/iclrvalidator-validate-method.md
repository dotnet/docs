---
description: "Learn more about: ICLRValidator::Validate Method"
...
Validates the portable executable (PE) or common intermediate language (CIL) in the specified file.
