...
> [!NOTE]
> .NET Framework version 2.0 does not provide a way for the host to load the native image of an assembly, as provided by the [Native Image Generator (Ngen.exe)](../../../framework/tools/ngen-exe-native-image-generator.md) utility.
