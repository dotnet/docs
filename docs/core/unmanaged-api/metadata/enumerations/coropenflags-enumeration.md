...
|`ofReadOnly`|Indicates that the file should be opened for reading, and that a call to `QueryInterface` for an [IMetaDataEmit](../interfaces/imtadataemit-interface.md) cannot be made.|
