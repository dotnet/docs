...
## Support for MTP in `dotnet test`

Starting in .NET 10, `dotnet test` natively supports [Microsoft.Testing.Platform (MTP)](../../testing/microsoft-testing-platform-intro.md). To enable this feature, add the following configuration to your *global.json* file:
