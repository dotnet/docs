...
New generic <xref:System.Text.Json.JsonSerializerOptions.GetTypeInfo%60%601> and `TryGetTypeInfo<T>()` methods return strongly typed metadata directly, eliminating the cast.
