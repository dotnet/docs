...
| [CA1865: Use char overload](../../fundamentals/code-analysis/quality-rules/ca1865.md) | Performance | The char overload is a better performing overload for a string with a single char. |
| [CA1866: Use char overload](../../fundamentals/code-analysis/quality-rules/ca1866.md) | Performance | The char overload is a better performing overload for a string with a single char. |
| [CA1867: Use char overload](../../fundamentals/code-analysis/quality-rules/ca1867.md) | Performance | The char overload is a better performing overload for a string with a single char. |
