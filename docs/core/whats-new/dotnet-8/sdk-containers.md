---
title: What's new in the SDK and containers for .NET 8
description: Learn about the new .NET SDK, containers, and tooling features introduced in .NET 8.
titleSuffix: ""
ms.date: 11/14/2023
ms.topic: overview
ms.author: gewarren
author: gewarren
---
# What's new in the SDK and containers for .NET 8
