...
description: Learn about the new .NET features introduced in .NET 9 for the runtime, libraries, SDK. Also finds links to what's new in other areas, such as ASP.NET Core.
titleSuffix: ""
ms.date: 08/15/2024
ms.topic: whats-new
---
