...
The updated `Main` method is now considered an [Async main](../fundamentals/program-structure/main-command-line.md#main-return-task), which allows for an asynchronous entry point into the executable. It is expressed as a call to `SumPageSizesAsync`.
