...
You can use object initializers to initialize type objects in a declarative manner without explicitly invoking a constructor for the type.  
 ...
 You must use an object initializer if you're defining an anonymous type. For more information, see [How to: Return Subsets of Element Properties in a Query](../classes-and-structs/fabdf349-f443-4e3f-8368-6c471be1dd7b.md).  
  
## Example  
 The following example shows how to initialize a new `StudentName` type by using object initializers.  
  
 [!code[csProgGuideLINQ#35](../arrays/codesnippet/CSharp/4b75ebb2-2e29-43de-929c-d736a8f27ce6_1.cs)]  
...
## Example  
 ...
 [!code[csProgGuideLINQ#36](../arrays/codesnippet/CSharp/4b75ebb2-2e29-43de-929c-d736a8f27ce6_2.cs)]  
  
## Compiling the Code  
 To run this code, copy and paste the class into a Visual C# console application project that has been created in [!INCLUDE[vsprvs](../classes-and-structs/includes/vsprvs_md.md)]. For more information, see [How to: Create a LINQ Project](../Topic/How%20to:%20Create%20a%20LINQ%20Project.md).  
