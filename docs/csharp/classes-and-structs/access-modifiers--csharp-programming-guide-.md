...
All types and type members have an accessibility level, which controls whether they can be used from other code in your assembly or other assemblies. You can use the following access modifiers to specify the accessibility of a type or member when you declare it:  
 ...
 [!code[csProgGuideObjects#72](../classes-and-structs/codesnippet/CSharp/access-modifiers--csharp-programming-guide-_1.cs)]  
...
## Class and Struct Member Accessibility  
 ...
 User-defined operators must always be declared as public. For more information, see [operator (C# Reference)](../keywords/operator--csharp-reference-2.md).  
 ...
 [!code[csProgGuideObjects#73](../classes-and-structs/codesnippet/CSharp/access-modifiers--csharp-programming-guide-_2.cs)]  
