...
> [!NOTE]
>  This topic discusses named methods. For information about anonymous functions, see [Anonymous Functions](../statements-expressions-operators/anonymous-functions--csharp-programming-guide-.md).  
  
## Method Signatures  
 Methods are declared in a [class](../keywords/class--csharp-reference-.md) or [struct](../keywords/struct--csharp-reference-.md) by specifying the access level such as `public` or `private`, optional modifiers such as `abstract` or `sealed`, the return value, the name of the method, and any method parameters. These parts together are the signature of the method.  
...
>  A return type of a method is not part of the signature of the method for the purposes of method overloading. However, it is part of the signature of the method when determining the compatibility between a delegate and the method that it points to.  
 ...
 [!code[csProgGuideObjects#40](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_1.cs)]  
...
## Method Access  
 ...
 [!code[csProgGuideObjects#41](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_2.cs)]  
...
## Method Parameters vs. Arguments  
 ...
 [!code[csProgGuideObjects#74](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_3.cs)]  
  
## Passing by Reference vs. Passing by Value  
 By default, when a value type is passed to a method, a copy is passed instead of the object itself. Therefore, changes to the argument have no effect on the original copy in the calling method. You can pass a value-type by reference by using the ref keyword. For more information, see [Passing Value-Type Parameters](../classes-and-structs/passing-value-type-parameters--csharp-programming-guide-.md). For a list of built-in value types, see [Value Types Table](../keywords/value-types-table--csharp-reference-.md).  
 ...
 [!code[csProgGuideObjects#42](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideObjects#75](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_5.cs)]  
 ...
 For more information about how to pass reference types by reference and by value, see [Passing Reference-Type Parameters](../classes-and-structs/passing-reference-type-parameters--csharp-programming-guide-.md) and [Reference Types](../keywords/reference-types--csharp-reference-.md).  
...
## Return Values  
 ...
 [!code[csProgGuideObjects#44](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_6.cs)]  
 ...
 [!code[csProgGuideObjects#45](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_7.cs)]  
  
 [!code[csProgGuideObjects#46](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_8.cs)]  
...
```  
 ...
 For more information, see [return](../keywords/return--csharp-reference-.md).  
  
## Async Methods  
 By using the async feature, you can invoke asynchronous methods without using explicit callbacks or manually splitting your code across multiple methods or lambda expressions. The async feature was introduced [!INCLUDE[vs_dev11_long](../async/includes/vs_dev11_long_md.md)].  
  
 If you mark a method with the [async](../keywords/async--csharp-reference-.md) modifier, you can use the [await](../keywords/await--csharp-reference-.md) operator in the method. When control reaches an await expression in the async method, control returns to the caller, and progress in the method is suspended until the awaited task completes. When the task is complete, execution can resume in the method.  
...
>  An async method returns to the caller when either it encounters the first awaited object that’s not yet complete or it gets to the end of the async method, whichever occurs first.  
 ...
 [!code[csAsyncMethod#2](../classes-and-structs/codesnippet/CSharp/methods--csharp-programming-guide-_9.cs)]  
  
 An async method can't declare any [ref](../keywords/ref--csharp-reference-.md) or [out](../keywords/out--csharp-reference-.md) parameters, but it can call methods that have such parameters.  
...
## Iterators  
 An iterator performs a custom iteration over a collection, such as a list or an array. An iterator uses the [yield return](../keywords/yield--csharp-reference-.md) statement to return each element one at a time. When a [yield return](../keywords/yield--csharp-reference-.md) statement is reached, the current location in code is remembered. Execution is restarted from that location when the iterator is called the next time.  
  
 You call an iterator from client code by using a [foreach](../keywords/foreach--in--csharp-reference-.md) statement.  
...
## See Also  
 ...
 [params](../keywords/params--csharp-reference-.md)   
 [return](../keywords/return--csharp-reference-.md)   
 [out](../keywords/out--csharp-reference-.md)   
