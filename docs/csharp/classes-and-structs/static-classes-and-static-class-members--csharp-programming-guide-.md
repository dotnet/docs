...
A [static](../keywords/static--csharp-reference-.md) class is basically the same as a non-static class, but there is one difference: a static class cannot be instantiated. In other words, you cannot use the [new](../keywords/new--csharp-reference-.md) keyword to create a variable of the class type. Because there is no instance variable, you access the members of a static class by using the class name itself. For example, if you have a static class that is named `UtilityClass` that has a public method named `MethodA`, you call the method as shown in the following example:  
...
-   Cannot contain [Instance Constructors](../classes-and-structs/instance-constructors--csharp-programming-guide-.md).  
 ...
 Static classes are sealed and therefore cannot be inherited. They cannot inherit from any class except <xref:System.Object>. Static classes cannot contain an instance constructor; however, they can contain a static constructor. Non-static classes should also define a static constructor if the class contains static members that require non-trivial initialization. For more information, see [Static Constructors](../classes-and-structs/static-constructors--csharp-programming-guide-.md).  
...
## Example  
 ...
 [!code[csProgGuideObjects#31](../classes-and-structs/codesnippet/CSharp/static-classes-and-static-class-members--csharp-programming-guide-_1.cs)]  
...
## Static Members  
 ...
 [!code[csProgGuideObjects#29](../classes-and-structs/codesnippet/CSharp/static-classes-and-static-class-members--csharp-programming-guide-_2.cs)]  
 ...
 [!code[csProgGuideObjects#30](../classes-and-structs/codesnippet/CSharp/static-classes-and-static-class-members--csharp-programming-guide-_3.cs)]  
...
## See Also  
 ...
 [Static Constructors](../classes-and-structs/static-constructors--csharp-programming-guide-.md)   
 [Instance Constructors](../classes-and-structs/instance-constructors--csharp-programming-guide-.md)