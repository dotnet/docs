...
The C# language is designed so that versioning between [base](../keywords/base--csharp-reference-.md) and derived classes in different libraries can evolve and maintain backward compatibility. This means, for example, that the introduction of a new member in a base [class](../keywords/class--csharp-reference-.md) with the same name as a member in a derived class is completely supported by C# and does not lead to unexpected behavior. It also means that a class must explicitly state whether a method is intended to override an inherited method, or whether a method is a new method that hides a similarly named inherited method.  
  
 In C#, derived classes can contain methods with the same name as base class methods.  
  
-   The base class method must be defined [virtual](../keywords/virtual--csharp-reference-.md).  
  
-   If the method in the derived class is not preceded by [new](../keywords/new--csharp-reference-.md) or [override](../keywords/override--csharp-reference-.md) keywords, the compiler will issue a warning and the method will behave as if the `new` keyword were present.  
...
-   The `override`, `virtual`, and `new` keywords can also be applied to properties, indexers, and events.  
 ...
 [!code[csProgGuideInheritance#27](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_1.cs)]  
  
 Your company uses this class, and you use it to derive your own class, adding a new method:  
  
 [!code[csProgGuideInheritance#28](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_2.cs)]  
 ...
 [!code[csProgGuideInheritance#29](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_3.cs)]  
 ...
 [!code[csProgGuideInheritance#30](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideInheritance#44](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_5.cs)]  
 ...
 [!code[csProgGuideInheritance#31](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_6.cs)]  
...
## Override and Method Selection  
 ...
 [!code[csProgGuideInheritance#32](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_7.cs)]  
 ...
 [!code[csProgGuideInheritance#33](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_8.cs)]  
 ...
 [!code[csProgGuideInheritance#34](../classes-and-structs/codesnippet/CSharp/versioning-with-the-override-and-new-keywords--csharp-programming-guide-_9.cs)]  
  
 For more examples of `new` and `override`, see [Knowing When to Use Override and New Keywords](../classes-and-structs/knowing-when-to-use-override-and-new-keywords--csharp-programming-guide-.md).  
