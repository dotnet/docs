...
'variable' is of type 'type'. A const field of a reference type other than string can only be initialized with null.  
 ...
 If you encounter this error by trying to create a [const](../keywords/const--csharp-reference-.md) string array, the solution is to make the array [readonly](../keywords/readonly--csharp-reference-.md), and initialize it in the constructor.  
