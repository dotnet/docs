...
-   A comma enclosed in brackets  
 ...
 For more information, see [Arrays](../arrays/arrays--csharp-programming-guide-.md) and the C# specification ([C# Language Specification](../language-reference/csharp-language-specification.md)) section on array initializers.  
