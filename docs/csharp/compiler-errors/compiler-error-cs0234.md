...
-   An assembly that contains the definition of a type was not referenced in the compilation; use [/reference (Import Metadata)](../compiler-options/-reference--csharp-compiler-options-.md) to specify the assembly  
  
-   You passed a variable name to the [typeof](../keywords/typeof--csharp-reference-.md) operator.  
