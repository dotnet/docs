...
-   The [/nostdlib](../compiler-options/-nostdlib--csharp-compiler-options-.md) option from the command line compiler has been specified. The /nostdlib option prevents the import of mscorlib.dll. Use this option if you want to define or create a user-specific System namespace.  
