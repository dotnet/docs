...
1.  Supply the missing body or accessor or else use the [abstract](../keywords/abstract--csharp-reference-.md), [extern](../keywords/extern--csharp-reference-.md), or [partial (Type)](../keywords/partial--type---csharp-reference-.md) modifiers on it and/or its enclosing type.  
