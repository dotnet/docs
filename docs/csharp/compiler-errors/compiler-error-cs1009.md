...
Unrecognized escape sequence  
 ...
 An unexpected character follows a backslash (\\) in a [string](../keywords/string--csharp-reference-.md). The compiler expects one of the valid escape characters. For more information, see [Character Escapes](../Topic/Character%20Escapes%20in%20Regular%20Expressions.md).  
