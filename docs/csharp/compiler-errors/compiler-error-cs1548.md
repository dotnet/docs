...
Cryptographic failure while signing assembly 'assembly' — 'reason'  
 ...
 For more information, see [How to: Sign an Assembly (Visual Studio)](http://msdn.microsoft.com/en-us/f468a7d3-234c-4353-924d-8e0ae5896564), [/keyfile (C# Compiler Options)](../compiler-options/-keyfile--csharp-compiler-options-.md) and [/delaysign (C# Compiler Options)](../compiler-options/-delaysign--csharp-compiler-options-.md).  
