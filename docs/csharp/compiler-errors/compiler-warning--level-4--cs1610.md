...
Unable to delete temporary file 'file' used for default Win32 resource -- resource  
 ...
 When using the [/win32res](../compiler-options/-win32res--csharp-compiler-options-.md) compiler option and when your **%TEMP%** directory does not have DELETE permission, this warning indicates that the compiler could not delete a temporary file that it created.  
