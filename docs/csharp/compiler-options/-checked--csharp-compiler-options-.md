...
The **/checked** option specifies whether an integer arithmetic statement that results in a value that is outside the range of the data type, and that is not in the scope of a [checked](../keywords/checked--csharp-reference-.md) or [unchecked](../keywords/unchecked--csharp-reference-.md) keyword, causes a run-time exception.  
