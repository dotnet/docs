...
## Remarks  
 The **/define** option has the same effect as using a [#define](../preprocessor-directives/sharpdefine--csharp-reference-.md) preprocessor directive except that the compiler option is in effect for all files in the project. A symbol remains defined in a source file until an [#undef](../preprocessor-directives/sharpundef--csharp-reference-.md) directive in the source file removes the definition. When you use the /define option, an `#undef` directive in one file has no effect on other source code files in the project.  
  
 You can use symbols created by this option with [#if](../preprocessor-directives/sharpif--csharp-reference-.md), [#else](../preprocessor-directives/sharpelse--csharp-reference-.md), [#elif](../preprocessor-directives/sharpelif--csharp-reference-.md), and [#endif](../preprocessor-directives/sharpendif--csharp-reference-.md) to compile source files conditionally.  
