...
## Remarks  
 The **/delaysign** option has no effect unless used with [/keyfile](../compiler-options/-keyfile--csharp-compiler-options-.md) or [/keycontainer](../compiler-options/-keycontainer--csharp-compiler-options-.md).  
