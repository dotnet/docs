...
-   Such user-defined types as a [class](../keywords/class--csharp-reference-.md), [delegate](../keywords/delegate--csharp-reference-.md), or [interface](../keywords/interface--csharp-reference-.md)  
  
-   Such members as a field, [event](../keywords/event--csharp-reference-.md), [property](../classes-and-structs/using-properties--csharp-programming-guide-.md), or method  
 ...
 Unless you compile with [/target:module](../compiler-options/-target-module--csharp-compiler-options-.md), `file` will contain \<assembly>\</assembly> tags specifying the name of the file containing the assembly manifest for the output file of the compilation.  
  
> [!NOTE]
>  The /doc option applies to all input files; or, if set in the Project Settings, all files in the project. To disable warnings related to documentation comments for a specific file or section of code, use [#pragma warning](../preprocessor-directives/sharppragma-warning--csharp-reference-.md).  
  
 See [Recommended Tags for Documentation Comments](../xmldoc/recommended-tags-for-documentation-comments--csharp-programming-guide-.md) for ways to generate documentation from comments in your code.  
