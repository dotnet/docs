...
## Remarks  
 ...
 If you compile with **/target:module**, the name of the key file is held in the module and incorporated into the assembly that is created when you compile an assembly with [/addmodule](../compiler-options/-addmodule--csharp-compiler-options-.md).  
  
 You can also pass your encryption information to the compiler with [/keycontainer](../compiler-options/-keycontainer--csharp-compiler-options-.md). Use [/delaysign](../compiler-options/-delaysign--csharp-compiler-options-.md) if you want a partially signed assembly.  
