...
>  When you create an instance of an embedded COM type in your code, you must create the instance by using the appropriate interface. Attempting to create an instance of an embedded COM type by using the CoClass causes an error.  
 ...
 To set the `/link` option in [!INCLUDE[vsprvs](../classes-and-structs/includes/vsprvs_md.md)], add an assembly reference and set the `Embed Interop Types` property to **true**. The default for the `Embed Interop Types` property is **false**.  
...
-   A field, property, event, or method that has a return type or parameter type from Assembly B is invoked.  
 ...
 Like the [/reference](../compiler-options/-reference--csharp-compiler-options-.md) compiler option, the `/link` compiler option uses the Csc.rsp response file, which references frequently used [!INCLUDE[dnprdnshort](../classes-and-structs/includes/dnprdnshort_md.md)] assemblies. Use the [/noconfig](../compiler-options/-noconfig--csharp-compiler-options-.md) compiler option if you do not want the compiler to use the Csc.rsp file.  
...
### Generic Interfaces  
 ...
 [!code[VbLinkCompilerCS#1](../compiler-options/codesnippet/CSharp/-link--csharp-compiler-options-_1.cs)]  
...
### Types That Have Generic Parameters  
 ...
 [!code[VbLinkCompilerCS#2](../compiler-options/codesnippet/CSharp/-link--csharp-compiler-options-_2.cs)]  
[!code[VbLinkCompilerCS#3](../compiler-options/codesnippet/CSharp/-link--csharp-compiler-options-_3.cs)]  
[!code[VbLinkCompilerCS#4](../compiler-options/codesnippet/CSharp/-link--csharp-compiler-options-_4.cs)]  
 ...
 [!code[VbLinkCompilerCS#5](../compiler-options/codesnippet/CSharp/-link--csharp-compiler-options-_5.cs)]  
