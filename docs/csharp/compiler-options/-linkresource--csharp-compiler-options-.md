...
Creates a link to a .NET Framework resource in the output file. The resource file is not added to the output file. This differs from the [/resource](../compiler-options/-resource--csharp-compiler-options-.md) option which does embed a resource file in the output file.  
 ...
 **/linkresource** requires one of the [/target](../compiler-options/-target--csharp-compiler-options-.md) options other than **/target:module**.  
