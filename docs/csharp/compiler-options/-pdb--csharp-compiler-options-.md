...
## Remarks  
 When you specify [/debug (C# Compiler Options)](../compiler-options/-debug--csharp-compiler-options-.md), the compiler will create a .pdb file in the same directory where the compiler will create the output file (.exe or .dll) with a file name that is the same as the name of the output file.  
