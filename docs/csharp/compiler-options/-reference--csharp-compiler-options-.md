...
The **/reference** option causes the compiler to import [public](../keywords/public--csharp-reference-.md) type information in the specified file into the current project, thus enabling you to reference metadata from the specified assembly files.  
...
## Remarks  
 ...
 The files you import must contain a manifest; the output file must have been compiled with one of the [/target](../compiler-options/-target--csharp-compiler-options-.md) options other than [/target:module](../compiler-options/-target-module--csharp-compiler-options-.md).  
  
 **/r** is the short form of **/reference**.  
  
 Use [/addmodule](../compiler-options/-addmodule--csharp-compiler-options-.md) to import metadata from an output file that does not contain an assembly manifest.  
...
-   You invoke a field, property, event, or method that has a return type or parameter type from Assembly B.  
 ...
 Use [/lib](../compiler-options/-lib--csharp-compiler-options-.md) to specify the directory in which one or more of your assembly references is located. The **/lib** topic also discusses the directories in which the compiler searches for assemblies.  
 ...
 The csc response (.rsp) file, which references commonly used .NET Framework assemblies, is used by default. Use [/noconfig](../compiler-options/-noconfig--csharp-compiler-options-.md) if you do not want the compiler to use csc.rsp.  
...
## Example  
 This example shows how to use the [extern alias](../keywords/extern-alias--csharp-reference-.md) feature.  
