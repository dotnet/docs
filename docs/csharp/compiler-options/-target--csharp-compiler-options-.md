...
The **/target** compiler option can be specified in one of four forms:  
 ...
 To create an .exe file for [!INCLUDE[win8_appname_long](../compiler-options/includes/win8_appname_long_md.md)] apps.  
  
 [/target:exe](../compiler-options/-target-exe--csharp-compiler-options-.md)  
 To create an .exe file.  
  
 [/target:library](../compiler-options/-target-library--csharp-compiler-options-.md)  
 To create a code library.  
  
 [/target:module](../compiler-options/-target-module--csharp-compiler-options-.md)  
 To create a module.  
  
 [/target:winexe](../compiler-options/-target-winexe--csharp-compiler-options-.md)  
