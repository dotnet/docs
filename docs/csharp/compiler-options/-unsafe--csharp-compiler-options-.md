...
The **/unsafe** compiler option allows code that uses the [unsafe](../keywords/unsafe--csharp-reference-.md) keyword to compile.  
...
## Remarks  
 For more information about unsafe code, see [Unsafe Code and Pointers](../unsafe-code-pointers/unsafe-code-and-pointers--csharp-programming-guide-.md).  
