...
## Remarks  
 ...
 See [/linkresource](../compiler-options/-linkresource--csharp-compiler-options-.md) (to reference) or [/resource](../compiler-options/-resource--csharp-compiler-options-.md) (to attach) a .NET Framework resource file. See [/win32res](../compiler-options/-win32res--csharp-compiler-options-.md) to import a .res file.  
