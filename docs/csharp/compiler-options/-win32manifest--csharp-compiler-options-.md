...
> [!NOTE]
>  This option and the [/win32res (C# Compiler Options)](../compiler-options/-win32res--csharp-compiler-options-.md) option are mutually exclusive. If you try to use both options in the same command line you will get a build error.  
