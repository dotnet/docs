...
This topic defines and briefly explains the important concepts needed to understand programming in C#. Later topics will explain each of these topics in more detail. This topic is meant to be an overview for those developers that are new to C#, or even new to programming in general.
