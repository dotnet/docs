...
```  
 ...
 For more examples, see [Using Variance in Delegates (C#)](../covariance-contravariance/using-variance-in-delegates--csharp-.md) and [Using Variance for Func and Action Generic Delegates (C#)](../covariance-contravariance/using-variance-for-func-and-action-generic-delegates--csharp-.md).  
...
-   The <xref:System.Converter`2> delegate  
 ...
 For more information and examples, see [Using Variance for Func and Action Generic Delegates (C#)](../covariance-contravariance/using-variance-for-func-and-action-generic-delegates--csharp-.md).  
