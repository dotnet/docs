...
description: Learn about the classes in .NET Framework that support delegates and how those map to the 'delegate' keyword.
ms.date: 06/20/2016
...
This article will cover the classes in .NET Framework
