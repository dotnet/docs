...
Exceptions are used to indicate that an error has occurred while running the program. Exception objects that describe an error are created and then *thrown* with the [throw](../keywords/throw--csharp-reference-.md) keyword. The runtime then searches for the most compatible exception handler.  
...
-   The method cannot complete its defined functionality.  
     ...
     [!code[csProgGuideExceptions#12](../exceptions/codesnippet/CSharp/creating-and-throwing-exceptions--csharp-programming-guide-_1.cs)]  
...
-   An inappropriate call to an object is made, based on the object state.  
     ...
     [!code[csProgGuideExceptions#13](../exceptions/codesnippet/CSharp/creating-and-throwing-exceptions--csharp-programming-guide-_2.cs)]  
...
-   When an argument to a method causes an exception.  
     ...
     [!code[csProgGuideExceptions#14](../exceptions/codesnippet/CSharp/creating-and-throwing-exceptions--csharp-programming-guide-_3.cs)]  
...
## Defining Exception Classes  
 ...
 [!code[csProgGuideExceptions#15](../exceptions/codesnippet/CSharp/creating-and-throwing-exceptions--csharp-programming-guide-_4.cs)]  
