...
> [!NOTE]
>  In Windows, the terms "directory" and "folder" are used interchangeably. Most documentation and user interface text uses the term "folder," but the [!INCLUDE[dnprdnshort](../classes-and-structs/includes/dnprdnshort_md.md)] class library uses the term "directory."  
...
## Example  
 ...
 [!code[csFilesandFolders#1](../file-system/codesnippet/CSharp/how-to--iterate-through-a-directory-tree--csharp-programming-guide-_1.cs)]  
...
## Example  
 ...
 [!code[csFilesandFolders#2](../file-system/codesnippet/CSharp/how-to--iterate-through-a-directory-tree--csharp-programming-guide-_2.cs)]  
