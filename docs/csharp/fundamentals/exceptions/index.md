...
For more information, see [Exceptions](~/_csharpstandard/standard/exceptions.md) in the [C# Language Specification](~/csharpstandard/standard/README.md). The language specification is the definitive source for C# syntax and usage.
