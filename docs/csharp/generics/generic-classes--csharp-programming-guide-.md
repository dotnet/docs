...
-   What constraints, if any, to apply to the type parameters (See [Constraints on Type Parameters](../generics/constraints-on-type-parameters--csharp-programming-guide-.md)).  
...
-   Whether to implement one or more generic interfaces.  
 ...
 For an example of a simple generic class, see [Introduction to Generics](../generics/introduction-to-generics--csharp-programming-guide-.md).  
 ...
 [!code[csProgGuideGenerics#16](../generics/codesnippet/CSharp/generic-classes--csharp-programming-guide-_1.cs)]  
 ...
 [!code[csProgGuideGenerics#17](../generics/codesnippet/CSharp/generic-classes--csharp-programming-guide-_2.cs)]  
 ...
 [!code[csProgGuideGenerics#18](../generics/codesnippet/CSharp/generic-classes--csharp-programming-guide-_3.cs)]  
 ...
 [!code[csProgGuideGenerics#19](../generics/codesnippet/CSharp/generic-classes--csharp-programming-guide-_4.cs)]  
  
 Generic types can use multiple type parameters and constraints, as follows:  
  
 [!code[csProgGuideGenerics#20](../generics/codesnippet/CSharp/generic-classes--csharp-programming-guide-_5.cs)]  
  
 Open constructed and closed constructed types can be used as method parameters:  
  
 [!code[csProgGuideGenerics#21](../generics/codesnippet/CSharp/generic-classes--csharp-programming-guide-_6.cs)]  
