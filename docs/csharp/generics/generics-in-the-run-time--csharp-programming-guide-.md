...
When a generic type or method is compiled into Microsoft intermediate language (MSIL), it contains metadata that identifies it as having type parameters. How the MSIL for a generic type is used differs based on whether the supplied type parameter is a value type or reference type.  
 ...
 [!code[csProgGuideGenerics#42](../generics/codesnippet/CSharp/generics-in-the-run-time--csharp-programming-guide-_1.cs)]  
 ...
 [!code[csProgGuideGenerics#43](../generics/codesnippet/CSharp/generics-in-the-run-time--csharp-programming-guide-_2.cs)]  
 ...
 [!code[csProgGuideGenerics#47](../generics/codesnippet/CSharp/generics-in-the-run-time--csharp-programming-guide-_3.cs)]  
  
 [!code[csProgGuideGenerics#44](../generics/codesnippet/CSharp/generics-in-the-run-time--csharp-programming-guide-_4.cs)]  
 ...
 [!code[csProgGuideGenerics#45](../generics/codesnippet/CSharp/generics-in-the-run-time--csharp-programming-guide-_5.cs)]  
 ...
 [!code[csProgGuideGenerics#46](../generics/codesnippet/CSharp/generics-in-the-run-time--csharp-programming-guide-_6.cs)]  
