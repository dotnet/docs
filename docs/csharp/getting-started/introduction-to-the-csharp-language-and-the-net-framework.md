...
-   For more information about [!INCLUDE[vbteclinq](~/includes/vbteclinq-md.md)], see [LINQ (Language-Integrated Query)](https://msdn.microsoft.com/library/bb397926.aspx).  
...
## .NET Framework Platform Architecture  
 ...
 For more information about the .NET Framework, see [Overview of the Microsoft .NET Framework](https://msdn.microsoft.com/library/ms687307(v=vs.85).aspx).  
