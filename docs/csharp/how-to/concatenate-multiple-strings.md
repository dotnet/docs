...
:::code language="csharp-interactive" source="../../../samples/snippets/csharp/how-to/strings/Concatenate.cs" id="1":::
...
:::code language="csharp-interactive" source="../../../samples/snippets/csharp/how-to/strings/Concatenate.cs" id="2":::

In some expressions, it's easier to concatenate strings using string interpolation, as the following code shows:

:::code language="csharp-interactive" source="../../../samples/snippets/csharp/how-to/strings/Concatenate.cs" id="3":::
...
:::code language="csharp-interactive" source="../../../samples/snippets/csharp/how-to/strings/Concatenate.cs" id="4":::
...
:::code language="csharp-interactive" source="../../../samples/snippets/csharp/how-to/strings/Concatenate.cs" id="5":::
...
:::code language="csharp-interactive" source="../../../samples/snippets/csharp/how-to/strings/Concatenate.cs" id="6":::
