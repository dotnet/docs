...
Decimal	128	decimal	at least –7.9 × 10−28 to 7.9 × 1028, with at least 28-digit precision1.0 × 10−28 to 7.9 × 1028, 28-digit precision
...
Delegate type	A null reference or a reference to an instance of a compatible that delegate type
...
throw statements and try statements	static double Divide(double x, double y) {
...
1.7.7.3 Method body and local variables
...
1.7.7.4 Static and instance methods
...
1.7.7.5 Virtual, override, and abstract methods
