...
Indexers can be declared on an [interface](../keywords/interface--csharp-reference-.md). Accessors of interface indexers differ from the accessors of [class](../keywords/class--csharp-reference-.md) indexers in the following ways:  
...
-   An interface accessor does not have a body.  
 ...
 [!code[csProgGuideIndexers#3](../classes-and-structs/codesnippet/CSharp/indexers-in-interfaces--csharp-programming-guide-_1.cs)]  
...
## Example  
 ...
 [!code[csProgGuideIndexers#4](../classes-and-structs/codesnippet/CSharp/indexers-in-interfaces--csharp-programming-guide-_2.cs)]  
