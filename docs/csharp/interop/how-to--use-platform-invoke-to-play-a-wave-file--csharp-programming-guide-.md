...
## Example  
 ...
 [!code[csProgGuideInterop#5](../interop/codesnippet/CSharp/how-to--use-platform-invoke-to-play-a-wave-file--csharp-programming-guide-_1.cs)]  
  
 [!code[csProgGuideInterop#3](../interop/codesnippet/CSharp/how-to--use-platform-invoke-to-play-a-wave-file--csharp-programming-guide-_2.cs)]  
...
3.  Copy the following code, and paste it in the `Form1.Designer.cs` file, in the `InitializeComponent()` method, after any existing code.  
     ...
     [!code[csProgGuideInterop#4](../interop/codesnippet/CSharp/how-to--use-platform-invoke-to-play-a-wave-file--csharp-programming-guide-_3.cs)]  
