...
-   [checked](../keywords/checked--csharp-reference-.md) Specify checked context.  
  
-   [unchecked](../keywords/unchecked--csharp-reference-.md) Specify unchecked context.  
...
-   Explicit numeric conversions between integral types.  
 ...
 The [/checked](../compiler-options/-checked--csharp-compiler-options-.md) compiler option lets you specify checked or unchecked context for all integer arithmetic statements that are not explicitly in the scope of a `checked` or `unchecked` keyword.  
