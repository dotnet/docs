...
The `continue` statement passes control to the next iteration of the enclosing [while](../keywords/while--csharp-reference-.md), [do](../keywords/do--csharp-reference-.md), [for](../keywords/for--csharp-reference-.md), or [foreach](../keywords/foreach--in--csharp-reference-.md) statement in which it appears.  
...
## Example  
 ...
 [!code[csrefKeywordsJump#3](../keywords/codesnippet/CSharp/continue--csharp-reference-_1.cs)]  
