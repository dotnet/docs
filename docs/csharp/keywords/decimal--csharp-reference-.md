...
```  
 ...
 Without the suffix m, the number is treated as a [double](../keywords/double--csharp-reference-.md) and generates a compiler error.  
...
```  
 ...
 For more information about implicit numeric conversions, see [Implicit Numeric Conversions Table](../keywords/implicit-numeric-conversions-table--csharp-reference-.md).  
  
 For more information about explicit numeric conversions, see [Explicit Numeric Conversions Table](../keywords/explicit-numeric-conversions-table--csharp-reference-.md).  
...
## Example  
 The following example causes a compiler error by trying to add [double](../keywords/double--csharp-reference-.md) and `decimal` variables.  
...
```  
 ...
 In this example, a `decimal` and an [int](../keywords/int--csharp-reference-.md) are mixed in the same expression. The result evaluates to the `decimal` type.  
  
 [!code[csrefKeywordsTypes#6](../keywords/codesnippet/CSharp/decimal--csharp-reference-_1.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsTypes#7](../keywords/codesnippet/CSharp/decimal--csharp-reference-_2.cs)]  
