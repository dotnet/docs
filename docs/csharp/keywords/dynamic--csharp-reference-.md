...
The `dynamic` type enables the operations in which it occurs to bypass compile-time type checking. Instead, these operations are resolved at run time. The `dynamic` type simplifies access to COM APIs such as the Office Automation APIs, and also to dynamic APIs such as IronPython libraries, and to the HTML Document Object Model (DOM).  
 ...
 [!code[csrefKeywordsTypes#21](../keywords/codesnippet/CSharp/dynamic--csharp-reference-_1.cs)]  
...
-   In declarations, as the type of a property, field, indexer, parameter, return value, local variable, or type constraint. The following class definition uses `dynamic` in several different declarations.  
     ...
     [!code[csrefKeywordsTypes#22](../keywords/codesnippet/CSharp/dynamic--csharp-reference-_2.cs)]  
  
-   In explicit type conversions, as the target type of a conversion.  
  
     [!code[csrefKeywordsTypes#23](../keywords/codesnippet/CSharp/dynamic--csharp-reference-_3.cs)]  
...
-   In any context where types serve as values, such as on the right side of an `is` operator or an `as` operator, or as the argument to `typeof` as part of a constructed type. For example, `dynamic` can be used in the following expressions.  
     ...
     [!code[csrefKeywordsTypes#24](../keywords/codesnippet/CSharp/dynamic--csharp-reference-_4.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsTypes#25](../keywords/codesnippet/CSharp/dynamic--csharp-reference-_5.cs)]  
  
 For more information and examples, see [Using Type dynamic](../types/using-type-dynamic--csharp-programming-guide-.md).  
...
## See Also  
 ...
 [How to: Safely Cast by Using as and is Operators](../types/how-to--safely-cast-by-using-as-and-is-operators--csharp-programming-guide-.md)   
 [Walkthrough: Creating and Using Dynamic Objects](../types/walkthrough--creating-and-using-dynamic-objects--csharp-and-visual-basic-.md)