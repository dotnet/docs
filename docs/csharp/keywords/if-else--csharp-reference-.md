...
An `if` statement identifies which statement to run based on the value of a `Boolean` expression. In the following example, the `Boolean` variable `result` is set to `true` and then checked in the `if` statement. The output is `The condition is true`.  
 ...
 [!code[csrefKeywordsSelection#1](../keywords/codesnippet/CSharp/if-else--csharp-reference-_1.cs)]  
...
```  
 ...
 [!code[csrefKeywordsSelection#2](../keywords/codesnippet/CSharp/if-else--csharp-reference-_2.cs)]  
 ...
 [!code[csrefKeywordsSelection#3](../keywords/codesnippet/CSharp/if-else--csharp-reference-_3.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsSelection#4](../keywords/codesnippet/CSharp/if-else--csharp-reference-_4.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsSelection#5](../keywords/codesnippet/CSharp/if-else--csharp-reference-_5.cs)]  
...
## Example  
 ...
 [!code[csrefKeywordsSelection#6](../keywords/codesnippet/CSharp/if-else--csharp-reference-_6.cs)]  
  
 Just as a statement in the else block or the then block can be any valid statement, you can use any valid Boolean expression for the condition. You can use logical operators such as [&&](../operators/---operator--csharp-reference-.md), [&](../operators/--operator--csharp-reference-.md), [&#124;&#124;](../operators/---operator--csharp-reference-.md), [&#124;](../operators/--operator--csharp-reference-.md) and [!](../operators/!-operator--csharp-reference-.md) to make compound conditions. The following code shows examples.  
