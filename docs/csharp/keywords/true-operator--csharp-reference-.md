...
Returns the [bool](../keywords/bool--csharp-reference-.md) value `true` to indicate that an operand is true and returns `false` otherwise.  
 ...
 [!code[csrefKeywordsOperator#16](../keywords/codesnippet/CSharp/true-operator--csharp-reference-_1.cs)]  
 ...
 If a type defines operator `true`, it must also define operator [false](../keywords/false--csharp-reference-.md).  
...
## See Also  
 ...
 [false](../keywords/false--csharp-reference-.md)