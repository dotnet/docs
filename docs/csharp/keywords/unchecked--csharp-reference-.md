...
The `unchecked` keyword is used to suppress overflow-checking for integral-type arithmetic operations and conversions.  
 ...
 [!code[csrefKeywordsChecked#5](../keywords/codesnippet/CSharp/unchecked--csharp-reference-_1.cs)]  
 ...
 Expressions that contain non-constant terms are unchecked by default at compile time and run time. See [checked](../keywords/checked--csharp-reference-.md) for information about enabling a checked environment.  
...
## Example  
 ...
 [!code[csrefKeywordsChecked#2](../keywords/codesnippet/CSharp/unchecked--csharp-reference-_2.cs)]  
...
## See Also  
 ...
 [checked](../keywords/checked--csharp-reference-.md)