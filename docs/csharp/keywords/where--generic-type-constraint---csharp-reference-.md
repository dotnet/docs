...
> [!NOTE]
>  For more information on the where clause in a query expression, see [where clause](../keywords/where-clause--csharp-reference-.md).  
 ...
 [!code[csrefKeywordsContextual#8](../keywords/codesnippet/CSharp/where--generic-type-constraint---csharp-reference-_3.cs)]  
...
```  
 ...
 For information on generic delegates, see [Generic Delegates](../generics/generic-delegates--csharp-programming-guide-.md).  
  
 For details on the syntax and use of constraints, see [Constraints on Type Parameters](../generics/constraints-on-type-parameters--csharp-programming-guide-.md).  
