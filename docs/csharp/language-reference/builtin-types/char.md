...
For more information, see the [Integral types](~/_csharpstandard/standard/types.md#integral-types) section of the [C# language specification](~/_csharpstandard/standard/README.md).
