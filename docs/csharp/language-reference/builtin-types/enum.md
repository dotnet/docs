...
- [Enum values and operations](~/_csharpstandard/standard/enums.md#enum-values-and-operations)
- [Enumeration logical operators](~/_csharpstandard/standard/expressions.md#enumeration-logical-operators)
- [Enumeration comparison operators](~/_csharpstandard/standard/expressions.md#enumeration-comparison-operators)
- [Explicit enumeration conversions](~/_csharpstandard/standard/conversions.md#explicit-enumeration-conversions)
- [Implicit enumeration conversions](~/_csharpstandard/standard/conversions.md#implicit-enumeration-conversions)
