...
- [How to safely cast using pattern matching and the as and is operators](/dotnet/csharp/fundamentals/object-oriented/tutorials/safely-cast-using-pattern-matching-is-and-as-operators.md)
