...
- Any property, including auto-implemented ones, must be read-only. In C# 9.0 and later, an auto-implemented property may have an [`init` accessor](../../whats-new/csharp-9.md#init-only-setters).
