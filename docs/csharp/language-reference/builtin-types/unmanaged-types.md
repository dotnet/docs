...
For more information, see the [Pointer types](~/_csharpstandard/standard/unsafe-code.md#pointer-types) section of the [C# language specification](~/_csharpstandard/standard/README.md).
