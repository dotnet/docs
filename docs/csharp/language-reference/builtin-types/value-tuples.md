...
You can also use tuple types instead of [anonymous types](/dotnet/csharp/fundamentals/types/anonymous-types); for example, in LINQ queries. For more information, see [Choosing between anonymous and tuple types](../../../standard/base-types/choosing-between-anonymous-and-tuple.md).
...
For more information about deconstruction of tuples and other types, see [Deconstructing tuples and other types](/dotnet/csharp/fundamentals/functional/deconstruct).
