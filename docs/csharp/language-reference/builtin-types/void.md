...
You can also use `void` as a referent type to declare a pointer to an unknown type. For more information, see [Pointer types](/dotnet/csharp/language-reference/unsafe-code/#pointer-types).
