...
A conversion with the [as](../../language-reference/operators/type-testing-and-assignment-operators.md#as-operator) operator is allowed by inheritance, reference conversions, and boxing conversions.
