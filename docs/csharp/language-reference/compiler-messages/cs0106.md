...
- The [static](../../../csharp/language-reference/keywords/static.md) modifier is not permitted on a local function. Whether a local function is static or instance is defined by its containing member.
...
- The [private](../keywords/private.md) modifier is not allowed on a local function. Local functions are always private.
