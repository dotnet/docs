...
namespace x
{
    ...
    // Even if there's a properly defined class and method or a properly defined struct 
    // in your code, the compiler will notice the violations and raise the CS0116 error
