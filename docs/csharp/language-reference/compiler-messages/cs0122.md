...
'member' is inaccessible due to its protection level  
 ...
 One cause of this (not shown in the sample below) can be omitting the **/out** compiler flag on the target of a friend assembly. For more information, see [Friend Assemblies](https://msdn.microsoft.com/library/0tke9fxk.aspx) and [/out (C# Compiler Options)](../../../csharp/language-reference/compiler-options/out-compiler-option.md)  
