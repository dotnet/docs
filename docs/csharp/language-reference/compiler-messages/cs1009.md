...
Unrecognized escape sequence  
 ...
 An unexpected character follows a backslash (\\) in a [string](../keywords/string.md). The compiler expects one of the valid escape characters. For more information, see [Character Escapes](../../../standard/base-types/character-escapes-in-regular-expressions.md).  
