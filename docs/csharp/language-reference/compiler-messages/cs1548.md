...
Cryptographic failure while signing assembly 'assembly' — 'reason'  
 ...
 For more information, see [How to: Sign an Assembly (Visual Studio)](https://docs.microsoft.com/dotnet/framework/app-domains/how-to-sign-an-assembly-with-a-strong-name), [/keyfile (C# Compiler Options)](../../../csharp/language-reference/compiler-options/keyfile-compiler-option.md) and [/delaysign (C# Compiler Options)](../../../csharp/language-reference/compiler-options/delaysign-compiler-option.md).  
  
 When creating an assembly, the C# compiler calls into a utility called al.exe. If there is a failure in the assembly creation, the reason for the failure is reported by al.exe. See [Al.exe Tool Errors and Warnings](https://docs.microsoft.com/dotnet/framework/tools/al-exe-assembly-linker#errors-and-warnings) and search that topic for the text reported by the compiler in 'reason'.  
  
## See Also  
 [How to: Sign an Assembly (Visual Studio)](https://docs.microsoft.com/dotnet/framework/app-domains/how-to-sign-an-assembly-with-a-strong-name)
