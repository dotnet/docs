...
Cryptographic failure while signing assembly 'assembly' — 'reason'  
 ...
 For more information, see [How to: Sign an Assembly (Visual Studio)](https://msdn.microsoft.com/library/ms247123.aspx), [/keyfile (C# Compiler Options)](../../../csharp/language-reference/compiler-options/keyfile-compiler-option.md) and [/delaysign (C# Compiler Options)](../../../csharp/language-reference/compiler-options/delaysign-compiler-option.md).  
  
 When creating an assembly, the C# compiler calls into a utility called al.exe. If there is a failure in the assembly creation, the reason for the failure is reported by al.exe. See [Al.exe Tool Errors and Warnings](https://msdn.microsoft.com/library/kchwc1f1.aspx) and search that topic for the text reported by the compiler in 'reason'.  
