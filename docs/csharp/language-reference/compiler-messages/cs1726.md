...
## See Also  
 [How to: Create Signed Friend Assemblies](https://docs.microsoft.com/dotnet/csharp/programming-guide/concepts/assemblies-gac/how-to-create-signed-friend-assemblies)
