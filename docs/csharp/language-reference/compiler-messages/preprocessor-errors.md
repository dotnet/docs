...
description: Learn how to diagnose and fix errors related to preprocessor tokens how they're used in C# source files.
f1_keywords:
  - "CS1024"
  - "CS1025"
  - "CS1027"
...
- [**CS1032**](#invalid-preprocessor-directive-syntax): *Cannot define/undefine preprocessor symbols after first token in file*
...
These errors indicate that you used invalid syntax for [preprocessor directives](../preprocessor-directives.md). Common causes include:
