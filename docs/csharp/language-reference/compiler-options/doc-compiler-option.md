...
- Such user-defined types as a [class](../keywords/class.md), [delegate](/dotnet/csharp/language-reference/builtin-types/reference-types), or [interface](../keywords/interface.md)  
