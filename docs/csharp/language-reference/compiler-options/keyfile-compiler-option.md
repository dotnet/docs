...
## Remarks  
 ...
 For more information, see [Creating and Using Strong-Named Assemblies](../../../standard/assembly/create-and-use-strong-named-assemblies.md) and [Delay Signing an Assembly](../../../standard/assembly/delay-sign-assembly.md).  
