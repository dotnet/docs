...
## See Also  
 ...
 [Walkthrough: Embedding Types from Managed Assemblies](https://docs.microsoft.com//dotnet/csharp/programming-guide/concepts/assemblies-gac/walkthrough-embedding-types-from-managed-assemblies-in-visual-studio)   
