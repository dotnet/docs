...
-   The existing assembly has granted friend assembly access to the assembly into which the .netmodule will be built.  
 ...
 For more information on friend assemblies, see [Friend Assemblies](https://docs.microsoft.com/dotnet/csharp/programming-guide/concepts/assemblies-gac/friend-assemblies).  
