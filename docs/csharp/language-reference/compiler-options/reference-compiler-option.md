...
dev_langs: ["CSharp"]
helpviewer_keywords: ["/r compiler option [C#]", "reference compiler option [C#]", "r compiler option [C#]", "/reference compiler option [C#]", "-r compiler option [C#]", "metadata import [C#]", "public type information [C#]", "-reference compiler option [C#]"]
