...
## Remarks  
 Use [/linkresource](../../../csharp/language-reference/compiler-options/linkresource-csharp-compiler-options.md) to link a resource to an assembly and not add the resource file to the output file.  
