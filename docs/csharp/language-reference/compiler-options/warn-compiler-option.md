...
f1_keywords: ["/warn"]
dev_langs: ["CSharp"]
helpviewer_keywords: ["warning level [C#]", "/w compiler option [C#]", "-w compiler option [C#]", "-warn compiler option [C#]", "/warn compiler option [C#]", "w compiler option [C#]", "warn compiler option [C#]"]
