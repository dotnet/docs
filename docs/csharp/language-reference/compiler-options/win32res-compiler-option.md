...
## Remarks  
 A Win32 resource file can be created with the [Resource Compiler](https://docs.microsoft.com/dotnet/csharp/language-reference/compiler-options/resource-compiler-option). The Resource Compiler is invoked when you compile a Visual C++ program; a .res file is created from the .rc file.  
