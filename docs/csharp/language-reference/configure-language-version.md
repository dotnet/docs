...
> [!TIP]
> To know what language version you're currently using, put `#error version` in your code. This makes the compiler produce a diagnostic, CS8304, with a message containing the language version being used.
