...
> [!TIP]
> Open a [developer command-line shell](../../framework/tools/developer-command-prompt-for-vs.md), and run the following command to see the listing of language versions available on your machine.
>
> ```CMD
> csc -langversion:?
> ```
