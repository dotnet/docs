...
[!code-csharp[csrefKeywordsModifiers#4](https://github.com/samples/snippets/csharp/VS_Snippets_VBCSharp/csrefKeywordsModifiers/CS/csrefKeywordsModifiers.cs#4)]
