...
|[dynamic](/dotnet/csharp/language-reference/builtin-types/reference-types)|Defines a reference type that enables operations in which it occurs to bypass compile-time type checking.|  
