...
|[and](../operators/patterns.md#logical-patterns)|Creates a pattern that matches when both of nested patterns match.|  
...
|[nint](../builtin-types/nint-nuint.md)|Defines a native-sized integer data type.|  
|[not](../operators/patterns.md#logical-patterns)|Creates a pattern that matches when the negated pattern doesn't match.|  
...
- [C# keywords](./index.md)
- [C# operators and expressions](../operators/index.md)
