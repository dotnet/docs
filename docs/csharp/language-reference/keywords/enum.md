...
The approved types for an enum are [byte](../builtin-types/integral-numeric-types.md), [sbyte](../builtin-types/integral-numeric-types.md), [short](../builtin-types/integral-numeric-types.md), [ushort](../builtin-types/integral-numeric-types.md), [int](int.md), [uint](../builtin-types/integral-numeric-types.md), [long](long.md), or [ulong](ulong.md).
