...
|[virtual](./virtual.md)|Allows derived classes to override the event behavior by using the [override](./override.md) keyword.|[Inheritance](/dotnet/csharp/fundamentals/object-oriented/inheritance)|
