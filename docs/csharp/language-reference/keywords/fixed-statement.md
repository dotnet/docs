...
For more information, see [The fixed statement](~/_csharpstandard/standard/unsafe-code.md#227-the-fixed-statement) section of the [C# language specification](~/_csharpstandard/standard/README.md).
