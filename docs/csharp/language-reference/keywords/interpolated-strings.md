...
The arguments of an interpolated string are easier to understand than a [composite format string](https://docs.microsoft.com/en-us/dotnet/articles/standard/base-types/composite-format#composite-format-string).  For example, the interpolated string  
