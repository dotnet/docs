...
The `is` operator checks if the result of an expression is compatible with a given type, or (starting with C# 7.0) tests an expression against a pattern. For information about the type-testing `is` operator see the [is operator](../operators/type-testing-and-assignment-operators.md#is-operator) section of the [Type-testing and assignment operators](../operators/type-testing-and-assignment-operators.md) article.
...
- [C# keywords](index.md)
- [Type-testing and assignment operators](../operators/type-testing-and-assignment-operators.md)
