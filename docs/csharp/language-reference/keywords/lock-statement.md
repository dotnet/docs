...
```  
 ...
 For more information, see [Thread Synchronization](https://msdn.microsoft.com/library/ms173179.aspx).  
  
## Remarks  
 The `lock` keyword ensures that one thread does not enter a critical section of code while another thread is in the critical section. If another thread tries to enter a locked code, it will wait, block, until the object is released.  
  
 The section [Threading](https://msdn.microsoft.com/library/ms173178.aspx) discusses threading.  
...
## See Also  
 ...
 [Threading](https://msdn.microsoft.com/library/ms173178.aspx)   
 ...
 [Thread Synchronization](https://msdn.microsoft.com/library/ms173179.aspx)
