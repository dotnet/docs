...
For more information, see the [Type parameter constraints](~/_csharpstandard/standard/classes.md#type-parameter-constraints) section of the [C# language specification](~/_csharpstandard/standard/README.md).
