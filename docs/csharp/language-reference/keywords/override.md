...
For more information, see the [Override methods](~/_csharpstandard/standard/classes.md#override-methods) section of the [C# language specification](~/_csharpstandard/standard/README.md).
