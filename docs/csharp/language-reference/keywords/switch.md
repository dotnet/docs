...
- a [string](string.md).
- a [bool](bool.md).
- an integral value, such as an [int](../builtin-types/integral-numeric-types.md) or a [long](long.md).
...
- Any integral constant, such as an [int](../builtin-types/integral-numeric-types.md), a [long](long.md), or a [byte](../builtin-types/integral-numeric-types.md).
