---
description: "try-finally - C# Reference"
...
For more information, see [The try statement](~/_csharpstandard/standard/statements.md#the-try-statement) section of the [C# language specification](~/_csharpstandard/standard/README.md).
