...
The `unsafe` keyword denotes an unsafe context, which is required for any operation involving pointers. For more information, see [Unsafe Code and Pointers](/dotnet/csharp/language-reference/unsafe-code).
...
- [Unsafe Code and Pointers](/dotnet/csharp/language-reference/unsafe-code)
