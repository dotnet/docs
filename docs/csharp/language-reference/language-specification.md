...
=======
 You can download this spec from the [Microsoft Download Center](http://www.microsoft.com/download/details.aspx?id=7029). If you've installed Visual Studio, you can also find the spec on your computer in the *Program Files (x86)/Microsoft Visual Studio \<version\>/VC#/Specifications/1033* folder. However, installations of Visual Studio Express don't include this file.  
>>>>>>> Updates
