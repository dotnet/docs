...
Version 6.0 of the specification has not been approved as a stadnard. This site contains the [*draft* C# 6.0 specification](lexical-structure.md). It is built from the markdown files contained in [the dotnet/csharplang GitHub repository](https://github.com/dotnet/csharplang/blob/master/spec/README.md).
