...
The conditional operator (`?:`), commonly known as the ternary operator, returns one of two values depending on the value of a Boolean expression. Following is the syntax for the conditional operator.  
