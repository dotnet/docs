...
For more information, see the [Default value expressions](~/_csharpstandard/standard/expressions.md#11820-default-value-expressions) section of the [C# language specification](~/_csharpstandard/standard/README.md).
