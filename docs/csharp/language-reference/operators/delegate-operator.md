...
For more information, see the [Anonymous function expressions](~/_csharpstandard/standard/expressions.md#1216-) section of the [C# language specification](~/_csharpstandard/standard/README.md).
