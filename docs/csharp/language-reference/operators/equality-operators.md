...
For more information, see the [Delegate equality operators](~/_csharpstandard/standard/expressions.md#delegate-equality-operators) section of the [C# language specification](~/_csharpstandard/standard/README.md).
