...
String equality comparisons are case-sensitive ordinal comparisons. For more information about string comparison, see [Compare strings in C#](../../fundamentals/strings/common-tasks/compare.md).
