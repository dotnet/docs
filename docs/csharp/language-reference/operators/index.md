...
[x \< y](relational-operators.md#less-than-operator-) – less than (true if x is less than y).

[x > y](relational-operators.md#greater-than-operator-) – greater than (true if x is greater than y).

[x \<= y](relational-operators.md#less-than-or-equal-operator-) – less than or equal to.

[x >= y](relational-operators.md#greater-than-or-equal-operator-) – greater than or equal to.
