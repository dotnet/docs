...
For more information, see [The is operator](~/_csharpstandard/standard/expressions.md#the-is-operator) section of the [C# language specification](~/_csharpstandard/standard/README.md) and the following C# language proposals:
