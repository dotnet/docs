...
As the preceding example shows, in the case of a type and a namespace, the produced name is not [fully qualified](~/_csharpstandard/standard/basic-concepts.md#fully-qualified-names).
...
For more information, see the [Nameof expressions](~/_csharpstandard/standard/expressions.md#nameof-expressions) section of the [C# language specification](~/_csharpstandard/standard/README.md).
