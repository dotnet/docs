...
For more information about fixed and movable variables, see the [Fixed and moveable variables](~/_csharpstandard/standard/unsafe-code.md#fixed-and-moveable-variables) section of the [C# language specification](~/_csharpstandard/standard/README.md).
...
- [Fixed and moveable variables](~/_csharpstandard/standard/unsafe-code.md#fixed-and-moveable-variables)
- [The address-of operator](~/_csharpstandard/standard/unsafe-code.md#the-address-of-operator)
- [Pointer indirection](~/_csharpstandard/standard/unsafe-code.md#pointer-indirection)
- [Pointer member access](~/_csharpstandard/standard/unsafe-code.md#pointer-member-access)
- [Pointer element access](~/_csharpstandard/standard/unsafe-code.md#pointer-element-access)
- [Pointer arithmetic](~/_csharpstandard/standard/unsafe-code.md#pointer-arithmetic)
- [Pointer increment and decrement](~/_csharpstandard/standard/unsafe-code.md#pointer-increment-and-decrement)
- [Pointer comparison](~/_csharpstandard/standard/unsafe-code.md#pointer-comparison)
