...
- [How to safely cast by using pattern matching and the is and as operators](/dotnet/csharp/fundamentals/object-oriented/tutorials/safely-cast-using-pattern-matching-is-and-as-operators.md)
