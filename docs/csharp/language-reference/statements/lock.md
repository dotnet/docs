...
For more information, see [The lock statement](~/_csharpstandard/standard/statements.md#the-lock-statement) section of the [C# language specification](~/_csharpstandard/standard/README.md).
