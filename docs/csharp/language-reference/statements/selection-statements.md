...
- [The `if` statement](~/_csharpstandard/standard/statements.md#the-if-statement)
- [The `switch` statement](~/_csharpstandard/standard/statements.md#the-switch-statement)
