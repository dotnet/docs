...
For more information, see the [Interpolated strings](~/_csharpstandard/standard/expressions.md#interpolated-strings) section of the [C# language specification](~/_csharpstandard/standard/README.md).
