...
> [!NOTE]
>  Do not confuse this kind of custom join operation with the use of multiple `from` clauses to access inner collections. For more information, see [join clause](../keywords/join-clause--csharp-reference-.md).  
...
## Example  
 ...
 [!code[csProgGuideLINQ#64](../arrays/codesnippet/CSharp/how-to--perform-custom-join-operations--csharp-programming-guide-_1.cs)]  
...
## Example  
 ...
 [!code[csProgGuideLINQ#13](../arrays/codesnippet/CSharp/how-to--perform-custom-join-operations--csharp-programming-guide-_2.cs)]  
  
## Compiling the Code  
  
-   Create a [!INCLUDE[vs_current_short](../classes-and-structs/includes/vs_current_short_md.md)] console application project that targets [!INCLUDE[dnprdnshort](../classes-and-structs/includes/dnprdnshort_md.md)] 3.5 or later. By default, the project has a reference to System.Core.dll and a `using` directive for the System.Linq namespace.  
