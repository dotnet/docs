...
### Group Join Example  
 ...
 [!code[CsLINQProgJoining#5](../linq-query-expressions/codesnippet/CSharp/how-to--perform-grouped-joins--csharp-programming-guide-_1.cs)]  
  
## Example  
  
### Group Join to Create XML Example  
 Group joins are ideal for creating XML by using [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)]. The following example is similar to the previous example except that instead of creating anonymous types, the result selector function creates XML elements that represent the joined objects. For more information about [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)], see [LINQ to XML](../Topic/LINQ%20to%20XML.md).  
  
 [!code[CsLINQProgJoining#6](../linq-query-expressions/codesnippet/CSharp/how-to--perform-grouped-joins--csharp-programming-guide-_2.cs)]  
