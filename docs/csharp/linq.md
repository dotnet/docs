...
-   A query is not executed until you iterate over the query variable in a `foreach` statement. For more information, see [Introduction to LINQ queries](programming-guide/concepts/linq/introduction-to-linq-queries.md).  
