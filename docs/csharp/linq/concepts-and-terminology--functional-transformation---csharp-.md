 ...
 *Functional programming* is a programming approach that directly supports pure functional transformation.  
 ...
 For more information about functional programming, see [Functional Programming vs. Imperative Programming (C#)](../linq/functional-programming-vs.-imperative-programming--csharp-.md).  
...
## Terminology  
 ...
 For more information about, see [Lambda Expressions](../statements-expressions-operators/lambda-expressions--csharp-programming-guide-.md).  
 ...
 For more information, see [Introduction to LINQ Queries (C#)](../linq/introduction-to-linq-queries--csharp-.md) and [Deferred Execution and Lazy Evaluation in LINQ to XML (C#)](../linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml--csharp-.md).  
