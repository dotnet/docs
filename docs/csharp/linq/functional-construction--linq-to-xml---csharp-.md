...
[!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] provides a powerful way to create XML elements called *functional construction*. Functional construction is the ability to create an XML tree in a single statement.  
  
 There are several key features of the [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] programming interface that enable functional construction:  
...
```  
 ...
 These features also enable you to write code that uses the results of [!INCLUDE[vbteclinq](../classes-and-structs/includes/vbteclinq_md.md)] queries when you create an XML tree, as follows:  
