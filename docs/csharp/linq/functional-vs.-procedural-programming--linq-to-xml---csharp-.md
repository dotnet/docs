...
-   In-memory XML tree modification using procedural code.  
 ...
 To see the two approaches contrasted, see [In-Memory XML Tree Modification vs. Functional Construction (LINQ to XML) (C#)](../linq/b5afc31d-a325-4ec6-bf17-0ff90a20ffca.md).  
  
 For a tutorial on writing functional transformations, see [Pure Functional Transformations of XML (C#)](../linq/pure-functional-transformations-of-xml--csharp-.md).  
