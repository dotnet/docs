...
This topic describes how you can control namespace prefixes when serializing an XML tree.  
 ...
 To control namespace prefixes, you insert attributes that declare namespaces. If you declare the namespaces with specific prefixes, [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] will attempt to honor the namespace prefixes when serializing.  
