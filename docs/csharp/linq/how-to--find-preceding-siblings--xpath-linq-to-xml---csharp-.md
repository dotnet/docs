...
This topic compares the XPath `preceding-sibling` axis to the [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] child <xref:System.Xml.Linq.XNode.ElementsBeforeSelf*?displayProperty=fullName> axis.  
