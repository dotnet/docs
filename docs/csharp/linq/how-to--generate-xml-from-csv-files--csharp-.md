...
This example shows how to use [!INCLUDE[vbteclinqext](../getting-started/includes/vbteclinqext_md.md)] and [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] to generate an XML file from a comma-separated value (CSV) file.  
  
## Example  
 The following code performs a [!INCLUDE[vbteclinq](../classes-and-structs/includes/vbteclinq_md.md)] query on an array of strings.  
