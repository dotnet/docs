...
To create an encoded XML document, you add an <xref:System.Xml.Linq.XDeclaration> to the XML tree, setting the encoding to the desired code page name.  
 ...
 If you set <xref:System.Xml.Linq.XDeclaration.Encoding*> to a valid code page name, [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] will serialize with the specified encoding.  
