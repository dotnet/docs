...
## Example  
 ...
 For a detailed tutorial that explains how this example works, see [Pure Functional Transformations of XML (C#)](../linq/pure-functional-transformations-of-xml--csharp-.md).  
...
```  
 ...
 When run with the sample Open XML document described in [Creating the Source Office Open XML Document (C#)](../linq/creating-the-source-office-open-xml-document--csharp-.md), this example produces the following output:  
