...
## Example  
 This example uses the following XML document: [Sample XML File: Numerical Data (LINQ to XML)](../linq/sample-xml-file--numerical-data--linq-to-xml-3.md).  
...
## Example  
 ...
 This example uses the following XML document: [Sample XML File: Numerical Data in a Namespace](../linq/sample-xml-file--numerical-data-in-a-namespace3.md).  
