...
## Example  
 ...
 This example uses the following XML document: [Sample XML File: Customers and Orders in a Namespace](../linq/sample-xml-file--customers-and-orders-in-a-namespace2.md).  
