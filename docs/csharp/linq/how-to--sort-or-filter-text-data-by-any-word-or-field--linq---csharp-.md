...
1.  Copy the scores.csv data from the topic [How to: Join Content from Dissimilar Files (LINQ) (C#)](../linq/how-to--join-content-from-dissimilar-files--linq---csharp-.md) and save it to your solution folder.  
