...
[!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] events enable you to be notified when an XML tree is altered.  
 ...
 For examples of [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] events, see <xref:System.Xml.Linq.XObject.Changing> and <xref:System.Xml.Linq.XObject.Changed>.  
