...
> [!NOTE]
> The examples in this topic use the `Person` and `Pet` data classes from [Perform inner joins](perform-inner-joins.md).
...
:::code language="csharp" source="../../../samples/snippets/csharp/concepts/linq/LinqSamples/GroupJoins.cs" id="grouped_joins_2":::
