...
This example builds on the previous example, [Retrieving the Text of the Paragraphs (C#)](../linq/retrieving-the-text-of-the-paragraphs--csharp-.md), by refactoring the concatenation of strings using a pure function that is implemented as an extension method.  
