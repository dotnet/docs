...
You can modify an XML tree, removing elements, attributes, and other types of nodes.  
 ...
 The main reason for doing this is that most of the collections you retrieve from an XML tree are yielded using deferred execution. If you do not first materialize them into a list, or if you do not use the extension methods, it is possible to encounter a certain class of bugs. For more information, see [Mixed Declarative Code/Imperative Code Bugs (LINQ to XML) (C#)](../linq/mixed-declarative-code-imperative-code-bugs--linq-to-xml---csharp-.md).  
...
### Description  
 ...
 For more information on the <xref:System.Linq.Enumerable.ToList*> operator, see [Converting Data Types (C#)](../linq/converting-data-types--csharp-.md).  
