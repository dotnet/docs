...
This example builds on the previous example, [Retrieving the Paragraphs and Their Styles (C#)](../linq/retrieving-the-paragraphs-and-their-styles--csharp-.md). This new example retrieves the text of each paragraph as a string.  
 ...
 These queries, which are chained together, use the processing model that is examined in detail in the topic [Tutorial: Chaining Queries Together (C#)](../linq/tutorial--chaining-queries-together--csharp-.md).  
...
## Example  
 ...
 For instructions for creating the source document for this example, see [Creating the Source Office Open XML Document (C#)](../linq/creating-the-source-office-open-xml-document--csharp-.md).  
