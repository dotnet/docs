...
The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] documentation. This file contains customers and orders.  
 ...
 For an example of writing LINQ queries that take advantage of this relationship using the `Join` clause, see [How to: Join Two Collections (LINQ to XML) (C#)](../linq/how-to--join-two-collections--linq-to-xml---csharp-.md).  
...
## See Also  
 [Sample XML Documents (LINQ to XML)](../linq/sample-xml-documents--linq-to-xml-2.md)