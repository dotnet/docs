...
The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](../linq/includes/sqltecxlinq_md.md)] documentation. This file contains customers and orders. The XML is in a namespace.  
