...
You can send arguments to the `Main` method by defining the method in one of the following ways:  
 ...
 [!code[csProgGuideMain#2](../inside-a-program/codesnippet/CSharp/command-line-arguments--csharp-programming-guide-_1.cs)]  
  
 [!code[csProgGuideMain#3](../inside-a-program/codesnippet/CSharp/command-line-arguments--csharp-programming-guide-_2.cs)]  
...
>  To enable command-line arguments in the `Main` method in a Windows Forms application, you must manually modify the signature of `Main` in program.cs. The code generated by the Windows Forms designer creates a `Main` without an input parameter. You can also use <xref:System.Environment.CommandLine*?displayProperty=fullName> or <xref:System.Environment.GetCommandLineArgs*?displayProperty=fullName> to access the command-line arguments from any point in a console or Windows application.  
 ...
 [!code[csProgGuideMain#4](../inside-a-program/codesnippet/CSharp/command-line-arguments--csharp-programming-guide-_3.cs)]  
...
1.  Paste the following code into any text editor, and then save the file as  a text file with the name `Factorial.cs`.  
     ...
     [!code[csProgGuideMain#16](../inside-a-program/codesnippet/CSharp/command-line-arguments--csharp-programming-guide-_4.cs)]  
