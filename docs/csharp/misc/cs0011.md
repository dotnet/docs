...
The base class or interface 'class' in assembly 'assembly' referenced by type 'type' could not be resolved  
 ...
 For more information, see [Add Reference Dialog Box](https://msdn.microsoft.com/library/ftcwa60a(v=vs.90).aspx) and [/reference (C# Compiler Options)](../../csharp/language-reference/compiler-options/reference-compiler-option.md).  
...
## See Also  
 [Add Reference Dialog Box](https://msdn.microsoft.com/library/ftcwa60a(v=vs.90).aspx)   
