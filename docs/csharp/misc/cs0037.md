...
Cannot convert null to 'type' because it is a non-nullable value type  
 ...
 The compiler cannot assign null to a value type; null can only be assigned to a [reference type](../language-reference/keywords/reference-types.md) or to a Nullable type. [struct](../language-reference/keywords/struct.md) is a value type. For more information, see [Nullable Types](../programming-guide/nullable-types/index.md).  
