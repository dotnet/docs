...
Inconsistent accessibility: base interface 'interface 1' is less accessible than interface 'interface 2'  
 ...
 Interface accessibility cannot be widened in a derived interface. For more information, see [Interfaces](../fundamentals/types/interfaces.md) and [Access Modifiers](../programming-guide/classes-and-structs/access-modifiers.md).  
