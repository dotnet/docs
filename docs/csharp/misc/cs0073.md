...
An add or remove accessor must have a body  
 ...
 An **add** or **remove** keyword in an [event](../language-reference/keywords/event.md) definition must have a body. For more information, see [Events](../events-overview.md).  
