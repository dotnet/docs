...
The event 'event' can only appear on the left hand side of += or -=  
 ...
 An [event](../language-reference/keywords/event.md) was called incorrectly. For more information, see [Events](../events-overview.md) and [Delegates](../delegates-overview.md).  
