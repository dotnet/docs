...
Constraints are not allowed on non-generic declarations  
 ...
 The syntax found may only be used in a generic declaration to apply constraints to the type parameter. For more information, see [Generics](/dotnet/csharp/fundamentals/types/generics).  
