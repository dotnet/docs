...
The namespace 'namespace' already contains a definition for 'type'  
 ...
 A [namespace](../language-reference/keywords/namespace.md) has duplicate identifiers. Rename or delete one of the duplicate identifiers. For more information, see [Namespaces](../fundamentals/program-structure/namespaces.md)  
