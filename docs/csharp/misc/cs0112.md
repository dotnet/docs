...
A static member 'function' in a class or struct can't be marked as override, virtual, or abstract.
  
Any method declaration in a class or struct that uses the `override`, **virtual**, or **abstract** keyword can't also use the **static** keyword.
