...
A using namespace directive can only be applied to namespaces; 'type' is a type not a namespace  
 ...
 A [using](../language-reference/keywords/using.md) directive can only take the name of a namespace as a parameter. For more information, see [Namespaces](/dotnet/csharp/fundamentals/types/namespaces).  
