...
The Conditional attribute is not valid on 'method' because it is an override method  
 ...
 The [Conditional](https://msdn.microsoft.com/library/4xssyw96(v=vs.90).aspx) attribute is not allowed on a method that is marked with the [override](../../csharp/language-reference/keywords/override.md) keyword. For more information, see [Knowing When to Use Override and New Keywords](../../csharp/programming-guide/classes-and-structs/knowing-when-to-use-override-and-new-keywords.md).  
