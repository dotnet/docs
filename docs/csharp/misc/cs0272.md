...
The property or indexer 'property/indexer' cannot be used in this context because the set accessor is inaccessible, this error occurs when the `set` accessor is not accessible to the program code.
