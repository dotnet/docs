...
> [!NOTE]
> Beginning with C# 10, you can initialize a struct's instance field or property at its declaration. For more information, see the [Struct initialization and default values](../language-reference/builtin-types/struct.md#struct-initialization-and-default-values) section of the [Structure types](../language-reference/builtin-types/struct.md) article.
