...
For general guidance on thread-safe programming, consider using <xref:System.Threading.Interlocked> operations or the [`lock`](../language-reference/statements/lock.md) statement instead of `volatile` fields.
