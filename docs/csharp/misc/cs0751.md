...
A partial method must be declared in a partial class or partial struct  
 ...
 It is not possible to declare a [partial](../language-reference/keywords/partial-member.md) method unless it is encapsulated inside a partial class or partial struct.  
