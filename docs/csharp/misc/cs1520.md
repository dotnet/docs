...
Method must have a return type  
 ...
 A method that is declared in a class, struct, or interface must have an explicit return type. In the following example, the Square method has a return value of [string](/dotnet/csharp/language-reference/builtin-types/reference-types):  
