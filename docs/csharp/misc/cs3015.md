...
'method signature' has no accessible constructors which use only CLS-compliant types  
 ...
 To be compliant with the Common Language Specification (CLS), the argument list of an attribute class cannot contain an array. For more information on CLS compliance, see [Language independence](../../standard/language-independence.md).
