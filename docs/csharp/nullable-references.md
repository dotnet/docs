...
- Any nullable reference type (noted by `?` after the type in the variable declaration) may be null. Static analysis determines if it the value is known to be not null when it is dereferenced. If not, the compiler warns you.
