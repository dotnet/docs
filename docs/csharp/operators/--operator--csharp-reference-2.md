...
## Remarks  
 ...
 User-defined types can overload the unary `-` and binary `-` operators. For more information, see [operator (C# Reference)](../keywords/operator--csharp-reference-2.md).  
  
## Example  
 [!code[csRefOperators#40](../operators/codesnippet/CSharp/--operator--csharp-reference-2_1.cs)]  
