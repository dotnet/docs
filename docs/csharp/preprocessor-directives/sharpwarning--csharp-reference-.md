...
## Remarks  
 A common use of `#warning` is in a conditional directive. It is also possible to generate a user-defined error with [#error](../preprocessor-directives/sharperror--csharp-reference-.md).  
