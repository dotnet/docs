...
### OrderBy Example
 ...
 The following example shows an extension method defined for the <xref:System.String?displayProperty=nameWithType> class. It is defined inside a non-nested, non-generic static class:  
