...
ms.topic: "article"
dev_langs: ["CSharp"]
helpviewer_keywords: ["get accessor [C#], declaring properties", "set accessor [C#]", "properties [C#], declaring", "read/write properties [C#]", "accessors [C#], declaring properties with"]
