...
> [!NOTE]
> In C# the [#define](..\..\language-reference\preprocessor-directives.md) preprocessor directive cannot be used to define constants in the way that is typically used in C and C++.  
