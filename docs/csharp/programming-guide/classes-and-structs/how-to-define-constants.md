...
> [!NOTE]
> In C# the [#define](/dotnet/csharp/language-reference/preprocessor-directives) preprocessor directive cannot be used to define constants in the way that is typically used in C and C++.  
