...
description: Named arguments in C# specify arguments by name, not position. Optional arguments can be omitted. Named & optional arguments facilitate calls to COM interfaces.
ms.date: 07/20/2015
f1_keywords: 
