...
ms.topic: "article"
f1_keywords: ["namedParameter_CSharpKeyword", "cs_namedParameter"]
dev_langs: ["CSharp"]
helpviewer_keywords: ["parameters [C#], named", "named arguments [C#]", "arguments [C#], named", "optional arguments [C#]", "arguments [C#], optional", "parameters [C#], optional", "named and optional arguments [C#]"]
