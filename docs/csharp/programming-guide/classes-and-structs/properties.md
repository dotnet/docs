...
For more information, see [Properties](~/_csharpstandard/standard/classes.md#properties) in the [C# Language Specification](~/csharpstandard/standard/README.md). The language specification is the definitive source for C# syntax and usage.
