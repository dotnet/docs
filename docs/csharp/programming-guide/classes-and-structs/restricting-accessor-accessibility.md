...
ms.topic: "article"
dev_langs: ["CSharp"]
helpviewer_keywords: ["read-only properties [C#]", "read-only indexers [C#]", "accessors [C#]", "properties [C#], read-only", "asymmetric accessor accesibility [C#]", "indexers [C#], read-only"]
