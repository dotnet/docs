...
For more information, see the [Static constructors](~/_csharpstandard/standard/classes.md#static-constructors) section of the [C# language specification](~/_csharpstandard/standard/README.md).
