...
For more information, see [Instance constructors](~/_csharpstandard/standard/classes.md#instance-constructors) and [Static constructors](~/_csharpstandard/standard/classes.md#static-constructors) in the [C# Language Specification](~/csharpstandard/standard/README.md). The language specification is the definitive source for C# syntax and usage.
