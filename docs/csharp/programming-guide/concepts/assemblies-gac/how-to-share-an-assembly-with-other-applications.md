...
5.  Access the types contained in the assembly from the other applications. For more information, see [How to: Reference a Strong-Named Assembly](https://docs.microsoft.com/dotnet/framework/app-domains/how-to-reference-a-strong-named-assembly).  
