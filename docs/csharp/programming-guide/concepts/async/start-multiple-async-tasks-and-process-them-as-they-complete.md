...
The updated `Main` method is now considered an [Async main](../../../whats-new/csharp-version-history.md#c-version-70), which allows for an asynchronous entry point into the executable. It is expressed as a call to `SumPageSizesAsync`.
...
The updated `Main` method is now considered an [Async main](../../../whats-new/csharp-version-history.md#c-version-70), which allows for an asynchronous entry point into the executable. It is expressed a call to `SumPageSizesAsync`.
