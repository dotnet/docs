...
The updated `Main` method is now considered an [Async main](/dotnet/csharp/whats-new/csharp-version-history#c-version-70), which allows for an asynchronous entry point into the executable. It is expressed as a call to `SumPageSizesAsync`.
...
The updated `Main` method is now considered an [Async main](/dotnet/csharp/whats-new/csharp-version-history#c-version-70), which allows for an asynchronous entry point into the executable. It is expressed a call to `SumPageSizesAsync`.
