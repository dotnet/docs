...
For more information on allowed parameter types, see the [Attributes](~/_csharpstandard/standard/attributes.md#attribute-parameter-types) section of the [C# language specification](~/_csharpstandard/standard/README.md)
