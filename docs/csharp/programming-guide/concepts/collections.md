---
title: "Collections (C#)"
description: Learn about collections in C#, which are used to work with groups of objects. Collections can grow and shrink dynamically as the needs of the application change.
ms.date: 07/20/2015
