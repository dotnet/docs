...
LINQ (Language-Integrated Query) can be used to access collections. LINQ queries provide filtering, ordering, and grouping capabilities. For more information, see  [Introduction to LINQ queries (C#)](linq/introduction-to-linq-queries.md).
