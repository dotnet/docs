...
|||  
|---|---|  
|[Performance Tips](/dotnet/framework/performance/performance-tips) | Discusses several basic rules that may help you increase the performance of your application.|
