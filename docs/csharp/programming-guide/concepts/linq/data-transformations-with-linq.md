...
ms.topic: "article"
dev_langs: ["CSharp"]
helpviewer_keywords: ["LINQ [C#], data transformations", "source elements [LINQ in C#]", "joining multiple inputs [LINQ in C#]", "multiple outputs for one output sequence [LINQ in C#]", "subset of source elements [LINQ in C#]", "data sources [LINQ in C#], data transformations", "data transformations [LINQ in C#]"]
