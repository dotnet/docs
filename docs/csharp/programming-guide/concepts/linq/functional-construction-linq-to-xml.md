...
description: Learn how the LINQ to XML programming interface that enables functional construction, the ability to create an XML tree in a single statement in C#.
ms.date: 07/20/2015
