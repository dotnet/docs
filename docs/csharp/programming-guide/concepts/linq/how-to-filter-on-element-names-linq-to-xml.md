...
description: Learn how to filter on the element name when you call a method that returns xref:System.Collections.Generic.IEnumerable%601 of xref:System.Xml.Linq.XElement.
ms.date: 07/20/2015
