...
description: Learn how to find an attribute of the parent element. See an example that finds a specific element, and then the 'id' attribute of that element.
ms.date: 07/20/2015
