...
description: Learn how to get the value of elements. See examples such as string or integer casting, or using the xref:System.Xml.Linq.XElement.Value%2A property.
ms.date: 07/20/2015
