...
description: Learn how to split a file into many files using groups. See an example of merging file contents, and then creating new files to organize the data in a new way.
ms.date: 07/20/2015
