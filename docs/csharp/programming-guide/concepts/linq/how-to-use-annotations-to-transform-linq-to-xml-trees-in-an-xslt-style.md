...
description: Learn how to use annotations to transform LINQ to XML trees in an SXLT style. See an example of transforming a tree using the XForm function.
ms.date: 07/20/2015
