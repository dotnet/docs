...
> [!NOTE]
>  The [!INCLUDE[linq_adonet](~/includes/linq-adonet-md.md)] documentation is located in the ADO.NET section of the .NET Framework SDK: [LINQ and ADO.NET](https://docs.microsoft.com/dotnet/framework/data/adonet/linq-and-ado-net).  
...
## See Also  
 [LINQ and ADO.NET](https://docs.microsoft.com/dotnet/framework/data/adonet/linq-and-ado-net)   
