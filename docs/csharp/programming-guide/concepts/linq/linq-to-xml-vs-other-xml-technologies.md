...
## LINQ to XML vs. XmlLite  
 ...
 XmlLite is not integrated with [!INCLUDE[vbteclinqext](~/includes/vbteclinqext-md.md)]. It does not yield the programmer productivity improvements that are the motivating force behind LINQ.  
