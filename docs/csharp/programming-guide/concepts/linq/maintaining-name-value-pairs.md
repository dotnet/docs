...
description: LINQ to XML contains methods that make it easy to keep name/value pairs, either as attributes or as a set of child elements.
ms.date: 07/20/2015
...
- [Modifying XML Trees (LINQ to XML) (C#)](./in-memory-xml-tree-modification-vs-functional-construction-linq-to-xml.md)
