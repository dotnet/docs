...
description: LINQ to XML methods can modify an XML tree directly. Iterating through one of the axes, modifying the XML tree as you do so, can give rise to strange bugs.
ms.date: 07/20/2015
