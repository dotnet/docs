...
A [delegate](/dotnet/csharp/language-reference/builtin-types/reference-types) can be associated with a named method. When you instantiate a delegate by using a named method, the method is passed as a parameter, for example:  
