...
For more information, see [Delegates](~/_csharpstandard/standard/delegates.md) in the [C# Language Specification](~/csharpstandard/standard/README.md). The language specification is the definitive source for C# syntax and usage.
