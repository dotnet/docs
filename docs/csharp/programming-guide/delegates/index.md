...
description: Explore delegate types in C# and refer to methods with a parameter list and return type, or pass methods as arguments to other methods.
ms.date: 03/11/2025
helpviewer_keywords: 
...
> [!NOTE]
> In the context of method overloading, the signature of a method doesn't include the return value. However, in the context of delegates, the signature does include the return value. In other words, a method must have the same return type as the delegate.
