...
For more information, see [Events](~/_csharpstandard/standard/classes.md#events) in the [C# Language Specification](~/csharpstandard/standard/README.md). The language specification is the definitive source for C# syntax and usage.
