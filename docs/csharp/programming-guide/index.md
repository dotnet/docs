...
This section provides detailed information on key C# language features and features accessible to C# through .NET.  
 ...
 For information about specific keywords, operators, and preprocessor directives, see [C# Reference](../language-reference/index.yml). For information about the C# Language Specification, see [C# Language Specification](~/_csharpstandard/standard/README.md).  
