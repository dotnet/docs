...
ms.topic: "article"
f1_keywords: ["CS5001", "main_CSharpKeyword", "Main"]
dev_langs: ["CSharp"]
helpviewer_keywords: ["Main method [C#]", "C# language, command-line arguments", "arguments [C#], command-line", "command line [C#], arguments", "command-line arguments [C#], Main method"]
