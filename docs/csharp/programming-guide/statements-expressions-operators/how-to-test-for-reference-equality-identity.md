...
You do not have to implement any custom logic to support reference equality comparisons in your types. This functionality is provided for all types by the static <xref:System.Object.ReferenceEquals*?displayProperty=nameWithType> method.
...
The example also shows why <xref:System.Object.ReferenceEquals*?displayProperty=nameWithType> always returns `false` for value types. This is due to **boxing**, which creates separate object instances for each value type argument. Additionally, you should not use <xref:System.Object.ReferenceEquals*> to determine string equality.
