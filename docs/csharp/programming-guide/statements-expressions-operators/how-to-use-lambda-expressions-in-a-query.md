...
## Compiling the Code  
 To run this code, copy and paste the method into the `StudentClass` that is provided in [How to: Query a Collection of Objects](/dotnet/csharp/linq/query-a-collection-of-objects) and call it from the `Main` method.  
