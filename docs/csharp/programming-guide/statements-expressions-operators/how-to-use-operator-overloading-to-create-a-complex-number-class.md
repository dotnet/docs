...
ms.topic: "article"
dev_langs: ["CSharp"]
helpviewer_keywords: ["complex numbers [C#]", "classes [C#], operator overloading", "operator overloading [C#], complex numbers", "operator overloading [C#], using to create classes", "operators [C#], overloading to create a complex number class"]
