...
|[==](../../language-reference/operators/equality-operators.md#equality-operator-), [!=](../../language-reference/operators/equality-operators.md#inequality-operator-), [\<](../../language-reference/operators/relational-operators.md#less-than-operator-), [>](../../language-reference/operators/relational-operators.md#greater-than-operator-), [\<=](../../language-reference/operators/relational-operators.md#less-than-or-equal-operator-), [>=](../../language-reference/operators/relational-operators.md#greater-than-or-equal-operator-)|The comparison operators can be overloaded (but see the note that follows this table).|
