...
- [Split strings into substrings in C#](../../fundamentals/strings/split.md): Contains code examples that illustrate how to use the <xref:System.String.Split*?displayProperty=nameWithType> method to parse strings.
- [Search strings in C#](../../fundamentals/strings/search.md): Explains how to search for specific text or patterns in strings.
