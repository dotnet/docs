...
### Format Method
The <xref:System.String.Format%2A?displayProperty=nameWithType> utilizes placeholders in braces to create a format string. The following example uses a format string to output the result of each iteration of a loop:git
