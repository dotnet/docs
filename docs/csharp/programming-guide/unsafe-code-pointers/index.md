...
ms.topic: "article"
dev_langs: ["CSharp"]
helpviewer_keywords: ["security [C#], type safety", "C# language, unsafe code", "type safety [C#]", "unsafe keyword [C#]", "unsafe code [C#]", "C# language, pointers", "pointers [C#], about pointers"]
