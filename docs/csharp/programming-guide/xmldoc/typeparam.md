...
## Remarks  
 ...
 The text for the `<typeparam>` tag will be displayed in IntelliSense, the [Object Browser Window](https://msdn.microsoft.com/library/9t97b7bh(v=vs.90).aspx) code comment web report.  
