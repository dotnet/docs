...
f1_keywords: ["cs.xml"]
dev_langs: ["CSharp"]
helpviewer_keywords: ["XML [C#], code comments", "comments [C#], XML", "documentation comments [C#]", "C# source code files", "C# language, XML code comments", "XML documentation comments [C#]"]
