...
### Subqueries in a query expression  
 ...
 For more information, see [How to: perform a subquery on a grouping operation](programming-guide/linq-query-expressions/how-to-perform-a-subquery-on-a-grouping-operation.md).  
  
## See Also  
 [C# programming guide](programming-guide/index.md)   
 [LINQ query expressions](programming-guide/linq-query-expressions/index.md)   
 [LINQ (Language-Integrated Query)](linq.md)   
