...
You can see an example solution by [looking at the finished sample code on GitHub](https://github.com/dotnet/samples/tree/master/samples/csharp/list-quickstart/Program.cs#L13-L23)
