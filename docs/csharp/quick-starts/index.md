...
This quickstart assumes you've finished the online quickstarts, and you've installed [.NET Core SDK](https://dot.net/core) and [Visual Studio Code](https://code.visualstudio.com/).