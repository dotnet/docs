...
You can check your answer by [looking at the finished sample code on GitHub](https://github.com/dotnet/samples/tree/master/samples/csharp/numbers-quickstart/Program.cs#L104-L106)
