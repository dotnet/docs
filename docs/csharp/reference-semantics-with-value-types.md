...
use those features, you must configure your project to use C# 7.2 or later. For more information on setting the language version see [configure the language version](configure-language-version.md).
