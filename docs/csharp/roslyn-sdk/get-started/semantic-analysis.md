...
You can see the finished code for this sample in [our GitHub repository](https://github.com/dotnet/samples/tree/master/samples/csharp/roslyn-sdk/SemanticQuickStart).
