...
- Unlike classes, structs can be instantiated without using a `new` operator.
   ...
   > [!NOTE]
   > In .NET Core 2.1 and later, structs must be instantiated by using a `new` operator. For more information, see [Breaking changes for migration from version 2.0 to 2.1](../core/compatibility/2.0-2.1.md#corefx).
