...
There are several rules that make tuple equality tests more convenient. Tuple equality performs [lifted conversions](../language-specification/index.md) if one of the tuples is a nullable tuple, as shown in the following code:
