...
## Example  
 ...
 [!code[csProgGuidePointers#3](../unsafe-code-pointers/codesnippet/CSharp/pointer-conversions--csharp-programming-guide-_1.cs)]  
  
 [!code[csProgGuidePointers#4](../unsafe-code-pointers/codesnippet/CSharp/pointer-conversions--csharp-programming-guide-_2.cs)]  
