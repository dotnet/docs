...
For more information on required members, See the [init-only](../programming-guide/classes-and-structs/properties.md#init-only) section of the properties article.
