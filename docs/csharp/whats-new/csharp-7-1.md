...
To use the latest features in a point release, you need to [configure the compiler language version](configure-language-versions.md) and select the version.
