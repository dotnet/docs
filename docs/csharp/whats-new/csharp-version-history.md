...
C# version 1.2 shipped with Visual Studio 2003. It contained a few small fixes to the language. Most notable is that starting with this version, the code generated in a `foreach` loop called <xref:System.IDisposable.Dispose()> on an <xref:System.IEnumerator> when that <xref:System.IEnumerator> implemented <xref:System.IDisposable>.
