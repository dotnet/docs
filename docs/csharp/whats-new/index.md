...
major features added in each release. This section provides information on new feature that have been released, either in a general release, or in a public preview. Detailed language feature status, including features considered for upcoming releases can be found [on the roslyn repository](https://github.com/dotnet/roslyn/blob/master/docs/Language%20Feature%20Status.md) on GitHub.
