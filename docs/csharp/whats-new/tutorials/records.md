...
You'll need to set up your machine to run .NET 6 or later, including the C# 10 or later compiler. The C# 9.0 compiler is available starting with [Visual Studio 2022 preview](https://visualstudio.microsoft.com/vs) or the [.NET 6.0 SDK](https://dotnet.microsoft.com/download).
