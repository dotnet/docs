...
## Remarks  
 The \<code> tag gives you a way to indicate multiple lines as code. Use [\<c>](../xmldoc/-c---csharp-programming-guide-.md) to indicate that text within a description should be marked as code.  
  
 Compile with [/doc](../compiler-options/-doc--csharp-compiler-options-.md) to process documentation comments to a file.  
  
## Example  
 See the [\<example>](../xmldoc/-example---csharp-programming-guide-.md) topic for an example of how to use the \<code> tag.  
