...
This Desktop Guide is written for Windows Froms on .NET 5. For more information about the .NET Framework version of Windows Forms, see [Windows Forms Archive](todo-some-link).
