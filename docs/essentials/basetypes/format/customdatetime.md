...
A date and time format string defines the text representation of a [DateTime](http://dotnet.github.io/api/System.DateTime.html) or [DateTimeOffset](http://dotnet.github.io/api/System.DateTimeOffset.html) value that results from a formatting operation . It can also define the representation of a date and time value that is required in a parsing operation in order to successfully convert the string to a date and time. A custom format string consists of one or more custom date and time format specifiers. Any string that is not a [standard date and time format string](standarddatetime.md) is interpreted as a custom date and time format string. 

Custom date and time format strings can be used with both [DateTime](http://dotnet.github.io/api/System.DateTime.html) and [DateTimeOffset](http://dotnet.github.io/api/System.DateTimeOffset.html)  values.
...
In parsing operations, custom date and time format strings can be used with the [DateTime.ParseExact](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_ParseExact_System_String_System_String_System_IFormatProvider_), [DateTime.TryParseExact](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_TryParseExact_System_String_System_String_System_IFormatProvider_System_Globalization_DateTimeStyles_System_DateTime__), [DateTimeOffset.ParseExact](http://dotnet.github.io/api/System.DateTimeOffset.html#System_DateTimeOffset_ParseExact_System_String_System_String_System_IFormatProvider_), and [DateTimeOffset.TryParseExact](http://dotnet.github.io/api/System.DateTimeOffset.html#System_DateTimeOffset_TryParseExact_System_String_System_String_System_IFormatProvider_System_Globalization_DateTimeStyles_System_DateTimeOffset__) methods. These methods require that an input string conform exactly to a particular pattern for the parse operation to succeed. The following example illustrates a call to the [DateTimeOffset.ParseExact(String, String, IFormatProvider)](http://dotnet.github.io/api/System.DateTimeOffset.html#System_DateTimeOffset_ParseExact_System_String_System_String_System_IFormatProvider_) method to parse a date that must include a day, a month, and a two-digit year.
...
"K" | Time zone information. | With [DateTime](http://dotnet.github.io/api/System.DateTime.html) values: `2019-06-15T13:45:30, Kind Unspecified ->`; `2019-06-15T13:45:30, Kind Utc -> Z`; `2019-06-15T13:45:30, Kind Local -> -07:00 (depends on local computer settings)`; With [DateTimeOffset](http://dotnet.github.io/api/System.DateTimeOffset.html) values: `2019-06-15T01:45:30-07:00 --> -07:00`; `2019-06-15T08:45:30+00:00 --> +00:00`
...
The "dddd" custom format specifier (plus any number of additional "d" specifiers) represents the full name of the day of the week. The localized name of the day of the week is retrieved from the [DateTimeFormatInfo.DayNames](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html#System_Globalization_DateTimeFormatInfo_DayNames) property of the current or specified culture. 
...
When you use "f" format specifiers as part of a format string supplied to the [DateTime.ParseExact](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_ParseExact_System_String_System_String_System_IFormatProvider_), [DateTime.TryParseExact](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_TryParseExact_System_String_System_String_System_IFormatProvider_System_Globalization_DateTimeStyles_System_DateTime__), [DateTimeOffset.ParseExact](http://dotnet.github.io/api/System.DateTimeOffset.html#System_DateTimeOffset_ParseExact_System_String_System_String_System_IFormatProvider_), or [DateTimeOffset.TryParseExact](http://dotnet.github.io/api/System.DateTimeOffset.html#System_DateTimeOffset_TryParseExact_System_String_System_String_System_IFormatProvider_System_Globalization_DateTimeStyles_System_DateTimeOffset__) method, the number of "f" format specifiers indicates the number of most significant digits of the seconds fraction that must be present to successfully parse the string.
...
The number of "F" format specifiers used with the [DateTime.ParseExact](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_ParseExact_System_String_System_String_System_IFormatProvider_), [DateTime.TryParseExact](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_TryParseExact_System_String_System_String_System_IFormatProvider_System_Globalization_DateTimeStyles_System_DateTime__), [DateTimeOffset.ParseExact](http://dotnet.github.io/api/System.DateTimeOffset.html#System_DateTimeOffset_ParseExact_System_String_System_String_System_IFormatProvider_), or [DateTimeOffset.TryParseExact](http://dotnet.github.io/api/System.DateTimeOffset.html#System_DateTimeOffset_TryParseExact_System_String_System_String_System_IFormatProvider_System_Globalization_DateTimeStyles_System_DateTimeOffset__) method indicates the maximum number of most significant digits of the seconds fraction that can be present to successfully parse the string.
...
If the "h" format specifier is used without other custom format specifiers, it is interpreted as a standard date and time format specifier and throws a [FormatException](http://dotnet.github.io/api/System.FormatException.html). For more information about using a single format specifier, see [Using Single Custom Format Specifiers](#Using-Single-Custom-Format-Specifiers) later in this topic.
...
The "K" custom format specifier represents the time zone information of a date and time value. When this format specifier is used with [DateTime](http://dotnet.github.io/api/System.DateTime.html) values, the result string is defined by the value of the [DateTime.Kind](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_Kind) property: 
 
* For the local time zone (a [DateTime.Kind](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_Kind) property value of [DateTimeKind.Local](http://dotnet.github.io/api/System.DateTimeKind.html#System_DateTimeKind_Local)), this specifier is equivalent to the "zzz" specifier and produces a result string containing the local offset from Coordinated Universal Time (UTC); for example, "-07:00". 

* For a UTC time (a [DateTime.Kind](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_Kind) property value of [DateTimeKind.Utc](http://dotnet.github.io/api/System.DateTimeKind.html#System_DateTimeKind_Utc)), the result string includes a "Z" character to represent a UTC date. 

* For a time from an unspecified time zone (a time whose [DateTime.Kind](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_Kind) property equals [DateTimeKind.Unspecified](http://dotnet.github.io/api/System.DateTimeKind.html#System_DateTimeKind_Unspecified)), the result is equivalent to [String.Empty](http://dotnet.github.io/api/System.String.html#System_String_Empty). 

For [DateTimeOffset](http://dotnet.github.io/api/System.DateTimeOffset.html) values, the "K" format specifier is equivalent to the "zz" format specifier, and produces a result string containing the [DateTimeOffset](http://dotnet.github.io/api/System.DateTimeOffset.html) value's offset from UTC. 

If the "K" format specifier is used without other custom format specifiers, it is interpreted as a standard date and time format specifier and throws a [FormatException](http://dotnet.github.io/api/System.FormatException.html). For more information about using a single format specifier, see [Using Single Custom Format Specifiers](#Using-Single-Custom-Format-Specifiers) later in this topic.

The following example displays the string that results from using the "K" custom format specifier with various [DateTime](http://dotnet.github.io/api/System.DateTime.html) and [DateTimeOffset](http://dotnet.github.io/api/System.DateTimeOffset.html) values on a system in the U.S. Pacific Time zone.
...
The "MMM" custom format specifier represents the abbreviated name of the month. The localized abbreviated name of the month is retrieved from the [DateTimeFormatInfo.AbbreviatedMonthNames](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html#System_Globalization_DateTimeFormatInfo_AbbreviatedMonthNames) property of the current or specified culture.
...
The "t" custom format specifier represents the first character of the AM/PM designator. The appropriate localized designator is retrieved from the [DateTimeFormatInfo.AMDesignator](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html#System_Globalization_DateTimeFormatInfo_AMDesignator) or [DateTimeFormatInfo.PMDesignator](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html#System_Globalization_DateTimeFormatInfo_PMDesignator) property of the current or specific culture. The AM designator is used for all times from 0:00:00 (midnight) to 11:59:59.999. The PM designator is used for all times from 12:00:00 (noon) to 23:59:59.999. 
...
In a parsing operation, a two-digit year that is parsed using the "yy" custom format specifier is interpreted based on the [Calendar.TwoDigitYearMax](http://dotnet.github.io/api/System.Globalization.Calendar.html#System_Globalization_Calendar_TwoDigitYearMax) property of the format provider's current calendar. The following example parses the string representation of a date that has a two-digit year by using the default Gregorian calendar of the en-US culture, which, in this case, is the current culture. It then changes the current culture's [CultureInfo](http://dotnet.github.io/api/System.Globalization.CultureInfo.html) object to use a [GregorianCalendar](http://dotnet.github.io/api/System.Globalization.GregorianCalendar.html) object whose [TwoDigitYearMax](http://dotnet.github.io/api/System.Globalization.GregorianCalendar.html#System_Globalization_GregorianCalendar_TwoDigitYearMax) property has been modified.
...
With [DateTime](http://dotnet.github.io/api/System.DateTime.html) values, the "z" custom format specifier represents the signed offset of the local operating system's time zone from Coordinated Universal Time (UTC), measured in hours. It does not reflect the value of an instance's [DateTime.Kind](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_Kind) property. For this reason, the "z" format specifier is not recommended for use with [DateTime](http://dotnet.github.io/api/System.DateTime.html) values.

With [DateTimeOffset](http://dotnet.github.io/api/System.DateTimeOffset.html) values, this format specifier represents the [DateTimeOffset](http://dotnet.github.io/api/System.DateTimeOffset.html) value's offset from UTC in hours. 
...
With [DateTime](http://dotnet.github.io/api/System.DateTime.html) values, the "zz" custom format specifier represents the signed offset of the local operating system's time zone from Coordinated Universal Time (UTC), measured in hours. It does not reflect the value of an instance's [DateTime.Kind](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_Kind) property. For this reason, the "zz" format specifier is not recommended for use with [DateTime](http://dotnet.github.io/api/System.DateTime.html) values.
...
With [DateTime](http://dotnet.github.io/api/System.DateTime.html) values, the "zzz" custom format specifier represents the signed offset of the local operating system's time zone from Coordinated Universal Time (UTC), measured in hours. It does not reflect the value of an instance's [DateTime.Kind](http://dotnet.github.io/api/System.DateTime.html#System_DateTime_Kind) property. For this reason, the "zzz" format specifier is not recommended for use with [DateTime](http://dotnet.github.io/api/System.DateTime.html) values.
...
Formatting is influenced by properties of the current [DateTimeFormatInfo](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html) object, which is provided implicitly by the current thread culture or explicitly by the [IFormatProvider](http://dotnet.github.io/api/System.IFormatProvider.html) parameter of the method that invokes formatting. For the [IFormatProvider](http://dotnet.github.io/api/System.IFormatProvider.html) parameter, you should specify a [CultureInfo](http://dotnet.github.io/api/System.Globalization.CultureInfo.html) object, which represents a culture, or a [DateTimeFormatInfo](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html) object. 

The result string produced by many of the custom date and time format specifiers also depends on properties of the current [DateTimeFormatInfo](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html) object. Your application can change the result produced by some custom date and time format specifiers by changing the corresponding [DateTimeFormatInfo](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html) property. For example, the "ddd" format specifier adds an abbreviated weekday name found in the [AbbreviatedDayNames](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html#System_Globalization_DateTimeFormatInfo_AbbreviatedDayNames) string array to the result string. Similarly, the "MMMM" format specifier adds a full month name found in the [MonthNames](http://dotnet.github.io/api/System.Globalization.DateTimeFormatInfo.html#System_Globalization_DateTimeFormatInfo_MonthNames) string array to the result string.
