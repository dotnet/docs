...
2. Determine whether you want to display the integer as a decimal value or a hexadecimal value.
  ...
  You can also use the format string in a method, such as [Console.WriteLine](http://dotnet.github.io/api/System.Console.html#System_Console_WriteLine) or [String.Format](http://dotnet.github.io/api/System.String.html#System_String_Format_System_IFormatProvider_System_String_System_Object_), that uses [composite formatting](../compositeformat.md).  
...
The following example pads two [Double](http://dotnet.github.io/api/System.Double.html) values with five leading zeros.
