...
The following code example uses the [Regex.Replace](https://dotnet.github.io/api/System.Text.RegularExpressions.Regex.html#System_Text_RegularExpressions_Regex_Replace_System_String_System_String_System_String_System_Text_RegularExpressions_RegexOptions_System_TimeSpan_) method to replace dates that have the form *mm/dd/yy* with dates that have the form *dd-mm-yy*.
