...
The following example shows how to use arrays of [System.Collections.Concurrent.BlockingCollection(Of T)](http://dotnet.github.io/api/System.Collections.Concurrent.BlockingCollection%601.html) objects with static methods such as **TryAddToAny** and **TryTakeFromAny** to implement fast and flexible data transfer between components. 
