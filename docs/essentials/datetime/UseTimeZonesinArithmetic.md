...
2. Convert a time to Coordinated Universal Time (UTC) by calling the [TimeZoneInfo.ConvertTime(DateTime, TimeZoneInfo)](http://dotnet.github.io/api/System.TimeZoneInfo.html#System_TimeZoneInfo_ConvertTime_System_DateTime_System_TimeZoneInfo_) method.
...
[Performing Arithmetic Operations with Dates and Times](essentials\datetime\PerformingArithmeticOperations.md)
