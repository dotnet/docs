...
-   Code that casts `IntPtr` to `Int32`.  
 ...
 For more information about how to port a 32-bit application to run on the 64-bit CLR, see [Migrating 32-bit Managed Code to 64-bit](http://go.microsoft.com/fwlink/?LinkId=150542) in Microsoft Docs.  
