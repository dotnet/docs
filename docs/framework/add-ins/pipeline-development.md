...
Add-in pipeline  
 ...
 To develop pipeline segments, you must create a directory structure that will contain them. For more information about development requirements and scope guidelines, see [Pipeline Development Requirements](http://msdn.microsoft.com/ef9fa986-e80b-43e1-868b-247f4c1d9da5).  
...
Add-in pipeline with types  
 ...
 The following table describes the pipeline segments for activating an add-in. For more information about these segments, see [Contracts, Views, and Adapters](http://msdn.microsoft.com/a6460173-9507-4b87-8c07-d4ee245d715c).  
...
## See Also  
 [Add-in Pipeline Scenarios](http://msdn.microsoft.com/feb70e0b-8734-494c-aeaf-b567f014043e)   
