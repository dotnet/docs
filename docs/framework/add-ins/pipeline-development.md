...
Add-in pipeline  
 ...
 To develop pipeline segments, you must create a directory structure that will contain them. For more information about development requirements and scope guidelines, see [Pipeline Development Requirements](https://msdn.microsoft.com/library/bb384240.aspx).  
...
Add-in pipeline with types  
 ...
 The following table describes the pipeline segments for activating an add-in. For more information about these segments, see [Contracts, Views, and Adapters](https://msdn.microsoft.com/library/bb384205.aspx).  
...
## See Also  
 [Add-in Pipeline Scenarios](https://msdn.microsoft.com/library/bb384242.aspx)   
