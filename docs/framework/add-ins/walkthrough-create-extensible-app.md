...
> [!NOTE]
>  You can find additional sample code, and customer technology previews of tools for building add-in pipelines, at the [Add-ins and Extensibility](~/dotnet/framework/add-ins/).  
