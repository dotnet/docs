...
description: Get information about the EventReason enumeration in .NET. This interface is in the adodb namespace and the adodb assembly (in the adodb.dll library).
ms.date: 03/28/2019
topic_type:
  - "apiref"
api_name:
