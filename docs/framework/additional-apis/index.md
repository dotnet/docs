...
The .NET Framework is constantly evolving. To improve cross-platform development, introduce new functionality early, new features are released out of band (OOB). This topic lists the OOB projects that we provide documentation for.  
