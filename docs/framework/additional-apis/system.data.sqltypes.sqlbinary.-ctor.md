...
Initializes a new instance of the `SqlBinary` struct without making a copy of the `byte[]` passed via the _value_ parameter. Future mutations to this array may cause the resulting `SqlBinary` instance to change its value.
