...
|[NIB: How to: Delay Sign an Assembly (Visual Studio)](https://msdn.microsoft.com/library/9fas12zx(v=vs.100).aspx)|Explains how to sign an assembly with a strong name after the assembly has been created.|  
