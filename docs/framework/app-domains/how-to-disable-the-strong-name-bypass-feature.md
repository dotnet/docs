...
1.  Open or create the application configuration file.  
     ...
     For more information about this file, see the Application Configuration Files section in [Configuring Apps](../../../docs/framework/configuring-apps/configuring-apps-by-using-configuration-files.md).  
...
## See Also  
 ...
 [\<bypassTrustedAppStrongNames> Element](../../../docs/framework/configuring-apps/file-schema/runtime/bypasstrustedappstrongnames-element.md)   
