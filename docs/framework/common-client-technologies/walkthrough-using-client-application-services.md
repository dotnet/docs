...
## See Also  
 ...
 [ASP.NET Web Site Administration Tool](https://msdn.microsoft.com/library/ms228053.aspx)   
 [Creating and Configuring the Application Services Database for SQL Server](https://msdn.microsoft.com/library/2fx93s7w.aspx)   
 [Walkthrough: Using ASP.NET Application Services](https://msdn.microsoft.com/library/bb515342.aspx)
