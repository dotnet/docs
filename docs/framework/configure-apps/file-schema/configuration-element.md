...
| [**\<system.runtime.remoting>** Settings Schema](https://msdn.microsoft.com/library/z415cf9a(v=vs.100).aspx) | All elements in the remoting settings schema. |
...
| [**\<webServices>** Settings Schema](https://msdn.microsoft.com/library/cctwteet(v=vs.100).aspx) | All elements in the Web services settings schema. |
