...
helpviewer_keywords: ["configuration settings [.NET Framework], custom", "schema configuration settings", "configuration sections [.NET Framework]", "custom elements", "configuration schema [.NET Framework], custom settings in configuration files", "elements [.NET Framework], custom settings in configuration files"]
