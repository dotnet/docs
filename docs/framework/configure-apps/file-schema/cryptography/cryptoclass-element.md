...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["http://schemas.microsoft.com/.NetConfiguration/v2.0#configuration/mscorlib/cryptographySettings/cryptoNameMapping/cryptoClasses/cryptoClass", "http://schemas.microsoft.com/.NetConfiguration/v2.0#cryptoClass"]
dev_langs: ["VB", "CSharp", "C++", "jsharp"]
helpviewer_keywords: ["cryptoClass element", "<cryptoClass> element"]
