...
## Remarks  
 ASN.1 object identifiers identify algorithms in some cryptographic formats. Map object identifiers to friendly names for the algorithms you want to identify. For more information about object identifiers, see Microsoft Docs.  
