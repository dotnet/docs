...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["http://schemas.microsoft.com/.NetConfiguration/v2.0#oidMap", "http://schemas.microsoft.com/.NetConfiguration/v2.0#configuration/mscorlib/cryptographySettings/oidMap"]
dev_langs: ["VB", "CSharp", "C++", "jsharp"]
helpviewer_keywords: ["<oidMap> element", "oidMap element"]
