...
[Remoting Settings Schema](https://msdn.microsoft.com/library/z415cf9a(v=vs.100).aspx)
...
[Web Services Settings Schema](https://msdn.microsoft.com/library/cctwteet(v=vs.100).aspx)
