...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["http://schemas.microsoft.com/.NetConfiguration/v2.0#configuration/system.net/webRequestModules/add", "http://schemas.microsoft.com/.NetConfiguration/v2.0#add"]
dev_langs: ["VB", "CSharp", "C++", "jsharp"]
helpviewer_keywords: ["<webRequestModules>, add element", "webRequestModules, add element", "add element, webRequestModules", "<add> element, webRequestModules"]
