...
## Remarks  
 ...
 Networking performance counters need to be enabled in the configuration file to be used. All networking performance counters are enabled or disabled with a single setting in the configuration file. Individual networking performance counters cannot be enabled or disabled. For more information on the specific networking performance counters, see [Networking Performance Counters](http://msdn.microsoft.com/d1860235-f643-46ae-846c-ff0ed8b0e3cd).  
...
## See Also  
 ...
 [Networking Performance Counters](http://msdn.microsoft.com/d1860235-f643-46ae-846c-ff0ed8b0e3cd)