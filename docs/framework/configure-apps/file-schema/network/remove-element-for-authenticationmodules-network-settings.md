...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["http://schemas.microsoft.com/.NetConfiguration/v2.0#configuration/system.net/authenticationModules/remove", "http://schemas.microsoft.com/.NetConfiguration/v2.0#remove"]
dev_langs: ["VB", "CSharp", "C++", "jsharp"]
helpviewer_keywords: ["remove element, authenticationModules", "<authenticationModules>, remove element", "<remove> element, authenticationModules", "authenticationModules, remove element"]
