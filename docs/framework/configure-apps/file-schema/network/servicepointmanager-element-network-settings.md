...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["http://schemas.microsoft.com/.NetConfiguration/v2.0#servicePointManager", "http://schemas.microsoft.com/.NetConfiguration/v2.0#configuration/system.net/settings/servicePointManager"]
dev_langs: ["VB", "CSharp", "C++", "jsharp"]
helpviewer_keywords: ["servicePointManager element", "<servicePointManager> element"]
