...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["http://schemas.microsoft.com/.NetConfiguration/v2.0#specifiedPickupDirectory", "http://schemas.microsoft.com/.NetConfiguration/v2.0#configuration/system.net/mailSettings/smtp/specifiedPickupDirectory"]
dev_langs: ["VB", "CSharp", "C++", "jsharp"]
helpviewer_keywords: ["specifiedPickupDirectory element", "<specifiedPickupDirectory> element"]
