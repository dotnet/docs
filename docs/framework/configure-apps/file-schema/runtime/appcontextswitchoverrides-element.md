...
|`Switch.System.Net.`<br/>`DontCheckCertificateEKUs`|Disables certificate EKU OID validation.|.NET Framework 4.6|
|`Switch.System.Net.`<br/>`DontEnableSchSendAuxRecord`|Disables TLS1.0 BEAST mitigation by disabling the use of SCH_SEND_AUX_RECORD.|.NET Framework 4.6|
