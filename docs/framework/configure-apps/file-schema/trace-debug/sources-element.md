...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["http://schemas.microsoft.com/.NetConfiguration/v2.0#configuration/system.diagnostics/sources", "http://schemas.microsoft.com/.NetConfiguration/v2.0#sources"]
dev_langs: ["VB", "CSharp", "C++", "jsharp"]
helpviewer_keywords: ["sources element", "trace sources", "<sources> element"]
