---
title: "&lt;add&gt; of &lt;commonParameters&gt; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Element|Description|  
|-------------|-----------------|  
|[\<commonParameters>](http://msdn.microsoft.com/d0e1e6fc-985a-4713-b7da-194e30dfab4c)|A collection of common parameters used by services. This collection will typically include the database connection string that might be shared by durable services.|  
...
```  
 ...
 For more information on using a configuration file to control the behavior of a <xref:System.Workflow.Runtime.WorkflowRuntime> object of a Windows Workflow Foundation host application, see [Workflow Configuration Files](http://msdn.microsoft.com/ada4bb90-6c9d-4f3d-a9d0-b559bb0f9909).  
...
## See Also  
 ...
 [\<commonParameters>](http://msdn.microsoft.com/d0e1e6fc-985a-4713-b7da-194e30dfab4c)
