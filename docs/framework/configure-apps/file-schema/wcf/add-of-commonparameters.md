...
|Element|Description|  
|-------------|-----------------|  
|[\<commonParameters>](https://msdn.microsoft.com/library/bb924496(v=vs.90).aspx)|A collection of common parameters used by services. This collection will typically include the database connection string that might be shared by durable services.|  
...
```  
 ...
 For more information on using a configuration file to control the behavior of a <xref:System.Workflow.Runtime.WorkflowRuntime> object of a Windows Workflow Foundation host application, see [Workflow Configuration Files](https://msdn.microsoft.com/library/ms732240(v=vs.90).aspx).  
...
## See Also  
 ...
 [\<commonParameters>](https://msdn.microsoft.com/library/bb924496(v=vs.90).aspx)
