...
|[\<synchronousReceive>](synchronousreceive-element.md)|Specifies runtime behavior for receiving messages in either a service or client application. It does not have any attributes or child elements.|
