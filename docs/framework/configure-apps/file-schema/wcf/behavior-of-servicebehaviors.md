---
description: "Learn more about: <behavior> of <serviceBehaviors>"
...
|[\<routing>](routing-of-servicebehavior.md)|Provides runtime access to the routing service to allow dynamic modification of the routing configuration.|
