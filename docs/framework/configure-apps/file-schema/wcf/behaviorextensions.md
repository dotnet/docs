...
## Security  
 ...
 For more information, see [How the Runtime Locates Assemblies](https://docs.microsoft.com/previous-versions/dotnet/netframework-1.1/yx7xezcf(v=vs.71)) and <xref:System.AppDomain.TypeResolve>.  
