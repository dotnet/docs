...
## Remarks  
 This binding is essentially a `WSHttpBinding` binding that supports transport-level security using certificates. For more information about configuring and using such a metadata endpoint, see [How to: Configure a Custom WS-Metadata Exchange Binding](../../extending/how-to-configure-a-custom-ws-metadata-exchange-binding.md), [How to: Retrieve Metadata Over a non-MEX Binding](../../extending/how-to-retrieve-metadata-over-a-non-mex-binding.md), and the sample [Custom Secure Metadata Endpoint](../../samples/custom-secure-metadata-endpoint.md).  
...
- [How to: Configure a Custom WS-Metadata Exchange Binding](../../extending/how-to-configure-a-custom-ws-metadata-exchange-binding.md)
- [How to: Retrieve Metadata Over a non-MEX Binding](../../extending/how-to-retrieve-metadata-over-a-non-mex-binding.md)
- [Custom Secure Metadata Endpoint](../../samples/custom-secure-metadata-endpoint.md)
