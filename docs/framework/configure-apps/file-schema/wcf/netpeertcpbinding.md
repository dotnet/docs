...
## Example  
 The following example demonstrates using the NetPeerTcpBinding binding, which provides multiparty communication using a peer channel. For a detailed scenario of using this binding, see [Net Peer TCP](http://msdn.microsoft.com/31f4db66-edb2-40a6-b92a-14098e92acae).  
...
## See Also  
 ...
 [Net Peer TCP](http://msdn.microsoft.com/31f4db66-edb2-40a6-b92a-14098e92acae)   
