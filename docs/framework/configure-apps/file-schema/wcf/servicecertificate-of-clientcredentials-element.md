---
description: "Learn more about: <serviceCertificate> of <clientCredentials> Element"
...
|Element|Description|
|-------------|-----------------|
|[\<defaultCertificate>](defaultcertificate-element.md)|Specifies an X.509 certificate to be used when a security token service (STS) does not provide one via a negotiation protocol.|
...
- <xref:System.ServiceModel.Configuration.ClientCredentialsElement.ServiceCertificate*>
- <xref:System.ServiceModel.Description.ClientCredentials>
- <xref:System.ServiceModel.Description.ClientCredentials.ServiceCertificate*>
