...
|---------------|-----------------|  
|httpHelpPageBinding|A string value that specifies the type of binding to be used when HTTP is utilized to access the service help page.<br /><br /> Only bindings with inner binding elements that support <!-- TODO: review code entity reference <xref:System.ServiceModel.Channels.IReplyChannel>  --> will be supported. Additionally, the <!-- TODO: review code entity reference <xref:System.ServiceModel.Channels.MessageVersion>  --> property of the binding must be <!-- TODO: review code entity reference <xref:System.ServiceModel.Channels.MessageVersion.None>  -->.|  
