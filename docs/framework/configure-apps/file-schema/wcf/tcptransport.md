...
|teredoEnabled|A Boolean value that specifies whether Teredo (a technology for addressing clients that are behind firewalls) is enabled. The default is `false`.<br /><br /> This property enables Teredo for the underlying TCP socket. For more information, see [Teredo Overview](https://www.microsoft.com/technet/network/ipv6/teredo.mspx).<br /><br /> This property is applicable only on Windows XP SP2 and Windows Server 2003. Windows Vista has a machine-wide configuration option for Teredo, so when running Vista, this property is ignored. Teredo requires that the client and service machines both have the Microsoft IPv6 stack installed and correctly configured for Teredo usage. For more information about configuring Teredo, see [Teredo Overview](https://www.microsoft.com/technet/network/ipv6/teredo.mspx). For more information, see [Windows Server 2003 Technology Centers](https://www.microsoft.com/windowsserver2003/technologies/default.mspx).|  
