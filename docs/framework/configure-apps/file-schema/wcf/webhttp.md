...
|defaultBodyStyle|Specifies the default body style of returned messages. [!INCLUDE[crdefault](../../../../../includes/crabout-md.md)] <xref:System.ServiceModel.Web.WebMessageBodyStyle> and [WCF Web HTTP Formatting](../../../../../docs/framework/wcf/feature-details/wcf-web-http-formatting.md).|  
