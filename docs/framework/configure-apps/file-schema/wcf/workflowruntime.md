...
|Element|Description|
|-------------|-----------------|
|`commonParameters`|A collection of common parameters used by services. This collection typically includes the database connection string that might be shared by durable services.|
