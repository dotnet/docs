...
|Element|Description|  
|-------------|-----------------|  
|[\<argument>](../../../../../docs/framework/configure-apps/file-schema/windows-workflow-foundation/argument.md)|An argument associated with an activity state query.|  
...
## See Also  
 <!-- TODO: review code entity reference <xref:System.ServiceModel.Activities.Tracking.Configuration.ArgumentElementCollection>  -->   
