...
-   Using the [\<probing>](../../../docs/framework/configure-apps/file-schema/runtime/probing-element.md) element.  
 ...
 You can also use the [.NET Framework Configuration Tool (Mscorcfg.msc)](https://msdn.microsoft.com/library/2bc0cxhc(v=vs.110).aspx) to specify assembly locations or specify locations for the common language runtime to probe for assemblies.  
...
## See Also  
 ...
 [Configuring .NET Framework Apps](https://msdn.microsoft.com/library/kza1yk3a.aspx)
