...
|**class**|Required attribute.<br /><br /> Specifies the value for the **name** attribute in the [\<cryptoClass>](../../../../../docs/framework/configuring-apps/file-schema/cryptography/cryptoclass-element.md) element.|  
