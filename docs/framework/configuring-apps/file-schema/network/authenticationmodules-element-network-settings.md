...
|**Element**|**Description**|  
|-----------------|---------------------|  
|[add](../../../../../docs/framework/configuring-apps/file-schema/network/add-element-for-authenticationmodules-network-settings.md)|Adds an authentication module to the application.|  
|[clear](../../../../../docs/framework/configuring-apps/file-schema/network/clear-element-for-authenticationmodules-network-settings.md)|Clears all authentication modules from the application.|  
|[remove](../../../../../docs/framework/configuring-apps/file-schema/network/remove-element-for-authenticationmodules-network-settings.md)|Removes an authentication module from the application.|  
