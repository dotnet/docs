...
|**Element**|**Description**|  
|-----------------|---------------------|  
|[\<mailSettings> Element (Network Settings)](../../../../../docs/framework/configuring-apps/file-schema/network/mailsettings-element-network-settings.md)|Configures mail sending options.|  
