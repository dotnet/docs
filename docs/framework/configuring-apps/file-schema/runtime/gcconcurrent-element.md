...
```  
 ...
 For more information on concurrent and background garbage collection, see the "Concurrent garbage collection" section in the [Fundamentals of Garbage Collection](../../../../../docs/standard/garbagecollection/fundamentals-of-garbage-collection.md) topic.  
...
## See Also  
 ...
 [Fundamentals of Garbage Collection](../../../../../docs/standard/garbagecollection/fundamentals-of-garbage-collection.md)