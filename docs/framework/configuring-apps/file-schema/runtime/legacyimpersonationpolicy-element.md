...
2.  In the call to the unmanaged hosting interface to load the common language runtime (CLR).  
 ...
 For more information, see the [\<alwaysFlowImpersonationPolicy> Element](../../../../../docs/framework/configuring-apps/file-schema/runtime/alwaysflowimpersonationpolicy-element.md).  
...
## See Also  
 ...
 [\<alwaysFlowImpersonationPolicy> Element](../../../../../docs/framework/configuring-apps/file-schema/runtime/alwaysflowimpersonationpolicy-element.md)