...
|Element|Description|  
|-------------|-----------------|  
|[\<listeners>](../../../../../docs/framework/configuring-apps/file-schema/trace-debug/listeners-element-for-trace.md)|Contains listeners that collect, store, and route messages.|  
