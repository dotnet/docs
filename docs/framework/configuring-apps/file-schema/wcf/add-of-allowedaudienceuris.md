...
|Element|Description|  
|-------------|-----------------|  
|[\<allowedAudienceUris>](../../../../../docs/framework/configuring-apps/file-schema/wcf/allowedaudienceuris.md)|Represents a collection of target URIs for which the <xref:System.IdentityModel.Tokens.SamlSecurityToken> security token can be targeted for in order to be considered valid by a <xref:System.IdentityModel.Selectors.SamlSecurityTokenAuthenticator> instance.|  
...
## See Also  
 ...
 [\<allowedAudienceUris>](../../../../../docs/framework/configuring-apps/file-schema/wcf/allowedaudienceuris.md)   
