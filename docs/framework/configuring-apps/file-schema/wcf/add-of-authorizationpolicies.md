...
|Element|Description|  
|-------------|-----------------|  
|[\<authorizationPolicies>](../../../../../docs/framework/configuring-apps/file-schema/wcf/authorizationpolicies.md)|Specifies a collection of authorization policy types.|  
...
## See Also  
 ...
 [\<add>](../../../../../docs/framework/configuring-apps/file-schema/wcf/add-of-authorizationpolicies.md)   
