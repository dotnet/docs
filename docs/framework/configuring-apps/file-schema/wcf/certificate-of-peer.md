---
title: "&lt;certificate&gt; of &lt;peer&gt; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Element|Description|  
|-------------|-----------------|  
|[\<peer>](../../../../../docs/framework/configuring-apps/file-schema/wcf/peer-of-servicecredentials.md)|Specifies the current credentials for a peer node.|  
