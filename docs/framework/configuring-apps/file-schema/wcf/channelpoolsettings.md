...
|Element|Description|  
|-------------|-----------------|  
|[\<oneWay>](../../../../../docs/framework/configuring-apps/file-schema/wcf/oneway.md)|Enables packet routing for a custom binding.|  
...
## See Also  
 ...
 [\<oneWay>](../../../../../docs/framework/configuring-apps/file-schema/wcf/oneway.md)   
