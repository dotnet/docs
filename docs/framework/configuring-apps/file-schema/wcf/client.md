...
|Element|Description|  
|-------------|-----------------|  
|[\<endpoint>](../../../../../docs/framework/configuring-apps/file-schema/wcf/endpoint-of-client.md)|Contains a collection of endpoint elements, that specify the endpoints that this client can connect to.|  
|[\<metadata>](../../../../../docs/framework/configuring-apps/file-schema/wcf/metadata.md)|Contains settings for processing metadata.|  
