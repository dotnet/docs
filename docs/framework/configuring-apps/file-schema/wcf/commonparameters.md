...
|Element|Description|  
|-------------|-----------------|  
|[\<add>](../../../../../docs/framework/configuring-apps/file-schema/wcf/add-of-commonparameters.md)|Adds a name-value pair of common parameters used by services to the collection.|  
  
### Parent Elements  
  
|Element|Description|  
|-------------|-----------------|  
|[\<workflowRuntime>](../../../../../docs/framework/configuring-apps/file-schema/wcf/workflowruntime.md)|Specifies settings for an instance of <xref:System.Workflow.Runtime.WorkflowRuntime> for hosting workflow-based [!INCLUDE[indigo1](../../../../../includes/indigo1-md.md)] services.|  
...
## See Also  
 ...
 [\<add>](../../../../../docs/framework/configuring-apps/file-schema/wcf/add-of-commonparameters.md)