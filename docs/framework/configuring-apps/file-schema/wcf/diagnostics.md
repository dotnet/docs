...
|Element|Description|  
|-------------|-----------------|  
|[\<endToEndTracing>](../../../../../docs/framework/configuring-apps/file-schema/wcf/endtoendtracing.md)|A configuration element that allows you to enable and disable different aspects of end-to-end tracing during the running of a service application.|  
|[\<messageLogging>](../../../../../docs/framework/configuring-apps/file-schema/wcf/messagelogging.md)|Describes the settings for WCF message logging.|  
