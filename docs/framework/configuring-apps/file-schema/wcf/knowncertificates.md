...
|Element|Description|  
|-------------|-----------------|  
|[\<add>](../../../../../docs/framework/configuring-apps/file-schema/wcf/add-of-knowncertificates.md)|Adds an X.509 certificate to the collection.|  
...
```  
 ...
 For an example that shows how to populate the collection in configuration, see [\<add>](../../../../../docs/framework/configuring-apps/file-schema/wcf/add-of-knowncertificates.md).  
...
## See Also  
 ...
 [\<add>](../../../../../docs/framework/configuring-apps/file-schema/wcf/add-of-knowncertificates.md)   
