...
|Element|Description|  
|-------------|-----------------|  
|[\<identity>](../../../../../docs/framework/configuring-apps/file-schema/wcf/identity.md)|Specifies identity information for the local issuer.|  
|[\<headers>](../../../../../docs/framework/configuring-apps/file-schema/wcf/headers-element.md)|A collection of address headers that are required in order to correctly address the local issuer. You can use the `add` keyword to add a header to this collection.|  
