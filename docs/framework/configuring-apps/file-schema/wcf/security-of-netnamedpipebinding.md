---
title: "&lt;security&gt; of &lt;netNamedPipeBinding&gt; | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Element|Description|  
|-------------|-----------------|  
|binding|The binding element of the [\<netNamedPipeBinding>](../../../../../docs/framework/configuring-apps/file-schema/wcf/netnamedpipebinding.md).|  
