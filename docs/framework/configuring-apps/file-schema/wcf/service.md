...
|Element|Description|  
|-------------|-----------------|  
|[\<endpoint>](../../../../../docs/framework/configuring-apps/file-schema/wcf/endpoint-element.md)|A collection of `endpoint` elements that expose this service.|  
|[\<host>](../../../../../docs/framework/configuring-apps/file-schema/wcf/host.md)|Specifies the host of this service instance. This element is of type <xref:System.ServiceModel.Configuration.HostElement>.|  
  
### Parent Elements  
  
|Element|Description|  
|-------------|-----------------|  
|[\<services>](../../../../../docs/framework/configuring-apps/file-schema/wcf/services.md)|The root element of all WCF configuration elements.|  
