...
|Element|Description|  
|-------------|-----------------|  
|[\<channelSettings>](../../../../../docs/framework/configuring-apps/file-schema/wf/channelsettings.md)|Specifies the settings of the channel cache.|  
|[\<factorySettings>](../../../../../docs/framework/configuring-apps/file-schema/wf/factorysettings.md)|Specifies the settings of the channel factory cache.|  
