...
|Element|Description|  
|-------------|-----------------|  
|[\<state>](../../../../../docs/framework/configuring-apps/file-schema/wf/states.md)|A subscribed state from the tracked workflow instance when the tracking record is created.|  
