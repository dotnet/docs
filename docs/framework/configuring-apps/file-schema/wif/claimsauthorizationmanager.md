...
|---------------|-----------------|  
|type|A custom type that derives from the <xref:System.Security.Claims.ClaimsAuthorizationManager> class. For more information about how to specify the `type` attribute, see [Custom Type References](../../../../../docs/framework/configuring-apps/file-schema/wf/configuration-schema.md#BKMK_CustomTypeReferences).|  
