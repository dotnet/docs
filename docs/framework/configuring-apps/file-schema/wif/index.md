...
## In This Section  
 [\<system.identityModel>](../../../../../docs/framework/configuring-apps/file-schema/wif/system-identitymodel.md) Provides configuration for enabling WIF options in applications.  
  
 [\<system.identityModel.services>](../../../../../docs/framework/configuring-apps/file-schema/wif/system-identitymodel-services.md) Provides configuration for passive federation using WIF. Configures the Session Authentication Module (SAM) and the Federated Authentication Module (WSFAM).  
