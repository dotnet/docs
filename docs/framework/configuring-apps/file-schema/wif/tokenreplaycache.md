...
## Remarks  
 The token replay cache is used to detect replayed tokens. Token replay detection is enabled by the [\<tokenReplayDetection>](../../../../../docs/framework/configuring-apps/file-schema/wif/tokenreplaydetection.md) element, which also specifies the maximum expiration time for tokens.  
...
## See Also  
 ...
 [\<tokenReplayDetection>](../../../../../docs/framework/configuring-apps/file-schema/wif/tokenreplaydetection.md)