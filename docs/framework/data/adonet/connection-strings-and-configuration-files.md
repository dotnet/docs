...
description: Learn how to store connection strings for ADO.NET applications in an application configuration files, as a best practice for security and maintenance.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
