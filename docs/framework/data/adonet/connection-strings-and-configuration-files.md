...
### Web.config Example  
 ...
 For more information securing ASP.NET applications, see [NIB: ASP.NET Security](https://docs.microsoft.com/previous-versions/aspnet/91f66yxt(v=vs.100)) and [ASP.NET 2.0 Security Practices at a Glance](https://go.microsoft.com/fwlink/?LinkId=59997) on the ASP.NET Developer Center.  
...
- [Using the Configuration Classes](https://docs.microsoft.com/previous-versions/ms228063(v=vs.140))
- [Configuring Apps](../../../../docs/framework/configure-apps/index.md)
- [ASP.NET Web Site Administration](https://docs.microsoft.com/previous-versions/6hy1xzbw(v=vs.140))
