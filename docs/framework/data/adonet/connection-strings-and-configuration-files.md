...
### Web.config Example  
 ...
 For more information securing ASP.NET applications, see [ASP.NET 2.0 Security Practices at a Glance](http://go.microsoft.com/fwlink/?LinkId=59997) on the ASP.NET Developer Center.  
