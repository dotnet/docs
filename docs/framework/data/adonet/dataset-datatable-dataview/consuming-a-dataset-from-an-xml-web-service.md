...
> [!NOTE]
>  We recommend that you always consider security implications when creating an XML Web service. For information on securing an XML Web service, see [Securing XML Web Services Created Using ASP.NET](https://msdn.microsoft.com/library/w67h0dw7(v=vs.100).aspx).  
...
## See Also  
 ...
 [Web Services Description Language Tool (Wsdl.exe)](https://msdn.microsoft.com/library/7h3ystb6(v=vs.100).aspx)   
