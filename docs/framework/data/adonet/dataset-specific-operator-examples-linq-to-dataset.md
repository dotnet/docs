...
The examples in this topic demonstrate how to use the <xref:System.Data.DataTableExtensions.CopyToDataTable*> method and the <xref:System.Data.DataRowComparer> class.
...
### Example
 ...
 This example loads a <xref:System.Data.DataTable> with query results by using the <xref:System.Data.DataTableExtensions.CopyToDataTable*> method.
