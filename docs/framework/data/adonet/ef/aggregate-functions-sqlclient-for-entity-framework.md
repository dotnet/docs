...
:::row:::
    ...
    :::column-end:::
    :::column:::
        Returns the sum of all the values in the collection.<br /><br /> **Arguments**<br /><br /> A Collection (T) where T is one of the following types: `Int32`, `Int64`, `Double`, `Decimal`.<br /><br /> **Return Value**<br /><br /> The type of `expression`.<br /><br /> **Example**<br /><br />
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        Returns the statistical variance of all values in the specified expression.<br /><br /> **Arguments**<br /><br /> A Collection (`Double`).<br /><br /> **Return Value**<br /><br /> A `Double`.<br /><br /> **Example**<br /><br />
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        Returns the statistical variance for the population for all values in the specified expression.<br /><br /> **Arguments**<br /><br /> A Collection (`Double`).<br /><br /> **Return Value**<br /><br /> A `Double`.<br /><br /> **Example**<br /><br />
