...
## Managing Transactions  
 ...
 To update data that is exposed through a conceptual model; see [How to: Manage Transactions in the Entity Framework](https://msdn.microsoft.com/library/bb738523(v=vs.110).aspx).  
