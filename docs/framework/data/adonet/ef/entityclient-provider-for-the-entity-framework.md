...
## Managing Transactions  
 ...
 To update data that is exposed through a conceptual model; see [How to: Manage Transactions in the Entity Framework](http://msdn.microsoft.com/4a55eb7f-f826-4a48-9df1-aebe2352ebef).  
