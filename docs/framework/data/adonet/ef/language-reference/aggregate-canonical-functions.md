...
:::row:::
    ...
    :::column-end:::
    :::column:::
        Returns the standard deviation of the non-null values.<br><br>**Arguments**<br><br>An `Int32`, `Int64`, `Double`, `Decimal`.<br><br>**Return Value**<br><br>A `Double`. `Null`, if all input values are `null` values.<br><br>**Example**
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        Returns the standard deviation for the population of all values.<br><br>**Arguments**<br><br>An `Int32`, `Int64`, `Double`, `Decimal`.<br><br>**Return Value**<br><br>A `Double`. `Null`, if all input values are `null` values.<br><br>**Example**
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        Returns the sum of the non-null values.<br><br>**Arguments**<br><br>An `Int32`, `Int64`, `Double`, `Decimal`.<br><br>**Return Value**<br><br>A `Double`. `Null`, if all input values are `null` values.<br><br>**Example**
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        Returns the variance of all non-null values.<br><br>**Arguments**<br><br>An `Int32`, `Int64`, `Double`, `Decimal`.<br><br>**Return Value**<br><br>A `Double`. `Null`, if all input values are `null` values.<br><br>**Example**
