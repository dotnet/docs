...
|[THEN](../../../../../../docs/framework/data/adonet/ef/language-reference/then-entity-sql.md)|The result of a [WHEN](https://msdn.microsoft.com/library/bb387119(v=vs.110).aspx) clause when it evaluates to true.|  
