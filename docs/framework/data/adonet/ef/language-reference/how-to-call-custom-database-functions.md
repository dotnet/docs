...
1. Create a custom function in your database.
     ...
     For more information about creating custom functions in SQL Server, see [CREATE FUNCTION (Transact-SQL)](/sql/t-sql/statements/create-function-transact-sql&view=sql-server-ver15).
