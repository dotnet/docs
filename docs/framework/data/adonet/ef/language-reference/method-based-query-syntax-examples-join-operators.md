...
### Example
 ...
 The following example performs a <xref:System.Linq.Enumerable.GroupJoin*> over the Contact and SalesOrderHeader tables to find the number of orders per contact. The order count and IDs for each contact are displayed.
