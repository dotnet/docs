...
### Example
 ...
 The following example uses the <xref:System.Linq.Enumerable.Skip*> method to get all but the first three contacts of the Contact table.
...
### Example
 ...
 The following example uses the <xref:System.Linq.Enumerable.Skip*> method to get all but the first two addresses in Seattle.
...
### Example
 ...
 The following example uses the <xref:System.Linq.Enumerable.Take*> method to get only the first five contacts from the Contact table.
...
### Example
 ...
 The following example uses the <xref:System.Linq.Enumerable.Take*> method to get the first three addresses in Seattle.
