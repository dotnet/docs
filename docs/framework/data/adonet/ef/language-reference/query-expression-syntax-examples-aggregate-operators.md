...
### Example
 ...
 The following example uses <xref:System.Linq.Enumerable.Average*> to get the average total due for each contact ID.
...
### Example
 ...
 The following example uses <xref:System.Linq.Enumerable.Average*> to get the orders with the average total due for each contact.
...
### Example
 ...
 The following example uses <xref:System.Linq.Enumerable.Count*> to return a list of contact IDs and how many orders each has.
...
### Example
 ...
 The following example groups products by color and uses <xref:System.Linq.Enumerable.Count*> to return the number of products in each color group.
