---
description: "Learn more about: Query Expression Syntax Examples: Element Operators"
...
### Example
 ...
 The following example uses the <xref:System.Linq.Enumerable.First*> method to return the first contact whose first name is "Brooke".
