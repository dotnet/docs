...
## Join Methods
 ...
 Most overloads of the join methods are supported, with the exception of those that use a <xref:System.Collections.Generic.IEqualityComparer`1>. This is because the comparer cannot be translated to the data source.
...
## Ordering Methods
 ...
 Most overloads of the ordering methods are supported, with the exception of those that use an <xref:System.Collections.Generic.IComparer`1>. This is because the comparer cannot be translated to the data source. The ordering methods are `OrderBy`, `OrderByDescending`, `ThenBy`, `ThenByDescending`, and `Reverse`.
...
## Grouping Methods
 ...
 Most overloads of the grouping methods are supported, with the exception of those that use an <xref:System.Collections.Generic.IEqualityComparer`1>. This is because the comparer cannot be translated to the data source.
