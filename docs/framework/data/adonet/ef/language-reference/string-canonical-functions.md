---
description: "Learn more about: String Canonical Functions"
...
|`Length(string)`|Returns the (`Int32`) length, in characters, of the string.<br /><br /> **Arguments**<br /><br /> `string`: A `String`.<br /><br /> **Return Value**<br /><br /> An `Int32`.<br /><br /> **Example**<br /><br /> `-- The following example returns 6.`<br /><br /> `Length('abcxyz')`|
