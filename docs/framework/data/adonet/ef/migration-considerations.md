...
> [!NOTE]
>  All of these tasks are performed automatically when you use the Entity Data Model tools starting with [!INCLUDE[vsOrcas](../../../../../includes/vsorcas-md.md)]. For more information, see [How to: Use the Entity Data Model Wizard](http://msdn.microsoft.com/dadb058a-c5d9-4c5c-8b01-28044112231d).  
...
2.  Define the models and mapping.  
     ...
     The model and mapping files define entities in the conceptual model; structures in the data source, such as tables, stored procedures, and views; and the mapping between the entities and data source structures. For more information, see [How to: Manually Define the Model and Mapping Files](http://msdn.microsoft.com/d4fd6864-f2a1-48f0-aa32-1e318775a99a).  
  
     Types that are defined in the storage model must match the name of objects in the data source. If the existing application exposes data as objects, you must ensure that the entities and properties that are defined in the conceptual model match the names of these existing data classes and properties. For more information, see [How to: Customize Modeling and Mapping Files to Work with Custom Objects](http://msdn.microsoft.com/bb40c4db-0121-4e45-a167-8fb06707a708).  
  
    > [!NOTE]
    >  The Entity Data Model Designer can be used to rename entities in the conceptual model to match existing objects. For more information, see [Entity Data Model Designer](http://msdn.microsoft.com/4ccd7ad6-b934-4f7c-82a0-cfd2d4a95faf).  
...
## Considerations for Applications that Bind Data to Controls  
 ...
 For more information, see [Binding Objects to Controls](http://msdn.microsoft.com/2fd34855-929b-4303-a91e-4bb69d958f2b).  
...
## Other Considerations  
 ...
 [!INCLUDE[vstecasp](../../../../../includes/vstecasp-md.md)] Web applications must frequently maintain the state of a Web page or of a user session. Objects in an <xref:System.Data.Objects.ObjectContext> instance can be stored in the client view state or in the session state on the server, and later retrieved and reattached to a new object context. For more information, see [Attaching and Detaching Objects](http://msdn.microsoft.com/41d5c1ef-1b78-4502-aa10-7e1438d62d23).  
