...
- [Join](method-based-query-syntax-examples-join-linq-to-dataset.md)
 ...
 Contains examples that demonstrate how to use the <xref:System.Data.DataTableExtensions.CopyToDataTable*> method and the <xref:System.Data.DataRowComparer> class.
