...
The examples in this topic demonstrate how to use the <xref:System.Linq.Enumerable.ToArray*>, <xref:System.Linq.Enumerable.ToDictionary*>, and <xref:System.Linq.Enumerable.ToList*> methods to immediately execute a query expression.
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.ToArray*> method to immediately evaluate a sequence into an array.
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.ToDictionary*> method to immediately evaluate a sequence and a related key expression into a dictionary.
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.ToList*> method to immediately evaluate a sequence into a <xref:System.Collections.Generic.List`1>, where `T` is of type <xref:System.Data.DataRow>.
