...
The examples in this topic demonstrate how to use the <xref:System.Linq.Enumerable.First*> and <xref:System.Linq.Enumerable.ElementAt*> methods to get <xref:System.Data.DataRow> elements from a <xref:System.Data.DataSet> using the query expression syntax.
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.ElementAt*> method to retrieve the fifth address where `PostalCode` == "M4B 1V7".
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.First*> method to return the first contact whose first name is 'Brooke'.
