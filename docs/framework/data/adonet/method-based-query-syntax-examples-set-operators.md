...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.Distinct*> method to remove duplicate elements in a sequence.
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.Except*> method to return contacts that appear in the first table but not in the second.
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.Intersect*> method to return contacts that appear in both tables.
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.Union*> method to return unique contacts from either of the two tables.
