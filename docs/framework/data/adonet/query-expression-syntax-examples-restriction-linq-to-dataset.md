...
The examples in this topic demonstrate how to use the <xref:System.Linq.Enumerable.Where*> method to query a <xref:System.Data.DataSet> using the query expression syntax.
...
### Example
 ...
 This example uses the <xref:System.Linq.Enumerable.Where*> method to find orders that were made after December 1, 2002 and then uses the <xref:System.Data.DataRow.GetChildRows*> method to get the details for each order.
