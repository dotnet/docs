...
## Windows Applications  
 ...
 [ClickOnce Deployment for Windows Forms Applications](http://msdn.microsoft.com/34d8c770-48f2-460c-8d67-4ea5684511df)  
...
|--------------|-----------------|  
|[NIB: ASP.NET Security](http://msdn.microsoft.com/04b37532-18d9-40b4-8e5f-ee09a70b311d)|Discusses how to secure ASP.NET applications.|  
|[Securing XML Web Services Created Using ASP.NET](http://msdn.microsoft.com/354b2ab1-2782-4542-b32a-dc560178b90c)|Discusses how to implement security for an ASP.NET Web Service.|  
...
|[NIB:Basic Security Practices for ASP.NET Web Applications](http://msdn.microsoft.com/94a52ab8-731d-417e-b997-721baf43df38)|General security information and links to further discussion,|  
...
|Resource|Description|  
|--------------|-----------------|  
|[Configuration of Remote Applications](http://msdn.microsoft.com/92c0c097-d984-4315-835b-7490ecdf1097)|Discusses how to configure remoting applications in order to avoid common problems.|  
|[Security in Remoting](http://msdn.microsoft.com/9574262c-d4b1-41c5-8600-24ff147c0add)|Describes authentication and encryption as well as additional security topics relevant to remoting.|  
...
## See Also  
 ...
 [Recommendations for Data Access Strategies](http://msdn.microsoft.com/72411f32-d12a-4de8-b961-e54fca7faaf5)   
