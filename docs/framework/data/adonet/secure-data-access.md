...
|[Recommendations for Data Access Strategies](https://docs.microsoft.com/previous-versions/8fxztkff(v=vs.100))|Provides recommendations for accessing data and performing database operations.|  
...
|Resource|Description|  
|--------------|-----------------|  
|[COM+ Role-Based Security and the .NET Framework](https://docs.microsoft.com/previous-versions/)|Discusses how to integrate managed code with COM+ security services.|  
