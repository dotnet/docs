...
|Resource|Description|  
|--------------|-----------------|  
|[Script Exploits Overview](https://msdn.microsoft.com/library/w1sw53ds.aspx)|Describes how to guard against scripting and SQL statement exploits.|  
...
|Resource|Description|  
|--------------|-----------------|  
|[COM+ Role-Based Security and the .NET Framework](https://msdn.microsoft.com/library/s6y8k15h(v=vs.90).aspx)|Discusses how to integrate managed code with COM+ security services.|  
...
|[Advanced COM Interoperability](https://msdn.microsoft.com/library/bd9cdfyx.aspx)|Contains advanced topics such as primary interop assemblies, threading and custom marshaling.|  
