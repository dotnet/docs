...
description: Learn how ADO.NET minimizes the cost of opening connections by using SQL Server connection pooling, which reduces the how many new connections must be opened.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
