...
description: Learn how to enable/disable MARS in a connection string, which works with SQL Server to allow the running multiple batches on a single connection in ADO.NET.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
