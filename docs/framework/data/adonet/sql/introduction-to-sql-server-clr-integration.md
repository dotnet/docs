...
- [Common Language Runtime (CLR) Integration Overview](https://docs.microsoft.com/previous-versions/sql/sql-server-2008/ms131089(v=sql.100))  
...
- [Enabling CLR Integration](https://docs.microsoft.com/previous-versions/sql/sql-server-2008/ms131048(v=sql.100))  
...
1. [Deploying CLR Database Objects](https://docs.microsoft.com/previous-versions/sql/sql-server-2008/ms345099(v=sql.100))  
...
- [CLR Integration Security](https://docs.microsoft.com/previous-versions/sql/sql-server-2008/ms131071(v=sql.100))  
...
- [Debugging CLR Database Objects](https://docs.microsoft.com/previous-versions/sql/sql-server-2008/ms131096(v=sql.100))  
