...
- [Common Language Runtime (CLR) Integration Overview](/previous-versions/sql/sql-server-2008/ms131089(v=sql.100))  
...
- [Enabling CLR Integration](/previous-versions/sql/sql-server-2008/ms131048(v=sql.100))  
...
1. [Deploying CLR Database Objects](/previous-versions/sql/sql-server-2008/ms345099(v=sql.100))  
...
- [CLR Integration Security](/previous-versions/sql/sql-server-2008/ms131071(v=sql.100))  
...
- [Debugging CLR Database Objects](/previous-versions/sql/sql-server-2008/ms131096(v=sql.100))  
