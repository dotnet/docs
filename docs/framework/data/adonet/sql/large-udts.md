---
title: "Large UDTs | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## SqlDataReader Considerations  
 The <xref:System.Data.SqlClient.SqlDataReader> has been extended beginning in SQL Server 2008 to support retrieving large UDT values. How large UDT values are processed by a <!-- TODO: review code entity reference <xref:SqlDataReader>  --> depends on the version of SQL Server you are using, as well as on the `Type System Version` specified in the connection string. For more information, see <xref:System.Data.SqlClient.SqlConnection.ConnectionString%2A>.  
