...
Use <xref:System.Linq.Enumerable.ToArray*> to create an array from a sequence.

## Example

 The following example uses <xref:System.Linq.Enumerable.ToArray*> to immediately evaluate a query into an array and to get the third element.
