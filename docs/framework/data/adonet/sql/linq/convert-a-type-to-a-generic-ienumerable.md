...
Use <xref:System.Linq.Enumerable.AsEnumerable*> to return the argument typed as a generic `IEnumerable`.
...
## Example
 ...
 The solution is to specify the client-side generic <xref:System.Collections.Generic.IEnumerable`1> implementation of `where` to replace the generic <xref:System.Linq.IQueryable`1>. You do this by invoking the <xref:System.Linq.Enumerable.AsEnumerable*> operator.
