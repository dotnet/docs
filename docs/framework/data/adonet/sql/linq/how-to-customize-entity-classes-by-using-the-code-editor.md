...
Developers using Visual Studio can use the Object Relational Designer to create or customize their entity classes.
 ...
 You can also use the Visual Studio code editor to write your own mapping code or to customize code that has already been generated. For more information, see [Attribute-Based Mapping](attribute-based-mapping.md).
 ...
 Describes how to use <xref:System.Data.Linq.Mapping.DatabaseAttribute.Name*>.
 ...
 Describes how to use <xref:System.Data.Linq.Mapping.ColumnAttribute.IsPrimaryKey>.
 ...
 Describes how to use <xref:System.Data.Linq.Mapping.ColumnAttribute.IsDbGenerated>.

 [How to: Represent Columns as Timestamp or Version Columns](how-to-represent-columns-as-timestamp-or-version-columns.md)
 Describes how to use <xref:System.Data.Linq.Mapping.ColumnAttribute.IsVersion>.

 [How to: Specify Database Data Types](how-to-specify-database-data-types.md)
 Describes how to use <xref:System.Data.Linq.Mapping.ColumnAttribute.DbType*>.

 [How to: Represent Computed Columns](how-to-represent-computed-columns.md)
 Describes how to use <xref:System.Data.Linq.Mapping.ColumnAttribute.Expression*>.

 [How to: Specify Private Storage Fields](how-to-specify-private-storage-fields.md)
 Describes how to use <xref:System.Data.Linq.Mapping.DataAttribute.Storage*>.

 [How to: Represent Columns as Allowing Null Values](how-to-represent-columns-as-allowing-null-values.md)
 Describes how to use <xref:System.Data.Linq.Mapping.ColumnAttribute.CanBeNull>.
 ...
 Describes how to use <xref:System.Data.Linq.Mapping.ColumnAttribute.UpdateCheck>.
