...
## Example
 ...
 You do not have to specify the <xref:System.Data.Linq.Mapping.TableAttribute.Name> property if the name can be inferred. If you do not specify a name, the name is presumed to be the same name as that of the property or field.
