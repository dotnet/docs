...
> [!NOTE]
> You must use the <xref:System.Data.Linq.IMultipleResults.GetResult*> pattern to obtain an enumerator of the correct type, based on your knowledge of the stored procedure.
