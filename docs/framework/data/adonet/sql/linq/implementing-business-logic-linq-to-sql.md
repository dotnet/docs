...
```  
 ...
 [Walkthrough: Customizing the insert, update, and delete behavior of entity classes](https://docs.microsoft.com/en-us/visualstudio/data-tools/walkthrough-customizing-the-insert-update-and-delete-behavior-of-entity-classes)  
