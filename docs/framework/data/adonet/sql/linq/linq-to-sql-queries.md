...
You define [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] queries by using the same syntax as you would in LINQ. The only difference is that the objects referenced in your queries are mapped to elements in a database. For more information, see [Introduction to LINQ Queries (C#)](/dotnet/csharp/linq/get-started/introduction-to-linq-queries).  
...
|Deferred versus immediate execution|See [Introduction to LINQ Queries (C#)](/dotnet/csharp/linq/get-started/introduction-to-linq-queries)|Same|  
...
- [Type Relationships in LINQ Query Operations](/dotnet/csharp/linq/get-started/type-relationships-in-linq-query-operations)
