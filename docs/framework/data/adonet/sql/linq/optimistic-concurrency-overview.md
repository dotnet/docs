...
- In the try/catch block of your call to <xref:System.Data.Linq.DataContext.SubmitChanges*>, specify at what point you want exceptions to be thrown.
...
- <xref:System.Data.Linq.DataContext.ChangeConflicts*?displayProperty=nameWithType>

- <xref:System.Data.Linq.DataContext.SubmitChanges*?displayProperty=nameWithType>

- <xref:System.Data.Linq.DataContext.Refresh*?displayProperty=nameWithType>
