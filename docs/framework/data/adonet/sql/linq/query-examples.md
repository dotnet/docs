---
description: "Learn more about: Query Examples"
...
## In This Section
 ...
 Describes how to use <xref:System.Linq.Enumerable.Average*>, <xref:System.Linq.Enumerable.Count*>, and so forth.

 [Return the First Element in a Sequence](return-the-first-element-in-a-sequence.md)
 Provides examples of using <xref:System.Linq.Enumerable.First*>.

 [Return Or Skip Elements in a Sequence](return-or-skip-elements-in-a-sequence.md)
 Provides examples of using <xref:System.Linq.Enumerable.Take*> and <xref:System.Linq.Enumerable.Skip*>.

 [Sort Elements in a Sequence](sort-elements-in-a-sequence.md)
 Provides examples of using <xref:System.Linq.Enumerable.OrderBy*>.

 [Group Elements in a Sequence](group-elements-in-a-sequence.md)
 Provides examples of using <xref:System.Linq.Enumerable.GroupBy*>.

 [Eliminate Duplicate Elements from a Sequence](eliminate-duplicate-elements-from-a-sequence.md)
 Provides examples of using <xref:System.Linq.Enumerable.Distinct*>.
