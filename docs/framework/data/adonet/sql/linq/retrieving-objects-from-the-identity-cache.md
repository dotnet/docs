...
- <xref:System.Data.Linq.Table`1> `.Function1(` `predicate` `)`

- <xref:System.Data.Linq.Table`1> `.Function1(` `predicate` `).Function2()`

 In these general forms, `Function1`, `Function2`, and `predicate` are defined as follows.

 `Function1` can be any of the following:

- <xref:System.Linq.Queryable.Where*>

- <xref:System.Linq.Queryable.First*>

- <xref:System.Linq.Queryable.FirstOrDefault*>

- <xref:System.Linq.Queryable.Single*>

- <xref:System.Linq.Queryable.SingleOrDefault*>
