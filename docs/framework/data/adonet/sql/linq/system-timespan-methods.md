...
|------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
|<xref:System.TimeSpan.Compare*>|<xref:System.TimeSpan.op_Equality*>|<xref:System.TimeSpan.Days*>|
|<xref:System.TimeSpan.CompareTo%28System.TimeSpan%29>|<xref:System.TimeSpan.op_GreaterThan*>|<xref:System.TimeSpan.Hours*>|
|<xref:System.TimeSpan.Duration*>|<xref:System.TimeSpan.op_GreaterThanOrEqual*>|<xref:System.TimeSpan.MaxValue>|
|<xref:System.TimeSpan.Equals%28System.TimeSpan%2CSystem.TimeSpan%29>|<xref:System.TimeSpan.op_Inequality*>|<xref:System.TimeSpan.Milliseconds*>|
|<xref:System.TimeSpan.Equals%28System.TimeSpan%29>|<xref:System.TimeSpan.op_LessThan*>|<xref:System.TimeSpan.Minutes*>|
||<xref:System.TimeSpan.op_LessThanOrEqual*>|<xref:System.TimeSpan.MinValue>|
