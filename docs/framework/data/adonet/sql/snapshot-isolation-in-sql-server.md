...
description: This article provides an overview of snapshot isolation and row versioning in SQL Server, and how to manage concurrency with isolation levels.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
