...
|[User Instances for Non-Administrators](https://docs.microsoft.com/previous-versions/sql/) in SQL Server Books Online|Describes how to create and deploy user instances.|  
