   ...
   class Program {  
      ...
      private static async Task PrintXmlValuesViaNVarChar() {  
         XmlReaderSettings xmlSettings = new XmlReaderSettings() {  
            ...
            CloseInput = true,  
            // If the Xml you are reading is not a valid document (as per https://msdn.microsoft.com/library/6bts1x50.aspx) you will need to set the conformance level to Fragment  
