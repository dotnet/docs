---
title: "Using System.Transactions in ASP.NET | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] security policy, see [securityPolicy Element (ASP.NET Settings Schema)](https://msdn.microsoft.com/library/zhs35b56(v=vs.110).aspx).  
...
```  
 ...
 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [add Element for assemblies for compilation (ASP.NET Settings Schema)](https://msdn.microsoft.com/library/37e2zyhb(v=vs.110).aspx).  
  
## See Also  
 [ASP.NET Trust Levels and Policy Files](https://msdn.microsoft.com/library/wyts434y.aspx)   
 [securityPolicy Element (ASP.NET Settings Schema)](https://msdn.microsoft.com/library/zhs35b56(v=vs.110).aspx)   
