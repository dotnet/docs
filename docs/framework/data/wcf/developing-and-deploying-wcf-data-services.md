...
-   A data service is usually developed as an [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] application project, but you can also create you data service as an [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] Web site project in Visual Studio. For information about the differences between the two types of projects, see [NIB: Web Application Projects versus Web Site Projects in Visual Studio](https://docs.microsoft.com/previous-versions/aspnet/dd547590(v=vs.110)).
...
-   **IIS-Hosted Web Server**
    ...
    -   **Deployment Technologies for ASP.NET Web Applications**
        ...
        -   [Web Deployment Package](https://docs.microsoft.com/previous-versions/aspnet/dd465323(v=vs.110))

        -   [One-Click Publishing](https://docs.microsoft.com/previous-versions/aspnet/dd465337(v=vs.110))

    -   **Deployment Technologies for ASP.NET Web Sites**

        -   [Copy Web Site Tool](https://docs.microsoft.com/previous-versions/c95809c0(v=vs.140))

        -   [Publish Web Site Tool](https://docs.microsoft.com/previous-versions/20yh9f1b(v=vs.140))

        -   [XCopy](https://docs.microsoft.com/previous-versions/f735abw9(v=vs.140))
