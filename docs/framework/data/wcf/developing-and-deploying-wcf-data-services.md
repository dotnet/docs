...
2.  **Visual Studio Development Server**  
    ...
    -   This server listens on `localhost` and on a specific port, not on port 80, which is the default port for HTTP messages. For more information, see [Web Servers in Visual Studio for ASP.NET Web Projects](http://msdn.microsoft.com/31d4f588-df59-4b7e-b9ea-e1f2dd204328).  
...
-   A data service is usually developed as an [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] application project, but you can also create you data service as an [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] Web site project in [!INCLUDE[vs_current_short](../../../../includes/vs-current-short-md.md)]. For information about the differences between the two types of projects, see [NIB: Web Application Projects versus Web Site Projects in Visual Studio](http://msdn.microsoft.com/2861815e-f5a2-4378-a2f8-b8a86dc012f5).  
...
-   **IIS-Hosted Web Server**  
    ...
    -   **Deployment Technologies for ASP.NET Web Applications**  
        ...
        -   [Web Deployment Package](http://msdn.microsoft.com/1f9713c8-9540-494c-b80d-9893b970ad6f)  
  
        -   [One-Click Publishing](http://msdn.microsoft.com/59226246-99ad-4aec-975d-7c61e8a8911c)  
    ...
    -   **Deployment Technologies for ASP.NET Web Sites**  
     ...
     [!INCLUDE[crabout](../../../../includes/crabout-md.md)] the deployment options for an [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] application, see [Web Deployment Overview for Visual Studio and ASP.NET](http://msdn.microsoft.com/99bd1927-b59f-4e02-87b4-55c6ba2adbc3).  
