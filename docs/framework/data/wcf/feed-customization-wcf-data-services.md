...
## Customizing Feeds with the Entity Framework Provider  
 ...
 For more information, see [How to: Customize Feeds with the Entity Framework Provider](../../../../docs/framework/data/wcf/how-to-customize-feeds-with-the-entity-framework-provider-wcf-data-services.md).  
