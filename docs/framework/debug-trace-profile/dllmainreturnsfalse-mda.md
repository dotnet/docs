...
helpviewer_keywords: ["managed debugging assistants (MDAs), DllMain returns false", "DllMainReturnsFalse MDA", "DllMain function", "MDAs (managed debugging assistants), DllMain returns false"]
