...
description: Review the invalidFunctionPointerInDelegate managed debugging assistant (MDA), which is invoked if an invalid function pointer is passed in to build a delegate.
ms.date: "03/30/2017"
helpviewer_keywords: 
