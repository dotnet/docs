...
helpviewer_keywords: ["invalidFunctionPointerInDelegate MDA", "managed debugging assistants (MDAs), invalid function pointer to delegates", "MDAs (managed debugging assistants), invalid function pointer to delegates", "function pointers, invalid", "marshaling, run-time errors", "managed debugging assistants (MDAs), marshaling", "MDAs (managed debugging assistants), marshaling", "invalid function pointers"]
