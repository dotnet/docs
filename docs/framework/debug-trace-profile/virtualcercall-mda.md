...
helpviewer_keywords: ["MDAs (managed debugging assistants), CER calls", "virtualCERCall MDA", "virtual CER calls", "constrained execution regions", "CER calls", "managed debugging assistants (MDAs), CER calls"]
