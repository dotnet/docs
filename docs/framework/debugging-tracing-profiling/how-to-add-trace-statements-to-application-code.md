...
1.  Call the <xref:System.Diagnostics.Trace.Assert%2A> method.  
    ...
    > [!NOTE]
    >  You can use **Assert** with both tracing and debugging. This example outputs the call stack to any listener in the **Listeners** collection. For more information, see [Assertions in Managed Code](../Topic/Assertions%20in%20Managed%20Code.md) and <xref:System.Diagnostics.Debug.Assert%2A?displayProperty=fullName>.  
