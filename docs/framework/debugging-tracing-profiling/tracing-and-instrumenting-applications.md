...
-   **Debugging** - Tracking down and fixing programming errors in an application under development. For more information, see [Debugging](../Topic/Debugging%20in%20Visual%20Studio.md).  
  
-   **Performance counters** - Components that allow you to track the performance of your application. For more information, see [Performance Counters](../../../docs/framework/debugging-tracing-profiling/performance-counters.md).  
...
2.  Create a set of switches. For more information, see [How to: Configure Trace Switches](../../../docs/framework/debugging-tracing-profiling/how-to-create-initialize-and-configure-trace-switches.md).  
  
3.  Add the trace statements to the application code.  
  
4.  Determine where you want the tracing output to appear and add the appropriate listeners. For more information, see [Creating and Initializing Trace Listeners](../../../docs/framework/debugging-tracing-profiling/how-to-create-and-initialize-trace-listeners.md).  
...
6.  Compile the application into executable code using one of the following procedures:  
    ...
    -   Use the **Trace** and **Debug** compiler directives for the command-line method of compiling. For more information, see [Compiling Conditionally with Trace and Debug](../../../docs/framework/debugging-tracing-profiling/how-to-compile-conditionally-with-trace-and-debug.md). Use this when compiling from the command line.  
  
7.  If a problem occurs during run time, turn on the appropriate trace switch. For more information, see [Configuring Trace Switches](../../../docs/framework/debugging-tracing-profiling/how-to-create-initialize-and-configure-trace-switches.md).  
...
## Output from Tracing  
 ...
 Tracing information is always written at least to the default <xref:System.Diagnostics.Trace> output target, the <xref:System.Diagnostics.DefaultTraceListener>. If for some reason you have deleted the <xref:System.Diagnostics.DefaultTraceListener> without adding any other listeners to the <xref:System.Diagnostics.Trace.Listeners%2A> collection, you will not receive any tracing messages. For more information, see [Trace Listeners](../../../docs/framework/debugging-tracing-profiling/trace-listeners.md).  
...
## See Also  
 ...
 [How to: Compile Conditionally with Trace and Debug](../../../docs/framework/debugging-tracing-profiling/how-to-compile-conditionally-with-trace-and-debug.md)   
 ...
 [How to: Create and Initialize Trace Sources](../../../docs/framework/debugging-tracing-profiling/how-to-create-and-initialize-trace-sources.md)   
 [How to: Use TraceSource and Filters with Trace Listeners](../../../docs/framework/debugging-tracing-profiling/how-to-use-tracesource-and-filters-with-trace-listeners.md)   
