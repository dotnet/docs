...
- If you are referencing a Microsoft [out-of-band package](../get-started/net-framework-and-out-of-band-releases.md) in your app, the assembly will be included in the app package.
