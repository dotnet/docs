...
- If you are referencing a Microsoft [out-of-band package](/dotnet/framework/get-started/the-net-framework-and-out-of-band-releases) in your app, the assembly will be included in the app package.
