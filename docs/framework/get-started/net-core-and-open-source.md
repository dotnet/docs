...
description: Read an overview about .NET Core, which is a general-purpose, modular, cross-platform, and open-source implementation of .NET Standard.
ms.date: "03/30/2017"
