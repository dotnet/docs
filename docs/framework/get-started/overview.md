...
- Workflow-enabled apps using Windows Workflow Foundation (WF). See [Building Workflows in the .NET Framework](https://docs.microsoft.com/previous-versions/hh156545(v=vs.110)).
