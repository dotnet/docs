...
3.  After the download completes, restart Visual Studio.  
 ...
 For detailed installation instructions, see [Installing NuGet client tools](/nuget/install-nuget-client-tools) on the NuGet Docs website. For more information about NuGet, see the [NuGet documentation](/nuget/).  
