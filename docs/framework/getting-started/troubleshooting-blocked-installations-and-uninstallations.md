...
When you run the [web or offline installer](../../../docs/framework/getting-started/install-the-net-framework.md) for the .NET Framework 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, or 4.6.2, you might encounter an issue that prevents or blocks the installation of the .NET Framework. The following table lists possible blocking issues and provides links to troubleshooting information.  
...
|The .NET Framework 4.5*.x*/4.6*.x* (*language*) requires the .NET Framework 4.5*.x*/4.6*.x*. Please install the .NET Framework 4.5*.x*/4.6*.x* from the Download Center and rerun Setup.|You must install the English version of the specified .NET Framework release before installing a language pack. For more information, see the section on [To install language packs](../../../docs/framework/getting-started/install-the-net-framework.md#standalone_language_packs) in the installation guide.|  
