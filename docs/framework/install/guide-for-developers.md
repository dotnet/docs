...
|----------------------------|----------------------------|----------------------------------|----------------------|  
|**4.7.2**|[.NET Framework 4.7.2 Developer Pack](http://go.microsoft.com/fwlink/?LinkId=863261)|[Download Center 4.7.2 web installer](http://go.microsoft.com/fwlink/?LinkId=863262)<br/><br/>[Download Center 4.7.2 offline installer](http://go.microsoft.com/fwlink/?LinkId=863265)|Included in: <br/>Windows 10 RS4<br /><br /> You can install on:<br/> <br/>Windows 10 Fall Creators Update<br/>Windows 10 Creators Update <br /> Windows 10 Anniversary Update<br /> Windows 8.1 and earlier<br /> Windows Server, version 1709 and earlier<br /> (for a full list, see [system requirements](~/docs/framework/get-started/system-requirements.md))||
