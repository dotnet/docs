...
These instructions will help you install the .NET Framework versions you need. The .NET Framework 4.7.1 is the latest version, however, it is not supported on Windows Vista.
...
The [.NET Framework 4.6](http://go.microsoft.com/fwlink/?LinkID=213834&dotnetdocs) is the latest supported .NET Framework version on Windows Vista.

The [.NET Framework 4.6](http://go.microsoft.com/fwlink/?LinkID=213834&dotnetdocs) supports applications built for .NET Framework 4.0 through 4.6.
