...
The [.NET Framework 4.0.3](https://www.microsoft.com/download/details.aspx?id=17851) is the latest supported .NET Framework version on Windows XP and Windows Server 2003. The .NET Framework 4.0.3 requires that the [.NET Framework 4](https://www.microsoft.com/download/details.aspx?id=17851) is installed first. Both of these .NET Framework versions are no longer supported by Microsoft.

## .NET Framework 4

You can install the [.NET Framework 4](https://www.microsoft.com/download/details.aspx?id=17851) on Windows XP. It's no longer supported by Microsoft.

## .NET Framework 3.5

You can install the [.NET Framework 3.5](https://www.microsoft.com/download/details.aspx?id=17851) on Windows XP.
