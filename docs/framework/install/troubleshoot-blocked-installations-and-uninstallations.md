...
|The .NET Framework 4.5.x/4.6.x/4.7.x/4.8 redistributable does not apply to this operating system. Please download the .NET Framework 4.5.x/4.6.x/4.7.x/4.8 for your operating system from the Microsoft Download Center.|You may be trying to install .NET Framework 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, 4.7.1, 4.7.2, or 4.8 on a platform that isn't supported, or you have chosen the installation package that does not include the components for all supported operating systems. Run the installation again by using the offline installer ([for 4.5.1](https://www.microsoft.com/download/details.aspx?id=40779), [for 4.5.2](https://www.microsoft.com/download/details.aspx?id=42642), [for 4.6](https://www.microsoft.com/downloads/details.aspx?FamilyID=79d20e23-ca0d-4415-9359-57b4fd808924&displaylang=en),  [for 4.6.1](https://www.microsoft.com/download/details.aspx?id=49982), for [4.6.2](https://www.microsoft.com/download/details.aspx?id=53323), for [4.7](https://www.microsoft.com/download/details.aspx?id=55169)), for [4.7.1](https://www.microsoft.com/download/details.aspx?id=56117), for [4.7.2](/windows/win32/debug/configuring-automatic-debugging), or for [4.8](/windows/win32/debug/configuring-automatic-debugging). For more information, see the [installation guide](guide-for-developers.md) and [system requirements](../get-started/system-requirements.md) for supported operating systems.|  
