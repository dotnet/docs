...
-   Formatted value types that contain only blittable types (and classes if they are marshaled as formatted types). For more information about formatted value types, see [Default Marshaling for Value Types](http://msdn.microsoft.com/4d9a876c-e05a-40ba-bd85-bd22877f984a).  
 ...
 The following table lists non-blittable types from the <xref:System> namespace. [Delegates](http://msdn.microsoft.com/d176ee76-f982-494b-b03d-92e4118896e2), which are data structures that refer to a static method or to a class instance, are also non-blittable.  
...
|[System.Boolean](http://msdn.microsoft.com/d4c00537-70f7-4ca6-8197-bfc1ec037ff9)|Converts to a 1, 2, or 4-byte value with `true` as 1 or -1.|  
|[System.Char](http://msdn.microsoft.com/cecc87c1-075e-4cde-aa56-33d189f66feb)|Converts to a Unicode or ANSI character.|  
|[System.Class](http://msdn.microsoft.com/fe334af5-0123-43d8-be84-26f6f023ddb6)|Converts to a class interface.|  
...
|[System.Valuetype](http://msdn.microsoft.com/4d9a876c-e05a-40ba-bd85-bd22877f984a)|Converts to a structure with a fixed memory layout.|  
