...
-   Formatted value types that contain only blittable types (and classes if they are marshaled as formatted types). For more information about formatted value types, see [Default Marshaling for Value Types](https://msdn.microsoft.com/en-us/library/4d9a876c-e05a-40ba-bd85-bd22877f984a(v=vs.100)).  
 ...
 The following table lists non-blittable types from the <xref:System> namespace. [Delegates](https://msdn.microsoft.com/en-us/library/d176ee76-f982-494b-b03d-92e4118896e2(v=vs.100)), which are data structures that refer to a static method or to a class instance, are also non-blittable.  
...
|[System.Boolean](https://msdn.microsoft.com/en-us/library/d4c00537-70f7-4ca6-8197-bfc1ec037ff9(v=vs.100))|Converts to a 1, 2, or 4-byte value with `true` as 1 or -1.|  
|[System.Char](https://msdn.microsoft.com/en-us/library/cecc87c1-075e-4cde-aa56-33d189f66feb(v=vs.100))|Converts to a Unicode or ANSI character.|  
|[System.Class](https://msdn.microsoft.com/en-us/library/fe334af5-0123-43d8-be84-26f6f023ddb6(v=vs.100))|Converts to a class interface.|  
...
|[System.Valuetype](https://msdn.microsoft.com/en-us/library/4d9a876c-e05a-40ba-bd85-bd22877f984a(v=vs.100))|Converts to a structure with a fixed memory layout.|  
