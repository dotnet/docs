...
## See Also  
 ...
 [Requirements for Registration-Free COM Interop](https://msdn.microsoft.com/library/f8h7012w.aspx)   
 [Configuring COM Components for Registration-Free Activation](https://msdn.microsoft.com/library/x65a421a.aspx)   
