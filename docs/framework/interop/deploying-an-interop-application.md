...
description: Deploy an interop application, which usually has a .NET client asseembly, interop assemblies of distinct COM type libraries, and registered COM components.
ms.date: "03/30/2017"
helpviewer_keywords: 
