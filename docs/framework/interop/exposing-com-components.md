...
This section summarizes the process needed to expose an existing COM component to managed code. For details about writing COM servers that tightly integrate with the .NET Framework, see [Design Considerations for Interoperation](http://msdn.microsoft.com/b59637f6-fe35-40d6-ae72-901e7a707689).  
...
2.  [Create COM types in managed Code](http://msdn.microsoft.com/1a95a8ca-c8b8-4464-90b0-5ee1a1135b66).  
