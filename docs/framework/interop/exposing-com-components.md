...
This section summarizes the process needed to expose an existing COM component to managed code. For details about writing COM servers that tightly integrate with the .NET Framework, see [Design Considerations for Interoperation](https://msdn.microsoft.com/library/61aax4kh.aspx).  
...
2.  [Create COM types in managed Code](https://msdn.microsoft.com/library/3y76b69k.aspx).  
...
## See Also  
 ...
 [Design Considerations for Interoperation](https://msdn.microsoft.com/library/61aax4kh.aspx)   
