...
3.  [Call a .NET object](https://msdn.microsoft.com/en-us/library/40c9626c-aea6-4bad-b8f0-c1de462efd33(v=vs.100)).  
...
4.  [Deploy an application for COM access](https://msdn.microsoft.com/en-us/library/fb63564c-c1b9-4655-a094-a235625882ce(v=vs.100)).  
