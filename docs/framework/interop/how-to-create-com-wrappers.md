...
You can now write code to access the COM object. You can begin by declaring the object, such as with an `Imports` statement for Visual Basic or a `Using` statement for [!INCLUDE[csprcslong](../../../includes/csprcslong-md.md)].
