...
|**LPCSTR**|**Const char https://github.com/dotnet/docs.ko-kr/pull/64**|<xref:System.String?displayProperty=nameWithType> or <xref:System.Text.StringBuilder?displayProperty=nameWithType>|Decorate with ANSI.|  
