...
-   **TestArrayOfStructs2** exported from PinvokeLib.dll.  
 ...
 [PinvokeLib.dll](http://msdn.microsoft.com/5d1438d7-9946-489d-8ede-6c694a08f614) is a custom unmanaged library that contains implementations for the previously listed functions and two structure variables, **MYPOINT** and **MYPERSON**. The structures contain the following elements:  
