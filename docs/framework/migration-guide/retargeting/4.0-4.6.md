---
title: Retargeting Changes for Migration from .NET Framework 4.0 to 4.6
description: Find information about application compatibility issues that might affect your app when migrating from .NET Framework 4.0 to 4.6.
ms.date: "07/10/2019"
