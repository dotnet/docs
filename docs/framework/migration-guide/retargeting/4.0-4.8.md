---
title: Retargeting Changes for Migration from .NET Framework 4.0 to 4.8
description: Find information about application compatibility issues that might affect your app when migrating from .NET Framework 4.0 to 4.8.
ms.date: "07/10/2019"
ms.assetid: 3590abad-bba8-4e03-8dba-c3a3107fc9cf
author: "chlowell"
---

# Retargeting Changes for Migration from .NET Framework 4.0 to 4.8
