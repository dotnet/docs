---
title: Retargeting Changes for Migration from .NET Framework 4.5 to 4.5.1
description: Find information about application compatibility issues that might affect your app when migrating from .NET Framework 4.5 to 4.5.1.
ms.date: "07/10/2019"
