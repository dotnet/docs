---
title: Retargeting Changes for Migration from .NET Framework 4.5 to 4.8
description: Find information about application compatibility issues that might affect your app when migrating from .NET Framework 4.5 to 4.8.
ms.date: "07/10/2019"
ms.assetid: 1e823378-f8a5-4768-9ccc-3c6b85ef612c
author: "chlowell"
---

# Retargeting Changes for Migration from .NET Framework 4.5 to 4.8
