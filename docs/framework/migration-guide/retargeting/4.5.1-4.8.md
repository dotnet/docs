---
title: Retargeting Changes for Migration from .NET Framework 4.5.1 to 4.8
description: Find information about application compatibility issues that might affect your app when migrating from .NET Framework 4.5.1 to 4.8.
ms.date: "07/10/2019"
ms.assetid: 3227e20b-5539-4ad8-9581-ee52151f3624
author: "chlowell"
---

# Retargeting Changes for Migration from .NET Framework 4.5.1 to 4.8
