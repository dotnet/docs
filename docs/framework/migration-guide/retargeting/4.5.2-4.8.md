---
title: Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.8
description: Find information about application compatibility issues that might affect your app when migrating from .NET Framework 4.5.2 to 4.8.
ms.date: "07/10/2019"
ms.assetid: 4dda0ee8-6791-4024-b8b3-df6ae0e86378
author: "chlowell"
---

# Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.8
