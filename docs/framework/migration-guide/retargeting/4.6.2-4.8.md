---
title: Retargeting Changes for Migration from .NET Framework 4.6.2 to 4.8
description: Find information about application compatibility issues that might affect your app when migrating from .NET Framework 4.6.2 to 4.8.
ms.date: "07/10/2019"
ms.assetid: a75894b6-5da2-4237-8a72-8ca49e64168a
author: "chlowell"
---

# Retargeting Changes for Migration from .NET Framework 4.6.2 to 4.8
