---
title: Retargeting changes for migration to .NET Framework 4.7.x
description: Find information about application compatibility issues that might affect your app when migrating to .NET Framework 4.7.x.
ms.date: 07/31/2023
author: "chlowell"
---
