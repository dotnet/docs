...
|   |   |
|---|---|
|Details|Beginning in the .NET Framework 4.6, changes to
...
executes.<br />Practically speaking, this means that
...
application.<br />This is due to a change in
...
|Suggestion|Apps affected by this change may work around it by storing the desired
<xref:System.Globalization.CultureInfo.CurrentCulture?displayProperty=name> or
...
can be avoided by targeting the .NET Framework 4.5.2.<br />Apps that target .NET Framework 4.6 or later can also work around this by
setting the following compatibility switch:<br /><pre><code>AppContext.SetSwitch(&quot;Switch.System.Globalization.NoAsyncCurrentCulture&quot;, true);</code></pre>This issue has been fixed by WPF in .NET Framework 4.6.2. It has also been fixed
