...
|   |   |
|---|---|
|Details|In .NET Framework versions prior to 4.6.2, customers with non-standard key sizes
...
|Suggestion|If there is any exception handling logic that relies on the previous behavior
where a
<xref:System.Security.Cryptography.CryptographicException?displayProperty=name>
