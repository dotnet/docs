---
title: Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.2
description: Find information about application compatibility issues from runtime changes that might affect your app when migrating from .NET Framework 4.5.1 to 4.6.2.
ms.date: "07/10/2019"
