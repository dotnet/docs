---
title: Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7
description: Find information about application compatibility issues from runtime changes that might affect your app when migrating from .NET Framework 4.5.2 to 4.7.
ms.date: "07/10/2019"
