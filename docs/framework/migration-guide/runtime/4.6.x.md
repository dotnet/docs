---
title: Runtime changes for migration to .NET Framework 4.6.x
description: Find information about application compatibility issues from runtime changes that might affect your app when migrating to .NET Framework 4.6.x.
ms.date: 07/31/2023
author: "chlowell"
ms.topic: article
---
