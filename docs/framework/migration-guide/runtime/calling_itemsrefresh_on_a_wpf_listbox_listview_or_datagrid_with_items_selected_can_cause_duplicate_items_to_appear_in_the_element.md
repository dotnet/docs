...
|   |   |
|---|---|
|Details|In the .NET Framework 4.5, calling ListBox.Items.Refresh from code while items
...
|Suggestion|This issue may be worked around by programatically unselecting items before
...
|Version|4.5|
|Type|Runtime|
|Affected APIs|<ul><li><xref:System.Windows.Data.CollectionView.Refresh?displayProperty=fullName></li></ul>|
