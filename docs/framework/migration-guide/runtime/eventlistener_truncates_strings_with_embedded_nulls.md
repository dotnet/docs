...
|   |   |
|---|---|
|Details|<xref:System.Diagnostics.Tracing.EventListener?displayProperty=name> truncates
...
|Suggestion|<xref:System.Diagnostics.Tracing.EventSource?displayProperty=name> data should
