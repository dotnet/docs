...
|   |   |
|---|---|
|Details|Because the <xref:System.Threading.Tasks.Task?displayProperty=name> class
...
|Suggestion|If an app depends on unobserved asynchronous exceptions propagating to the
...
<a href="https://docs.microsoft.com/en-us/dotnet/articles/framework/configure-apps/file-schema/runtime/throwunobservedtaskexceptions-element">runtime configuration element</a>.|
|Scope|Edge|
|Version|4.5|
|Type|Runtime|
