...
|   |   |
|---|---|
|Details|Improvements were made to
...
|Suggestion|Be aware that some glyph bounding box sizes have increased. These changes will
...
the app.config file:<br /><pre><code>&lt;appsettings&gt;<br />&lt;add key=&quot;IncludeAllInkInBoundingBox&quot; value=&quot;false&quot;&gt;<br />&lt;/appsettings&gt;</code></pre>|
|Scope|Edge|
|Version|4.5|
|Type|Runtime|
