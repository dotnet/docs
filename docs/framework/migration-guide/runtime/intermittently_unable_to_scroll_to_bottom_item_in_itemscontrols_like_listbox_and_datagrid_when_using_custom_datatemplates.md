...
|   |   |
|---|---|
|Details|In some instances, a bug in the .NET Framework 4.5 is causing ItemsControls
...
then.|
|Suggestion|This issue has been fixed in the .NET Framework 4.5.2 and may be addressed by
