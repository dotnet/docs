...
|   |   |
|---|---|
|Details|Right-clicking a selected
...
that row.|
|Suggestion|This issue has been fixed in the .NET Framework 4.6 and may be addressed by
upgrading to that version of the .NET Framework.|
|Scope|Edge|
|Version|4.5|
|Type|Runtime|
|Affected APIs|<ul><li><xref:System.Windows.Controls.DataGrid.%23ctor?displayProperty=fullName></li></ul>|
