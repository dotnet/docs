...
|   |   |
|---|---|
|Details|Connections to SQL Server databases using the <a href="https://technet.microsoft.com/en-us/library/ms191229%28v=sql.105%29.aspx">Virtual Interface Adapter (VIA) protocol</a> are no longer supported.
...
If this app is connecting to SQL via a protocol other than VIA (tcp: or np: for example), then no breaking change will be encountered.<br />Also, connections to SQL Server 7 (1997) are no longer supported.|
