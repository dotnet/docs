...
|   |   |
|---|---|
|Details|Beginning in the .NET Framework 4.5, the Replace method in OData URLs is
...
|Suggestion|If the replace method is required (which is uncommon), it can be re-enabled
