...
-   Limit the method access to callers of a specified identity--essentially, any particular [evidence](https://msdn.microsoft.com/library/7y5x1hcd(v=vs.100).aspx) (strong name, publisher, zone, and so on) you choose.  
