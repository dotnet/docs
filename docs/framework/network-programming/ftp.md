...
> [!NOTE]
> This article is specific to projects that target .NET Framework. For .NET 6+ projects, [FTP is no longer supported](../../core/compatibility/networking/6.0/webrequest-deprecated.md).
