...
## Implementing the Peer Name Resolution Protocol  
 ...
 Message passing between PeerToPeer applications is still handled by underlying architectures such as PeerChannel and WCF [Large Data and Streaming](/previous-versions/dotnet/netframework-4.0/ms733742(v=vs.100)).  
