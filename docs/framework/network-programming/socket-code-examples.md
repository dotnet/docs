...
description: Review these examples to see how to use the Socket class as a client to connect to network services and as a server to listen for connections from clients.
ms.date: "03/30/2017"
helpviewer_keywords: 
