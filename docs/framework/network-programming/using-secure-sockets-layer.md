...
description: Learn about how the System.Net classes use the Secure Sockets Layer to encrypt the connection for several network protocols in the .NET Framework.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
