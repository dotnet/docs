...
## Caching in WCF REST Services  
 ...
 The .NET Framework also enables you to implement conditional HTTP GET caching. In REST scenarios, a conditional HTTP GET request is often used by services to implement intelligent HTTP caching as described in the [HTTP Specification](https://www.w3.org/Protocols/rfc2616/rfc2616.html). For more information, see [Caching Support for WCF Web HTTP Services](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/ee230443(v=vs.100)).  
