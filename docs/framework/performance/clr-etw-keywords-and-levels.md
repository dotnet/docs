...
|--------------------------|-----------|-------------|  
|`GCKeyword`|0x00000001|Enables the collection of [garbage collection events](garbage-collection-etw-events.md).|  
|`LoaderKeyword`|0x00000008|Enables the collection of [loader events](loader-etw-events.md).|  
|`JITKeyword`|0x00000010|Enables the collection of [just-in-time (JIT) events](jit-tracing-etw-events.md).|  
...
|`SecurityKeyword`|0x00000400|Enables the collection of [security events](security-etw-events.md).|  
...
|`JITTracingKeyword`|0x00001000|Enables the collection of [JIT tracing events](jit-tracing-etw-events.md).|  
|`InteropKeyword`|0x00002000|Enables the collection of [interop events](interop-etw-events.md).|  
