...
In the EVENT_HEADER structure, the ProviderId GUID for events generated by <xref:System.Threading.Tasks.Parallel.For*?displayProperty=nameWithType>, <xref:System.Threading.Tasks.Parallel.ForEach*?displayProperty=nameWithType> and <xref:System.Threading.Tasks.Parallel.Invoke*?displayProperty=nameWithType> is:
