...
For more information about the security model in the .NET Framework 4, see [Security Changes](/previous-versions/dotnet/framework/windows-identity-foundation/security-changes).
...
- [Security Changes](/previous-versions/dotnet/framework/windows-identity-foundation/security-changes)
