...
- Addresses an issue where intermittent crashes could occur in some 64-bit .NET Framework scenarios. (*Applies to: .NET Framework 4.8.1*)
...
| .NET Framework 3.5, 4.8.1 | [5122386](https://support.microsoft.com/kb/5122386) |
| **Windows 11, version 25H2** | |
| .NET Framework 3.5, 4.8.1 | [5122385](https://support.microsoft.com/kb/5122385) |
