...
- [WIF How-To's Index](../../../docs/framework/security/wif-how-tos-index.md)
  ...
  - [How To: Build Claims-Aware ASP.NET Application Using Windows Authentication](../../../docs/framework/security/how-to-build-claims-aware-aspnet-app-using-windows-authentication.md)
