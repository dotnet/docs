---
title: "Serialization How-to Topics | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   [How to: Use the XML Schema Definition Tool to Generate Classes and XML Schema Documents](../../../docs/framework/serialization/51f0edc3-993d-4051-b7f2-77753694d3d1.md)  
...
-   [How to: Control Serialization of Derived Classes](../../../docs/framework/serialization/how-to-control-serialization-of-derived-classes.md)  
  
-   [How to: Qualify XML Element and XML Attribute Names](../../../docs/framework/serialization/how-to-qualify-xml-element-and-xml-attribute-names.md)  
...
-   [How to: Chunk Serialized Data](../../../docs/framework/serialization/how-to-chunk-serialized-data.md)  
