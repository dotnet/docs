...
## Response File Example  
 The following listing shows an example of a response file, `response.rsp`. For more information on response files, see [Response Files](../Topic/MSBuild%20Response%20Files.md).  
