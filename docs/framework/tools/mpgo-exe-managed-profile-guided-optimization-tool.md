...
This tool is automatically installed with Visual Studio. To run the tool, use a [developer command-line shell](developer-command-prompt-for-vs.md) with administrator credentials.
