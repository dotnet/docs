...
## See Also  
 ...
 [NIB: Writing Verifiably Type-Safe Code](https://msdn.microsoft.com/library/01k04eaf(v=vs.100).aspx)   
 [Type Safety and Security](https://msdn.microsoft.com/library/hbzz1a9a.aspx)   
