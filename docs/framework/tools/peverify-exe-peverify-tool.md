...
## Remarks  
 The common language runtime relies on the type-safe execution of application code to help enforce security and isolation mechanisms. Normally, code that is not [verifiably type safe](http://msdn.microsoft.com/095cd1f6-d8db-4c0e-bce2-83ccb34dd5dc) cannot run, although you can set security policy to allow the execution of trusted but unverifiable code.  
...
## See Also  
 ...
 [NIB: Writing Verifiably Type-Safe Code](http://msdn.microsoft.com/d18f10ef-3b48-4f47-8726-96714021547b)   
 [Type Safety and Security](http://msdn.microsoft.com/095cd1f6-d8db-4c0e-bce2-83ccb34dd5dc)   
