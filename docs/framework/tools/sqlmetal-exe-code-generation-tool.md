...
- From a .dbml file, generate code and mapping attributes or a mapping file.  
 ...
 This tool is automatically installed with Visual Studio. By default, the file is located at `drive`:\Program Files\Microsoft SDKs\Windows\v`n.nn`\bin. If you do not install Visual Studio, you can also get the SQLMetal file by downloading the [Windows SDK](https://www.microsoft.com/download/details.aspx?id=8279).  
