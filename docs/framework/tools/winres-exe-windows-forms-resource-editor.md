...
Winres.exe is installed with Visual Studio. To run the tool, use the Developer Command Prompt for Visual Studio. For more information, see [Developer Command Prompt for Visual Studio](developer-command-prompt-for-vs.md).
