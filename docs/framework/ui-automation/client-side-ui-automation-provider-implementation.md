...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["UI Automation, client-side provider implementation", "client-side UI Automation provider, implementation", "provider implementation, UI Automation"]
