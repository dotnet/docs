...
description: See how to expose the content of a table using UI Automation. The content and intrinsic properties of each cell within a tabular control is exposed.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
