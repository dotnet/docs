...
> [!NOTE]
>  Since focus changes are global desktop events, focus change events outside the table should be filtered. See the [TrackFocus Sample](https://docs.microsoft.com/previous-versions/ms771428(v=vs.100)) for a related implementation.  
