...
> [!NOTE]
>  Since focus changes are global desktop events, focus change events outside the table should be filtered. See the [TrackFocus Sample](https://msdn.microsoft.com/library/ms771428(v=vs.100).aspx) for a related implementation.  
