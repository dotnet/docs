...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["client-side UI Automation provider, implementation within applications", "UI Automation, implementing client-side provider within application"]
