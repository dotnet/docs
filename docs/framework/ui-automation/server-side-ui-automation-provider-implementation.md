...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["server-side UI Automation provider implementation", "UI Automation, server-side provider implementation", "provider implementation, UI Automation"]
