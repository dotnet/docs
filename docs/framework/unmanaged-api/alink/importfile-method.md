...
## Parameters
 ...
 `ppAssemblyScope`
 Receives pointer to [IMetaDataAssemblyImport Interface](../../../core/unmanaged-api/metadata/interfaces/imetadataassemblyimport-interface.md). Can be NULL if the file is not an assembly.
