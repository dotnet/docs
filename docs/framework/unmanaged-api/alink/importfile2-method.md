...
## Parameters
 ...
 `pAssemblyScopeIn`
 Optional scope [IMetaDataAssemblyImport Interface](../../../core/unmanaged-api/metadata/interfaces/imetadataassemblyimport-interface.md) interface.
 ...
 `ppAssemblyScope`
 Receives the [IMetaDataAssemblyImport Interface](../../../core/unmanaged-api/metadata/interfaces/imetadataassemblyimport-interface.md) interface. NULL if the file is not an assembly.
