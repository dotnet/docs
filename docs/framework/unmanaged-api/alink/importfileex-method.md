...
## Parameters
 ...
 `ppAssemblyScope`
 Receives assembly import scope [IMetaDataAssemblyImport Interface](../../../core/unmanaged-api/metadata/interfaces/imetadataassemblyimport-interface.md) interface. Is set to NULL if file is not an assembly.
