...
|`gcType`|A member of the [CorDebugGCType](../../../../docs/framework/unmanaged-api/debugging/icordebugcode-interface1.md) enumeration that indicates whether the garbage collector is running on a workstation or a server.|  
