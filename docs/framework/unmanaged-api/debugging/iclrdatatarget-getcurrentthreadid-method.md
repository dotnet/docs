...
dev_langs: ["C++"]
helpviewer_keywords: ["GetCurrentThreadID method, ICLRDataTarget interface [.NET Framework debugging]", "ICLRDataTarget::GetCurrentThreadID method [.NET Framework debugging]"]
