...
dev_langs: ["C++"]
helpviewer_keywords: ["GetMetadata method, ICLRMetadataLocator interface [.NET Framework debugging]", "ICLRMetadataLocator::GetMetadata method [.NET Framework debugging]"]
