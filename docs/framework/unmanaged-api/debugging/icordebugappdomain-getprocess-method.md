...
dev_langs: ["C++"]
helpviewer_keywords: ["GetProcess method, ICorDebugAppDomain interface [.NET Framework debugging]", "ICorDebugAppDomain::GetProcess method [.NET Framework debugging]"]
