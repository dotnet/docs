...
|[EnumerateAssemblies Method](../../../../docs/framework/unmanaged-api/debugging/icordebugappdomain2-interface1.md)|Gets an enumerator for the assemblies in the application domain.|  
...
|[GetObject Method](../../../../docs/framework/unmanaged-api/debugging/corelementtype-enumeration1.md)|Gets an interface pointer to the common language runtime (CLR) application domain.|  
