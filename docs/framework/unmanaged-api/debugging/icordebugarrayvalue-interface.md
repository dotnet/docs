...
|Method|Description|  
|------------|-----------------|  
|[GetBaseIndicies Method](../../../../docs/framework/unmanaged-api/debugging/icordebugmodulebreakpoint-interface1.md)|Gets the base index of each dimension in the array.|  
...
|[GetElement Method](../../../../docs/framework/unmanaged-api/debugging/icordebugmoduleenum-interface1.md)|Gets a value representing the given element in the array.|  
