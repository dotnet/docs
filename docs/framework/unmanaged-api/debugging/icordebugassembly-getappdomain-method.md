...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugAssembly::GetAppDomain method [.NET Framework debugging]", "GetAppDomain method, ICorDebugAssembly interface [.NET Framework debugging]"]
