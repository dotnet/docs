...
dev_langs: ["C++"]
helpviewer_keywords: ["Next method, ICorDebugBlockingObjectEnum interface [.NET Framework debugging]", "ICorDebugBlockingObjectEnum::Next method [.NET Framework debugging]"]
