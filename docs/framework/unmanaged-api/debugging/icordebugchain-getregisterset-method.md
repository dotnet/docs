...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugChain::GetRegisterSet method [.NET Framework debugging]", "GetRegisterSet method, ICorDebugChain interface [.NET Framework debugging]"]
