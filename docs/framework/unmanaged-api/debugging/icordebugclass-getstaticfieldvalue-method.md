...
dev_langs: ["C++"]
helpviewer_keywords: ["GetStaticFieldValue method, ICorDebugClass interface [.NET Framework debugging]", "ICorDebugClass::GetStaticFieldValue method [.NET Framework debugging]"]
