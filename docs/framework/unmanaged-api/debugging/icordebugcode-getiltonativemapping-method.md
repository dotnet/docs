...
dev_langs: ["C++"]
helpviewer_keywords: ["GetILToNativeMapping method, ICorDebugCode interface [.NET Framework debugging]", "ICorDebugCode::GetILToNativeMapping method [.NET Framework debugging]"]
