...
dev_langs: ["C++"]
helpviewer_keywords: ["GetVersionNumber method, ICorDebugCode interface [.NET Framework debugging]", "ICorDebugCode::GetVersionNumber method [.NET Framework debugging]"]
