...
|[Continue Method](../../../../docs/framework/unmanaged-api/debugging/icordebugmodule-interface1.md)|Resumes execution of managed threads after a call to [ICorDebugController::Stop](../../../../docs/framework/unmanaged-api/debugging/icordebugcontroller-stop-method.md).|  
...
|[EnumerateThreads Method](../../../../docs/framework/unmanaged-api/debugging/getting-started-tutorial1.md)|Gets an enumerator for the active managed threads in the process.|  
