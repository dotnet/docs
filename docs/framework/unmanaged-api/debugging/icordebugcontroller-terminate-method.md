...
dev_langs: ["C++"]
helpviewer_keywords: ["Terminate method, ICorDebugController interface [.NET Framework debugging]", "ICorDebugController::Terminate method [.NET Framework debugging]"]
