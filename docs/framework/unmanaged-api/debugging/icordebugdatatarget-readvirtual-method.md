...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugDataTarget::ReadVirtual method [.NET Framework debugging]", "ReadVirtual method, ICorDebugDataTarget interface [.NET Framework debugging]"]
