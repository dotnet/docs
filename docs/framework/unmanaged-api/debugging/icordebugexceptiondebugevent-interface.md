---
title: "ICorDebugExceptionDebugEvent Interface | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Method|Description|  
|------------|-----------------|  
|[GetFlags Method](../../../../docs/framework/unmanaged-api/debugging/icordebugthread2-interface1.md)|Gets a flag that indicates whether the exception is can be intercepted.|  
