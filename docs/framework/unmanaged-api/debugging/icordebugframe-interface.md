...
|[GetFunction Method](../../../../docs/framework/unmanaged-api/debugging/icordebughandlevalue-interface1.md)|Gets a pointer to the ICorDebugFunction that contains the code associated with this stack frame.|  
