...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugGenericValue::SetValue method [.NET Framework debugging]", "SetValue method, ICorDebugGenericValue interface [.NET Framework debugging]"]
