...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugHeapSegmentEnum::Next method [.NET Framework debugging]", "Next method, ICorDebugHeapSegmentEnum interface [.NET Framework debugging]"]
