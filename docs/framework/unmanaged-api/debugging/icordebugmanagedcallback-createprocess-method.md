...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugManagedCallback::CreateProcess method [.NET Framework debugging]", "CreateProcess method, ICorDebugManagedCallback interface [.NET Framework debugging]"]
