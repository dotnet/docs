---
title: "ICorDebugManagedCallback2 Interface | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Method|Description|  
|------------|-----------------|  
|[ChangeConnection Method](../../../../docs/framework/unmanaged-api/debugging/icordebugclass2-interface1.md)|Notifies the debugger that the set of tasks associated with the specified connection has changed.|  
...
|[Exception Method](../../../../docs/framework/unmanaged-api/debugging/icordebugmodule2-interface1.md)|Notifies the debugger that a search for an exception handler has started.|  
