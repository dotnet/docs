...
|[GetFlags Method](../../../../docs/framework/unmanaged-api/debugging/icordebugfunction-interface1.md)|Gets the flags associated with this MDA.|  
|[GetName Method](../../../../docs/framework/unmanaged-api/debugging/icordebugheapvalue2-interface1.md)|Gets a string containing the name of this MDA.|  
|[GetOSThreadId Method](../../../../docs/framework/unmanaged-api/debugging/icordebugboxvalue-interface1.md)|Gets the operating system thread identifier upon which this MDA is executing.|  
