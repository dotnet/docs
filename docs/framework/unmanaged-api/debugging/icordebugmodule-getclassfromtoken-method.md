...
dev_langs: ["C++"]
helpviewer_keywords: ["GetClassFromToken method, ICorDebugModule interface [.NET Framework debugging]", "ICorDebugModule::GetClassFromToken method [.NET Framework debugging]"]
