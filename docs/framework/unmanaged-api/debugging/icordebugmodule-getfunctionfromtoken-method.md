...
dev_langs: ["C++"]
helpviewer_keywords: ["GetFunctionFromToken method, ICorDebugModule interface [.NET Framework debugging]", "ICorDebugModule::GetFunctionFromToken method [.NET Framework debugging]"]
