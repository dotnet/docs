...
|[GetJITCompilerFlags Method](../../../../docs/framework/unmanaged-api/debugging/icordebugmodulebreakpoint-interface1.md)|Gets the flags that control the just-in-time (JIT) compilation for this `ICorDebugModule2`.|  
