...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugNativeFrame::GetLocalDoubleRegisterValue method [.NET Framework debugging]", "GetLocalDoubleRegisterValue method [.NET Framework debugging]"]
