...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugNativeFrame::GetLocalRegisterMemoryValue method [.NET Framework debugging]", "GetLocalRegisterMemoryValue method [.NET Framework debugging]"]
