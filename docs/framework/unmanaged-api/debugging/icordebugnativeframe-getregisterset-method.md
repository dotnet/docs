...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugNativeFrame::GetRegisterSet method [.NET Framework debugging]", "GetRegisterSet method, ICorDebugNativeFrame interface [.NET Framework debugging]"]
