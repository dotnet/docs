...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugObjectValue::GetClass method [.NET Framework debugging]", "GetClass method, ICorDebugObjectValue interface [.NET Framework debugging]"]
