...
dev_langs: ["C++"]
helpviewer_keywords: ["ClearCurrentException method, ICorDebugProcess interface [.NET Framework debugging]", "ICorDebugProcess::ClearCurrentException method [.NET Framework debugging]"]
