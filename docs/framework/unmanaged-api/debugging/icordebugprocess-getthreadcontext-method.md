...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugProcess::GetThreadContext method [.NET Framework debugging]", "GetThreadContext method, ICorDebugProcess interface [.NET Framework debugging]"]
