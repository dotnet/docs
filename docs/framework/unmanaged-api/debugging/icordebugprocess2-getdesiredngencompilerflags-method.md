...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugProcess2::GetDesiredNGENCompilerFlags method [.NET Framework debugging]", "GetDesiredNGENCompilerFlags method [.NET Framework debugging]"]
