...
dev_langs: ["C++"]
helpviewer_keywords: ["GetReferenceValueFromGCHandle method [.NET Framework debugging]", "ICorDebugProcess2::GetReferenceValueFromGCHandle method [.NET Framework debugging]"]
