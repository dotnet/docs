...
dev_langs: ["C++"]
helpviewer_keywords: ["EnumerateHandles method, ICorDebugProcess5 interface [.NET Framework debugging]", "ICorDebugProcess5::EnumerateHandles method [.NET Framework debugging]"]
