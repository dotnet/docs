...
dev_langs: ["C++"]
helpviewer_keywords: ["EnumerateHeapRegions method, ICorDebugProcess5 interface [.NET Framework debugging]", "ICorDebugProcess5::EnumerateHeapRegions method [.NET Framework debugging]"]
