...
|[EnumerateGCReferences Method](../../../../docs/framework/unmanaged-api/debugging/icordebugthread-interface1.md)|Gets an enumerator for all objects that are to be garbage-collected in a process.|  
|[EnumerateHandles Method](../../../../docs/framework/unmanaged-api/debugging/icordebugthread2-interface1.md)|Gets an enumerator for object handles in a process.|  
