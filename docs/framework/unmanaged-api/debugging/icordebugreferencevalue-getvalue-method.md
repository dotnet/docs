...
dev_langs: ["C++"]
helpviewer_keywords: ["GetValue method, ICorDebugReferenceValue interface [.NET Framework debugging]", "ICorDebugReferenceValue::GetValue method [.NET Framework debugging]"]
