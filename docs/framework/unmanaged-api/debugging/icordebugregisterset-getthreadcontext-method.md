...
dev_langs: ["C++"]
helpviewer_keywords: ["GetThreadContext method, ICorDebugRegisterSet interface [.NET Framework debugging]", "ICorDebugRegisterSet::GetThreadContext method [.NET Framework debugging]"]
