...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugRegisterSet::SetThreadContext method [.NET Framework debugging]", "SetThreadContext method, ICorDebugRegisterSet interface [.NET Framework debugging]"]
