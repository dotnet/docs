...
dev_langs: ["C++"]
helpviewer_keywords: ["GetContext method, ICorDebugStackWalk interface [.NET Framework debugging]", "ICorDebugStackWalk::GetContext method [.NET Framework debugging]"]
