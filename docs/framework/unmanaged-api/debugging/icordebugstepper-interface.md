...
|Method|Description|  
|------------|-----------------|  
|[Deactivate Method](../../../../docs/framework/unmanaged-api/debugging/codechunkinfo-structure1.md)|Causes this `ICorDebugStepper` to cancel the last step command it received.|  
