...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugStringValue::GetString method [.NET Framework debugging]", "GetString method, ICorDebugStringValue interface [.NET Framework debugging]"]
