...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugThread::GetRegisterSet method [.NET Framework debugging]", "GetRegisterSet method, ICorDebugThread interface [.NET Framework debugging]"]
