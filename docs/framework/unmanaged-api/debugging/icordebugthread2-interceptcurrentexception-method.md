...
dev_langs: ["C++"]
helpviewer_keywords: ["InterceptCurrentException method [.NET Framework debugging]", "ICorDebugThread2::InterceptCurrentException method [.NET Framework debugging]"]
