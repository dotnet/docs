...
dev_langs: ["C++"]
helpviewer_keywords: ["EnumerateTypeParameters method, ICorDebugType interface [.NET Framework debugging]", "ICorDebugType::EnumerateTypeParameters method [.NET Framework debugging]"]
