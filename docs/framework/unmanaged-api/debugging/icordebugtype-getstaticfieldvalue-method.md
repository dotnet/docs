...
dev_langs: ["C++"]
helpviewer_keywords: ["GetStaticFieldValue method, ICorDebugType interface [.NET Framework debugging]", "ICorDebugType::GetStaticFieldValue method [.NET Framework debugging]"]
