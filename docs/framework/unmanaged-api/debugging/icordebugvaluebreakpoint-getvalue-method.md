...
dev_langs: ["C++"]
helpviewer_keywords: ["GetValue method, ICorDebugValueBreakpoint interface [.NET Framework debugging]", "ICorDebugValueBreakpoint::GetValue method [.NET Framework debugging]"]
