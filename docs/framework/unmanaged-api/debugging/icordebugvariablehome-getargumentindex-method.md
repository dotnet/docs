...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugVariableHome::GetArgumentiIndex method [.NET Framework debugging]", "GetArgumentIndex method, ICorDebugVariableHome interface [.NET Framework debugging]"]
