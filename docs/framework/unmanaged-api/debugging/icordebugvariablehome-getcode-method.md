...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugVariableHome::GetCode method [.NET Framework debugging]", "GetCode method, ICorDebugVariableHome interface [.NET Framework debugging]"]
