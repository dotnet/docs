...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugVariableHome::GetLocationType method [.NET Framework debugging]", "GetLocationType method, ICorDebugVariableHome interface [.NET Framework debugging]"]
