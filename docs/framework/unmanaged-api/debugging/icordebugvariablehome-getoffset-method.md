...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugVariableHome::GetOffset method [.NET Framework debugging]", "GetOffset method, ICorDebugVariableHome interface [.NET Framework debugging]"]
