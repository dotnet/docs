...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugVariableHome::GetRegister method [.NET Framework debugging]", "GetRegister method, ICorDebugVariableHome interface [.NET Framework debugging]"]
