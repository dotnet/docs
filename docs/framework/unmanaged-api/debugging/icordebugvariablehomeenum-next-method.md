...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorDebugVariableHomeEnum::Next method [.NET Framework debugging]", "Next method, ICorDebugVariableHomeEnum interface [.NET Framework debugging]"]
