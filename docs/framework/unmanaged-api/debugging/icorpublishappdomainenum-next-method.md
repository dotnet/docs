...
dev_langs: ["C++"]
helpviewer_keywords: ["Next method, ICorPublishAppDomainEnum interface [.NET Framework debugging]", "ICorPublishAppDomainEnum::Next method [.NET Framework debugging]"]
