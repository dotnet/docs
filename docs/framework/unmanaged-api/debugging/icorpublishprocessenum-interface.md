...
A subclass of the [ICorPublishEnum](../../../../docs/framework/unmanaged-api/debugging/corelementtype-enumeration1.md) interface that provides methods to traverse a collection of [ICorPublishProcess](../../../../docs/framework/unmanaged-api/debugging/icorpublishprocess-interface.md) objects.  
...
## Remarks  
 The `ICorPublishProcessEnum` interface implements the methods of the abstract interface, [ICorPublishEnum](../../../../docs/framework/unmanaged-api/debugging/corelementtype-enumeration1.md).  
