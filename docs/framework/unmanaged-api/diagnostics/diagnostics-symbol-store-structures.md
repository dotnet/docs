...
ms.topic: "reference"
dev_langs: ["C++"]
helpviewer_keywords: ["unmanaged structures [.NET Framework], diagnostics symbol store", "unmanaged structures [.NET Framework], debugging", "diagnostics symbol store structures [.NET Framework]", "structures [.NET Framework debugging]"]
