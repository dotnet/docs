...
Given a metadata interface and a stream that contains the symbol store, returns the correct <xref:ISymUnmanagedReader> structure that will read the debugging symbols from the given symbol store.  
