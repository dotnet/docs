...
dev_langs: ["C++"]
helpviewer_keywords: ["GetSignature method, ISymUnmanagedConstant interface [.NET Framework debugging]", "ISymUnmanagedConstant::GetSignature method [.NET Framework debugging]"]
