...
dev_langs: ["C++"]
helpviewer_keywords: ["GetValue method, ISymUnmanagedConstant interface [.NET Framework debugging]", "ISymUnmanagedConstant::GetValue method [.NET Framework debugging]"]
