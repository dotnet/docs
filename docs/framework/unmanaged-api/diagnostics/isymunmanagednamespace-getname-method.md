...
dev_langs: ["C++"]
helpviewer_keywords: ["ISymUnmanagedNamespace::GetName method [.NET Framework debugging]", "GetName method, ISymUnmanagedNamespace interface [.NET Framework debugging]"]
