...
dev_langs: ["C++"]
helpviewer_keywords: ["ISymUnmanagedNamespace::GetNamespaces method [.NET Framework debugging]", "GetNamespaces method, ISymUnmanagedNamespace interface [.NET Framework debugging]"]
