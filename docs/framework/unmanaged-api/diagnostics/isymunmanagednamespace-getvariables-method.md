...
dev_langs: ["C++"]
helpviewer_keywords: ["ISymUnmanagedNamespace::GetVariables method [.NET Framework debugging]", "GetVariables method, ISymUnmanagedNamespace interface [.NET Framework debugging]"]
