...
dev_langs: ["C++"]
helpviewer_keywords: ["GetMethodFromDocumentPosition method [.NET Framework debugging]", "ISymUnmanagedReader::GetMethodFromDocumentPosition method [.NET Framework debugging]"]
