...
dev_langs: ["C++"]
helpviewer_keywords: ["ISymUnmanagedReader::GetNamespaces method [.NET Framework debugging]", "GetNamespaces method, ISymUnmanagedReader interface [.NET Framework debugging]"]
