...
dev_langs: ["C++"]
helpviewer_keywords: ["ISymUnmanagedReader::GetVariables method [.NET Framework debugging]", "GetVariables method, ISymUnmanagedReader interface [.NET Framework debugging]"]
