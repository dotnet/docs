...
dev_langs: ["C++"]
helpviewer_keywords: ["ISymUnmanagedReader::Initialize method [.NET Framework debugging]", "Initialize method, ISymUnmanagedReader interface [.NET Framework debugging]"]
