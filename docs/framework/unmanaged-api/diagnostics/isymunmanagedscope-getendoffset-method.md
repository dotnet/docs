...
dev_langs: ["C++"]
helpviewer_keywords: ["ISymUnmanagedScope::GetEndOffset method [.NET Framework debugging]", "GetEndOffset method, ISymUnmanagedScope interface [.NET Framework debugging]"]
