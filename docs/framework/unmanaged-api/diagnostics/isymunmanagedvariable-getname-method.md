...
dev_langs: ["C++"]
helpviewer_keywords: ["GetName method, ISymUnmanagedVariable interface [.NET Framework debugging]", "ISymUnmanagedVariable::GetName method [.NET Framework debugging]"]
