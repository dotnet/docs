...
dev_langs: ["C++"]
helpviewer_keywords: ["GetSignature method, ISymUnmanagedVariable interface [.NET Framework debugging]", "ISymUnmanagedVariable::GetSignature method [.NET Framework debugging]"]
