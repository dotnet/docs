...
dev_langs: ["C++"]
helpviewer_keywords: ["GetStartOffset method, ISymUnmanagedVariable interface [.NET Framework debugging]", "ISymUnmanagedVariable::GetStartOffset method [.NET Framework debugging]"]
