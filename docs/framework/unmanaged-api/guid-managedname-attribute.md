...
## Remarks
 ...
 Use <xref:System.Runtime.InteropServices.ComTypes.ITypeInfo2.GetCustData*?displayProperty=nameWithType> or <xref:System.Runtime.InteropServices.ComTypes.ITypeLib2.GetCustData*?displayProperty=nameWithType> to retrieve the managed name from the attribute.
