...
#### Parameters  
 `iDebuggerVersion`  
 [in] The version of `ICorDebug` that is expected by the debugger. See the [CorDebugInterfaceVersion](../../../../docs/framework/unmanaged-api/debugging/icordebugclass2-interface1.md) enumeration for valid values.  
