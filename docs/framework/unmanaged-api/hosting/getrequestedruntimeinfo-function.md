---
description: "Learn more about: GetRequestedRuntimeInfo Function"
...
## Remarks
 ...
 The `GetRequestedRuntimeInfo` method returns runtime information about the version loaded into the process, which is not necessarily the latest version installed on the computer.
