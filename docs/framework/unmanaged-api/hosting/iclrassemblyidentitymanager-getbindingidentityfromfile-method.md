...
dev_langs: ["C++"]
helpviewer_keywords: ["GetBindingIdentityFromFile method [.NET Framework hosting]", "ICLRAssemblyIdentityManager::GetBindingIdentifyFromFile method [.NET Framework hosting]"]
