...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRAssemblyIdentityManager::GetReferencedAssembliesFromStream method [.NET Framework hosting]", "GetReferencedAssembliesFromStream method [.NET Framework hosting]"]
