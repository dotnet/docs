...
dev_langs: ["C++"]
helpviewer_keywords: ["SetAppDomainManagerType method, ICLRControl interface [.NET Framework hosting]", "ICLRControl::SetAppDomainManagerType method [.NET Framework hosting]"]
