...
dev_langs: ["C++"]
helpviewer_keywords: ["IsDebuggerAttached method, ICLRDebugManager interface [.NET Framework hosting]", "ICLRDebugManager::IsDebuggerAttached method [.NET Framework hosting]"]
