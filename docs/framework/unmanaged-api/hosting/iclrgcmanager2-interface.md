---
title: "ICLRGCManager2 Interface | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Remarks  
 ...
 The common language runtime (CLR) implements its garbage collection mechanism with the managed <xref:System.GC> type. For more information about the garbage collection system, see [Garbage Collection](../../../../docs/standard/garbagecollection/garbage-collection.md).  
