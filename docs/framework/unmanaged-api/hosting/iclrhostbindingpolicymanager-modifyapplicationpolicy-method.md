...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRHostBindingPolicyManager::ModifyApplicationPolicy method [.NET Framework hosting]", "ModifyApplicationPolicy method [.NET Framework hosting]"]
