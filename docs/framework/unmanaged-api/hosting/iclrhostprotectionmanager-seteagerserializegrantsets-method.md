...
dev_langs: ["C++"]
helpviewer_keywords: ["SetEagerSerializeGrantSets method [.NET Framework hosting]", "ICLRHostProtectionManager::SetEagerSerializeGrantSets method [.NET Framework hosting]"]
