...
dev_langs: ["C++"]
helpviewer_keywords: ["RequestRuntimeLoadedNotification method [.NET Framework hosting]", "ICLRMetaHost::RequestRuntimeLoadedNotification method [.NET Framework hosting]"]
