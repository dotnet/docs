...
## Remarks
 ...
 The `pdwAppDomainId` parameter is set to the value of the <xref:System.AppDomain.Id> property of the <xref:System.AppDomain> in which the current thread is executing.
