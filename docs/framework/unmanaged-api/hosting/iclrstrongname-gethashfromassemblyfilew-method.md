...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRStrongName::GetHashFromAssemblyFileW method [.NET Framework hosting]", "GetHashFromAssemblyFileW method, ICLRStrongName interface [.NET Framework hosting]"]
