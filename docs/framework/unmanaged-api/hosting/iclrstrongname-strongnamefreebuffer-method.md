...
dev_langs: ["C++"]
helpviewer_keywords: ["StrongNameFreeBuffer method, ICLRStrongName interface [.NET Framework hosting]", "ICLRStrongName::StrongNameFreeBuffer method [.NET Framework hosting]"]
