...
dev_langs: ["C++"]
helpviewer_keywords: ["StrongNameGetBlobFromImage method, ICLRStrongName interface [.NET Framework hosting]", "ICLRStrongName::StrongNameGetBlobFromImage method [.NET Framework hosting]"]
