...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRStrongName::StrongNameHashSize method [.NET Framework hosting]", "StrongNameHashSize method, ICLRStrongName interface [.NET Framework hosting]"]
