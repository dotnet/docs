...
dev_langs: ["C++"]
helpviewer_keywords: ["StrongNameKeyDelete method, ICLRStrongName interface [.NET Framework hosting]", "ICLRStrongName::StrongNameKeyDelete method [.NET Framework hosting]"]
