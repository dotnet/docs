...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRStrongName::StrongNameKeyGenEx method [.NET Framework hosting]", "StrongNameKeyGenEx method, ICLRStrongName interface [.NET Framework hosting]"]
