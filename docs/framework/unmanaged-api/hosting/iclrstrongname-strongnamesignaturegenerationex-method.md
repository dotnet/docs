...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRStrongName::StrongNameSignatureGenerationEx method [.NET Framework hosting]", "StrongNameSignatureGenerationEx method, ICLRStrongName interface [.NET Framework hosting]"]
