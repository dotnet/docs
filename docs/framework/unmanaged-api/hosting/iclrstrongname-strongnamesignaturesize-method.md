...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRStrongName::StrongNameSignatureSize method [.NET Framework hosting]", "StrongNameSignatureSize method, ICLRStrongName interface [.NET Framework hosting]"]
