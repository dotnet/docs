...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRStrongName::StrongNameSignatureVerification method [.NET Framework hosting]", "StrongNameSignatureVerification method, ICLRStrongName interface [.NET Framework hosting]"]
