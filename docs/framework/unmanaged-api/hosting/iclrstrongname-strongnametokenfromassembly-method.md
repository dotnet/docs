...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRStrongName::StrongNameTokenFromAssembly method [.NET Framework hosting]", "StrongNameTokenFromAssembly method, ICLRStrongName interface [.NET Framework hosting]"]
