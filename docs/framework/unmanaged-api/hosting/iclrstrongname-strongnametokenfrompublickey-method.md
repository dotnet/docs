...
dev_langs: ["C++"]
helpviewer_keywords: ["ICLRStrongName::StrongNameTokenFromPublicKey method [.NET Framework hosting]", "StrongNameTokenFromPublicKey method, ICLRStrongName interface [.NET Framework hosting]"]
