...
## Parameters
 ...
 If the value is `true`, the runtime resets data that was stored using <xref:System.Threading.Thread.AllocateDataSlot*> or <xref:System.Threading.Thread.AllocateNamedDataSlot*>.
