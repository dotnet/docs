...
dev_langs: ["C++"]
helpviewer_keywords: ["IGCThreadControl::SuspensionEnding method [.NET Framework hosting]", "SuspensionEnding method, IGCThreadControl interface [.NET Framework hosting]"]
