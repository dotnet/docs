...
dev_langs: ["C++"]
helpviewer_keywords: ["IGCThreadControl::SuspensionStarting method [.NET Framework hosting]", "SuspensionStarting method, IGCThreadControl interface [.NET Framework hosting]"]
