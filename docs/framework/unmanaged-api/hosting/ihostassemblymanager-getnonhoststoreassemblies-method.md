...
dev_langs: ["C++"]
helpviewer_keywords: ["IHostAssemblyManager::GetNonHostStoreAssemblies method [.NET Framework hosting]", "GetNonHostStoreAssemblies method [.NET Framework hosting]"]
