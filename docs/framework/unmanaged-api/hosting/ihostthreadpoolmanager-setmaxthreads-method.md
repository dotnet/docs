...
dev_langs: ["C++"]
helpviewer_keywords: ["IHostThreadPoolManager::SetMaxThreads method [.NET Framework hosting]", "SetMaxThreads method, IHostThreadPoolManager interface [.NET Framework hosting]"]
