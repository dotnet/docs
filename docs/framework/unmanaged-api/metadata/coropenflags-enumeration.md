...
|`ofTakeOwnership`|Indicates that the memory was allocated using a call to [CoTaskMemAlloc](https://msdn.microsoft.com/library/windows/desktop/ms692727(v=vs.85).aspx) and will be freed by the metadata.|  
