...
## Remarks
 ...
 Typically, you want a token to be processed if it is in the metadata scope. The `MarkToken` method is passed to the metadata engine via the [IMetaDataEmit::SetHandler](../../../core/unmanaged-api/metadata/interfaces/imetadataemit-sethandler-method.md) method.
