...
dev_langs: ["C++"]
helpviewer_keywords: ["CloseEnum method, IMetaDataAssemblyImport interface [.NET Framework metadata]", "IMetaDataAssemblyImport::CloseEnum method [.NET Framework metadata]"]
