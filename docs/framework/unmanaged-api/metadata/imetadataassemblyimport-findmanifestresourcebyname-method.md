...
dev_langs: ["C++"]
helpviewer_keywords: ["FindManifestResourceByName method [.NET Framework metadata]", "IMetaDataAssemblyImport::FindManifestResourceByName method [.NET Framework metadata]"]
