...
dev_langs: ["C++"]
helpviewer_keywords: ["GetManifestResourceProps method [.NET Framework metadata]", "IMetaDataAssemblyImport::GetManifestResourceProps method [.NET Framework metadata]"]
