...
#### Parameters  
 `pITI`  
 [in] Pointer to an [ITypeInfo](https://msdn.microsoft.com/library/ms221696(v=vs.100).aspx) interface that provides the type information on which to open the scope.  
