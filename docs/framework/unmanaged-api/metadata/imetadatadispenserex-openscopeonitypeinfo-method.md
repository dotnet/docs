...
#### Parameters  
 `pITI`  
 [in] Pointer to an [ITypeInfo](http://msdn.microsoft.com/f3356463-3373-4279-bae1-953378aa2680) interface that provides the type information on which to open the scope.  
