...
dev_langs: ["C++"]
helpviewer_keywords: ["IMetaDataImport::GetClassLayout method [.NET Framework metadata]", "GetClassLayout method, IMetaDataImport interface [.NET Framework metadata]"]
