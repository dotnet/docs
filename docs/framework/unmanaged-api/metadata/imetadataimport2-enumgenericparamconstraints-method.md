...
dev_langs: ["C++"]
helpviewer_keywords: ["EnumGenericParamConstraints method [.NET Framework metadata]", "IMetaDataImport2::EnumGenericParamConstraints method [.NET Framework metadata]"]
