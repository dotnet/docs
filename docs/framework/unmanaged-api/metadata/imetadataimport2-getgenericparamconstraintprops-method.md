...
dev_langs: ["C++"]
helpviewer_keywords: ["IMetaDataImport2::GetGenericParamConstraintProps method [.NET Framework metadata]", "GetGenericParamConstraintProps method [.NET Framework metadata]"]
