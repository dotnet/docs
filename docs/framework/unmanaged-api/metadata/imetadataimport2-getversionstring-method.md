...
dev_langs: ["C++"]
helpviewer_keywords: ["GetVersionString method, IMetaDataImport2 interface [.NET Framework metadata]", "IMetaDataImport2::GetVersionString method [.NET Framework metadata]"]
