...
These articles describe APIs for .NET Framework. For unmanaged APIs that are supported on .NET (Core), see [.NET metadata (unmanaged API reference)](../../../core/unmanaged-api/metadata/index.md).
