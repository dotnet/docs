...
> [!NOTE]
> The `FunctionTailcall` function is deprecated in .NET Framework version 2.0. It will continue to work, but will incur a performance penalty. Use the [FunctionTailcall2](functiontailcall2-function.md) function instead.  
