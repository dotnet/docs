...
dev_langs: ["C++"]
helpviewer_keywords: ["AppDomainCreationStarted method [.NET Framework profiling]", "ICorProfilerCallback::AppDomainCreationStarted method [.NET Framework profiling]"]
