...
dev_langs: ["C++"]
helpviewer_keywords: ["AppDomainShutdownFinished method [.NET Framework profiling]", "ICorProfilerCallback::AppDomainShutdownFinished method [.NET Framework profiling]"]
