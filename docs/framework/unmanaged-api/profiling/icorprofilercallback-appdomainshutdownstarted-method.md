...
dev_langs: ["C++"]
helpviewer_keywords: ["AppDomainShutdownStarted method [.NET Framework profiling]", "ICorProfilerCallback::AppDomainShutdownStarted method [.NET Framework profiling]"]
