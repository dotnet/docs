...
dev_langs: ["C++"]
helpviewer_keywords: ["ExceptionCLRCatcherExecute method [.NET Framework profiling]", "ICorProfilerCallback::ExceptionCLRCatcherExecute method [.NET Framework profiling]"]
