...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerCallback::ExceptionCLRCatcherFound method [.NET Framework profiling]", "ExceptionCLRCatcherFound method [.NET Framework profiling]"]
