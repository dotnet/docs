...
dev_langs: ["C++"]
helpviewer_keywords: ["ExceptionOSHandlerEnter method [.NET Framework profiling]", "ICorProfilerCallback::ExceptionOSHandlerEnter method [.NET Framework profiling]"]
