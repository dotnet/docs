...
dev_langs: ["C++"]
helpviewer_keywords: ["ExceptionOSHandlerLeave method [.NET Framework profiling]", "ICorProfilerCallback::ExceptionOSHandlerLeave method [.NET Framework profiling]"]
