...
dev_langs: ["C++"]
helpviewer_keywords: ["ExceptionSearchCatcherFound method [.NET Framework profiling]", "ICorProfilerCallback::ExceptionSearchCatcherFound method [.NET Framework profiling]"]
