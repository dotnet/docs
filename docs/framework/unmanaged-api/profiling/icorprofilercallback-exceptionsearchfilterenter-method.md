...
dev_langs: ["C++"]
helpviewer_keywords: ["ExceptionSearchFilterEnter method [.NET Framework profiling]", "ICorProfilerCallback::ExceptionSearchFilterEnter method [.NET Framework profiling]"]
