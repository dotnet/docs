...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerCallback::ExceptionSearchFilterLeave method [.NET Framework profiling]", "ExceptionSearchFilterLeave method [.NET Framework profiling]"]
