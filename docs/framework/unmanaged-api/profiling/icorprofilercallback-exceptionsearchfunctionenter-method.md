...
dev_langs: ["C++"]
helpviewer_keywords: ["ExceptionSearchFunctionEnter method [.NET Framework profiling]", "ICorProfilerCallback::ExceptionSearchFunctionEnter method [.NET Framework profiling]"]
