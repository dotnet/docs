...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerCallback::ExceptionUnwindFinallyEnter method [.NET Framework profiling]", "ExceptionUnwindFinallyEnter method [.NET Framework profiling]"]
