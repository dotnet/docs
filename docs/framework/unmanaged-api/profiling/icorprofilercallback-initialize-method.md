...
dev_langs: ["C++"]
helpviewer_keywords: ["Initialize method, ICorProfilerCallback interface [.NET Framework profiling]", "ICorProfilerCallback::Initialize method [.NET Framework profiling]"]
