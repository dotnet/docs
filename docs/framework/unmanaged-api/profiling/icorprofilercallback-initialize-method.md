...
#### Parameters  
 ...
 [in] Pointer to an [IUnknown](../Topic/IUnknown.md) interface that the profiler must query for an [ICorProfilerInfo](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo-interface.md) interface pointer.  
