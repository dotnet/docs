...
dev_langs: ["C++"]
helpviewer_keywords: ["JITCachedFunctionSearchStarted method [.NET Framework profiling]", "ICorProfilerCallback::JITCachedFunctionSearchStarted method [.NET Framework profiling]"]
