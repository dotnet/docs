...
dev_langs: ["C++"]
helpviewer_keywords: ["ManagedToUnmanagedTransition method [.NET Framework profiling]", "ICorProfilerCallback::ManagedToUnmanagedTransition method [.NET Framework profiling]"]
