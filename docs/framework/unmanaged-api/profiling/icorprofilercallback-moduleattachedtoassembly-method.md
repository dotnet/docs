...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerCallback::ModuleAttachedToAssembly method [.NET Framework profiling]", "ModuleAttachedToAssembly method [.NET Framework profiling]"]
