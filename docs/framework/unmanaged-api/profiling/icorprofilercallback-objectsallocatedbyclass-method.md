...
dev_langs: ["C++"]
helpviewer_keywords: ["ObjectsAllocatedByClass method [.NET Framework profiling]", "ICorProfilerCallback::ObjectsAllocatedByClass method [.NET Framework profiling]"]
