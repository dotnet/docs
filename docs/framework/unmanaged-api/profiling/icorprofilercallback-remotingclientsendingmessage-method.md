...
dev_langs: ["C++"]
helpviewer_keywords: ["RemotingClientSendingMessage method [.NET Framework profiling]", "ICorProfilerCallback::RemotingClientSendingMessage method [.NET Framework profiling]"]
