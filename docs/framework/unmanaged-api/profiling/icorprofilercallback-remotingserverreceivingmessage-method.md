...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerCallback::RemotingServerReceivingMessage method [.NET Framework profiling]", "RemotingServerReceivingMessage method [.NET Framework profiling]"]
