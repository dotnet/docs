...
dev_langs: ["C++"]
helpviewer_keywords: ["RemotingServerSendingReply method [.NET Framework profiling]", "ICorProfilerCallback::RemotingServerSendingReply method [.NET Framework profiling]"]
