...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerCallback::UnmanagedToManagedTransition method [.NET Framework profiling]", "UnmanagedToManagedTransition method [.NET Framework profiling]"]
