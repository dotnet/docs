...
dev_langs: ["C++"]
helpviewer_keywords: ["ReJITCompilationStarted method, ICorProfilerCallback4 interface [.NET Framework profiling]", "ICorProfilerCallback4::ReJITCompilationStarted method [.NET Framework profiling]"]
