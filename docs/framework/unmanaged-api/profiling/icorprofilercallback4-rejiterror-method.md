...
dev_langs: ["C++"]
helpviewer_keywords: ["ReJITError method, ICorProfilerCallback4 interface [.NET Framework profiling]", "ICorProfilerCallback4::ReJITError method [.NET Framework profiling]"]
