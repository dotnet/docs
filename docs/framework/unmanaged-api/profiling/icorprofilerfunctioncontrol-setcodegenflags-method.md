...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerFunctionControl::SetCodegenFlags method [.NET Framework profiling]", "SetCodegenFlags method, ICorProfilerFunctionControl interface [.NET Framework profiling]"]
