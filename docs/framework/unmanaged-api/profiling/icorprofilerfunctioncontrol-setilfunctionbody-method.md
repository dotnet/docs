...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerFunctionControl::SetILFunctionBody method [.NET Framework profiling]", "SetILFunctionBody method, ICorProfilerFunctionControl interface [.NET Framework profiling]"]
