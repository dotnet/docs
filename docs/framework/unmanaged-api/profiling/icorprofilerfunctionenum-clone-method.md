...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerFunctionEnum::Clone method [.NET Framework profiling]", "Clone method, ICorProfilerFunctionEnum interface [.NET Framework profiling]"]
