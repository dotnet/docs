...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerFunctionEnum::GetCount method [.NET Framework profiling]", "GetCount method, ICorProfilerFunctionEnum interface [.NET Framework profiling]"]
