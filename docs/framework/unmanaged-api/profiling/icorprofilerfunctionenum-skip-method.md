...
dev_langs: ["C++"]
helpviewer_keywords: ["Skip method, ICorProfilerFunctionEnum interface [.NET Framework profiling]", "ICorProfilerFunctionEnum::Skip method [.NET Framework profiling]"]
