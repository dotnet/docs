...
dev_langs: ["C++"]
helpviewer_keywords: ["GetCurrentThreadID method, ICorProfilerInfo interface [.NET Framework profiling]", "ICorProfilerInfo::GetCurrentThreadID method [.NET Framework profiling]"]
