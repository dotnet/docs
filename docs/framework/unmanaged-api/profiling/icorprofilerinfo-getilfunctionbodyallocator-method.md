...
dev_langs: ["C++"]
helpviewer_keywords: ["GetILFunctionBodyAllocator method [.NET Framework profiling]", "ICorProfilerInfo::GetILFunctionBodyAllocator method [.NET Framework profiling]"]
