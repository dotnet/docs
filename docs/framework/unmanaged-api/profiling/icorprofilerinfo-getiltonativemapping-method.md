...
dev_langs: ["C++"]
helpviewer_keywords: ["GetILToNativeMapping method, ICorProfilerInfo interface [.NET Framework profiling]", "ICorProfilerInfo::GetILToNativeMapping method [.NET Framework profiling]"]
