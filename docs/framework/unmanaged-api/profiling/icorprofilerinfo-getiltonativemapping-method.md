---
description: "Learn more about: ICorProfilerInfo::GetILToNativeMapping Method"
...
Gets a map from common intermediate language (CIL) offsets to native offsets for the code contained in the specified function.
