...
dev_langs: ["C++"]
helpviewer_keywords: ["GetInprocInspectionInterface method [.NET Framework profiling]", "ICorProfilerInfo::GetInprocInspectionInterface method [.NET Framework profiling]"]
