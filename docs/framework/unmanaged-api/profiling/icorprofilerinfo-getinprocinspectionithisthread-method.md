...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerInfo::GetInprocInspectionIThisThread method [.NET Framework profiling]", "GetInprocInspectionIThisThread method [.NET Framework profiling]"]
