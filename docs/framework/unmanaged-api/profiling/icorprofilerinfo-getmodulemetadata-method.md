...
## Parameters
 ...
 `dwOpenFlags`
 [in] A value of the [CorOpenFlags](../../../core/unmanaged-api/metadata/enumerations/coropenflags-enumeration.md) enumeration that specifies the mode for opening manifest files. Only the `ofRead`, `ofWrite` and `ofNoTransform` bits are valid.
