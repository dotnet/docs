...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerInfo::GetThreadContext method [.NET Framework profiling]", "GetThreadContext method, ICorProfilerInfo interface [.NET Framework profiling]"]
