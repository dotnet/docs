...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerInfo::GetTokenAndMetadataFromFunction method [.NET Framework profiling]", "GetTokenAndMetadataFromFunction method [.NET Framework profiling]"]
