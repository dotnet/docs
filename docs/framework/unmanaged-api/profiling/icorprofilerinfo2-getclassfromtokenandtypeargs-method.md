...
dev_langs: ["C++"]
helpviewer_keywords: ["GetClassFromTokenAndTypeArgs method [.NET Framework profiling]", "ICorProfilerInfo2::GetClassFromTokenAndTypeArgs method [.NET Framework profiling]"]
