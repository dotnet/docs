...
## Parameters
 ...
 `rFieldOffset`
 [in, out] An array of [COR_FIELD_OFFSET](../../../core/unmanaged-api/metadata/structures/set-structure.md) structures, each of which contains the tokens and offsets of the class's fields.
