...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerInfo2::GetNotifiedExceptionCaluseInfo method [.NET Framework profiling]", "GetNotifiedExceptionCaluseInfo method [.NET Framework profiling]"]
