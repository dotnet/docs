---
description: "Learn more about: ICorProfilerInfo3::GetModuleInfo2 Method"
...
## Remarks
 ...
 For dynamic modules, the `szName` parameter is the metadata name of the module, and the base address is 0 (zero). The metadata name is the value in the Name column from the Module table inside metadata. This is also exposed as the <xref:System.Reflection.Module.ScopeName%2A?displayProperty=nameWithType> property to managed code, and as the `szName` parameter of the [IMetaDataImport::GetScopeProps](../../../core/unmanaged-api/metadata/interfaces/imetadataimport-getscopeprops-method.md) method to unmanaged metadata client code.
