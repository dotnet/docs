...
dev_langs: ["C++"]
helpviewer_keywords: ["RequestReJIT method, ICorProfilerInfo4 interface [.NET Framework profiling]", "ICorProfilerInfo4::RequestReJIT method [.NET Framework profiling]"]
