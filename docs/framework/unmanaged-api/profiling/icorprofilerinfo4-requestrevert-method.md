...
dev_langs: ["C++"]
helpviewer_keywords: ["RequestRevert method, ICorProfilerInfo4 interface [.NET Framework profiling]", "ICorProfilerInfo4::RequestRevert method [.NET Framework profiling]"]
