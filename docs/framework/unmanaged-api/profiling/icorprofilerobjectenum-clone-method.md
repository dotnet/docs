---
description: "Learn more about: ICorProfilerObjectEnum::Clone Method"
...
Gets an interface pointer to a copy of this [ICorProfilerObjectEnum](icorprofilerobjectenum-interface.md) interface.  
