...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerObjectEnum::GetCount method [.NET Framework profiling]", "GetCount method, ICorProfilerObjectEnum interface [.NET Framework profiling]"]
