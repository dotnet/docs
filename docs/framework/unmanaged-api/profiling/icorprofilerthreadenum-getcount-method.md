...
dev_langs: ["C++"]
helpviewer_keywords: ["ICorProfilerThreadEnum::GetCount method [.NET Framework profiling]", "GetCount method, ICorProfilerThreadEnum interface [.NET Framework profiling]"]
