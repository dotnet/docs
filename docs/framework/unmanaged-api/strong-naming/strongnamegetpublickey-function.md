...
Gets the public key from a private/public key pair. The key pair can be supplied either as a key container name within a cryptographic service provider (CSP) or as a raw collection of bytes.
 ...
 This function has been deprecated. Use the [ICLRStrongName::StrongNameGetPublicKey](../../../core/unmanaged-api/hosting/iclrstrongname-strongnamegetpublickey-method.md) method instead.
...
- [StrongNameGetPublicKey Method](../../../core/unmanaged-api/hosting/iclrstrongname-strongnamegetpublickey-method.md)
- [StrongNameTokenFromPublicKey Method](../../../core/unmanaged-api/hosting/iclrstrongname-strongnametokenfrompublickey-method.md)
