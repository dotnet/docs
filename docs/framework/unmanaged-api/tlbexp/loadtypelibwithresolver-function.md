...
#### Parameters  
 ...
 `regkind`  
 [in] A [REGKIND enumeration](/previous-versions/windows/desktop/api/oleauto/ne-oleauto-tagregkind) flag that controls how the type library is registered. Its possible values are:  
