...
#### Parameters  
 `bstrSimpleName`  
 [in] A [BSTR](https://msdn.microsoft.com/library/ms221069(v=vs.100).aspx) that contains the simple name of the type library.  
 ...
 `syskind`  
 [in] A [SYSKIND](https://msdn.microsoft.com/library/ms221272(v=vs.100).aspx) flag that identifies the operating environment. Common values are SYS_WIN32 and SYS_WIN64.  
  
 `pbstrResolvedTlbName`  
 [out] A pointer to a [BSTR](https://msdn.microsoft.com/library/ms221069(v=vs.100).aspx) that contains the full path of the type library named in the `bstrSimpleName` parameter.  
...
## Remarks  
 ...
 Custom implementations of this interface must return a [BSTR](https://msdn.microsoft.com/library/ms221069(v=vs.100).aspx) that contains the full path of the type library named in the `bstrSimpleName` parameter.  
...
## See Also  
 ...
 [LoadTypeLibEx](https://msdn.microsoft.com/library/ms221249(v=vs.100).aspx)
