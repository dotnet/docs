...
#### Parameters  
 `bstrSimpleName`  
 [in] A [BSTR](http://msdn.microsoft.com/1b2d7d2c-47af-4389-a6b6-b01b7e915228) that contains the simple name of the type library.  
 ...
 `syskind`  
 [in] A [SYSKIND](http://msdn.microsoft.com/662048b2-59a8-48ca-9e4f-2f9a5306faa1) flag that identifies the operating environment. Common values are SYS_WIN32 and SYS_WIN64.  
  
 `pbstrResolvedTlbName`  
 [out] A pointer to a [BSTR](http://msdn.microsoft.com/1b2d7d2c-47af-4389-a6b6-b01b7e915228) that contains the full path of the type library named in the `bstrSimpleName` parameter.  
...
## Remarks  
 ...
 Custom implementations of this interface must return a [BSTR](http://msdn.microsoft.com/1b2d7d2c-47af-4389-a6b6-b01b7e915228) that contains the full path of the type library named in the `bstrSimpleName` parameter.  
...
## See Also  
 ...
 [LoadTypeLibEx](http://msdn.microsoft.com/56a7f9e1-810b-4a42-aa4d-691f4304f5ef)