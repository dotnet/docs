...
|---------|---------|
| [BeginEnumeration function](beginenumeration.md) | Resets the enumerator to the beginnining of an enumeration of WMI object properties. |
...
| [Delete function](delete.md) | Deletes a specififed property from a class definition and all of its qualifiers. |
...
| [EndMethodEnumeration function](endmethodenumeration.md) | Terminates an enumeration sequence started with a call to the |
