...
-   [\<endpoint> element reference](https://docs.microsoft.com/previous-versions/ms731304(v=vs.90))  
...
### The \<binding> Element  
 ...
 For more information about configuring services and clients, see [Configuring Windows Communication Foundation Applications](https://docs.microsoft.com/previous-versions/ms730120(v=vs.90)).  
