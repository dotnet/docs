...
-   [\<endpoint> element reference](https://msdn.microsoft.com/library/ms731304(v=vs.90).aspx)  
...
### The \<binding> Element  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] configuring services and clients, see [Configuring Windows Communication Foundation Applications](https://msdn.microsoft.com/library/ms730120(v=vs.90).aspx).  
