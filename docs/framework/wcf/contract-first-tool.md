...
## Configuring contract-first options
 ...
 ![WCF Project Options showing contract&#45;first](/media/contract-first-tool/contract-first-options.png)

 To configure advanced properties, click the Advanced button.

 ![Advanced Contract&#45;First Properties](./media/contract-first-tool/advanced-contract-settings.png)
...
```
 ...
 ![Using types derived from a service contract](./media/contract-first-tool/service-contract-types.png)
