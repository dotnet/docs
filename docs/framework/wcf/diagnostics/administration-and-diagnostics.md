...
-   Event tracing writes events in the Event Log for any major issues. You can then use the Event Viewer to examine any abnormalities. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] the [Event Logging](../../../../docs/framework/wcf/diagnostics/event-logging/event-logging-in-wcf.md) topic.  
  
-   Performance counters exposed through Performance Monitor enable you to monitor your application and system's health. [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] the [Performance Counters](../../../../docs/framework/wcf/diagnostics/performance-counters/wcf-performance-counters.md) topic.  
...
## See Also  
 ...
 [Exceptions Reference](../../../../docs/framework/wcf/diagnostics/exceptions-reference/exceptions-reference.md)   
