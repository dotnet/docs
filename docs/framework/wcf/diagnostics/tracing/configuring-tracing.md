...
## Configuring Trace Listeners to Consume Traces  
 ...
 You can also configure a trace listener programmatically. [!INCLUDE[crdefault](../../../../../includes/crabout-md.md)] [How to: Create and Initialize Trace Listeners](http://go.microsoft.com/fwlink/?LinkId=94648) and [Creating a Custom TraceListener](http://go.microsoft.com/fwlink/?LinkId=96239).  
