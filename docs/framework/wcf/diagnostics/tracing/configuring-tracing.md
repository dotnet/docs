...
## Configuring Trace Listeners to Consume Traces  
 ...
 You can also configure a trace listener programmatically. For more information, see [How to: Create and Initialize Trace Listeners](/dotnet/framework/debug-trace-profile/how-to-create-and-initialize-trace-listeners) and [Creating a Custom TraceListener](https://msdn.microsoft.com/msdnmag/issues/06/04/CLRInsideOut/default.aspx#S2).  
...
- [How to: Create and Initialize Trace Listeners](/dotnet/framework/debug-trace-profile/how-to-create-and-initialize-trace-listeners)
