...
- [How to: Create and Initialize Trace Listeners](https://docs.microsoft.com/dotnet/framework/debug-trace-profile/how-to-create-and-initialize-trace-listeners)
- [Creating a Custom TraceListener](https://msdn.microsoft.com/msdnmag/issues/06/04/CLRInsideOut/default.aspx#S2)
