---
description: "Learn more about: Channel Model Overview"
...
- <xref:System.ServiceModel.Channels.IDuplexChannel>
 ...
 Further, each of these shapes has an equivalent that extends <xref:System.ServiceModel.Channels.ISessionChannel`1?displayProperty=nameWithType> to support sessions. These are:
