...
description: Learn how to implement behavior interfaces in WCF applications and add them to a service description or endpoint programmatically or in a configuration file.
ms.date: "03/30/2017"
helpviewer_keywords: 
