...
3. Make sure the compiled assembly is signed with a strong name. For details, see the [Strong Name Tool (SN.EXE)](/dotnet/framework/tools/sn-exe-strong-name-tool) and the compiler commands for your language.
