...
-   Perform as a factory for <xref:System.IdentityModel.Selectors.SecurityTokenManager> implementations.  
 ...
 For more information about the credentials classes and how they fit into the WCF security architecture, see [Security Architecture](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/ms788756(v=vs.100)).  
