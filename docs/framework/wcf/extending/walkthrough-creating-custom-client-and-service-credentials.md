...
-   Perform as a factory for <xref:System.IdentityModel.Selectors.SecurityTokenManager> implementations.  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] the credentials classes and how they fit into the [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] security architecture, see [Security Architecture](https://msdn.microsoft.com/library/ms788756(v=vs.110).aspx).  
