...
-   Perform as a factory for <xref:System.IdentityModel.Selectors.SecurityTokenManager> implementations.  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] the credentials classes and how they fit into the [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] security architecture, see [Security Architecture](http://msdn.microsoft.com/16593476-d36a-408d-808c-ae6fd483e28f).  
