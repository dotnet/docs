...
```
 ...
 These exception classes will be readily reusable with the WCF <xref:System.ServiceModel.FaultException`1> class to throw a new `FaultException<AnticipatedException>(anticipatedException);`
