...
> [!IMPORTANT]
>  For ASP.NET to access a SQL database, you must use the [ASP.NET SQL Server Registration Tool](http://go.microsoft.com/fwlink/?LinkId=152536). In addition you must allow the appropriate user account access to the database and table. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Accessing SQL Server from a Web Application](http://go.microsoft.com/fwlink/?LinkId=178988).  
