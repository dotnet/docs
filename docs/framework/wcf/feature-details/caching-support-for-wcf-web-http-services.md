...
> [!IMPORTANT]
> For ASP.NET to access a SQL database, you must use the [ASP.NET SQL Server Registration Tool](/previous-versions/dotnet/netframework-2.0/ms229862(v=vs.80)). In addition you must allow the appropriate user account access to the database and table. For more information, see [Accessing SQL Server from a Web Application](/previous-versions/ht43wsex(v=vs.140)).  
