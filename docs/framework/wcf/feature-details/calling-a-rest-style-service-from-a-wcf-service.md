...
Using <xref:System.ServiceModel.ClientBase`1> to implement the client proxy. For each method called, a new <xref:System.ServiceModel.OperationContextScope> is created and used to call the operation.
