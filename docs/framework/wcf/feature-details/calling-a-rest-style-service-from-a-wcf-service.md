...
description: Learn how to force a WCF service to use the right context with a REST-style service by creating a scope and calling the REST-style service from that scope.
ms.date: "03/30/2017"
