...
```  
 ...
 If you see this error ensure WAS for Non-HTTP Activation is installed and configured properly. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [How to: Install and Configure WCF Activation Components](../../../../docs/framework/wcf/feature-details/how-to-install-and-configure-wcf-activation-components.md).  
