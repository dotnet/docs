...
description: Discover the data contract and member naming rules and default behavior of the WCF infrastructure, which supports Data Contract Equivalence.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
