...
#### SPN/UPN Problems with the Kerberos Protocol  
 ...
 To obtain an SPN for your service's account, you need to be an Active Directory domain administrator. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Kerberos Technical Supplement for Windows](http://go.microsoft.com/fwlink/?LinkID=88330).  
