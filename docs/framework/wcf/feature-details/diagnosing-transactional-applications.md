...
## Performance Counters  
 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] provides a standard set of performance counters for you to measure your transactional application's performance. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Performance Counters](../../../../docs/framework/wcf/diagnostics/performance-counters/index.md).  
...
-   Standard [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] tracing  
     ...
     This type of tracing is the same as tracing any [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] application. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Configuring Tracing](../../../../docs/framework/wcf/diagnostics/tracing/configuring-tracing.md).  
