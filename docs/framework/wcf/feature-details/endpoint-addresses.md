...
-   In configuration, custom [\<headers>](../../../../docs/framework/configure-apps/file-schema/wcf/headers.md) are specified as children of the [\<endpoint>](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/ms731320(v=vs.100)) element.  
...
-   In configuration, specify a custom listening address with the `ListenUri` attribute of the service [\<endpoint>](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/ms731320(v=vs.100)) element.  
