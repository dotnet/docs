...
- DISCO request (using the [DiscoveryClientProtocol](/dotnet/api/system.web.services.discovery.discoveryclientprotocol&view=netframework-4.8) from ASP.NET Web services) to the supplied address.  
