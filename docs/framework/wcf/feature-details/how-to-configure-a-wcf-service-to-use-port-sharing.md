---
description: "Learn more about: How to: Configure a Windows Communication Foundation Service to Use Port Sharing"
...
The easiest way to use net.tcp:// port sharing in your Windows Communication Foundation (WCF) application is to expose a service using the <xref:System.ServiceModel.NetTcpBinding>.
 ...
 This binding provides a <xref:System.ServiceModel.NetTcpBinding.PortSharingEnabled> property that controls whether net.tcp:// port sharing is enabled for the service being configured with this binding.
...
2. Create an instance of the <xref:System.ServiceModel.NetTcpBinding> class and set the <xref:System.ServiceModel.NetTcpBinding.PortSharingEnabled> property to `true`.
