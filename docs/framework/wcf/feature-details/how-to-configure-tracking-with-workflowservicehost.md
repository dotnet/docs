...
This topic explains how to configure tracking for a .NET Framework 4.6.1 workflow hosted in <xref:System.ServiceModel.Activities.WorkflowServiceHost>. It is configured through a Web.config file by specifying a service behavior.
