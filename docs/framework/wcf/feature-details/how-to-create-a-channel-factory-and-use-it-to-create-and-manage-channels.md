...
The <xref:System.ServiceModel.DuplexChannelFactory`1> class provides the means to create and manage duplex channels of different types that clients use to send and receive messages to and from service endpoints.
...
- <xref:System.ServiceModel.DuplexChannelFactory`1>
