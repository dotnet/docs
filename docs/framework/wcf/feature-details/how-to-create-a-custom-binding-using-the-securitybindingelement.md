...
|||TcpTransportBindingElement|TcpTransportBindingElement|TcpTransportBindingElement|  
 ...
 Note that there are many configurable settings on the SecurityBindingElements. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [SecurityBindingElement Authentication Modes](../../../../docs/framework/wcf/feature-details/securitybindingelement-authentication-modes.md).  
