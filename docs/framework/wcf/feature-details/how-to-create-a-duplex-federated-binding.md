...
2. Inside the [\<customBinding>](../../../../docs/framework/configure-apps/file-schema/wcf/custombinding.md) element, create a [\<binding>](/dotnet/framework/configure-apps/file-schema/wcf/bindings) element with the `name` attribute set to `FederationDuplexHttpMessageSecurityBinding`.

3. Inside the [\<binding>](/dotnet/framework/configure-apps/file-schema/wcf/bindings) element, create a [\<security>](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-custombinding.md) element with the `authenticationMode` attribute set to `SecureConversation`.
...
2. Inside the [\<customBinding>](../../../../docs/framework/configure-apps/file-schema/wcf/custombinding.md) element, create a [\<binding>](/dotnet/framework/configure-apps/file-schema/wcf/bindings) element with the `name` attribute set to `FederationDuplexTcpMessageSecurityBinding`.
...
2. Inside the [\<customBinding>](../../../../docs/framework/configure-apps/file-schema/wcf/custombinding.md) element, create a [\<binding>](/dotnet/framework/configure-apps/file-schema/wcf/bindings) element with the `name` attribute set to `FederationDuplexTcpTransportSecurityWithMessageCredentialBinding`.
