...
2. Modify the <xref:System.ServiceModel.ServiceContractAttribute?displayProperty=nameWithType> that declares the contract by setting the <xref:System.ServiceModel.ServiceContractAttribute.SessionMode?displayProperty=nameWithType> property to either:
...
- <xref:System.ServiceModel.ServiceContractAttribute.SessionMode*?displayProperty=nameWithType>
