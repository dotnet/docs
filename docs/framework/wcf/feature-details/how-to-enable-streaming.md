...
description: Learn how to enable streamed messages in WCF. By default, WCF uses buffered transfers, which must be completely received before they are processed.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
