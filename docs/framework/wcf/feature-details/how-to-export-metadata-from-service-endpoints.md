...
3. Set the <xref:System.ServiceModel.Description.MetadataExporter.PolicyVersion> property to one of the values from the <xref:System.ServiceModel.Description.PolicyVersion> enumeration. This sample sets the value to <xref:System.ServiceModel.Description.PolicyVersion.Policy15*> which corresponds to WS-Policy 1.5.
