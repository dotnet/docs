...
3.  Within the `Main()` method, add the following code:  
 ...
 You have completed implementing a discoverable service. Continue on to [How to: Implement a Client Application that Uses the Discovery Proxy to Find a Service](../../../../docs/framework/wcf/feature-details/how-to-implement-a-client-application-that-uses-the-discovery-proxy-to-find-a-service.md).  
