...
- [MSMQ Activation](/previous-versions/dotnet/framework/wcf/samples/msmq-activation)
- [NamedPipe Activation](/previous-versions/dotnet/framework/wcf/samples/namedpipe-activation)
