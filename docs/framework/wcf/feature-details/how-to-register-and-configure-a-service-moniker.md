...
3. Compile the managed WCF client as a strong-named assembly. This requires signing with a cryptographic key pair. For more information, see [Signing an Assembly with a Strong Name](/previous-versions/dotnet/netframework-1.1/xc31ft41(v=vs.71)) in the .NET Developer's Guide.  
