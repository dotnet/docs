...
3.  Compile the managed [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] client as a strong-named assembly. This requires signing with a cryptographic key pair. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Signing an Assembly with a Strong Name](http://go.microsoft.com/fwlink/?LinkId=94874) in the .NET Developer's Guide.  
