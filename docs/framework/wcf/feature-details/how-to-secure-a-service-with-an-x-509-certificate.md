...
1.  Create the service contract and the implemented service. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Designing and Implementing Services](../../../../docs/framework/wcf/designing-and-implementing-services.md).  
