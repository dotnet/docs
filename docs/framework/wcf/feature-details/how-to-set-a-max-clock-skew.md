...
2. Create a [\<binding>](/dotnet/framework/configure-apps/file-schema/wcf/bindings) element and set the `name` attribute to an appropriate value. The following example sets it to `MaxClockSkewBinding`.  
