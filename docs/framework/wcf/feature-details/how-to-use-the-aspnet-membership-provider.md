...
description: Learn how the ASP.NET membership provider supports websites that lets users create a user name and password for access without an account in a Windows domain.
ms.date: "03/30/2017"
helpviewer_keywords:
  - "WCF and ASP.NET"
  - "WCF, authorization"
