...
## See Also  
 [How to: Configure WCF Service to Interoperate with ASP.NET Web Service Clients](../../../../docs/framework/wcf/feature-details/how-to-configure-wcf-service-to-interoperate-with-asp-net-web-service-clients.md)