...
```
 ...
 With <xref:System.Runtime.Serialization.DataContractSerializer.PreserveObjectReferences*> set to `false` (the default), the following XML is generated:
...
```
 ...
 With <xref:System.Runtime.Serialization.DataContractSerializer.PreserveObjectReferences*> set to `true`, the following XML is generated:
