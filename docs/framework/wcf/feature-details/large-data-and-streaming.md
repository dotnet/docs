...
description: Learn about considerations for WCF XML-based communication, encoders, and streaming data. Text-based encoding poses challenges for the transfer of binary data.
ms.date: "03/30/2017"
