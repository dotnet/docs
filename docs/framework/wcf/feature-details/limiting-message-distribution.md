...
- For code snippets and related information, see the [Peer Channel blog](https://blogs.msdn.microsoft.com/peerchan/2006/10/04/the-peerhopcount-attribute-controlling-message-distribution/).
...
- For code snippets and related information, see the [Peer Channel blog](https://blogs.msdn.microsoft.com/peerchan/2006/08/25/peer-channel-and-messagepropagationfilter/).
