...
## Using Net.tcp Port Sharing in an Application  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] how to do this, see [How to: Configure a WCF Service to Use Port Sharing](../../../../docs/framework/wcf/feature-details/how-to-configure-a-windows-communication-foundation-service-to-use-port-sharing.md).  
...
## See Also  
 ...
 [How to: Configure a WCF Service to Use Port Sharing](../../../../docs/framework/wcf/feature-details/how-to-configure-a-windows-communication-foundation-service-to-use-port-sharing.md)   
