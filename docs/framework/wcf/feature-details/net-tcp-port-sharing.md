...
description: Learn about a TCP-based protocol for high-performance communication and the service that enables ports to be shared across multiple user processes in WFC.
ms.date: "03/30/2017"
helpviewer_keywords: 
  - "port activation [WCF]"
  - "port sharing [WCF]"
