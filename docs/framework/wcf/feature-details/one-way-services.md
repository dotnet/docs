---
title: "One-Way Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   When using the <xref:System.ServiceModel.NetMsmqBinding> or the <xref:System.ServiceModel.MsmqIntegration.MsmqIntegrationBinding> class. ([!INCLUDE[crabout](../../../../includes/crabout-md.md)] this scenario, see [Queues in WCF](../../../../docs/framework/wcf/feature-details/queues-in-windows-communication-foundation.md).)  
