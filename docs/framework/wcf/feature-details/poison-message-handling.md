...
## Best Practice: Handling MsmqPoisonMessageException  
 ...
 A receiving application can implement the <xref:System.ServiceModel.Dispatcher.IErrorHandler> interface to handle any errors that the application requires. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Extending Control Over Error Handling and Reporting](../../../../docs/framework/wcf/samples/extending-control-over-error-handling-and-reporting.md).  
