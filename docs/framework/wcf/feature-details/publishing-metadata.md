...
description: Learn how WCF services publish metadata by publishing one or more metadata endpoints, which makes the metadata available using standard protocols.
ms.date: "03/30/2017"
helpviewer_keywords: 
