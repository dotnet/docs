...
-   [Queues in WCF](../../../../docs/framework/wcf/feature-details/queues-in-windows-communication-foundation.md), which offer both reliable transfers and separation between the source and the destination.  
