...
### Windows  
 ...
 The Kerberos protocol is used by default when choosing message credential. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Exploring Kerberos, the Protocol for Distributed Security in Windows 2000](http://go.microsoft.com/fwlink/?LinkId=87790).  
