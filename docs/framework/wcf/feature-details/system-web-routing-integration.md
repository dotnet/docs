...
```  
 ...
 This loads a module and handler required for routing. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [Routing](../../../../docs/framework/wcf/feature-details/routing.md). You must also set the `aspNetCompatibilityEnabled` attribute to `true` in the `<serviceHostingEnvironment>` element as shown in the following example.  
