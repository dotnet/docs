...
description: Review this WCF scenario, which uses transport security to authenticate a server by using a certificate that the clients trust. The client is not authenticated.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
