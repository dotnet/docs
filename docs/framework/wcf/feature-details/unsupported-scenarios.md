 ...
 *Cryptography API: Next Generation (CNG)* is the long-term replacement for the CryptoAPI. This API is available in unmanaged code on Windows Vista,  [!INCLUDE[lserver](../../../../includes/lserver-md.md)] and later Windows versions.  
