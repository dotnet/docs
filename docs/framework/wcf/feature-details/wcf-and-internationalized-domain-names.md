...
## System.Uri and IDN
 ...
 <xref:System.Uri> has two properties <xref:System.Uri.Host*> and <xref:System.Uri.DnsSafeHost*>. These properties contain Unicode or Punycode values depending upon the IDN configuration settings.
