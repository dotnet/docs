...
> [!WARNING]
>  Installing the WebDAV extension for IIS can cause Web HTTP services to return an HTTP 405 error as the WebDAV extension attempts to handle all PUT requests. To work around this issue you can uninstall the WebDAV extension or disable the WebDAV extension for your web site. [!INCLUDE[crdefault](../../../../includes/crabout-md.md)] [IIS and WebDav](http://learn.iis.net/page.aspx/357/webdav-for-iis-70/)  
