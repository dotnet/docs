...
When hosting a Windows Communication Foundation (WCF) service written with [!INCLUDE[netfx35_long](../../../includes/netfx35-long-md.md)] on a machine running .NET Framework version 4, you may get a <xref:System.ServiceModel.ProtocolException> with the following text.  
