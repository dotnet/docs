...
description: Learn the hosting options for a WCF service. A service must be hosted in a run-time environment that creates it and controls its context and lifetime.
ms.date: "03/30/2017"
helpviewer_keywords:
