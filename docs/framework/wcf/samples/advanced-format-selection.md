...
1.  Open the solution for the Advanced Format Selection Sample. When launching Visual Studio 2012, you should run as an administrator for the sample to execute successfully. Do this by right-clicking the Visual Studio 2012 icon and choosing **Run as Administrator** from the context menu.
