...
> [!IMPORTANT]
>  If you are running this sample in [!INCLUDE[windowsver](../../../../includes/windowsver-md.md)] or [!INCLUDE[win7_client_firstref](../../../../includes/win7-client-firstref-md.md)], ensure that you are running Visual Studio 2012 with elevated privileges.
...
1.  Open the ByteStreamHttpBinding.sln file in Visual Studio 2012.
