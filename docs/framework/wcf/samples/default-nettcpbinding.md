...
>  `<InstallDrive>:\WF_WCF_Samples\WCF\Basic\Binding\Net\TCP\Default`  
 ...
 The binding is specified in the configuration files for the client and service. The binding type is specified in the `binding` attribute of the [\<endpoint>](https://msdn.microsoft.com/library/ms731304(v=vs.90).aspx) element as shown in the following sample configuration.  
