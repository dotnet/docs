...
1.  Open the solution for the Form Post Sample. When launching Visual Studio 2012, you must run as an administrator to execute the sample successfully. Do this by right-clicking the Visual Studio 2012 icon and choosing "Run as Administrator" from the context menu.
