...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["service behaviors, impersonation sample", "Impersonating the Client Sample [Windows Communication Foundation]", "impersonation, Windows Communication Foundation sample"]
