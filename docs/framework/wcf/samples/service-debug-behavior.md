...
```  
 ...
 [\<serviceDebug>](../../../../docs/framework/configuring-apps/file-schema/wcf/servicedebug.md) is the configuration element that allows changing the service debug behavior properties. The user can modify this behavior to achieve the following:  
