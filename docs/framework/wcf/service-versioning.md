...
- Specify a <xref:System.Runtime.Serialization.DataContractAttribute.Name*> and <xref:System.Runtime.Serialization.DataContractAttribute.Namespace*>. You should always specify the name and namespace of your data contract to prevent your .NET type's name and namespace from being exposed in the contract. This way, if you decide later to change the .NET namespace or type name, your data contract remains the same.

- Specify <xref:System.Runtime.Serialization.DataMemberAttribute.Name*>. You should always specify the name of your data members to prevent your .NET member name from being exposed in the contract. This way, if you decide later to change the .NET name of the member, your data contract remains the same.
