...
-   The <xref:System.ServiceModel.NetMsmqBinding?displayProperty=fullName> binding provides MSMQ datagram sessions. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)][Queues in WCF](../../../docs/framework/wcf/feature-details/queues-in-windows-communication-foundation.md).  
