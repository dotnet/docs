...
|receiveTimeout|SMSvcHost.exe|30 seconds|[Configuring the Net.TCP Port Sharing Service](https://docs.microsoft.com/dotnet/framework/wcf/feature-details/configuring-the-net-tcp-port-sharing-service)|  
