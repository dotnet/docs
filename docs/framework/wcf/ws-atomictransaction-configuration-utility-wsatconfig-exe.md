...
## Remarks  
 ...
 If you are running [!INCLUDE[wxp](../../../includes/wxp-md.md)] or [!INCLUDE[ws2003](../../../includes/ws2003-md.md)], you must download an update before running WsatConfig.exe. For more information about this update, see [Update for Commerce Server 2007 (KB912817)](https://www.microsoft.com/downloads/details.aspx?displaylang=en&FamilyID=b08bc139-f61a-423d-8f02-3e5d2fad725d) and [Availability of Windows XP COM+ Hotfix Rollup Package 13](https://support.microsoft.com/help/912817).  
