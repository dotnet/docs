...
**Workflow completed successfully with status: Canceled.**  [!INCLUDE[crabout](../../../includes/crabout-md.md)] cancellation, see [Cancellation](../../../docs/framework/wf/modeling-cancellation-behavior-in-workflows.md).  
...
## See Also  
 ...
 [Compensable Activity](../../../docs/framework/wf/samples/compensable-activity-sample.md)