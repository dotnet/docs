...
## In This Section  
 [Required Arguments and Overload Groups](../../../docs/framework/wf/required-arguments-and-overload-groups.md)  
 Describes how to use the `RequiredArgument` and `OverloadGroup` attributes to provide validation.  
  
 [Imperative Code-Based Validation](../../../docs/framework/wf/imperative-code-based-validation.md)  
 ...
 [Declarative Constraints](../../../docs/framework/wf/declarative-constraints.md)  
 Describes how to use declarative constraints to provide complex activity validation.  
  
 [Invoking Activity Validation](../../../docs/framework/wf/invoking-activity-validation.md)  
