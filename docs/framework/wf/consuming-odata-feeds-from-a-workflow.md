...
### Adding a Service Reference to the WCF Data Service  
 ...
 ![Add Service Reference](../../../docs/framework/wf/media/addservicereferencetonorthwindodataservice.gif "AddServiceReferencetoNorthwindODataService")  
...
> [!NOTE]
>  [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Asynchronous Operations (WCF Data Services)](http://go.microsoft.com/fwlink/?LinkId=193396) and [Creating Asynchronous Activities](../../../docs/framework/wf/creating-asynchronous-activities-in-wf.md).  
