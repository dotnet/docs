...
-   Samples for these activities can be found in the following sections:  
    ...
    -   Basic: [Services](../../../docs/framework/wf/samples/services.md)  
  
    -   Scenarios: [Services](../../../docs/framework/wf/samples/services.md)  
...
-   Samples for the <xref:System.ServiceModel.WorkflowServiceHost> can be found in the following sections:  
    ...
    -   Application: [Suspended Instance Management](../../../docs/framework/wf/samples/suspended-instance-management.md)  
...
-   Designer Documentation:  
    ...
    -   [Flowchart Activity Designers](../Topic/Flowchart%20Activity%20Designers.md)  
...
-   Designer Documentation:  
    ...
    -   [Parallel Activity Designer](../Topic/Parallel%20Activity%20Designer.md)  
  
    -   [ParallelForEach\<T> Activity Designer](../Topic/ParallelForEach%3CT%3E%20Activity%20Designer.md)  
...
-   Designer Documentation: [InvokeMethod Activity Designer](../Topic/InvokeMethod%20Activity%20Designer.md)  
...
-   Samples:  
    ...
    1.  [Fault Handling in a Flowchart Activity Using TryCatch](../../../docs/framework/wf/samples/fault-handling-in-a-flowchart-activity-using-trycatch.md)  
  
    2.  [Using Procedural Activities](../../../docs/framework/wf/samples/using-procedural-activities.md)  
  
-   Designer Documentation: [Error Handling Activity Designers](../Topic/Error%20Handling%20Activity%20Designers.md)  
...
-   Sample: [Using the Pick Activity](../../../docs/framework/wf/samples/using-the-pick-activity.md)  
  
-   Designer documentation: [Pick Activity Designer](../Topic/Pick%20Activity%20Designer.md)  
...
3.  Samples: [Tracking](../../../docs/framework/wf/samples/tracking.md)  
  
4.  Conceptual documentation: [Workflow Tracking and Tracing](../../../docs/framework/wf/workflow-tracking-and-tracing.md)  
...
2.  Samples: [Persistence](../../../docs/framework/wf/samples/persistence.md)  
  
3.  Conceptual documentation: [SQL Workflow Instance Store](../../../docs/framework/wf/sql-workflow-instance-store.md).