---
title: "How to: Create a Custom Instance Store | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## A sample instance store  
 The following code sample is a complete instance store implementation, taken from the [Corporate Purchase Process](../../../docs/framework/wf/samples/corporate-purchase-process.md) sample. This instance store persists workflow data to a file using XML.  
