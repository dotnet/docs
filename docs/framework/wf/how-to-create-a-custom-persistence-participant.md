---
title: "How to: Create a Custom Persistence Participant | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
The following procedure has steps to create a persistence participant. See the [Participating in Persistence](http://go.microsoft.com/fwlink/?LinkID=177735) sample and [Store Extensibility](../../../docs/framework/wf/store-extensibility.md) topic for sample implementations of persistence participants.  
