...
20. Press CTRL+SHIFT+B to build the solution.  
     ...
     For instructions on how to create a workflow by using these activities, see the next step in the tutorial, [How to: Create a Workflow](../../../docs/framework/wf/how-to-create-a-workflow.md).  
...
## See Also  
 ...
 [How to: Create a Workflow](../../../docs/framework/wf/how-to-create-a-workflow.md)   
