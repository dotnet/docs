...
-   [To create the persistence database](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_CreatePersistenceDatabase)  
  
-   [To add the reference to the DurableInstancing assemblies](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_AddReference)  
  
-   [To create the workflow host form](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_CreateForm)  
  
-   [To add the properties and helper methods of the form](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_AddHelperMethods)  
  
-   [To configure the instance store, workflow lifecycle handlers, and extensions](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_ConfigureWorkflowApplication)  
  
-   [To enable starting and resuming multiple workflow types](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_WorkflowVersionMap)  
  
-   [To start a new workflow](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_StartWorkflow)  
  
-   [To resume a workflow](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_ResumeWorkflow)  
  
-   [To terminate a workflow](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_TerminateWorkflow)  
  
-   [To build and run the application](../../../docs/framework/wf/how-to-create-and-run-a-long-running-workflow.md#BKMK_BuildAndRun)  
...
5.  Set the **AcceptButton** property of the form to **EnterGuess**.  
 ...
 ![WF45 Getting Started Tutorial Workflow Host Form](../../../docs/framework/wf/media/wf45gettingstartedtutorialworkflowhostform.png "WF45GettingStartedTutorialWorkflowHostForm")  
...
3.  Remove or comment out the existing workflow hosting code from [How to: Run a Workflow](../../../docs/framework/wf/how-to-run-a-workflow.md), and replace it with the following code.  
