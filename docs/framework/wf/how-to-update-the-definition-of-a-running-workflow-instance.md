...
Dynamic update provides a mechanism for workflow application developers to update the workflow definition of a persisted workflow instance. The required change can be to implement a bug fix, new requirements, or to accommodate unexpected changes. This step in the tutorial demonstrates how to use dynamic update to modify  persisted instances of the `v1` number guessing workflow to match the new functionality introduced in [How to: Host Multiple Versions of a Workflow Side-by-Side](../../../docs/framework/wf/how-to-host-multiple-versions-of-a-workflow-side-by-side.md).  
...
-   [To create the CreateUpdateMaps project](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_CreateProject)  
  
-   [To update StateMachineNumberGuessWorkflow](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_StateMachine)  
  
-   [To update FlowchartNumberGuessWorkflow](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_Flowchart)  
  
-   [To update SequentialNumberGuessWorkflow](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_Sequential)  
  
-   [To build and run the CreateUpdateMaps application](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_CreateUpdateMaps)  
  
-   [To build the updated workflow assembly](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_BuildAssembly)  
  
-   [To update WorkflowVersionMap with the new versions](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_UpdateWorkflowVersionMap)  
  
-   [To apply the dynamic updates](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_ApplyUpdate)  
  
-   [To run the application with the updated workflows](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_BuildAndRun)  
  
-   [To enable starting previous versions of the workflows](../../../docs/framework/wf/how-to-update-the-definition-of-a-running-workflow-instance.md#BKMK_StartPreviousVersions)  
...
3.  Next, update the expressions of the two `WriteLine` activities that display whether the user's guess is too high or too low so that they match the updates made in [How to: Host Multiple Versions of a Workflow Side-by-Side](../../../docs/framework/wf/how-to-host-multiple-versions-of-a-workflow-side-by-side.md).  
...
3.  Navigate to the **NumberGuessWorkflowActivities_du** folder you created in [How to: Host Multiple Versions of a Workflow Side-by-Side](../../../docs/framework/wf/how-to-host-multiple-versions-of-a-workflow-side-by-side.md), select **NumberGuessWorkflowActivities.csproj** (or **vbproj**), and click **Open**.  
...
6.  Navigate to the **NumberGuessWorkflowActivities_du** folder you created in [How to: Host Multiple Versions of a Workflow Side-by-Side](../../../docs/framework/wf/how-to-host-multiple-versions-of-a-workflow-side-by-side.md).  
...
12. Rename **NumberGuessWorkflowActivities.dll** to **NumberGuessWorkflowActivities_v15.dll**, and copy it to the **PreviousVersions** folder you created in [How to: Host Multiple Versions of a Workflow Side-by-Side](../../../docs/framework/wf/how-to-host-multiple-versions-of-a-workflow-side-by-side.md).  
...
4.  Select one of the `v1` workflows you started at the beginning of the [How to: Host Multiple Versions of a Workflow Side-by-Side](../../../docs/framework/wf/how-to-host-multiple-versions-of-a-workflow-side-by-side.md) topic. Note that the version information under the status window indicates that the workflow is a version **1.5.0.0** workflow. Note that there is no information indicated about previous guesses other than whether they were too high or too low.  
