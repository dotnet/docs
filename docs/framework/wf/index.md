...
## In This Section  
 [Guide to the Windows Workflow Documentation](../../../docs/framework/wf/guide-to-the-documentation.md)  
 ...
 [What's New in Windows Workflow Foundation in .NET 4.5](../../../docs/framework/wf/whats-new-in-wf-in-dotnet.md)  
 ...
 [Windows Workflow Foundation Glossary for .NET Framework 4.5](../../../docs/framework/wf/glossary.md)  
 Defines a list of terms that are specific to WF.  
  
 [Windows Workflow Samples](../../../docs/framework/wf/samples/index.md)  
