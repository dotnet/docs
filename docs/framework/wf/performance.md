...
### Environment Setup  
 ![Workflow Performance Test Environment](../../../docs/framework/wf/media/wfperfenvironment.gif "WFPerfEnvironment")  
...
### Replicator compared to ParallelForEach  
 ...
 ![WF3 ReplicatorActivity and WF4 ParallelForEach](../../../docs/framework/wf/media/replicatorandparallelforeach.gif "ReplicatorAndParallelForEach")  
...
```  
 ...
 ![WF3 and WF basic compensation workflows](../../../docs/framework/wf/media/basiccompensationworkflows.gif "BasicCompensationWorkflows")  
  
 Figure 2 – WF3 (left) and WF4 (right) basic compensation workflows  
  
### Performance Test Results  
 ![Performance Test Results](../../../docs/framework/wf/media/performancedata.gif "PerformanceData")  
  
 ![Performance Test Data Graph](../../../docs/framework/wf/media/performancetestchart.gif "PerformanceTestChart")  
...
### Performance  
 ![Online Store Service Performance Graph](../../../docs/framework/wf/media/onlinestoreperfgraph.gif "OnlineStorePerfGraph")  
...
##### Environment Setup  
 ![Environment setup for latency and throughput tests](../../../docs/framework/wf/media/latencyandthroughputenvironment.gif "LatencyAndThroughputEnvironment")  
...
##### Test Setup  
 ...
 ![WF 4 Correlation Scope](../../../docs/framework/wf/media/correlationscopeworkflow.gif "CorrelationScopeWorkflow")  
...
##### Test Results  
 ![Latency Results](../../../docs/framework/wf/media/latencyresultsgraph.gif "LatencyResultsGraph")  
...
#### Test Setup  
 ![Correlation Throughput Workflow Test](../../../docs/framework/wf/media/correlationthroughputworkflow.gif "CorrelationThroughputWorkflow")  
...
#### Test Results  
 ![Correlation Throughput](../../../docs/framework/wf/media/correlationthroughputgraph.gif "CorrelationThroughputGraph")  
...
#### Correlation with Persistence  
 ...
 ![Correlation and persistence results](../../../docs/framework/wf/media/correlationandpersistencegraph.gif "CorrelationAndPersistenceGraph")  
...
### Test Setup  
 ...
 ![Equation to compute number of activities](../../../docs/framework/wf/media/numberofactivitiesequation.gif "NumberOfActivitiesEquation")  
  
 The WF3 test’s activity count can be computed with a slightly different equation due to an extra sequence:  
  
 ![Equation to compute number of activities](../../../docs/framework/wf/media/w3numberofactivitiesequation.gif "W3NumberOfActivitiesEquation")  
 ...
 ![Compares number of activities used in each test](../../../docs/framework/wf/media/comparechart.gif "CompareChart")  
 ...
 ![Complex Workflow](../../../docs/framework/wf/media/complexworkflowthroughputworkflow.gif "ComplexWorkflowThroughputWorkflow")  
 ...
 ![WF3 Workflow](../../../docs/framework/wf/media/wf3workflow.gif "WF3Workflow")  
 ...
 ![Nested sequences](../../../docs/framework/wf/media/nestedsequencewf.gif "NestedSequenceWF")  
  
 Tracking and persistence are not used as part of this test.  
  
### Test Results  
 ![Throughput Graph](../../../docs/framework/wf/media/testresults1.gif "TestResults1")  
...
### Workflow Complexity Test  
 ...
 ![Complex Workflows](../../../docs/framework/wf/media/complexworkflowboth.gif "ComplexWorkflowBoth")  
 ...
 ![Memory Usage Graph](../../../docs/framework/wf/media/complexmemoryusage.gif "ComplexMemoryUsage")  
...
### Multiple Workflow Definitions Test  
 ...
 ![Workflow Services in WF3 and WF4](../../../docs/framework/wf/media/receiveworkflowboth.gif "ReceiveWorkflowBoth")  
...
### Test Setup  
 ...
 ![Persistence Workflows](../../../docs/framework/wf/media/persistworkflow.gif "PersistWorkflow")  
...
### Test Results  
 ![Throughput Persistence](../../../docs/framework/wf/media/throughputpersistence.gif "ThroughputPersistence")  
...
### Test Results  
 ![Workflow Tracing Cost](../../../docs/framework/wf/media/workflowtracingcost.gif "WorkflowTracingCost")  
