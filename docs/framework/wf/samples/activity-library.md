...
## In This Section  
 [Policy Activity in .NET Framework 4.5](../../../../docs/framework/wf/samples/policy-activity-in-net-framework-4-5.md)  
 ...
 [Custom Activity to Switch on a Range of Values](../../../../docs/framework/wf/samples/custom-activity-to-switch-on-a-range-of-values.md)  
 Demonstrates how to create a custom activity that extends the use of a <xref:System.Activities.Statements.Switch%601>.  
  
 [LINQ to Objects Activity](../../../../docs/framework/wf/samples/linq-to-objects-activity.md)  
 Demonstrates how to create an activity to use LINQ to Objects to query elements in a collection.  
  
 [LINQ to SQL Sample](../../../../docs/framework/wf/samples/linq-to-sql-sample.md)  
 Demonstrates how to create an activity to use LINQ to SQL query entities from tables in SQL Server databases.  
  
 [Using the InvokePowerShell Activity](../../../../docs/framework/wf/samples/using-the-invokepowershell-activity.md)  
 Demonstrates how to invoke Windows PowerShell commands using the InvokePowerShell activity.  
  
 [RangeEnumeration Activity](../../../../docs/framework/wf/samples/rangeenumeration-activity.md)  
 Demonstrates how to create a custom activity that iterates over a collection of numbers.  
  
 [Regular Expression Activities](../../../../docs/framework/wf/samples/regular-expression-activities.md)  
 ...
 [SendMail Custom Activity](../../../../docs/framework/wf/samples/sendmail-custom-activity.md)  
 ...
 [For Activity](../../../../docs/framework/wf/samples/for-activity.md)  
 ...
 [Wait For Input Activity](../../../../docs/framework/wf/samples/wait-for-input-activity.md)  
 Demonstrates how to create named bookmarks in a workflow.  
  
 [Throttled Parallel ForEach](../../../../docs/framework/wf/samples/throttled-parallel-foreach.md)  
 ...
 [Entity Activities](../../../../docs/framework/wf/samples/entity-activities.md)  
 Demonstrates how to use the ADO.NET Entity Framework with [!INCLUDE[wf2](../../../../includes/wf2-md.md)] to simplify data access.  
  
 [Database Access Activities](../../../../docs/framework/wf/samples/database-access-activities.md)  
 ...
 [CommentOut Activity](../../../../docs/framework/wf/samples/commentout-activity.md)  
 ...
 [Externalized Policy Activity in .NET Framework 4.5](../../../../docs/framework/wf/samples/externalized-policy-activity-in-net-framework-4-5.md)  
