...
## In This Section  
 [Custom Composite Designers - Workflow Item Presenter](../../../../docs/framework/wf/samples/custom-composite-designers-workflow-item-presenter.md)  
 This sample shows how to build an activity designer that surfaces such a “drop zone.”  
  
 [Custom Composite Designers - Workflow Items Presenter](../../../../docs/framework/wf/samples/custom-composite-designers-workflow-items-presenter.md)  
 This sample shows how to build an activity designer that surfaces such an editable collection.  
  
 [Metadata Store Programmability](../../../../docs/framework/wf/samples/metadata-store-programmability.md)  
 ...
 [Using the ExpressionTextBox in a Custom Activity Designer](../../../../docs/framework/wf/samples/using-the-expressiontextbox-in-a-custom-activity-designer.md)  
 ...
 [Using Editing Scope](../../../../docs/framework/wf/samples/using-editing-scope.md)  
