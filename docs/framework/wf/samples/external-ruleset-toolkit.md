...
-   An `ExternalPolicy` activity that requests a RuleSet from the RuleSet service and runs the RuleSet against the workflow.  
 ...
 ![External RuleSet Sample Conceptual Overview](../../../../docs/framework/wf/samples/media/rulesettoolkitsampleoverview.gif "RuleSetToolkitSampleOverview")  
...
## RuleSet Tool  
 ...
 ![External RuleSet Toolket Sample output](../../../../docs/framework/wf/samples/media/rulesetbrowser.gif "RuleSetBrowser")  
 ...
 ![External RuleSet Toolkit Sample Output](../../../../docs/framework/wf/samples/media/ruleseteditor.gif "RuleSetEditor")  
 ...
 ![Workflow &#47;Type Selection](../../../../docs/framework/wf/samples/media/71f08d57-e8f2-499e-8151-ece2cbdcabfd.gif "71f08d57-e8f2-499e-8151-ece2cbdcabfd")  
 ...
 ![Validation Errors from External RuleSet Sample](../../../../docs/framework/wf/samples/media/validationerrorsruleset.png "ValidationErrorsRuleSet")  
 ...
 ![Ruleset selector](../../../../docs/framework/wf/samples/media/rulesetselector.gif "RuleSetSelector")  
