---
title: "Rules Samples | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## In This Section  
 [Advanced Policy](../../../../docs/framework/wf/samples/advanced-policy.md)  
 ...
 [IfElse With Rules](../../../../docs/framework/wf/samples/ifelse-with-rules.md)  
 Demonstrates the use of a rule condition with an <xref:System.Workflow.Activities.IfElseActivity> activity.  
  
 [Conditioned Activity Group](../../../../docs/framework/wf/samples/conditioned-activity-group.md)  
 Demonstrates a travel booking application.  
  
 [Order Processing with Policy](../../../../docs/framework/wf/samples/order-processing-with-policy.md)  
