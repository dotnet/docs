...
## In This Section  
 [Activity Library](../../../../docs/framework/wf/samples/activity-library.md)  
 ...
 [Auto-Confirm Pattern](../../../../docs/framework/wf/samples/auto-confirm-pattern.md)  
 Consists of three scenarios that run illustrating a custom `AutoConfirmScope` activity.  
  
 [StateMachine Scenario Using a Combination of FlowChart and Pick](../../../../docs/framework/wf/samples/statemachine-scenario-using-a-combination-of-flowchart-and-pick.md)  
 ...
 [WPF and WF Integration in XAML](../../../../docs/framework/wf/samples/wpf-and-wf-integration-in-xaml.md)  
 ...
 [External Ruleset Toolkit](../../../../docs/framework/wf/samples/external-ruleset-toolkit.md)  
