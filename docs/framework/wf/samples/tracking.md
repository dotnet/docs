...
## In This Section  
 [Custom Tracking](../../../../docs/framework/wf/samples/custom-tracking.md)  
 ...
 [Extract WF Data using Tracking](../../../../docs/framework/wf/samples/extract-wf-data-using-tracking.md)  
 Demonstrates how to use workflow tracking to extract workflow variables and arguments from activities.  
  
 [Tracking Using a Text File](../../../../docs/framework/wf/samples/tracking-using-a-text-file.md)  
