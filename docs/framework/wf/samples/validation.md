...
## In This Section  
 [External Activity Validation](../../../../docs/framework/wf/samples/external-activity-validation.md)  
 This sample shows how to add validation logic to a built-in activity that you are not the author of.  
  
 [Basic Validation](../../../../docs/framework/wf/samples/basic-validation.md)  
 ...
 [OverloadGroups](../../../../docs/framework/wf/samples/overloadgroups.md)  
 ...
 [Activity Relationships Validation](../../../../docs/framework/wf/samples/activity-relationships-validation.md)  
