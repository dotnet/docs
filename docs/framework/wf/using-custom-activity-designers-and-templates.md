...
## In This Section  
 [How to: Create a Custom Activity Designer](../../../docs/framework/wf/how-to-create-a-custom-activity-designer.md)  
 ...
 [How to: Create a Custom Activity Template](../../../docs/framework/wf/how-to-create-a-custom-activity-template.md)  
 ...
 [Using the ModelItem Editing Context](../../../docs/framework/wf/using-the-modelitem-editing-context.md)  
 Describes how to use the features of the ModelItem editing context to allow the designer to interact with the host.  
  
 [Binding a custom activity property to a designer control](../../../docs/framework/wf/binding-a-custom-activity-property-to-a-designer-control.md)  
