---
title: "What&#39;s New in Windows Workflow Foundation | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Easier Ability to Extend WF Designer Experience  
 The new WF Designer is built on [!INCLUDE[avalon1](../../../includes/avalon1-md.md)] and provides an easier model to use when rehosting the WF Designer outside of Visual Studio and also provides easier mechanisms for creating custom activity designers. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)][Customizing the Workflow Design Experience](../../../docs/framework/wf/customizing-the-workflow-design-experience.md).