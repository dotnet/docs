...
- **Networking**
  ...
  - **Socket reuse**
    ...
    In .NET Framework 4.6, two new APIs have been added to enable port reuse, which effectively removes the 64-K limit on concurrent connections:
