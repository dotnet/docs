...
|Type|Message|  
|----------|-------------| 
|System.Activities.Statements.Interop](assetId:///T:System.Activities.Statements.Interop)|First deprecated in the .NET Framework 4.5.<br /><br />The Workflow Foundation 3.0 types are deprecated. Instead, use the Workflow 4.0 types from <xref:System.Activities>.\*.|  
...
|Type|Message|  
|----------|-------------|  
|<xref:Microsoft.Build.BuildEngine.Engine?displayProperty=fullName>|This class has been deprecated. Please use <xref:Microsoft.Build.Evaluation.ProjectCollection?displayProperty=fullName> from the [Microsoft.Build](https://docs.microsoft.com/visualstudio/msbuild/msbuild-reference) assembly instead.|  
|<xref:Microsoft.Build.BuildEngine.Project?displayProperty=fullName>|This class has been deprecated. Please use <xref:Microsoft.Build.Evaluation.ProjectCollection?displayProperty=fullName> from the [Microsoft.Build](https://docs.microsoft.com/visualstudio/msbuild/msbuild-reference) assembly instead.|  
