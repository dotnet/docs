...
|Type|Message|  
|----------|-------------|  
|<xref:Microsoft.Build.BuildEngine.Engine?displayProperty=fullName>|This class has been deprecated. Please use <xref:Microsoft.Build.Evaluation.ProjectCollection?displayProperty=fullName> from the [Microsoft.Build](/visualstudio/msbuild/msbuild-reference) assembly instead.|  
|<xref:Microsoft.Build.BuildEngine.Project?displayProperty=fullName>|This class has been deprecated. Please use <xref:Microsoft.Build.Evaluation.ProjectCollection?displayProperty=fullName> from the [Microsoft.Build](/visualstudio/msbuild/msbuild-reference) assembly instead.|  
