...
description: See what's new in .NET accessibility, starting with .NET 4.7.1. Accessibility features let an app provide the right experience for Assistive Technology users.
