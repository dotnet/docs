...
[Create Projects from Templates](https://docs.microsoft.com/previous-versions/0fyc0azh(v=vs.140)) -  Describes the projects types used in this chapter and how to choose between them.
