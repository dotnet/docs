...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["debugging Windows Service applications", "debugging [Visual Studio], Windows services", "troubleshooting service applications", "services, troubleshooting", "troubleshooting debugging, Windows Services", "Windows Service applications, debugging", "services, debugging", "Windows Service applications, troubleshooting"]
