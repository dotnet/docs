...
description: DynamicActivity is a concrete, sealed class with a public constructor. Use the class to assemble activity functionality at runtime using an activity DOM.
ms.date: "03/30/2017"
...
## DynamicActivity Features
 ...
 <xref:System.Activities.DynamicActivity> has access to execution properties, arguments and variables, but no access to runtime services such as scheduling child activities or tracking.
