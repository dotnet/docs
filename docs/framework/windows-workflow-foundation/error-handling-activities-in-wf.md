...
[!INCLUDE[netfx_current_long](../../../includes/netfx-current-long-md.md)] provides several system-provided activities for implementing error handling and recovery. [!INCLUDE[crdefault](../../../includes/crabout-md.md)] [Exceptions](../../../docs/framework/windows-workflow-foundation/exceptions.md).  
