...
- [Configuration Channel Factory](/dotnet/api/system.servicemodel.configuration.configurationchannelfactory-1&view=netframework-4.8)

- [Standard Endpoint Element](/dotnet/api/system.servicemodel.configuration.standardendpointelement&view=netframework-4.8)
...
- [Data Contract Resolver API documentation](/dotnet/api/system.runtime.serialization.datacontractresolver&view=netframework-4.8)
