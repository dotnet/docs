...
description: This article creates a workflow that uses both built-in activities, such as the Sequence activity, and custom activities from a previous article.
ms.date: "03/30/2017"
dev_langs:
  - "csharp"
  - "vb"
