...
> [!NOTE]
> To download a completed version of the tutorial, see [Windows Workflow Foundation (WF45) - Getting Started Tutorial](https://code.msdn.microsoft.com/Windows-Workflow-deed2cd5).  
