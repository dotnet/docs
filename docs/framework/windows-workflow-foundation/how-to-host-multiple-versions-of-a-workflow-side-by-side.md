...
> [!NOTE]
> Each step in the Getting Started tutorial depends on the previous steps. If you did not complete the previous steps you can download a completed version of the tutorial from [Windows Workflow Foundation (WF45) - Getting Started Tutorial](https://code.msdn.microsoft.com/Windows-Workflow-deed2cd5).
