...
description: This article shows you how to create a workflow host and run the workflow defined in a previous article in this Windows Workflow Foundation tutorial.
ms.date: "03/30/2017"
dev_langs:
  - "csharp"
  - "vb"
