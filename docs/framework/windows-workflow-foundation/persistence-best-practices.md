...
### Scenario: Workflow Uses Delay Activities with Short Durations  
 ...
 Set <xref:System.ServiceModel.Activities.Description.WorkflowIdleBehavior.TimeToUnload%2A> to longer than or equal to <xref:System.Activities.DurableInstancing.SqlWorkflowInstanceStore.RunnableInstancesDetectionPeriod> to keep the instance in memory for at least one polling interval.  
