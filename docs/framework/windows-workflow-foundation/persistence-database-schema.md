...
|IsCompleted|Bit|Indicates whether the Workflow Instance has finished executing. **Note:**  If the **InstanceCompletionAction** property is set to **DeleteAll**, the instances are removed from the view upon completion.|  
