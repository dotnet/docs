...
The [AccessingOperationContext sample](https://github.com/dotnet/samples/tree/main/framework/windows-workflow-foundation/scenario/Services/AccessingOperationContext/CS) demonstrates how the messaging activities (<xref:System.ServiceModel.Activities.Receive> and <xref:System.ServiceModel.Activities.Send>) can be used with a custom scope activity to access <xref:System.ServiceModel.OperationContext.Current*> and attach or retrieve a custom message header within an outgoing or incoming message.
