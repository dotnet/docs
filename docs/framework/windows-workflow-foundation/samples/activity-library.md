...
## In This Section
 ...
 [SendMail Custom Activity](../samples/sendmail-custom-activity.md)  
 ...
 [Throttled Parallel ForEach](../samples/throttled-parallel-foreach.md)  
 ...
 [Database Access Activities](../samples/database-access-activities.md)  
 ...
 [Externalized Policy Activity in .NET Framework 4.5](../samples/externalized-policy-activity-in-net-framework-4-5.md)  
