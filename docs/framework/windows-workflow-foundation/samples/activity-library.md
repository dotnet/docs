...
## In This Section
 ...
 Demonstrates how to create activities that allow accessing databases to retrieve or modify information and use [ADO.NET](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/e80y5yhx(v=vs.100)) to access the database.  
