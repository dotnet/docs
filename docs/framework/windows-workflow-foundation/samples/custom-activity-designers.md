...
## In This Section  
 [Custom Composite Designers - Workflow Item Presenter](../samples/custom-composite-designers-workflow-item-presenter.md)  
 This sample shows how to build an activity designer that surfaces such a "drop zone."  
  
 [Custom Composite Designers - Workflow Items Presenter](../samples/custom-composite-designers-workflow-items-presenter.md)  
 ...
 [Using Editing Scope](../samples/using-editing-scope.md)  
