...
Database access activities allow you to access a database within a workflow. These activities allow accessing databases to retrieve or modify information and use [ADO.NET](/previous-versions/dotnet/netframework-4.0/e80y5yhx(v=vs.100)) to access the database.
