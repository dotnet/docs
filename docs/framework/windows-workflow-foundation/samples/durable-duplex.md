...
2.  Set up the virtual application.
    ...
    1.  From a Visual Studio 2010 command prompt, register ASP.NET by running the following command.

        ```
        aspnet_regiis -i
        ```

    2.  Run Visual Studio 2010 with administrator permissions by right-clicking Visual Studio 2010 and selecting **Run as administrator**.

    3.  Using Visual Studio 2010, open the DurableDuplex.sln file.
