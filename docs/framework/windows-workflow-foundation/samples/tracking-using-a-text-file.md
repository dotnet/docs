...
6.  Using [!INCLUDE[fileExplorer](../../../../includes/fileexplorer-md.md)], go to your Visual Studio 2010 folder (the default installation folder is %SystemDrive%\Program Files\Microsoft Visual Studio 10.0). Then locate the Common7\IDE\ subfolder.
