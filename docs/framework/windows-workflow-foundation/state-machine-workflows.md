...
description: Learn about creating state machine workflows using the StateMachine activity, with State, Transition, and others, to build state machine workflow programs.
ms.date: "03/30/2017"
