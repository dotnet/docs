...
## Tracking Participant Event Data  
 ...
 Complex types in variables, arguments, and custom data items are serialized to the ETW event record using the [NetDataContractSerializer Class](/dotnet/api/system.runtime.serialization.netdatacontractserializer&view=netframework-4.8). This class includes CLR-type information in the serialized XML steam.  
