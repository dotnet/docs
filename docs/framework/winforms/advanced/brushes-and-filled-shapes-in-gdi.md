...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["brushes [Windows Forms], GDI+", "filled shapes [Windows Forms], GDI+", "shapes [Windows Forms], GDI+", "GDI+, brushes", "GDI+, filled shapes", "gradient brushes", "brushes [Windows Forms], gradient"]
