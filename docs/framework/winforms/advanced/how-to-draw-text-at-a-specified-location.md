...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["text, drawing at specified locations [Windows Forms]", "drawing text", "drawing text, specified locations [Windows Forms]", "Windows Forms, drawing text a a specified location"]
