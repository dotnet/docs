...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["text [Windows Forms], drawing at specified locations [Windows Forms]", "drawing text", "drawing text [Windows Forms], specified locations [Windows Forms]", "Windows Forms, drawing text a a specified location"]
