...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["fonts, international", "international applications [Windows Forms], character display", "fonts, globalization considerations", "localization [Windows Forms], fonts", "Windows Forms controls, labels", "font fallback in Windows Forms", "globalization [Windows Forms], character sets"]
