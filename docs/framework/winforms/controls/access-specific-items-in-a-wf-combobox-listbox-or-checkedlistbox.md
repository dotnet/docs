...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["ComboBox control [Windows Forms], accessing items", "ListBox control [Windows Forms], returning item information", "list boxes [Windows Forms], accessing items", "ListBox control [Windows Forms], accessing items", "combo boxes [Windows Forms], accessing items", "CheckedListBox control [Windows Forms], accessing items"]
