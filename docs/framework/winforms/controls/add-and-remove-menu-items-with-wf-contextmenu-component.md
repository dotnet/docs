...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["context menus, removing items", "ContextMenu component [Windows Forms], adding items", "shortcut menus, removing items", "shortcut menus, examples", "context menus, adding items", "shortcut menus, adding items", "ContextMenu component [Windows Forms], removing items", "context menus, examples", "examples [Windows Forms], context menus"]
