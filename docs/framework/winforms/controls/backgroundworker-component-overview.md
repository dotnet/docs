---
title: "BackgroundWorker Component Overview | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   Local disk access, given its slow speed relative to memory access  
 ...
 For more information on using event handlers, see [Events](../../../../docs/standard/events/handling-and-raising-events.md).  
