...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["DataGridView control [Windows Forms], basic features", "columns [Windows Forms], DataGridView control", "data grids [Windows Forms], examples", "DataGridView control [Windows Forms], examples"]
