...
dev_langs: ["jsharp"]
helpviewer_keywords: ["bound controls, check boxes", "CheckBox control [Windows Forms], about CheckBox control", "data binding, checkbox controls", "data-bound controls, check boxes", "check boxes, about check boxes"]
