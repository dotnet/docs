...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["data grids [Windows Forms], sort modes", "DataGridView control [Windows Forms], sort mode"]
