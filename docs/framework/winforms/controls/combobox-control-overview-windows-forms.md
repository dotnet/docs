...
dev_langs: ["jsharp"]
helpviewer_keywords: ["drop-down lists [Windows Forms], Windows Forms", "ComboBox control [Windows Forms], about ComboBox control", "drop-down lists [Windows Forms], ComboBox control", "combo boxes [Windows Forms], about combo boxes"]
