...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["data grids [Windows Forms], customizing rows", "rows, customizing in DataGridView control", "DataGridView control [Windows Forms], customizing rows"]
