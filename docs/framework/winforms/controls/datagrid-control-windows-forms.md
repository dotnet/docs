...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["datasets [Windows Forms], user interface", "DataGrid control [Windows Forms]", "datasets [Windows Forms], displaying in DataGrid control", "displaying data, on forms", "data [Windows Forms], displaying on Windows Forms"]
