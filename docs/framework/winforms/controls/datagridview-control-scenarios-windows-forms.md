...
## Scenario 3: Advanced Data  
 ...
 For more information about virtual mode, see [Walkthrough: Implementing Virtual Mode in the Windows Forms DataGridView Control](../../../../docs/framework/winforms/controls/walkthrough-implementing-virtual-mode-in-the-windows-forms-datagridview-control.md).  
