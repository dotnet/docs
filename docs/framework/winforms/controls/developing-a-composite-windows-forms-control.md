...
-   [Walkthrough: Authoring a Composite Control with Visual C#](https://docs.microsoft.com/dotnet/framework/winforms/controls/walkthrough-authoring-a-composite-control-with-visual-csharp))  
