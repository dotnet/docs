...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["custom controls [Windows Forms], composite controls", "composite controls", "composite controls, Windows Forms", "controls [Windows Forms], composite"]
