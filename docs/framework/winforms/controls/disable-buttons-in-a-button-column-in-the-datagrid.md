...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["data grids [Windows Forms], disabling buttons", "buttons [Windows Forms], disabling in button columns", "DataGridView control [Windows Forms], disabling button cells"]
