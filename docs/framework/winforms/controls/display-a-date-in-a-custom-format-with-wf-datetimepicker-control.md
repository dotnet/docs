...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["DateTimePicker control [Windows Forms], display styles", "examples [Windows Forms], DateTimePicker control", "dates, displaying in DateTimePicker control"]
