...
dev_langs: ["jsharp"]
helpviewer_keywords: ["examples [Windows Forms], LinkLabel control", "Web pages, displaying", "linking, to Web pages from forms", "Windows Forms, linking to Web pages", "LinkLabel control [Windows Forms], examples"]
