...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["data [Windows Forms], displaying in tabular format", "data grids, displaying data", "displaying data, data grids", "DataGridView control [Windows Forms], displaying data"]
