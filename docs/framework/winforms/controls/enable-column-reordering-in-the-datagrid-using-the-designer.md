...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["DataGridView control [Windows Forms], column order", "Windows Forms, columns", "columns [Windows Forms], reordering", "data [Windows Forms], displaying"]
