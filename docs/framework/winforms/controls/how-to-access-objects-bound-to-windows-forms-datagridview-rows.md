...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["object binding, accessing bound objects", "data grids, accessing bound objects", "DataGridView control [Windows Forms], accessing objects bound to rows"]
