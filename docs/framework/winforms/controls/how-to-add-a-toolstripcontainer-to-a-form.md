...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["toolbars [Windows Forms], built-in rafting", "ToolStrip control [Windows Forms], built-in rafting", "ToolStripContainer control [Windows Forms], adding to Windows Forms"]
