...
>  There are performance limitations for Windows Forms when ActiveX controls are added to them.  
 ...
 Before you add ActiveX controls to your form, you must add them to the Toolbox. For more information, see [COM Components, Customize Toolbox Dialog Box](http://msdn.microsoft.com/171333f3-f207-4e02-bbdc-17862556212c).  
