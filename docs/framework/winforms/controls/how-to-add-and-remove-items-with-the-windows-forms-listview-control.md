...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["ListView control [Windows Forms], populating", "list views [Windows Forms], adding list items", "ListView control [Windows Forms], adding list items"]
