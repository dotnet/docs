...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["layout [Windows Forms], child controls", "FlowLayoutPanel control [Windows Forms], child controls", "controls [Windows Forms], child", "child controls, anchoring and docking"]
