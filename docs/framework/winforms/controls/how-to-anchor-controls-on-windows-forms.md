...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["Anchor property, enabling resizable forms", "Windows Forms controls, screen resolutions", "resizing forms", "Windows Forms controls, size", "screen resolution and control display", "controls [Windows Forms], anchoring", "forms, resizing", "Windows Forms, resizing", "controls [Windows Forms], positioning"]
