...
-   Select the **SnapToGrid** layout mode in the Windows Forms Designer **Options** dialog box.  
     ...
     For more information, see [General, Windows Forms Designer, Options Dialog Box](https://msdn.microsoft.com/library/5aazxs78(v=vs.110).aspx). All controls now align themselves along the points on the grid.  
