...
1.  Add a <xref:System.Windows.Forms.NotifyIcon> component to your form, and set the important properties, such as the <xref:System.Windows.Forms.NotifyIcon.Icon%2A> and <xref:System.Windows.Forms.NotifyIcon.Visible%2A> properties.  
     ...
     For more information, see [How to: Add Application Icons to the TaskBar with the Windows Forms NotifyIcon Component](../../../../docs/framework/winforms/controls/how-to-add-application-icons-to-the-taskbar-with-the-windows-forms-notifyicon-component.md).  
...
## See Also  
 ...
 [How to: Add Application Icons to the TaskBar with the Windows Forms NotifyIcon Component](../../../../docs/framework/winforms/controls/how-to-add-application-icons-to-the-taskbar-with-the-windows-forms-notifyicon-component.md)   
