...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["context menus [Windows Forms], for background processes", "NotifyIcon component [Windows Forms], associating shortcut menus", "shortcut menus [Windows Forms], for background processes"]
