...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["UserControl class, creating composite controls", "user controls [Windows Forms], creating", "user controls [Windows Forms], inheriting from", "composite controls [Windows Forms], creating"]
