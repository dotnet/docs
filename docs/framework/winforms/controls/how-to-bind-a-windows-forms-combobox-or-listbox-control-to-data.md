...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["data [Windows Forms], binding to controls", "list boxes, data binding", "ComboBox control [Windows Forms], data binding", "data binding, combo boxes", "ListBox control [Windows Forms], data binding", "combo boxes, data binding", "bound controls, combo boxes", "Windows Forms controls, data binding", "data-bound controls, Windows Forms"]
