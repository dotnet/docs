...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["MaskedTextBox control [Windows Forms]", "data binding [Windows Forms], MaskedTextBox control [Windows Forms]", "MaskedTextBox control [Windows Forms], binding data"]
