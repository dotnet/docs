...
To build this example in Visual Studio or Visual Studio Code, paste the code into the *Form1* code file in a new Windows Forms project (.NET Framework or .NET Core 3.0 and above).  For more information, see [How to: Compile and run a complete Windows Forms code example using Visual Studio](https://msdn.microsoft.com/library/Bb129228\(v=vs.110\)). For information about building the example from the C# or Visual Basic command line, see [Build from the command line](/visual-basic/reference/command-line-compiler/building-from-the-command-line) or [Command-line building with csc.exe](/csharp/language-reference/compiler-options/command-line-building-with-csc-exe).  
  
Populate the `connectionString` variable in the example with the values for your Northwind SQL Server sample database connection. Windows Authentication, also called *integrated security*, is a more secure way to control database access than storing a password in the connection string. For more information about connection security, see [Protect connection information](../../framework/data/adonet/protecting-connection-information.md).  
