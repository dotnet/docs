...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["DataGridView control [Windows Forms], object binding", "data grids [Windows Forms], object binding", "object binding [Windows Forms], DataGridView control"]
