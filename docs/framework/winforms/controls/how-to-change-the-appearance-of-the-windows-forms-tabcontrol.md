...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["icons, displaying on tabs", "TabControl control [Windows Forms], changing page appearance", "tabs, controlling appearance", "buttons [Windows Forms], displaying tabs as"]
