...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["TextBox control [Windows Forms], entering passwords", "password boxes, creating", "PasswordChar property in text boxes", "passwords, input mask", "passwords, password text box"]
