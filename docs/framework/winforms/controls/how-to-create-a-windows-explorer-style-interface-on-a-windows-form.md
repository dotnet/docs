...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["Windows Explorer, creating with Windows Forms", "SplitContainer control [Windows Forms], Explorer-style interface", "forms [Windows Forms], Windows Explorer type"]
