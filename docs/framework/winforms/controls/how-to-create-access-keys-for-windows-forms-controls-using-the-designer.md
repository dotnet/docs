...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["controls [Windows Forms], access keys", "Button control [Windows Forms], access keys", "dialog box controls [Windows Forms], mnemonics", "access keys [Windows Forms], creating for controls", "mnemonics [Windows Forms], adding to dialog box controls", "ampersand character in shortcut key", "Windows Forms controls, access keys", "examples [Windows Forms], controls", "Text property, specifying access keys for controls", "keyboard shortcuts, creating for controls", "access keys [Windows Forms], Windows Forms", "ALT key"]
