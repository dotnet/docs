...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["controls [Windows Forms], access keys", "dialog box controls [Windows Forms], mnemonics", "access keys [Windows Forms], creating for controls", "Label control [Windows Forms], creating access keys", "mnemonics [Windows Forms], adding to dialog box controls", "mnemonics", "Windows Forms controls, access keys", "UseMnemonic property, Label control", "keyboard shortcuts, creating for controls", "access keys [Windows Forms], Windows Forms"]
