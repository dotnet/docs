...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["controls [Windows Forms], access keys", "dialog box controls, mnemonics", "access keys, creating for controls", "Label control [Windows Forms], creating access keys", "mnemonics, adding to dialog box controls", "mnemonics", "Windows Forms controls, access keys", "UseMnemonic property, Label control", "keyboard shortcuts, creating for controls", "access keys, Windows Forms"]
