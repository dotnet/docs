...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["toolbars [Windows Forms], customizing colors", "colors [Windows Forms], customizing in ToolStrip controls [Windows Forms]", "ToolStrip control [Windows Forms], custom colors"]
