...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["global assembly cache, Choose Toolbox Items dialog box", "AssemblyFoldersEx, Choose Toolbox Items dialog box", "controls, display in Choose Toolbox Items dialog box", "assembly folder registration, Choose Toolbox Items dialog box", "Choose Toolbox Items dialog box, display control"]
