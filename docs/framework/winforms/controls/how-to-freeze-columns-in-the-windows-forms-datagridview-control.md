...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["columns [Windows Forms], freezing", "DataGridView control [Windows Forms], freezing columns", "DataGridView control [Windows Forms], columns always in view"]
