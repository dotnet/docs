...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["ListView control [Windows Forms], grouping items", "lists [Windows Forms], grouping items", "grouping", "list views [Windows Forms], grouping items", "groups", "groups, in Windows Forms controls"]
