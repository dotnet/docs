...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["ContextMenuStrip control [Windows Forms]", "context menus [Windows Forms], event handling", "ToolStrip control [Windows Forms]", "event handling, context menus", "shortcut menus [Windows Forms], event handling"]
