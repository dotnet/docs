...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["inheritance, Windows Forms custom controls", "UserControl class, inheriting from", "user controls [Windows Forms], creating", "composite controls, creating"]
