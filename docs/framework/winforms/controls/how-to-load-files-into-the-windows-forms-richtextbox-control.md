...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["text boxes [Windows Forms], displaying files", "examples [Windows Forms], text boxes", ".rtf files [Windows Forms], opening in RichTextBox control", "RTF files [Windows Forms], opening in RichTextBox control", "text files [Windows Forms], displaying in RichTextBox control", ".rtf files [Windows Forms], displaying in RichTextBox control", "RichTextBox control [Windows Forms], opening files", "RTF files [Windows Forms], displaying in RichTextBox control"]
