...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["images [Windows Forms], controlling placement in PictureBox control [Windows Forms]", "examples [Windows Forms], PictureBox control", "PictureBox control [Windows Forms], picture size and alignment", "pictures, controlling placement in PictureBox control [Windows Forms]"]
