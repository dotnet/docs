...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["Click event [Windows Forms], monitoring in DataGrid controls", "DataGrid control [Windows Forms], examples", "DataGrid control [Windows Forms], returning clicked cell value", "cells, location in DataGrid", "examples [Windows Forms], DataGrid control", "DataGrid control [Windows Forms], click events"]
