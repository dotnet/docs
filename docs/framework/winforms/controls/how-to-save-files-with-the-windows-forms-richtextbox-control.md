...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["saving files", "RTF files [Windows Forms], saving in RichTextBox control", "examples [Windows Forms], text boxes", "saving files [Windows Forms], RichTextBox control", "files [Windows Forms], saving with RichTextBox control", "RichTextBox control [Windows Forms], saving files", ".rtf files [Windows Forms], saving in RichTextBox control", "text files [Windows Forms], saving from RichTextBox control"]
