...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["snap to grid, Windows Forms Designer", "grids [Windows Forms], options in Windows Forms", "snaplines [Windows Forms], Windows Forms Designer", "Windows Forms, grid options in designer", "Windows Forms Designer"]
