...
1.  Create a Windows control library project called **TestContainerExample**. For details, see [Windows Control Library Template](http://msdn.microsoft.com/722f4e2d-1310-4ed5-8f33-593337ab66b4).  
...
7.  Add another user control to the **TestContainerExample** project. For details, see [NIB:How to: Add Existing Items to a Project](http://msdn.microsoft.com/15f4cfb7-78ab-457f-9f14-099a25a6a2d3).  
...
1.  Create a Windows control library project called **TestContainerExample2**. For details, see [Windows Control Library Template](http://msdn.microsoft.com/722f4e2d-1310-4ed5-8f33-593337ab66b4).  
...
## See Also  
 ...
 [User Control Designer](http://msdn.microsoft.com/2abb9eec-ba32-45cb-b73d-8b52a8bd6bf1)