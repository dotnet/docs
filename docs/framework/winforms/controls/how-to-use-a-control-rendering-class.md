...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["professional appearance, rendering Windows Forms controls", "visual themes [Windows Forms], applying to Windows Forms controls", "visual styles [Windows Forms], rendering Windows Forms controls"]
