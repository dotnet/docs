...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["data [Windows Forms], validation", "DataGridView control [Windows Forms], data validation", "data grids [Windows Forms], validating data", "data validation, Windows Forms"]
