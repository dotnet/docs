...
description: Learn how to view multiple lines in the Windows Forms TextBox control by setting the Multiline, WordWrap, and ScrollBars properties to appropriate values.
ms.date: "03/30/2017"
helpviewer_keywords: 
  - "newline"
  - "end of line"
