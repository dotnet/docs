...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["WebBrowser.ObjectForScripting", "WebBrowser.Document"]
dev_langs: ["jsharp"]
helpviewer_keywords: ["WebBrowser control [Windows Forms], examples", "communications, DHTML and client applications", "examples [Windows Forms], WebBrowser control", "WebBrowser control [Windows Forms], communication between DHTML and client application", "DHTML, embedding in Windows Forms"]
