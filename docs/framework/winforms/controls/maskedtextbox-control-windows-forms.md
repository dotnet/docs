...
dev_langs: ["jsharp"]
helpviewer_keywords: ["MaskedTextBox control [Windows Forms]", "user input, validating in Windows Forms", "validating user input, Windows Forms", "text boxes, validating user input"]
