...
## In This Section  
 ...
 [How to: Set and Return Numeric Values with the Windows Forms NumericUpDown Control](../../../../docs/framework/winforms/controls/how-to-set-and-return-numeric-values-with-the-windows-forms-numericupdown-control.md)  
