...
dev_langs: ["jsharp"]
helpviewer_keywords: ["PictureBox control [Windows Forms], about PictureBox controls", "picture controls, about picture controls", "image controls, about image controls"]
