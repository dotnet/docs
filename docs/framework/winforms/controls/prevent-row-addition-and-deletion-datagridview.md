...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["DataGridView control [Windows Forms], disabling data entry", "data entry, disabling in grids", "data grids [Windows Forms], disabling data entry"]
