...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["checked list items, Windows Forms controls", "list controls, Windows Forms", "list items, Windows Forms controls that display", "radio buttons", "RadioButton control [Windows Forms]"]
