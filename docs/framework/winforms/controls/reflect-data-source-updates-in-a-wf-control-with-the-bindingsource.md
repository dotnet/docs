...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["data binding, updating", "BindingSource component [Windows Forms], updating data binding", "examples [Windows Forms], BindingSource component", "data sources, updating", "BindingSource component [Windows Forms], examples"]
