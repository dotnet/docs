...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["DataGridView control [Windows Forms], row sizing", "data grids, column sizing", "DataGridView control [Windows Forms], column sizing", "DataGridView control [Windows Forms], sizing options", "data grids, row sizing", "data grids, sizing options"]
