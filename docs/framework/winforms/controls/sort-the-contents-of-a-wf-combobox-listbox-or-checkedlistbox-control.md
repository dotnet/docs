...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["CheckedListBox control [Windows Forms], sorting", "ComboBox control [Windows Forms], sorting contents", "combo boxes [Windows Forms], sorting contents", "list boxes [Windows Forms], sorting contents", "ListBox control [Windows Forms], sorting contents"]
