...
dev_langs: ["jsharp"]
helpviewer_keywords: ["TabControl control [Windows Forms], about TabControl control", "tab pages, about tab pages", "property pages, Windows Forms", "Windows Forms dialog boxes, tabs"]
