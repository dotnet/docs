...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["ToolStrip control [Windows Forms], ToolStripProgressBar", "ToolStripProgressBar control [Windows Forms]", "toolbars [Windows Forms], progress bars", "progress controls [Windows Forms]"]
