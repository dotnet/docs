...
This topic lists the following common problems that arise when developing components and controls. For more information, see [Programming with Components](https://docs.microsoft.com/previous-versions/0ffkdtkf(v=vs.140)).  
...
- [Component Authoring](https://docs.microsoft.com/previous-versions/5dya64wy(v=vs.140))
- [Troubleshooting Design-Time Development](https://docs.microsoft.com/previous-versions/ms171843(v=vs.140))
