...
> [!NOTE]
>  For information about authoring a control to use on Web Forms, see [Developing Custom ASP.NET Server Controls](../Topic/Developing%20Custom%20ASP.NET%20Server%20Controls.md).  
...
## Custom Design Experience  
 ...
 Use the <xref:System.ComponentModel.DesignerAttribute> to associate your control with your designer. For more information, see [Extending Design-Time Support](../Topic/Extending%20Design-Time%20Support.md) and [How to: Create a Windows Forms Control That Takes Advantage of Design-Time Features](../Topic/How%20to:%20Create%20a%20Windows%20Forms%20Control%20That%20Takes%20Advantage%20of%20Design-Time%20Features.md).  
