...
> [!NOTE]
>  For information about authoring a control to use on Web Forms, see [Developing Custom ASP.NET Server Controls](https://docs.microsoft.com/previous-versions/zt27tfhy(v=vs.140)).  
...
- [Extending Design-Time Support](https://docs.microsoft.com/previous-versions/37899azc(v=vs.140))
- [How to: Create a Windows Forms Control That Takes Advantage of Design-Time Features](https://docs.microsoft.com/previous-versions/307hck25(v=vs.140))
