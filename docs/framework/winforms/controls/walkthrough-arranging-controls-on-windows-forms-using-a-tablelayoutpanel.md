...
1.  Create a Windows Application project called "TableLayoutPanelExample". For more information, see [How to: Create a Windows Application Project](https://msdn.microsoft.com/library/42wc9kk5(v=vs.110).aspx) .  
...
## See Also  
 ...
 [Walkthrough: Creating a Resizable Windows Form for Data Entry](https://msdn.microsoft.com/library/991eahec(v=vs.110).aspx)   
 [Walkthrough: Creating a Localizable Windows Form](https://msdn.microsoft.com/library/7k9fa71y(v=vs.110).aspx)   
