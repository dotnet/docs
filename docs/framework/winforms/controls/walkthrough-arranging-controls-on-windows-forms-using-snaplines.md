...
1.  Create a Windows-based application project called "SnaplineExample". For details, see [How to: Create a Windows Application Project](http://msdn.microsoft.com/b2f93fed-c635-4705-8d0e-cf079a264efa).  
...
1.  From the **Tools** menu, open the **Options** dialog box. Open the Windows Forms Designer dialog box. For details, see [General, Windows Forms Designer, Options Dialog Box](http://msdn.microsoft.com/8dd170af-72f0-4212-b04b-034ceee92834).  
