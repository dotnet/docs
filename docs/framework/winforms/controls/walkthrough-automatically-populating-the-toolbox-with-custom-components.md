...
2.  Add a new component to the project. Call it `DemoComponent`.  
     ...
     For more information, see [NIB:How to: Add New Project Items](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/w0572c5b(v=vs.100)).  
...
1.  Unload the project from the solution.  
     ...
     For more information about unloading projects, see [NIB:How to: Unload and Reload Projects](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/tt479x1t(v=vs.100)). If you are prompted to save, choose **Yes**.  
...
- [How to: Manipulate Toolbox Tabs](https://docs.microsoft.com/previous-versions/66kwe227(v=vs.110))
