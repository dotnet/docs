...
2.  Add a new **UserControl** item to the DebugControlLibrary project. For details, see [NIB:How to: Add New Project Items](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/w0572c5b(v=vs.100)). Give the new source file a base name of "DebugControl".  
  
3.  Using the **Solution Explorer**, delete the project's default control by deleting the code file with a base name of "`UserControl1`". For details, see [NIB:How to: Remove, Delete, and Exclude Items](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/0ebzhwsk(v=vs.100)).  
...
- [How to: Access Design-Time Services](https://docs.microsoft.com/previous-versions/ms171822(v=vs.140))
- [How to: Access Design-Time Support in Windows Forms](https://docs.microsoft.com/previous-versions/ms171827(v=vs.140))
