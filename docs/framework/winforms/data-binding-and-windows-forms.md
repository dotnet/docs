...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["master-details lists", "data [Windows Forms], data binding", "reports, Windows Forms", "lookup tables, data binding", "data [Windows Forms], complex data binding", "data binding [Windows Forms], Windows Forms", "data [Windows Forms], simple data binding", "Windows Forms controls, data binding", "data-bound controls, Windows Forms"]
