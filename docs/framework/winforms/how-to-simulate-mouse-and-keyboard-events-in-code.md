...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["keyboards, event simulation", "user input [Windows Forms], simulating", "SendKeys, using", "mouse clicks, simulating", "mouse [Windows Forms], event simulation"]
