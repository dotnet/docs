...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["Windows Forms, validating user input", "validation, Windows Forms user input", "user input [Windows Forms], validating in Windows Forms", "validating user input [Windows Forms], Windows Forms"]
