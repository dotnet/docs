...
ms.topic: "article"
dev_langs: ["jsharp"]
helpviewer_keywords: ["data [Windows Forms]", "Windows Forms, data binding", "data [Windows Forms], architecture", "bound controls, Windows Forms", "Windows Forms controls, data binding"]
