...
## Related Sections  
 [NIB: Default Security Policy](https://msdn.microsoft.com/library/03kwzyfc(v=vs.100).aspx)  
 Lists the default permissions granted in the Full Trust, Local Intranet, and Internet permission sets.  
  
 [NIB: General Security Policy Administration](https://msdn.microsoft.com/library/ed5htz45(v=vs.100).aspx)  
 ...
 [NIB: Requesting Permissions](https://msdn.microsoft.com/library/yd267cce(v=vs.100).aspx)  
 ...
 [NIB: Determining When to Modify Security Policy](https://msdn.microsoft.com/library/xky659fc(v=vs.100).aspx)  
 Explains how to determine when your applications need to diverge from the default security policy.  
  
 [NIB: Deploying Security Policy](https://msdn.microsoft.com/library/13wcxx6y(v=vs.100).aspx)  
