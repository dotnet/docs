...
- [Accessing and Manipulating Pen Input](https://msdn.microsoft.com/library?url=/library/tpcsdk10/lonestar/whitepapers/designguide/tbconaboutrealtimestylus_overview.asp)
