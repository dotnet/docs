...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["implementing, wrappers", "registering properties", "properties, metadata", "metadata, for properties", "custom dependency properties", "properties, registering", "wrappers, implementing", "dependency properties, custom"]
