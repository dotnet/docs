...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["dependency properties [WPF], validation", "coerce value callbacks", "callbacks [WPF], validation", "dependency properties [WPF], callbacks", "validation of dependency properties [WPF]"]
