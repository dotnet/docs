...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["wrappers [WPF], access", "wrappers [WPF], security", "dependency properties [WPF], security", "security [WPF], wrappers", "validation [WPF], dependency properties", "dependency properties [WPF], access", "security [WPF], dependency properties"]
