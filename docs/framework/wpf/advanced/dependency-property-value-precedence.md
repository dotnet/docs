...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["dependency properties [WPF], classes as owners", "dependency properties [WPF], metadata", "classes [WPF], owners of dependency properties", "metadata [WPF], dependency properties"]
