...
Sphere following the path geometry of text  
 ...
 For more information, see [How to: Create a PathGeometry Animation for Text](https://msdn.microsoft.com/library/ms743610(v=vs.110).aspx).  
...
## See Also  
 ...
 [How to: Create a PathGeometry Animation for Text](https://msdn.microsoft.com/library/ms743610(v=vs.110).aspx)
