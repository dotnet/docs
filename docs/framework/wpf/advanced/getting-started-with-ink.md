...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["procedural code in lieu of XAML", "gradient brush [WPF], animating colors of", "XAML [WPF], procedural code in lieu of", "animation [WPF], gradient brush colors", "brushes [WPF], animating colors of"]
