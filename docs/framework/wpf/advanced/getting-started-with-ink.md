...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["procedural code in lieu of XAML", "gradient brush, animating colors of", "XAML, procedural code in lieu of", "animation, gradient brush colors", "brushes, animating colors of"]
