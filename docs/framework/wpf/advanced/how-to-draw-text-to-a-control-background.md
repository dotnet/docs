...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["controls, drawing text to backgrounds", "text, drawing to control backgrounds", "drawing, text to control backgrounds", "backgrounds, drawing text to", "typography, drawing text to control backgrounds"]
