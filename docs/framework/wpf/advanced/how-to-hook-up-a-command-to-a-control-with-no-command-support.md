...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["Control class, attaching a RoutedCommand", "classes, Control, attaching a RoutedCommand", "RoutedCommand class, attaching to a Control", "classes, RoutedCommand, attaching to a Control"]
