...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["resources [WPF], packaging string resources", "packaging string resources", "ResourceDictionary [WPF]", "localization [WPF], packaging string resources"]
