...
## See Also  
 ...
 [How to: Change the Margin Property](https://msdn.microsoft.com/library/ms750561(v=vs.110).aspx)   
 [How to: Convert a ListBoxItem to a new Data Type](https://msdn.microsoft.com/library/ms749147(v=vs.110).aspx)   
