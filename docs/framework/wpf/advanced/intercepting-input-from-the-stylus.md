...
## Architecture  
 The <xref:System.Windows.Input.StylusPlugIns.StylusPlugIn> is the evolution of the [StylusInput](https://msdn.microsoft.com/library/tpcsdk10/lonestar/microsoft.stylusinput/microsoft.stylusinput.asp) APIs, described in [Accessing and Manipulating Pen Input](https://msdn.microsoft.com/library?url=/library/tpcsdk10/lonestar/whitepapers/designguide/tbconaboutrealtimestylus_overview.asp), in the [Microsoft Windows XP Tablet PC Edition Software Development Kit 1.7](https://www.microsoft.com/download/404Error.aspx).  
