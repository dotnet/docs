...
helpviewer_keywords: ["Windows Presentation Foundation, interoperability", "WPF, migration", "Windows Forms controls [WPF interoperability]", "controls [WPF interoperability]", "Windows Presentation Foundation, migration", "interoperability [WPF]", "WPF, interoperability", "migration [WPF]"]
