...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["application resources [WPF], performance", "resources [WPF], performance", "static resources [WPF]", "sharing resources [WPF]", "brushes [WPF], performance", "sharing brushes without copying"]
