...
-   For additional reference material on the [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] print path and the various [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] conversion options, see [Microsoft XPS Document Converter (MXDC)](https://docs.microsoft.com/windows/desktop/printdocs/microsoft-xps-document-converter--mxdc-) and "XPSDrv" in the [Windows Driver Kit](https://docs.microsoft.com/windows-hardware/drivers/).  
...
- [Microsoft XPS Document Converter (MXDC)](https://docs.microsoft.com/windows/desktop/printdocs/microsoft-xps-document-converter--mxdc-)
