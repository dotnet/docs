...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["attached events [WPF]", "grouped button set", "routed events [WPF]", "events [WPF], routed", "tunneling", "events [WPF], attached", "routing strategies for events [WPF]", "button set [WPF], grouped", "bubbling"]
