...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["attached events", "grouped button set", "routed events", "events, routed", "tunneling", "events, attached", "routing strategies for events", "button set, grouped", "bubbling"]
