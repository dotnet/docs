...
## Enabling Ink in an Application  
 All three platforms ship objects and controls that enable an application to receive input from a tablet pen.  The Windows Forms and COM platforms ship with [Microsoft.Ink.InkPicture](https://docs.microsoft.com/previous-versions/aa514604(v=msdn.10)), [Microsoft.Ink.InkEdit](https://docs.microsoft.com/previous-versions/ms835842(v=msdn.10)), [Microsoft.Ink.InkOverlay](https://docs.microsoft.com/previous-versions/ms833057(v=msdn.10)) and [Microsoft.Ink.InkCollector](https://docs.microsoft.com/previous-versions/ms836493(v=msdn.10)) classes.  [Microsoft.Ink.InkPicture](https://docs.microsoft.com/previous-versions/aa514604(v=msdn.10)) and [Microsoft.Ink.InkEdit](https://docs.microsoft.com/previous-versions/ms835842(v=msdn.10)) are controls that you can add to an application to collect ink.  The [Microsoft.Ink.InkOverlay](https://docs.microsoft.com/previous-versions/ms833057(v=msdn.10)) and [Microsoft.Ink.InkCollector](https://docs.microsoft.com/previous-versions/ms836493(v=msdn.10)) can be attached to an existing window to ink-enable windows and custom controls.  
...
|-----------------|--------------------------|------------------------------------------|  
|Add an ink-enabled control to an application|See [Getting Started with Ink](../../../../docs/framework/wpf/advanced/getting-started-with-ink.md).|See [Auto Claims Form Sample](/windows/desktop/tablet/auto-claims-form-sample)|  
|Enable ink on a custom control|See [Creating an Ink Input Control](../../../../docs/framework/wpf/advanced/creating-an-ink-input-control.md).|See [Ink Clipboard Sample](/windows/desktop/tablet/ink-clipboard-sample).|  
  
## Ink Data  
 On the Windows Forms and COM platforms, [Microsoft.Ink.InkCollector](https://docs.microsoft.com/previous-versions/ms836493(v=msdn.10)), [Microsoft.Ink.InkOverlay](https://docs.microsoft.com/previous-versions/ms833057(v=msdn.10)), [Microsoft.Ink.InkEdit](https://docs.microsoft.com/previous-versions/ms835842(v=msdn.10)), and [Microsoft.Ink.InkPicture](https://docs.microsoft.com/previous-versions/aa514604(v=msdn.10)) each expose a [Microsoft.Ink.Ink](https://docs.microsoft.com/previous-versions/aa515768(v=msdn.10)) object. The [Microsoft.Ink.Ink](https://docs.microsoft.com/previous-versions/aa515768(v=msdn.10)) object contains the data for one or more [Microsoft.Ink.Stroke](https://docs.microsoft.com/previous-versions/ms827842(v=msdn.10)) objects and exposes common methods and properties to manage and manipulate those strokes.  The [Microsoft.Ink.Ink](https://docs.microsoft.com/previous-versions/aa515768(v=msdn.10)) object manages the lifetime of the strokes it contains; the [Microsoft.Ink.Ink](https://docs.microsoft.com/previous-versions/aa515768(v=msdn.10)) object creates and deletes the strokes that it owns.  Each [Microsoft.Ink.Stroke](https://docs.microsoft.com/previous-versions/ms827842(v=msdn.10)) has an identifier that is unique within its parent [Microsoft.Ink.Ink](https://docs.microsoft.com/previous-versions/aa515768(v=msdn.10)) object.  
  
 On the WPF platform, the <xref:System.Windows.Ink.Stroke?displayProperty=nameWithType> class owns and manages its own lifetime. A group of <xref:System.Windows.Ink.Stroke> objects can be collected together in a <xref:System.Windows.Ink.StrokeCollection>, which provides methods for common ink data management operations such as hit testing, erasing, transforming, and serializing the ink. A <xref:System.Windows.Ink.Stroke> can belong to zero, one, or more <xref:System.Windows.Ink.StrokeCollection> objects at any give time.  Instead of having a [Microsoft.Ink.Ink](https://docs.microsoft.com/previous-versions/aa515768(v=msdn.10)) object, the <xref:System.Windows.Controls.InkCanvas> and <xref:System.Windows.Controls.InkPresenter> contain a <xref:System.Windows.Ink.StrokeCollection?displayProperty=nameWithType>.  
  
 The following pair of illustrations compares the ink data object models.  On the Windows Forms and COM platforms, the [Microsoft.Ink.Ink](https://docs.microsoft.com/previous-versions/aa515768(v=msdn.10)) object constrains the lifetime of the [Microsoft.Ink.Stroke](https://docs.microsoft.com/previous-versions/ms827842(v=msdn.10)) objects, and the stylus packets belong to the individual strokes.  Two or more strokes can reference the same [Microsoft.Ink.DrawingAttributes](https://docs.microsoft.com/previous-versions/ms837931(v=msdn.10)) object, as shown in the following illustration.  
...
|Hit test|<xref:System.Windows.Ink.StrokeCollection.HitTest%2A>|[Microsoft.Ink.Ink.HitTest](https://docs.microsoft.com/previous-versions/aa515934(v=msdn.10))|  
...
## Events from the Tablet Pen  
 The [Microsoft.Ink.InkOverlay](https://docs.microsoft.com/previous-versions/ms833057(v=msdn.10)), [Microsoft.Ink.InkCollector](https://docs.microsoft.com/previous-versions/ms836493(v=msdn.10)), and [Microsoft.Ink.InkPicture](https://docs.microsoft.com/previous-versions/aa514604(v=msdn.10)) on the Windows Forms and COM platforms receive events when the user inputs pen data.  The [Microsoft.Ink.InkOverlay](https://docs.microsoft.com/previous-versions/ms833057(v=msdn.10)) or [Microsoft.Ink.InkCollector](https://docs.microsoft.com/previous-versions/ms836493(v=msdn.10)) is attached to a window or a control, and can subscribe to the events raised by the tablet input data.  The thread on which these events occurs depends on whether the events are raised with a pen, a mouse, or programmatically.  For more information about threading in relation to these events, see [General Threading Considerations](/windows/desktop/tablet/general-threading-considerations) and [Threads on Which an Event Can Fire](/windows/desktop/tablet/threads-on-which-an-event-can-fire).  
