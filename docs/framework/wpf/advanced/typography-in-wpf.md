...
## Improved Quality and Performance of Text  
 ...
 ![Text with ClearType y&#45;direction anti&#45;aliasing](./media/typograpny-in-wpf/text-y-direction-antialiasing.gif)  
Text with ClearType y-direction antialiasing  
 ...
 ![Diagram of the text rendering pipeline](./media/text-rendering-pipeline.png)  
