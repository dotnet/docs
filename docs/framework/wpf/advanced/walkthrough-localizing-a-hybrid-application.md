...
1.  Create a WPF Application project named                                  `LocalizingWpfInWf`. For more information, see                                  [How to: Create a Windows Application Project](https://msdn.microsoft.com/library/42wc9kk5(v=vs.110).aspx).  
...
## See Also  
 ...
 [Walkthrough: Localizing Windows Forms](https://msdn.microsoft.com/library/y99d1cd3(v=vs.110).aspx)   
