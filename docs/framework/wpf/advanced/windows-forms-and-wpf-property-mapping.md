...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["property mapping [WPF interoperability]", "Windows Forms [WPF], interoperability with", "Windows Forms, WPF interoperation", "interoperability [WPF], Windows Forms", "WindowsFormsHost element property mapping"]
