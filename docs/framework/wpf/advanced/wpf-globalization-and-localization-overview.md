...
-   You can validate original source elements and semantics at compile time because the BAML form of XAML is the compiled form [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)].  
