...
## The XAML Language Specification  
 ...
 For more information about the XAML language specification, download [\[MS-XAML\]](/previous-versions/msp-n-p/ff650760(v=pandp.10)) from the Microsoft Download Center.  
