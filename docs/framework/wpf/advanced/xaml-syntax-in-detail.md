...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["XML [WPF], namespaces", "XAML [WPF], parsing of attributes", "parsing of attributes", "XAML [WPF], markup extensions", "attached properties [WPF]", "tag syntax [XAML]", "markup extensions [WPF]", "XAML [WPF], object element syntax", "XAML [WPF], syntax terminology", "attached events [WPF]", "lookup semantics", "XAML [WPF], attached events", "XAML [WPF], content syntax", "XAML [WPF], lookup semantics", "content syntax [WPF]", "object element syntax [WPF]", "syntax terminology [XAML]", "XAML [WPF], attached properties", "attributes [XAML], parsing", "XAML [WPF], tag syntax", "XAML [WPF], attribute syntax", "property element syntax", "terminology [XAML]", "namespaces [WPF], XML", "attribute syntax [XAML]", "XAML [WPF], property element syntax"]
