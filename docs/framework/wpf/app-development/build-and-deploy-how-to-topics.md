...
## Related Sections  
 ...
 [How to: Create a New WPF Application Project](https://msdn.microsoft.com/library/bb546958(v=vs.110).aspx)  
  
 [How to: Create a New WPF Browser Application Project](https://msdn.microsoft.com/library/bb628663(v=vs.110).aspx)
