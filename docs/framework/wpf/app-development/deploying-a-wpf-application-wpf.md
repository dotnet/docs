...
### Windows Installer  
 ...
 For more information about [!INCLUDE[TLA2#tla_wininstall](../../../../includes/tla2sharptla-wininstall-md.md)], see [Windows Installer Deployment](https://msdn.microsoft.com/library/2kt85ked(v=vs.120).aspx).  
