...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["Firefox add-ons for .NET application deployment", "WPF plug-in for Firefox", ".NET application deployment [WPF], deploying with Firefox add-ons", ".NET Framework Assistant for Firefox"]
