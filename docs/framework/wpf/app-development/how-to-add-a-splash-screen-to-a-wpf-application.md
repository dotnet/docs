...
2.  Add the image file to the WPF Application project. For more information, see [NIB:How to: Add Existing Items to a Project](https://msdn.microsoft.com/library/9f4t9t92(v=vs.100).aspx).  
...
## See Also  
 ...
 [NIB:How to: Add Existing Items to a Project](https://msdn.microsoft.com/library/9f4t9t92(v=vs.100).aspx)
