...
## Example  
 Code that is running from content that is hosted in a <xref:System.Windows.Navigation.NavigationWindow>, <xref:System.Windows.Controls.Frame> using <xref:System.Windows.Navigation.NavigationService>, or Windows Internet Explorer can navigate back through navigation history, one entry at a time.  
