...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["pack URI scheme", "loading embedded resources [WPF]", "URIs (Uniform Resource Identifiers)", "Uniform Resource Identifiers (URIs)", "loading non-resource files", "application management [WPF]"]
