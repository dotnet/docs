...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["application-scope properties [WPF], persisting", "persisting application-scope properties [WPF]", "properties [WPF], persisting", "restoring application-scope properties [WPF]", "properties [WPF], restoring", "application-scope properties [WPF], restoring"]
