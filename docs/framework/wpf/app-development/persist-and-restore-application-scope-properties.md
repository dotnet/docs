...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["application-scope properties, persisting", "persisting application-scope properties", "properties, persisting", "restoring application-scope properties", "properties, restoring", "application-scope properties, restoring"]
