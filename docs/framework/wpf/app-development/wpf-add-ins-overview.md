...
> [!NOTE]
>  For more information regarding the creation of remotable [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] objects, see [Making Objects Remotable](https://msdn.microsoft.com/library/wcf3swha(v=vs.100).aspx).  
...
## See Also  
 ...
 [.NET Framework Remoting Overview](https://msdn.microsoft.com/library/kwdt6w2k(v=vs.100).aspx)   
 [Making Objects Remotable](https://msdn.microsoft.com/library/wcf3swha(v=vs.100).aspx)   
