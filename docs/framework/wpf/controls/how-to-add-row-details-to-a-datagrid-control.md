...
4. On the <xref:System.Windows.DataTemplate>, set the [x:Key Directive](../../../desktop-wpf/xaml-services/x-key-directive.md) to a value that uniquely identifies the data template.  
