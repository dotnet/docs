---
title: "How to: Crop an Image | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
This example shows how to crop an image using <xref:System.Windows.Media.Imaging.CroppedBitmap>.  
 ...
 <xref:System.Windows.Media.Imaging.CroppedBitmap> is primarily used when encoding a cropped version of an image to save out to a file. To crop an image for display purposes see the [Create a Clip Region](http://msdn.microsoft.com/56e4bed6-78d7-4292-b917-d72d0b3e4376) topic.  
...
## See Also  
 [Create a Clip Region](http://msdn.microsoft.com/56e4bed6-78d7-4292-b917-d72d0b3e4376)