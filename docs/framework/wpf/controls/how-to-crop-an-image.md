...
This example shows how to crop an image using <xref:System.Windows.Media.Imaging.CroppedBitmap>.  
 ...
 <xref:System.Windows.Media.Imaging.CroppedBitmap> is primarily used when encoding a cropped version of an image to save out to a file. To crop an image for display purposes see the [Create a Clip Region](https://docs.microsoft.com/previous-versions/ms746710(v=vs.100)) topic.  
...
## See also
- [Create a Clip Region](https://docs.microsoft.com/previous-versions/ms746710(v=vs.100))
