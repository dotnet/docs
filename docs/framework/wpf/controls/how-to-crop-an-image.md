...
This example shows how to crop an image using <xref:System.Windows.Media.Imaging.CroppedBitmap>.  
 ...
 <xref:System.Windows.Media.Imaging.CroppedBitmap> is primarily used when encoding a cropped version of an image to save out to a file. To crop an image for display purposes see the [Create a Clip Region](https://msdn.microsoft.com/library/ms746710(v=vs.110).aspx) topic.  
...
## See Also  
 [Create a Clip Region](https://msdn.microsoft.com/library/ms746710(v=vs.110).aspx)
