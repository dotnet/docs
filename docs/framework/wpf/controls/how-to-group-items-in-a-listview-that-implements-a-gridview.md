...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["ListView controls [WPF], grouping items with GridViews", "grouping items in ListViews implementing GridViews", "GridView controls [WPF], grouping items"]
