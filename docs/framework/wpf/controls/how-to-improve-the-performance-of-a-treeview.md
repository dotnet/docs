...
## Description  
 The following example creates a <xref:System.Windows.Controls.TreeView> that sets <xref:System.Windows.Controls.VirtualizingStackPanel.IsVirtualizing%2A?displayProperty=fullName> to true and <xref:System.Windows.Controls.VirtualizingStackPanel.VirtualizationMode%2A?displayProperty=fullName> to <xref:System.Windows.Controls.VirtualizationMode.Recycling> to optimize its performance.  
