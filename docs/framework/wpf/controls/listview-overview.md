...
## Sharing the Same View Mode  
 ...
 To specify a view mode that can be simultaneously used by more than one <xref:System.Windows.Controls.ListView>, use templates or styles. For an example of how to define views as <xref:System.Windows.FrameworkElement.Resources%2A>, see [ListView with Multiple Views Sample](https://msdn.microsoft.com/en-us/library/ms771469).  
...
## Creating a Custom View Mode  
 ...
 For an example of a custom view mode, see [ListView with Multiple Views Sample](https://msdn.microsoft.com/en-us/library/ms771469).  
