...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["triggers", "styles, referencing", "event triggers", "styles, prerequisites", "styles, declaring", "styles, overview", "styles, extending", "styles, triggers", "styles, event triggers"]
