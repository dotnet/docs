...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["triggers", "styles [WPF], referencing", "event triggers", "styles [WPF], prerequisites", "styles [WPF], declaring", "styles [WPF], overview", "styles [WPF], extending", "styles [WPF], triggers", "styles [WPF], event triggers"]
