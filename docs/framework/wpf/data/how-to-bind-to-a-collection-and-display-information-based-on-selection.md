...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["data collections [WPF], selecting data for views", "data binding [WPF], creating views of data collections", "data binding [WPF], selecting data for views", "data binding [WPF], binding to collections"]
