...
## Example  
 This example uses the [MSDN/TechNet Publishing System (MTPS) Content Service](https://msdn.microsoft.com/msdnmag/issues/06/10/InsideMSDN/default.aspx) to retrieve the list of languages supported by a specified document.  
