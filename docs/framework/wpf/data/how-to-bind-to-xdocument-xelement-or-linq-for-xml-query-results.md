...
XML data can be stored as a XAML resource using <xref:System.Windows.Data.ObjectDataProvider>. For a complete example, see  [L2DBForm.xaml source code](l2dbform-xaml-source-code). The following sample shows how code can set the data context to an object resource.
...
- [WPF Data Binding Using LINQ to XML Example](wpf-data-binding-using-linq-to-xml-example)
- [LINQ to XML Dynamic Properties](linq-to-xml-dynamic-properties)
