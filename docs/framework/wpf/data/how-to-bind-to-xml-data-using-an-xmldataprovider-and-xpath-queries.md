...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["XmlDataProvider [WPF], binding to XML data", "data binding [WPF], binding to XML data using XmlDataProvider queries", "binding [WPF], to XML data using XmlDataProvider queries"]
