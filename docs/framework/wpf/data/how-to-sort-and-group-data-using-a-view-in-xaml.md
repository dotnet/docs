...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["data binding, grouping data in views in XAML", "XAML, sorting data in views", "grouping data in views in XAML", "data binding, sorting data in views in XAML", "sorting data in views in XAML", "XAML, grouping data in views", "views, sorting data", "views, grouping data"]
