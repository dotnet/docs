...
4. Replace the <xref:System.Windows.Controls.DataGridTextColumn> elements to <xref:System.Windows.Controls.DataGridTemplateColumn> under the <xref:System.Windows.Controls.DataGrid> element and apply the templates to them.
