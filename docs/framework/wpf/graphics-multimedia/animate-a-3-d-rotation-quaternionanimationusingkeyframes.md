...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["3-D translations [WPF], animating [WPF], with key frames (QuaternionAnimationUsingKeyFrames)", "key frames [WPF], QuaternionAnimationUsingKeyFrames", "animation [WPF], 3-D translations [WPF], with key frames (QuaternionAnimationUsingKeyFrames)"]
