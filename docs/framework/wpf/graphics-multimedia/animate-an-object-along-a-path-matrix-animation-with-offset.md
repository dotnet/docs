...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["offset accumulation", "animation [WPF], objects along paths (matrix animation with offset accumulation)", "matrix animation with offset accumulation"]
