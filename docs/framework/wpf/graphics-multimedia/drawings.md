...
helpviewer_keywords: ["graphics [WPF], drawings", "ImageDrawing objects [WPF]", "draw [WPF]", "drawings", "GlyphRunDrawing objects [WPF]", "GeometryDrawing objects [WPF]", "Drawing objects [WPF]", "DrawingGroup objects [WPF]"]
