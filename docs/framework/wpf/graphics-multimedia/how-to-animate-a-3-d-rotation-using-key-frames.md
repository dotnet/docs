...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["animation [WPF], 3-D translations [WPF], with key frames (Rotation3DAnimation)", "key frames [WPF], Rotation3DAnimation", "3-D translations [WPF], animating [WPF], with key frames (Rotation3DAnimation)"]
