...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["animation [WPF], Matrix properties with key frames", "Matrix properties [WPF], animating with key frames", "key frames [WPF], animating Matrix properties with"]
