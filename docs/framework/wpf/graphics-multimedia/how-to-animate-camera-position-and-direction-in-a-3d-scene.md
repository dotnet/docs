...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["animation, camera position in 3-D scenes", "camera direction, animating in 3-D scenes", "3-D scenes, animating camera position", "3-D scenes, animating camera direction", "camera position, animating in 3-D scenes", "animation, camera direction in 3-D scenes"]
