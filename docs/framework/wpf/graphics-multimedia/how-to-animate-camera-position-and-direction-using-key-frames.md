...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["animation [WPF], camera direction with key frames", "key frames [WPF], animating camera direction", "animation [WPF], camera position with key frames", "camera position [WPF], animating with key frames", "key frames [WPF], animating camera position", "camera direction [WPF], animating with key frames"]
