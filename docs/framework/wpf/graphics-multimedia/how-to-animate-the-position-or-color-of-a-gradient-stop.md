...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["position [WPF], animating", "animation [WPF], position of GradientStop objects", "GradientStop objects [WPF], animating color of", "colors [WPF], animating", "animation [WPF], color of GradientStop objects", "GradientStop objects [WPF], animating position of"]
