...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["graphics [WPF], Polygon elements", "closed shapes [WPF], drawing with Polygon elements", "Polygon elements", "drawing [WPF], closed shapes with Polygon elements"]
