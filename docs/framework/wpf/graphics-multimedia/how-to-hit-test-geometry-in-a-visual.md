...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["hit tests [WPF], on visual objects comprising Geometry objects [WPF]", "visual objects [WPF], hit tests on", "Geometry objects [WPF], visual objects comprising"]
