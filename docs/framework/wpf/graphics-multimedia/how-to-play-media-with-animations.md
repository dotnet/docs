...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["multimedia, playback with animations", "playback of media, with animations", "animation, media playback with", "media, playback with animations"]
