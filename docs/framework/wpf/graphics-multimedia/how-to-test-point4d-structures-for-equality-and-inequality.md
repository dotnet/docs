...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["inequality [WPF], testing Point4D structures for", "equality [WPF], testing Point4D structures for", "testing [WPF], Point4D structures for equality", "Point4D structures [WPF], testing for inequality", "testing [WPF], Point4D structures for inequality", "Point4D structures [WPF], testing for equality"]
