...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["synchronizing media playback with events [WPF]", "playback of media [WPF], synchronizing with events", "media [WPF], synchronizing playback with events", "multimedia [WPF], synchronizing media playback with events"]
