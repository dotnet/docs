...
helpviewer_keywords: ["shapes [WPF]", "drawing, shapes", "Geometry objects", "transforming Shapes", "graphics, Shape objects", "painting Shapes", "Path objects", "stretchable Shapes", "Shape objects"]
