...
helpviewer_keywords: ["shapes [WPF]", "drawing [WPF], shapes", "Geometry objects [WPF]", "transforming Shapes", "graphics [WPF], Shape objects", "painting Shapes", "Path objects", "stretchable Shapes", "Shape objects [WPF]"]
