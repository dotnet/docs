...
ms.tgt_pltfrm: ""
ms.topic: "article"
helpviewer_keywords: ["partial trust security [WPF]", "detecting permissions", "security settings for Internet Explorer", "partial trust applications [WPF], debugging", "permissions [WPF], managing", "debugging partial trust applications [WPF]", "permissions [WPF], detecting", "feature security requirements", "managing permissions"]
