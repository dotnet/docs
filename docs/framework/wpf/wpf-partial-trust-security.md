...
-   [Securing ClickOnce Applications](../Topic/Securing%20ClickOnce%20Applications.md).  
 ...
 Alternatively, you can use the ClickOnce Trusted Deployment model for full trust deployment from any security zone. For more information, see                  [Trusted Application Deployment Overview](../Topic/Trusted%20Application%20Deployment%20Overview.md) and                  [Security](../../../docs/framework/wpf/security-wpf.md).  
