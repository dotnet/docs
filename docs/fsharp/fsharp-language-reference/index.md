...
|[Automatic Generalization](automatic-generalization.md)|Describes generic constructs in F#.|
...
|[Members](members.md)|Describes members of F# object types.|
...
|[Exception Handling](exception-handling.md)|Contains information about exception handling support in the F# language.|
...
|Title|Description|
|-----|-----------|
|[values](values.md)|Describes values, which are immutable quantities that have a specific type; values can be integral or floating point numbers, characters or text, lists, sequences, arrays, tuples, discriminated unions, records, class types, or function values.|
...
|Topic|Description|
|-----|-----------|
|[Compiler Options](compiler-options)|Describes the command-line options for the F# compiler.|
