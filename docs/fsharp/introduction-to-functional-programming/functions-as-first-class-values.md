...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet20.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet21.fs)]

F# provides the following more concise syntax to achieve the same result with less typing.

[!code-fsharp[Main](../../../samples/fsharp/countor/snippet22.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet23.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet24.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet25.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet26.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet27.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet28.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet29.fs)]

The following function call returns a string.

[!code-fsharp[Main](../../../samples/fsharp/countor/snippet30.fs)]

The following function call, declared inline, returns a Boolean value. The value displayed is `True`.

[!code-fsharp[Main](../../../samples/fsharp/countor/snippet31.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet34.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet35.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet36.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet37.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet38.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet39.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet40.fs)]

To verify that the function still works as it did before, try the original test cases again.

[!code-fsharp[Main](../../../samples/fsharp/countor/snippet41.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet42.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet43.fs)]

To take it one step further, substitute the value that `applyIt` is bound to for `applyIt`.

[!code-fsharp[Main](../../../samples/fsharp/countor/snippet44.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet45.fs)]

- You can pass a function as an argument.
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet46.fs)]
...
[!code-fsharp[Main](../../../samples/fsharp/countor/snippet47.fs)]
