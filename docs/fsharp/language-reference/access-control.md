...
Signatures in F# provide another mechanism for controlling access to F# program elements. Signatures are not required for access control. For more information, see [Signatures](/dotnet/fsharp/language-reference/signature-files).
...
- [Signatures](/dotnet/fsharp/language-reference/signature-files)
