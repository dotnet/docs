...
You may optionally enable the warning (`/warnon:3388` or property `<WarnOn>3388</WarnOn>`) to show a warning at every point an additional implicit upcast is used, as described in [Optional warnings for implicit conversions](#optional-warnings-for-implicit-conversions).
