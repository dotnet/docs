...
This error is given when a record field is mutably assigned, but the record field is not marked mutable.
...
To solve this error you have to change either the way the field is defined, or how you're setting the new value.
