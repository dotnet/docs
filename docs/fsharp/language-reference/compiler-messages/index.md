...
- add it yourself by following the instructions in [create-new-fsharp-compiler-message.fsx](./util/create-new-fsharp-compiler-message.fsx) and opening a pull request for this repository.
