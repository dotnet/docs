...
|<code>--deterministic[+&#124;-]</code>|Produce a deterministic assembly (including module version GUID and timestamp).  This cannot be used with wildcard version numbers, and only supports embedded and portable debugging types|
