...
This topic describes compiler command-line options for the F# compiler. The command `dotnet build` invokes the F# compiler F# project files. F# project files are noted with the `.fsproj` extension.
