...
|---------------|-----------|
|**-a****&lt;filename&gt;**|Generates a library and specifies its filename. This option is a short form of **--target:library****&lt;filename&gt;**.|
