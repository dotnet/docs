...
|----|-----------|-------------|
|[List](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-collections-list-1.html)|An ordered, immutable series of elements of the same type. Implemented as a linked list.|[Lists](lists.md)<br /><br />[List Module](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-collections-listmodule.html)|
