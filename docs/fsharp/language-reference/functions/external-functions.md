...
Interoperability with native code is referred to as *platform invoke* and is a feature of the CLR. For more information, see [Interoperating with Unmanaged Code](../../../standard/native-interop/cominterop.md). The information in that section is applicable to F#.
