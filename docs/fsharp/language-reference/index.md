...
This section is a reference to the F# language, a multi-paradigm programming language targeting the .NET Standard. The F# language supports functional, object-oriented and imperative programming models.
