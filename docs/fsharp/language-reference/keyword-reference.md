...
|`false`|[Primitive Types](/dotnet/fsharp/language-reference/basic-types)|Used as a Boolean literal.|
...
|`true`|[Primitive Types](/dotnet/fsharp/language-reference/basic-types)|Used as a Boolean literal.|
...
|`void`|[Primitive Types](/dotnet/fsharp/language-reference/basic-types)|Indicates the .NET `void` type. Used when interoperating with other .NET languages.|
