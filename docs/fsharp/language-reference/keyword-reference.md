...
|`let!`|[Async expressions](async-expressions.ms)<br /><br />[Computation Expressions](computation-expressions.md)|Used in asynchronous workflows to bind a name to the result of an asynchronous computation, or, in other computation expressions, used to bind a name to a result, which is of the computation type.|
...
|`return`|[Async expressions](async-expressions.ms)<br /><br />[Computation Expressions](computation-expressions.md)|Used to indicate a value to provide as the result of a computation expression.|
|`return!`|[Computation Expressions](computation-expressions.md)<br /><br />[Async expressions](async-expressions.ms)|Used to indicate a computation expression that, when evaluated, provides the result of the containing computation expression.|
...
|`use!`|[Computation Expressions](computation-expressions.md)<br /><br />[Async expressions](async-expressions.ms)|Used instead of `let!` in asynchronous workflows and other computation expressions for values that require `Dispose` to be called to free resources.|
...
|`yield!`|[Computation Expressions](computation-expressions.md)<br /><br />[Async expressions](async-expressions.ms)|Used in a computation expression to append the result of a given computation expression to a collection of results for the containing computation expression.|
