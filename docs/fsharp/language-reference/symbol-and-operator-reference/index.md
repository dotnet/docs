...
|`.`|[Members](../members/index.md)<br /><br />[Primitive Types](/dotnet/fsharp/language-reference/basic-types)|<ul><li>Accesses a member, and separates individual names in a fully qualified name.<br /></li><li>Specifies a decimal point in floating point numbers.<br /></li></ul>|
