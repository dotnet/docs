...
|[chunkBySize](array.chunkBySize%5B't%5D-function-%5Bfsharp%5D.md)<br />**: int -&gt; 'T [] -&gt; 'T [] []**|Divides the input array into chunks of size at most `chunkSize`.|
