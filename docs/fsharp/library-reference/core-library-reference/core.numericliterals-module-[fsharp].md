...
Provides a default implementations of F# numeric literal syntax for literals of the form *ddd*I. For more information, see [Literals](../../language-reference/literals.md).
