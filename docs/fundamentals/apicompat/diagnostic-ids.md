...
| CP0012 | Either the `virtual` or `abstract` keyword was removed from a member that was previously virtual or abstract. | Add the `virtual` or `abstract` keyword back to the member. |
