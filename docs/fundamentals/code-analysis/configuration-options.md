...
To set the default rule severity for a [category of rules](quality-rules/categories.md), use the following syntax. The category for each rule is provided in the individual rule reference pages, for example, [CA1000](quality-rules/ca1000.md).
