...
To fix a violation of this rule, implement the <xref:System.IDisposable> interface. In the <xref:System.IDisposable.Dispose*?displayProperty=nameWithType> method, call the <xref:System.IDisposable.Dispose*> method of the field's type.
