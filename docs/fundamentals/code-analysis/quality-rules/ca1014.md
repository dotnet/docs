...
If you must suppress this warning, add `dotnet_diagnostic.CA1014.severity = none` to your *.globalconfig* file. Or, if your project has no code files, add `<NoWarn>CA1014</NoWarn>` to your project file.
