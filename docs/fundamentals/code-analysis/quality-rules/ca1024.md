...
In addition, if your class implements the <xref:System.Xml.Serialization.IXmlSerializable> interface, it's okay to suppress the CA1024 warning on your <xref:System.Xml.Serialization.IXmlSerializable.GetSchema> method implementation.
