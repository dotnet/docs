...
Do not suppress a warning from this rule. Catching general exception types can hide runtime problems from the library user and can make debugging more difficult.
