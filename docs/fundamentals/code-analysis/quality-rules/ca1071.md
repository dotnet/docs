---
title: "CA1067: Override base.Equals when implementing IEquatable (code analysis)"
...
A type implementing <xref:System.IEquatable%601> interface indicates that it
...
See [here](/dotnet/api/system.iequatable-1#notes-to-implementers) for more
details.
