...
The [cref](../../../csharp/language-reference/xmldoc/recommended-tags.md) tag in an XML documentation comment uses a [prefix](/dotnet/csharp/language-reference/xmldoc#id-strings).
