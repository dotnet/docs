...
- The literal string is passed to the `string value` or `string format` parameter of a <xref:System.Console.Write*?displayProperty=nameWithType> or <xref:System.Console.WriteLine*?displayProperty=nameWithType> method overload.
