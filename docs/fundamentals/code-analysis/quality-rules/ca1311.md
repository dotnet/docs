...
It's safe to suppress a warning from this rule if you're certain that <xref:System.Threading.Thread.CurrentCulture?displayProperty=nameWithType> will never change.
