...
This rule is enabled by default only for projects targeting .NET 6.0 or later. However, you can [enable](#configure-code-to-analyze) it for projects that target other frameworks.
