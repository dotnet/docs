...
Replace the `if` block that throws the exception with a call to <xref:System.ArgumentNullException.ThrowIfNull*?displayProperty=nameWithType>. Or, in Visual Studio, use the lightbulb menu to fix your code automatically.
