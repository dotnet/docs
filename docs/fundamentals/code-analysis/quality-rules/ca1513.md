...
Replace the `if` block that throws the exception with a call to <xref:System.ObjectDisposedException.ThrowIf*>. Or, in Visual Studio, use the lightbulb menu to fix your code automatically.
