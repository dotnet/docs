...
A redundant length argument is passed to <xref:System.String.Substring*?displayProperty=nameWithType>, <xref:System.Span`1.Slice*?displayProperty=nameWithType>, <xref:System.ReadOnlySpan`1.Slice*?displayProperty=nameWithType>, or <xref:System.Memory`1.Slice*?displayProperty=nameWithType> when slicing to the end of a string or buffer.
