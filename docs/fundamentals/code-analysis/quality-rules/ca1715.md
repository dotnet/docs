...
You can configure which parts of your code this rule analyzes. For more information, see [Code quality rule configuration options](../code-quality-rule-options.md).
