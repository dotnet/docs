...
- A `[Pure]` method is called and the value the method returns is never used.
...
If method A calls a LINQ method B but does not use the result, use the result in a conditional statement, assign the result to a variable, or pass it as an argument to another method.

-or-

If method A calls a pure method B but does not use the result, use the result in a conditional statement, assign the result to a variable, or pass it as an argument to another method.
