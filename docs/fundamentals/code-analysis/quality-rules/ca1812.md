...
- The class is registered in an inversion of control (IoC) container as part of the [dependency injection](../../../core/extensions/dependency-injection/overview.md) pattern.
