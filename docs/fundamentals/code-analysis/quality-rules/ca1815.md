...
The following code fixes the previous violation by overriding <xref:System.ValueType.Equals*?displayProperty=fullName> and implementing the equality operators (`==` and `!=`):
