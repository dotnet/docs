...
When using a range-indexer on an array and implicitly assigning the value to <xref:System.Span`1> or <xref:System.Memory`1>.

## Rule description

The range indexer on a <xref:System.Span`1> is a non-copying <xref:System.Span`1.Slice*?#System_Span_1_Slice_System_Int32_System_Int32_> operation. But for the range indexer on an array, the method <xref:System.Runtime.CompilerServices.RuntimeHelpers.GetSubArray*> will be used instead of <xref:System.Span`1.Slice*?#System_Span_1_Slice_System_Int32_System_Int32_>, which produces a copy of the requested portion of the array. This copy is usually unnecessary when it's implicitly used as a <xref:System.Span`1> or <xref:System.Memory`1> value. If a copy isn't intended, use the <xref:System.MemoryExtensions.AsSpan*?#System_MemoryExtensions_AsSpan__1___0___> or <xref:System.MemoryExtensions.AsMemory*?#System_MemoryExtensions_AsMemory__1___0___> method to avoid the unnecessary copy. If the copy is intended, either assign it to a local variable first or add an explicit cast. The analyzer only reports when an implicit cast is used on the result of the range indexer operation.
...
To fix a violation of this rule, use the <xref:System.MemoryExtensions.AsSpan*?#System_MemoryExtensions_AsSpan__1___0___> or <xref:System.MemoryExtensions.AsMemory*?#System_MemoryExtensions_AsMemory__1___0___> extension method to avoid creating unnecessary data copies.
