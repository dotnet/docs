...
This rule locates string-concatenation expressions that contain <xref:System.String.Substring*> calls and suggests replacing <xref:System.String.Substring*> with <xref:System.MemoryExtensions.AsSpan*> and using the span-based overload of <xref:System.String.Concat*?displayProperty=nameWithType>.
