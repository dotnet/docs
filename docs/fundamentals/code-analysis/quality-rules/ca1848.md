...
Use of [logger extension methods](xref:Microsoft.Extensions.Logging.LoggerExtensions), such as <xref:Microsoft.Extensions.Logging.LoggerExtensions.LogInformation*> and <xref:Microsoft.Extensions.Logging.LoggerExtensions.LogDebug*>.

## Rule description

For high-performance logging scenarios, use the [LoggerMessage](../../../core/extensions/logging/source-generation.md) pattern instead of <xref:Microsoft.Extensions.Logging.Logger`1> extension methods.
