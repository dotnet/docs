...
- <xref:System.String.IndexOf*?displayProperty=nameWithType>
- <xref:System.String.LastIndexOf*?displayProperty=nameWithType>
...
- <xref:Microsoft.Extensions.Primitives.StringSegment.Equals*?displayProperty=nameWithType>
