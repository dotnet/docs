...
The <xref:System.Text.RegularExpressions.Group.Success> property of the result from <xref:System.Text.RegularExpressions.Regex.IsMatch*?displayProperty=nameWithType> is used to check if a pattern matches.
