...
- <xref:System.Text.RegularExpressions.Regex.Count*?displayProperty=nameWithType>
- <xref:System.Text.RegularExpressions.Regex.Matches*?displayProperty=nameWithType>
