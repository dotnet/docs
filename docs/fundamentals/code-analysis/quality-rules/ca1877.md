...
Multiple consecutive <xref:System.IO.Path.Combine*?displayProperty=nameWithType> or <xref:System.IO.Path.Join*?displayProperty=nameWithType> operations are used to build a path.
...
- <xref:System.IO.Path.Join*?displayProperty=nameWithType>
