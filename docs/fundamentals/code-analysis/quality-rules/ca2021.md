...
A call to <xref:System.Linq.Enumerable.Cast``1(System.Collections.IEnumerable)?displayProperty=nameWithType> or <xref:System.Linq.Enumerable.OfType``1(System.Collections.IEnumerable)?displayProperty=nameWithType> specifies a type parameter that's incompatible with the type of the input collection.

## Rule description

<xref:System.Linq.Enumerable.Cast``1(System.Collections.IEnumerable)?displayProperty=nameWithType> and <xref:System.Linq.Enumerable.OfType``1(System.Collections.IEnumerable)?displayProperty=nameWithType> require compatible types to produce the expected result:

- The generic cast used by the sequence returned by <xref:System.Linq.Enumerable.Cast``1(System.Collections.IEnumerable)> throws an <xref:System.InvalidCastException> at runtime on elements of incompatible types.
- The generic type check used by <xref:System.Linq.Enumerable.OfType``1(System.Collections.IEnumerable)> won't succeed with elements of incompatible types, resulting in an empty sequence.

Widening and user-defined conversions aren't supported with generic types.

## How to fix violations

Use a compatible type for the type parameter of <xref:System.Linq.Enumerable.Cast``1(System.Collections.IEnumerable)> and <xref:System.Linq.Enumerable.OfType``1(System.Collections.IEnumerable)>.
