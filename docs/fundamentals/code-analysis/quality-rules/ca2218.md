...
:::code language="csharp" source="snippets/csharp/all-rules/ca2218.cs" "id="1":::

The following example fixes the violation by overriding <xref:System.Object.GetHashCode>.

:::code language="csharp" source="snippets/csharp/all-rules/ca2218.cs" "id="2":::

## Structure example

The following example shows a structure (value type) that violates this rule.

:::code language="csharp" source="snippets/csharp/all-rules/ca2218.cs" "id="3":::

The following example fixes the violation by overriding <xref:System.Object.GetHashCode>.

:::code language="csharp" source="snippets/csharp/all-rules/ca2218.cs" "id="4":::
