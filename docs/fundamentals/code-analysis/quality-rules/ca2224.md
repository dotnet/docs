...
A public type implements the equality operator but doesn't override the <xref:System.Object.Equals*?displayProperty=fullName> method.
...
To fix a violation of this rule, you should either remove the implementation of the equality operator, or override <xref:System.Object.Equals*> and have the two methods return the same values. If the equality operator doesn't introduce inconsistent behavior, you can fix the violation by providing an implementation of <xref:System.Object.Equals*> that calls the <xref:System.Object.Equals*> method in the base class.

## When to suppress warnings

It's safe to suppress a warning from this rule if the equality operator returns the same value as the inherited implementation of <xref:System.Object.Equals*>. The examples in this article include a type that could safely suppress a warning from this rule.
