...
By default, this rule only analyzes calls to the three methods mentioned above, but this is [configurable](#configure-code-to-analyze).
...
- [Additional string formatting fethods](#additional-string-formatting-fethods)
- [Try determine additional string formatting methods automatically](#try-determine-additional-string-formatting-methods-automatically)

You can configure these options for just this rule, for all rules, or for all rules in this category (Usage). For more information, see [Code quality rule configuration options](../code-quality-rule-options.md).

### Additional string formatting fethods
...
### Try determine additional string formatting methods automatically
