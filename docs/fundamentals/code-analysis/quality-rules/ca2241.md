...
- [CA2241: Provide correct arguments to formatting methods](#ca2241-provide-correct-arguments-to-formatting-methods)
  - [Cause](#cause)
  - [Rule description](#rule-description)
  - [How to fix violations](#how-to-fix-violations)
  - [When to suppress warnings](#when-to-suppress-warnings)
  - [Configure code to analyze](#configure-code-to-analyze)
