...
This rule locates calls to <xref:System.String.IndexOf*> where the result is used to check for the presence or absence of a substring, and suggests using <xref:System.String.Contains*> instead, to improve readability.
