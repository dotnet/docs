...
If you just want to suppress a single violation in a file-based app, add a `#:property` directive to the entry point file. This syntax is specific to file-based apps; use `#pragma warning` directives for traditional project-based source files.
