...
For file-based apps, suppress a single violation by adding a `#:property` directive to the entry point file. For traditional project-based source files, add `#pragma warning` directives instead.
