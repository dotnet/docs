...
When you create a multi-file file-based program, start the entry point file with a shebang (`#!`) line to clearly distinguish it from files brought in with `#:include`. This helps tools identify the entry point correctly and improves direct shell execution support.
