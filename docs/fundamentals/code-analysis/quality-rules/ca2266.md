...
To suppress a single violation in a file-based app, add a `#:property` directive to the entry point file. For traditional project-based source files, use `#pragma warning` directives instead.
