...
For file-based apps, suppress a single violation by adding a `#:property` directive to the entry point file. For traditional project-based source files, use `#pragma warning` directives instead.
