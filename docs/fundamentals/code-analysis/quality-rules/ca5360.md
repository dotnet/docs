...
- <xref:System.IO.Directory.Delete*?displayProperty=fullName>
- <xref:System.IO.DirectoryInfo.Delete*?displayProperty=fullName>
- <xref:System.IO.File.AppendAllLines*?displayProperty=fullName>
- <xref:System.IO.File.AppendAllText*?displayProperty=fullName>
- <xref:System.IO.File.AppendText*?displayProperty=fullName>
- <xref:System.IO.File.Copy*?displayProperty=fullName>
- <xref:System.IO.File.Delete*?displayProperty=fullName>
- <xref:System.IO.File.WriteAllBytes*?displayProperty=fullName>
- <xref:System.IO.File.WriteAllLines*?displayProperty=fullName>
- <xref:System.IO.File.WriteAllText*?displayProperty=fullName>
- <xref:System.IO.FileInfo.Delete*?displayProperty=fullName>
- <xref:System.IO.Log.LogStore.Delete*?displayProperty=fullName>
- <xref:System.Reflection.Assembly.GetLoadedModules*?displayProperty=fullName>
- <xref:System.Reflection.Assembly.Load*?displayProperty=fullName>
...
- <xref:System.Reflection.Assembly.LoadModule*?displayProperty=fullName>
- <xref:System.Reflection.Assembly.LoadWithPartialName*?displayProperty=fullName>
- <xref:System.Reflection.Assembly.ReflectionOnlyLoad*?displayProperty=fullName>
- <xref:System.Reflection.Assembly.ReflectionOnlyLoadFrom*?displayProperty=fullName>
- <xref:System.Reflection.Assembly.UnsafeLoadFrom*?displayProperty=fullName>
...
- Implementing <xref:System.Runtime.Serialization.IDeserializationCallback.OnDeserialization*?displayProperty=fullName>.
- Implementing <xref:System.IDisposable.Dispose*?displayProperty=fullName>.
- Is a destructor.
