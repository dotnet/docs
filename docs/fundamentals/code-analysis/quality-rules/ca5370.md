...
- Starting in .NET Framework 2.0, `XmlValidatingReader` is considered obsolete. You can instantiate a validating reader with <xref:System.Xml.XmlReader.Create*?displayProperty=nameWithType>.
