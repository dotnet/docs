...
| [CA1865: Use char overload](ca1865.md) | The char overload is a better performing overload for a string with a single char. |
| [CA1866: Use char overload](ca1866.md) | The char overload is a better performing overload for a string with a single char. |
| [CA1867: Use char overload](ca1867.md) | The char overload is a better performing overload for a string with a single char. |
