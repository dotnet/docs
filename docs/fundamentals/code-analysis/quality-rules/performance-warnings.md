...
| [CA1850: Prefer static 'HashData' method over 'ComputeHash'](ca1850.md) | It is more efficient to use the static `HashData` method over creating and managing a `HashAlgorithm` instance to call `ComputeHash`. |
