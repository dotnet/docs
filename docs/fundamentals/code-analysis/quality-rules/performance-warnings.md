...
| [CA1839: Use `string.Contains(char)` instead of `string.Contains(string)` with single characters](ca1839.md) | Consider using `string.Contains(char)` instead of `string.Contains(string)` when searching for a single character. |
