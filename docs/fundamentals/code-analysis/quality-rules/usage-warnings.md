...
|[CA2218: Override GetHashCode on overriding Equals](ca2218.md)|A public type overrides <xref:System.Object.Equals*?displayProperty=fullName> but does not override <xref:System.Object.GetHashCode*?displayProperty=fullName>.|
...
|[CA2224: Override equals on overloading operator equals](ca2224.md)|A public type implements the equality operator but doesn't override <xref:System.Object.Equals*?displayProperty=fullName>.|
...
|[CA2241: Provide correct arguments to formatting methods](ca2241.md)|The format argument passed to <xref:System.String.Format*?displayProperty=nameWithType> does not contain a format item that corresponds to each object argument, or vice versa.|
...
| [CA2267: Quote whitespace in file-based program directive values](ca2267.md) | The value of a file-based program `#:` directive contains unquoted whitespace. The unquoted form is deprecated; wrap values that contain whitespace in double quotes so they're parsed unambiguously. |
