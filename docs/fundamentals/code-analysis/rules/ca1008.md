...
|Fix is a breaking or non-breaking change|Non-breaking - When you're prompted to add a `None` value to a non-flag enumeration. Breaking - When you're prompted to rename or remove any enumeration values.|
...
:::code language="vbnet" source="snippets/vb/ca1008-enums-should-have-zero-value_1.vb":::
