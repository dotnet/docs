...
[!code-vb[FxCop.Design.AssembliesCom#1](../../../../samples/snippets/fundamentals/code-analysis/visualbasic/ca1017-mark-assemblies-with-comvisibleattribute_1.vb)]
[!code-csharp[FxCop.Design.AssembliesCom#1](../../../../samples/snippets/fundamentals/code-analysis/csharp/ca1017-mark-assemblies-with-comvisibleattribute_1.cs)]

## See also

- [Interoperating with Unmanaged Code](../../../framework/interop/index.md)
- [Qualifying .NET Types for Interoperation](../../../framework/interop/qualifying-net-types-for-interoperation.md)
