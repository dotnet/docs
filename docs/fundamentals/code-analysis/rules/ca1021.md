...
[!code-csharp[FxCop.Design.NoRefOrOut#1](snippets/csharp/ca1021-avoid-out-parameters_1.cs)]
...
[!code-csharp[FxCop.Design.TestNoRefOrOut#1](snippets/csharp/ca1021-avoid-out-parameters_2.cs)]
...
[!code-csharp[FxCop.Design.RefByRefNo#1](snippets/csharp/ca1021-avoid-out-parameters_3.cs)]

## Example 4

The following application calls each method in the library to demonstrate the behavior.

[!code-csharp[FxCop.Design.TestRefByRefNo#1](snippets/csharp/ca1021-avoid-out-parameters_4.cs)]
...
[!code-csharp[FxCop.Design.TryPattern#1](snippets/csharp/ca1021-avoid-out-parameters_5.cs)]
