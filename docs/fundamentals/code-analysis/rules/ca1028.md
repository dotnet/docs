...
[!code-csharp[FxCop.Design.EnumIntegralType#1](snippets/csharp/ca1028-enum-storage-should-be-int32_1.cs)]

## Example of how to fix

The following example fixes the previous violation by changing the underlying data type to <xref:System.Int32>.

[!code-csharp[FxCop.Design.EnumIntegralTypeFixed#1](snippets/csharp/ca1028-enum-storage-should-be-int32_2.cs)]
