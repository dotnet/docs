...
[!code-csharp[FxCop.Design.IComparable#1](snippets/csharp/ca1036-override-methods-on-comparable-types_1.cs)]

The following application code tests the behavior of the <xref:System.IComparable> implementation that was shown earlier.

[!code-csharp[FxCop.Design.TestIComparable#1](snippets/csharp/ca1036-override-methods-on-comparable-types_2.cs)]
