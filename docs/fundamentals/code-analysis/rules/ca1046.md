...
[!code-csharp[FxCop.Design.RefTypesNoEqualityOp#1](snippets/csharp/ca1046-do-not-overload-operator-equals-on-reference-types_1.cs)]

## Example 2

The following application compares some references.

[!code-csharp[FxCop.Design.TestRefTypesNoEqualityOp#1](snippets/csharp/ca1046-do-not-overload-operator-equals-on-reference-types_2.cs)]
