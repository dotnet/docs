...
Additionally, public fields cannot be protected by [Link demands](../../../framework/misc/link-demands.md). For more information, see [CA2112: Secured types should not expose fields](../code-quality/ca2112.md). (Link demands are not applicable to .NET Core apps.)
