...
Additionally, public fields cannot be protected by [Link demands](../../../framework/misc/link-demands.md). For more information, see [CA2112: Secured types should not expose fields](ca2112.md). (Link demands are not applicable to .NET Core apps.)
...
[!code-csharp[FxCop.Design.TypesPublicInstanceFields#1](../../../../samples/snippets/fundamentals/code-analysis/csharp/ca1051-do-not-declare-visible-instance-fields_1.cs)]

## Related rules

- [CA2112: Secured types should not expose fields](ca2112.md)
