...
:::code language="vbnet" source="snippets/vb/ca1060-move-p-invokes-to-nativemethods-class_1.vb" id="snippet1":::
...
:::code language="vbnet" source="snippets/vb/ca1060-move-p-invokes-to-nativemethods-class_1.vb" id="snippet2":::
...
:::code language="vbnet" source="snippets/vb/ca1060-move-p-invokes-to-nativemethods-class_1.vb" id="snippet3":::
...
:::code language="vbnet" source="snippets/vb/ca1060-move-p-invokes-to-nativemethods-class_1.vb" id="snippet4":::
