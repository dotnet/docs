...
:::code language="vbnet" source="snippets/vb/ca1060-move-p-invokes-to-nativemethods-class_1.vb":::
...
:::code language="vbnet" source="snippets/vb/ca1060-move-p-invokes-to-nativemethods-class_2.vb":::
...
:::code language="vbnet" source="snippets/vb/ca1060-move-p-invokes-to-nativemethods-class_3.vb":::
...
:::code language="vbnet" source="snippets/vb/ca1060-move-p-invokes-to-nativemethods-class_4.vb":::
