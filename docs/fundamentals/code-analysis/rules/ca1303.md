...
You can configure this option for just this rule, for all rules, or for all rules in this category (Globalization). For more information, see [Configure code analysis rules](../configure-rules.md).
