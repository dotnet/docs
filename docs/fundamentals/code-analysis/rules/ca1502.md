...
You can learn more about code metrics at [Measure complexity of managed code](code-metrics-values.md).
...
- [Measuring Complexity and Maintainability of Managed Code](code-metrics-values.md)
