...
[!code-csharp[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix#1](snippets/csharp/ca1715-identifiers-should-have-correct-prefix_1.cs)]

The following code snippet fixes the previous violation by prefixing the interface with 'I':

[!code-csharp[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix2#1](snippets/csharp/ca1715-identifiers-should-have-correct-prefix_2.cs)]
...
[!code-csharp[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix3#1](snippets/csharp/ca1715-identifiers-should-have-correct-prefix_3.cs)]

The following code snippet fixes the previous violation by prefixing the generic type parameter with 'T':

[!code-csharp[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix4#1](snippets/csharp/ca1715-identifiers-should-have-correct-prefix_4.cs)]
