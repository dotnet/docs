...
|Fix is a breaking or non-breaking change|Breaking - when fired on interfaces.<br /><br /> Non-breaking - when raised on generic type parameters.|
...
You can configure which parts of your code this rule analyzes. For more information, see [Configure code analysis rules](../configure-rules.md).
...
[!code-vb[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix#1](../../../../samples/snippets/fundamentals/code-analysis/visualbasic/ca1715-identifiers-should-have-correct-prefix_1.vb)]
[!code-csharp[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix#1](../../../../samples/snippets/fundamentals/code-analysis/csharp/ca1715-identifiers-should-have-correct-prefix_1.cs)]

The following code snippet fixes the previous violation by prefixing the interface with 'I':

[!code-csharp[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix2#1](../../../../samples/snippets/fundamentals/code-analysis/csharp/ca1715-identifiers-should-have-correct-prefix_2.cs)]
[!code-vb[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix2#1](../../../../samples/snippets/fundamentals/code-analysis/visualbasic/ca1715-identifiers-should-have-correct-prefix_2.vb)]

## Type parameter naming example

The following code snippet shows an incorrectly named generic type parameter:

[!code-vb[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix3#1](../../../../samples/snippets/fundamentals/code-analysis/visualbasic/ca1715-identifiers-should-have-correct-prefix_3.vb)]
[!code-csharp[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix3#1](../../../../samples/snippets/fundamentals/code-analysis/csharp/ca1715-identifiers-should-have-correct-prefix_3.cs)]

The following code snippet fixes the previous violation by prefixing the generic type parameter with 'T':

[!code-csharp[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix4#1](../../../../samples/snippets/fundamentals/code-analysis/csharp/ca1715-identifiers-should-have-correct-prefix_4.cs)]
[!code-vb[FxCop.Naming.IdentifiersShouldHaveCorrectPrefix4#1](../../../../samples/snippets/fundamentals/code-analysis/visualbasic/ca1715-identifiers-should-have-correct-prefix_4.vb)]
