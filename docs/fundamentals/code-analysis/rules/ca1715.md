...
:::code language="vbnet" source="snippets/vb/ca1715-identifiers-should-have-correct-prefix_1.vb":::
...
:::code language="vbnet" source="snippets/vb/ca1715-identifiers-should-have-correct-prefix_2.vb":::

## Type parameter naming example

The following code snippet shows an incorrectly named generic type parameter:

:::code language="vbnet" source="snippets/vb/ca1715-identifiers-should-have-correct-prefix_3.vb":::
...
:::code language="vbnet" source="snippets/vb/ca1715-identifiers-should-have-correct-prefix_4.vb":::
