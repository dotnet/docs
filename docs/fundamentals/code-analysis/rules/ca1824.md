...
> [!TIP]
> See [Packaging and deploying resources](../../../framework/resources/packaging-and-deploying-resources-in-desktop-apps.md) for the process that <xref:System.Resources.ResourceManager> uses to probe for resource files.
...
- [CA1703 - Resource strings should be spelled correctly](ca1703.md)
- [CA1701 - Resource string compound words should be cased correctly](ca1701.md)
