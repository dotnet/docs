...
It's safe to suppress a violation of this rule if creating a copy is intended. Other than the [usual ways to suppress code analysis warnings](in-source-suppression-overview.md), you can also add an explicit cast to avoid the warning.
