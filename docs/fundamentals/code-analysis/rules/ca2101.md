...
> [!CAUTION]
> [Code Access Security](../../../framework/misc/code-access-security.md) (CAS) should not be considered a security boundary.
...
[!code-csharp[FxCop.Security.PinvokeAnsiUnicode#1](../../../../samples/snippets/fundamentals/code-analysis/csharp/ca2101-specify-marshaling-for-p-invoke-string-arguments_1.cs)]
