...
:::code language="vbnet" source="snippets/vb/ca2208-instantiate-argument-exceptions-correctly_1.vb" id="snippet1":::

The following code fixes the previous violation by switching the constructor arguments.

:::code language="csharp" source="snippets/csharp/all-rules/ca2208.cs" id="snippet2":::

:::code language="vbnet" source="snippets/vb/ca2208-instantiate-argument-exceptions-correctly_1.vb" id="snippet2":::
