...
description: "Learn about code analysis rule CA5389: Do not add archive item's path to the target file system path"
...
You can apply the configuration to just this rule, to all rules, or to all rules in this category (Security). For more information, see [Configure .NET code-quality analyzers](configure-fxcop-analyzers.md).
