...
This style rule concerns the use of C# [pattern matching](/dotnet/csharp/fundamentals/functiona/pattern-matching) over an `as` expression followed by a `null` check.
...
- [Pattern matching in C#](/dotnet/csharp/fundamentals/functiona/pattern-matching)
