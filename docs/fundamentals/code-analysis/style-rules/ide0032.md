...
| **Option values** | `true` | Prefer auto properties over properties with private backing fields|
||`false` | Prefer properties with private backing fields over auto properties |
