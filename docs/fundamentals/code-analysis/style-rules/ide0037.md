...
This rule enforces whether inferred [tuple](../../../csharp/language-reference/builtin-types/value-tuples.md) element names and inferred [anonymous type](../../../csharp/fundamentals/types/tuples.md) member names are preferred when the tuple or anonymous type is declared.
