...
This rule enforces whether inferred [tuple](../../../csharp/language-reference/builtin-types/value-tuples.md) element names and inferred [anonymous type](../../../csharp/programming-guide/classes-and-structs/anonymous-types.md) member names are preferred when the tuple or anonymous type is declared.
