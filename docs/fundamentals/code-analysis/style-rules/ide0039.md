...
This style rule concerns the use of [local functions](/dotnet/csharp/programming-guide/classes-and-structs/local-functions) versus lambdas (anonymous functions).
