...
This style rule concerns specifying the readonly modifier for fields which are only initialized (either inline or inside of a constructor), but never re-assigned.
