...
| **Option values** | `always_for_clarity` | Prefer parentheses to clarify relational operator (`>`, `<`, `<=`, `>=`, `is`, `as`, `==`, `!=`) precedence|
...
| **Option values** | `always_for_clarity` | Prefer parentheses to clarify operator precedence|
