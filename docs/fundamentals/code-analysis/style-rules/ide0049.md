---
title: "Use language keywords instead of framework type names for type references (IDE0049)"
...
- [Code style rules by option](index-by-option.md)
- [Code style rules by ID](index-by-rule-id.md)
