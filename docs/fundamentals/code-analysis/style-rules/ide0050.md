...
This rule recommends use of [tuples](../../../csharp/language-reference/builtin-types/value-tuples.md) over [anonymous types](../../../csharp/fundamentals/types/tuples.md), when the anonymous type has two or more fields.
