...
This style rule concerns the use of [expression bodies](/dotnet/csharp/programming-guide/statements-expressions-operators/expression-bodied-members) versus block bodies for lambdas.
