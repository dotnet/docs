...
This style rule concerns the use of [expression bodies](../../../csharp/language-reference/operators/lambda-operator.md#expression-body-definition) versus block bodies for [local functions](../../../csharp/programming-guide/classes-and-structs/local-functions.md). Local functions are private methods of a type that are nested in another member.
