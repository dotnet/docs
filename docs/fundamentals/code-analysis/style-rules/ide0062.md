...
This style rule concern with preference of [local functions](/dotnet/csharp/programming-guide/classes-and-structs/local-functions) being marked as `static`, when possible.
