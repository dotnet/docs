...
This style rule concerns the use of [`using` statements](../../../csharp/language-reference/statements/using.md) without curly braces, also known as `using` declarations. This alternative syntax was introduced in C# 8.0.
