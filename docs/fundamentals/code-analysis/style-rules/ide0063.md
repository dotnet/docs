...
This style rule concerns the use of [`using` statements](../../../csharp/language-reference/keywords/using-statement.md) without curly braces, also known as `using` declarations. This [alternative syntax](~/_csharplang/proposals/csharp-8.0/using.md) was introduced in C# 8.0.
