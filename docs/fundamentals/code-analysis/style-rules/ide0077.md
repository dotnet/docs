...
The recommended format for `Target` is the *documentation ID* format. For information about documentation IDs, see [Documentation ID format](/dotnet/csharp/language-reference/language-specification/documentation-comments.md#id-string-format).
...
- [Documentation ID format](/dotnet/csharp/language-reference/language-specification/documentation-comments.md#id-string-format)
