...
This style rule concerns the use of C# [pattern matching](../../../csharp/fundamentals/functional/pattern-matching.md) constructs.
...
- [C# 9.0 pattern matching](/dotnet/csharp/whats-new/csharp-version-history#c-version-9#pattern-matching-enhancements)
