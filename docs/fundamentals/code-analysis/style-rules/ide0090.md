...
This style rule concerns the use of C# 9.0 [target-typed new](/dotnet/csharp/language-reference/language-specification/expressions#128172-object-creation-expressions) expressions when the created type is apparent.
