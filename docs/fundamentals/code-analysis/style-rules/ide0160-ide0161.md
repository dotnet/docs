...
These rules concern [how namespaces are declared](../../../csharp/language-reference/keywords/namespace.md). For `IDE0161` to report violations when block-scoped namespaces are used, you must set the associated option to `file_scoped`.
