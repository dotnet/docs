...
This rule flags the use of a `Main` method entry point in a project that could be converted to [top-level statements](../../../csharp/fundamentals/program-structure/top-level-statements.md) instead.
