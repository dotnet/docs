...
This rule flags code that uses `goto` statements or boolean flag patterns to break out of or continue nested loops, where a [labeled `break` or `continue` statement](../../../csharp/language-reference/statements/jump-statements.md) (C# 15+) would be clearer and more concise.
