...
This rule identifies incomplete member declarations where a type name can't be resolved in the current context. It's an internal IDE diagnostic that enables code fixes such as **Add Import**, **Fully Qualify**, and **Generate Type** to work on incomplete member declarations.
