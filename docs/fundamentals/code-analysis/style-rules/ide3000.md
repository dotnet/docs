...
When you click on the light bulb suggestion, select the **Implement using Copilot** option to prompt GitHub Copilot to generate an implementation for the method.
