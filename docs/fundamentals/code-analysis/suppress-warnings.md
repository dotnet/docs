...
Use the *documentation ID* for the API you want to reference in the `Target` attribute. For information about documentation IDs, see [Documentation ID format](../../../csharp/language-reference/language-specification/documentation-comments.md#id-string-format).
