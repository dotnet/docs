...
Use a [#pragma warning (C#)](/dotnet/csharp/language-reference/preprocessor-directives) or [Disable (Visual Basic)](../../visual-basic/language-reference/directives/disable-enable.md) directive to suppress the warning for only a specific line of code.
