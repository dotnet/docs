...
These events come with high performance overhead and their shape is constantly changing. As the name suggests, they are not part of the public API and you should therefore not rely on their behavior or existence. On top of that, they are not anyhow redacted and thus might contain PII.
...
Or they can be consumed out of process via dotnet-trace:
