...
The `StringSort` value can only be used with <xref:System.Globalization.CompareInfo.Compare*?displayProperty=nameWithType> and <xref:System.Globalization.CompareInfo.GetSortKey*?displayProperty=nameWithType>. <xref:System.ArgumentException> is thrown if the StringSort value is used with <xref:System.Globalization.CompareInfo.IsPrefix*?displayProperty=nameWithType>, <xref:System.Globalization.CompareInfo.IsSuffix*?displayProperty=nameWithType>, <xref:System.Globalization.CompareInfo.IndexOf*?displayProperty=nameWithType>, or <xref:System.Globalization.CompareInfo.LastIndexOf*?displayProperty=nameWithType>.
