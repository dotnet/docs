...
For a list of initial property values for an instance of <xref:System.NotSupportedException>, see the <xref:System.NotSupportedException.%23ctor*> constructors.
...
If a <xref:System.NotSupportedException.%23ctor*> exception is thrown, check:
