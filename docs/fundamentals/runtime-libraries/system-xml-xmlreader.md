...
|<xref:System.Xml.XmlReader.GetAttribute*> method or <xref:System.Xml.XmlReader.Item> property|Get the value of a specified attribute.|
...
When the XML reader is positioned on a document type node, the <xref:System.Xml.XmlReader.GetAttribute*> method and <xref:System.Xml.XmlReader.Item> property can be used to return the values for the SYSTEM and PUBLIC literals. For example, calling `reader.GetAttribute("PUBLIC")` returns the PUBLIC value.
