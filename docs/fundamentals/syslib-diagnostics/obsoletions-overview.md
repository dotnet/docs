...
If you must use the obsolete APIs and the `SYSLIB1XXX` diagnostic does not surface as an error, you can suppress the warning in code or in your project file.
