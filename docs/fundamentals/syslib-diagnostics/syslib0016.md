...
For better performance and fewer allocations, use the <xref:System.Drawing.Graphics.GetContextInfo*?displayProperty=nameWithType> overloads that accept arguments:
