...
> [!NOTE]
> These prerequisites apply to Visual Studio. For other development environments, see [Install GitHub Copilot upgrade](../core/porting/github-copilot-upgrade/install.md).
