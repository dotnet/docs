...
|Suggestion|This change only affects applications targeting the .NET Framework 4.6.1. This change may be disabled (or enabled if targetting pre-4.6.1) with the <a href="../../../../framework/migration-guide/mitigation-x509certificateclaimset-findclaims-method.md">DisableMultipleDNSEntries</a> compatibility switch.|
|Scope|Minor|
|Version|4.6.1|
|Type|Retargeting|
