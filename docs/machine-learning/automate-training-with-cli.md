...
description: Discover how to use the ML.NET CLI tool to automatically train the best model from the command-line. This is a great PR to test some automation.
ms.date: 11/10/2022
