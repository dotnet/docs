...
- the source code that was used to for feature selection and model training (so that you can understood the model)
...
1. Via an application, with the AutoML API
