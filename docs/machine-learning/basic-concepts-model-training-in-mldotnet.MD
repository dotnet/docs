...
ms.topic: overview
ms.custom: mvc
#Customer intent: As a developer, I want to learn high level ML.NET concepts so that I can understand how to leverage machine learning in my applications.
---
# Overview of ML.NET
...
## Basic concepts for model training
