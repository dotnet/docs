...
|Generalized additive model (GAM)|Like decision tree algorithms, generalized additive model (GAM) algorithms also use trees. They bridge the gap between the explainability of linear models and tree models.|
