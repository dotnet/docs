...
Experiments are highly configurable. See the [AutoML API docs](https://docs.microsoft.com/en-us/dotnet/api/?view=automl-dotnet) for a full list of configuration settings.
