...
| <xref:Microsoft.ML.DnnImageFeaturizer.ResNet18Extension> | This is an extension method to be used with the <xref:Microsoft.ML.Transforms.DnnImageFeaturizerEstimator> to use a pretrained ResNet18 model. The NuGet containing this extension is also guaranteed to include the binary model file. |
| <xref:Microsoft.ML.DnnImageFeaturizer.ResNet50Extension> | This is an extension method to be used with the <xref:Microsoft.ML.Transforms.DnnImageFeaturizerEstimator> to use a pretrained ResNet50model. The NuGet containing this extension is also guaranteed to include the binary model file. |
| <xref:Microsoft.ML.DnnImageFeaturizer.ResNet101Extension> | This is an extension method to be used with the <xref:Microsoft.ML.Transforms.DnnImageFeaturizerEstimator> to use a pretrained ResNet101 model. The NuGet containing this extension is also guaranteed to include the binary model file. |
...
| Transform | Definition |
| --- | --- |
| <xref:Microsoft.ML.Transforms.BootstrapSampleTransform> | Approximates bootstrap sampling using Poisson sampling. |
...
| <xref:Microsoft.ML.Transforms.SlotsDroppingTransformer> | Drops slots from columns.|
