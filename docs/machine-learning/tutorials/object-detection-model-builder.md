...
1. In **Connection Settings**, change the **Display Name** for the source connection to *StopSignImages*, and select *Local File System* as the **Provider**. For the **Folder Path**, select the folder which contains the 50 training images, and then select **Save Connection**.
