...
1. In Visual Studio 2022 open the project generated in the folder named `SampleClassification` within your original destination folder (in the tutorial was named `/cli-test`). You should see the project similar to:
