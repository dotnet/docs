...
The Orleans programming model is based on [asynchronous programming](../../csharp/async-renamed.md). Using the grain reference from the previous example, here's how to perform a grain method invocation:
