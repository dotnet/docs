---
title: Unit testing sample project
description: Explore how to unit test .NET Orleans apps.
ms.date: 02/04/2022
---

# Unit testing in Orleans
...
To create a collection fixture:
...
Orleans also makes it possible to mock many parts of the system, and for many scenarios, this is the easiest way to unit test grains.
This approach does have limitations (for example, around scheduling reentrancy and serialization), and may require that grains include code used only by your unit tests. The [Orleans TestKit](https://github.com/OrleansContrib/OrleansTestKit) provides an alternative approach which side-steps many of these limitations.
