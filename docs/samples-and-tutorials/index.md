...
Many topics show source code and samples that are available for viewing or download from GitHub. To view a sample, follow the sample link to the sample folder at aspnet/Docs or dotnet/docs on GitHub. To obtain the code for a sample mentioned in a topic, follow these instructions:
