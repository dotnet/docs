...
This guide provides end-to-end guidance on building monolithic web applications using ASP&period;NET Core and Azure.
...
A secondary audience is technical decision makers who are already familiar ASP&period;NET and/or Azure and are looking for information on whether it makes sense to upgrade to ASP&period;NET Core for new or existing projects.
...
[Next] (modern-web-application-characteristics.md)
