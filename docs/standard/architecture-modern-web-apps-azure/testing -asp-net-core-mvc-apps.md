---
title: Testing ASP.NET Core MVC Apps | Microsoft Docs 
description: Architecting Modern Web Applications with ASP.NET Core and Azure | Testing ASP.NET Core MVC Apps
