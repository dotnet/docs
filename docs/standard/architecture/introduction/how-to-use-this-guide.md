---
title: How to use this guide | Microsoft Docs 
description: .NET Microservices Architecture for Containerized .NET Applications | How to use this guide
...
[Previous] (who-should-use-this-guide.md)
[Next] (related-microservice-and-container-based-reference-application-eshoponcontainers.md)
