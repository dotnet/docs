---
title: Implementing validations in the domain model layer | Microsoft Docs 
description: .NET Microservices Architecture for Containerized .NET Applications | Implementing validations in the domain model layer
...
[Previous] (designing-validations-in-the-domain-model-layer.md)
[Next] (client-side-validation-(validation-in-the-presentation-layers).md)
