...
### [State and data in Docker applications](architect-microservice-container-applications/docker-applications-state-data.md)
...
### [Applying simplified CQRS and DDD patterns in a microservice](microservice-ddd-cqrs-patterns/applying-simplified-cqrs-and-ddd-patterns-in-a-microservice.md)
...
### [Implementing a microservice domain model with .NET Core](microservice-ddd-cqrs-patterns/net-core-microservice-domain-model-using.md)
...
### [Health monitoring](implement-resilient-applications/monitor-app-health)
