...
>
> - For .NET and .NET Core, add a reference to the NuGet package that contains the assembly. Either use the NuGet Package Manager in Visual Studio or add a [`<PackageReference>`](../../core/tools/dependencies.md#add-and-remove-package-depencencies) element for the assembly to the *.csproj* or *.vbproj* project.
