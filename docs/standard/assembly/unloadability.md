...
> - If a reference to an object was available at any point in a method, the JIT compiler might keep the reference in a stack slot or processor register for as long as it wants in the current function.
