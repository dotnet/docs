...
description: In this article, learn about the Task-based Asynchronous Pattern (TAP). TAP is the recommended asynchronous design pattern for new development in .NET.
ms.date: "02/26/2019"
