...
<a name="Events"></a>   
### Events  
 An event defines an incident that can be responded to, and defines methods for subscribing to, unsubscribing from, and raising the event. Events are often used to inform other types of state changes. For more information, see [Events](../../../docs/standard/events/handling-and-raising-events.md).  
