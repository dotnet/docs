...
description: Learn to use custom TimeSpan format strings in .NET. A custom format string contains one or more TimeSpan format specifiers & any number of literal characters.
ms.date: "03/30/2017"
