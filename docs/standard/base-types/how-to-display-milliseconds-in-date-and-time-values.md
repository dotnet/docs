...
> [!TIP]
> The <xref:System.Globalization.NumberFormatInfo.NumberDecimalSeparator?displayProperty=fullName> property specifies the millisecond separator.

## Example

The example displays the millisecond component of a <xref:System.DateTime> and a <xref:System.DateTimeOffset> value to the console, alone and included in a longer date and time string.
