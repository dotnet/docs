...
description: In this article, read an example that shows how to strip potentially harmful characters from a string by using the static Regex.Replace method.
ms.date: "03/30/2017"
