...
|`@`|Match the @ character.|
|`(?<=[0-9a-z])`|Continue the match if the character that precedes the @ character is A through Z, a through z, or 0 through 9. This pattern defines a zero-width positive lookbehind assertion.|
