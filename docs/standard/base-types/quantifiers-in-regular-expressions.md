...
### Match Zero or More Times: *  
 ...
 The following example illustrates this regular expression. Of the nine decimal integers in the input string, five match the pattern and four (`95`, `929`, `9219`, and `9919`) do not.  
