...
* Language support: Visual Basic and F# are currently supported in .NET Core but not for all project types. For a list of supported project templates, see [](../core/tools/dotnet-new.md#arguments).
