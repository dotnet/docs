...
* *.NET Framework*
* *.NET 5+*, which includes .NET Core, .NET 5, and later versions.
...
- Your app uses .NET Framework technologies that aren't available for .NET 5+.
...
### .NET Framework technologies not available for .NET 5+
