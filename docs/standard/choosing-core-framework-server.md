...
* WPF and Windows Forms: WPF (Windows Presentation Foundation) and Windows Forms Applications are only available on the .NET Framework and there are no plans to bring them to .NET Core and these will continue to be part of .NET Standard. 
