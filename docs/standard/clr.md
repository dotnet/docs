...
|[NIB: Overview of the .NET Framework](https://msdn.microsoft.com/library/a4t23ktk(v=vs.100).aspx)|Describes key .NET Framework concepts such as the common type system, cross-language interoperability, managed execution, application domains, and assemblies.|  
