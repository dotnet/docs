...
description: Know when to use a thread-safe collection in .NET. Learn about 5 collection types that are specially designed to support multithreaded add & remove operations.
ms.date: "03/30/2017"
