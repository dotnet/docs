---
title: "When to Use a Thread-Safe Collection | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
## ConcurrentBag  
 In pure producer-consumer scenarios, <xref:System.Collections.Concurrent.ConcurrentBag%601?displayProperty=fullName> will probably perform more slowly than the other concurrent collection types.  
...
## BlockingCollection  
 When bounding and blocking semantics are required, <xref:System.Collections.Concurrent.BlockingCollection%601?displayProperty=fullName> will probably perform faster than any custom implementation. It also supports rich cancellation, enumeration, and exception handling.  
