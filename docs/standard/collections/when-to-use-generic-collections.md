...
For programs that target the .NET Standard 1.0 or later, you should use the generic collection classes in the <xref:System.Collections.Concurrent> namespace when multiple threads might be adding or removing items from the collection concurrently. Additionally, when immutability is desired consider the generic collection classes <xref:System.Collections.Immutable>.
...
When considering immutability as a functional desire of application development, the <xref:System.Collections.Immutable> namespace offers generic collection types. All of the immutable collection types offer `Builders` as an optimization to performing numerous mutations, which work to batch operations in an unfrozen state. When all mutations have been completed on a `Builder` instance call `ToImmutable` to freezes all nodes - thus resulting in an `Immutable*<T>` generic collection.

- The <xref:System.Collections.Immutable.ImmutableList%601.Builder> object can be created by calling the nongeneric <xref:System.Collections.Immutable.ImmutableList.CreateBuilder%2A?displayProperty=nameWithType> function. From an <xref:System.Collections.Immutable.ImmutableList%601.Builder> instance, you can call <xref:System.Collections.Immutable.ImmutableList%601.Builder.ToImmutable%2A?displayProperty=nameWithType>. Likewise, from an <xref:System.Collections.Immutable.ImmutableList%601> you can call <xref:System.Collections.Immutable.ImmutableList%601.ToBuilder?displayProperty=nameWithType> to create a builder instance from the generic immutable collection.

- The <xref:System.Collections.Immutable.ImmutableArray%601.Builder> object can be created by calling the nongeneric <xref:System.Collections.Immutable.ImmutableArray.CreateBuilder%2A?displayProperty=nameWithType> function. From an <xref:System.Collections.Immutable.ImmutableArray%601.Builder> instance, you can call <xref:System.Collections.Immutable.ImmutableArray%601.Builder.ToImmutable%2A?displayProperty=nameWithType>. Likewise, from an <xref:System.Collections.Immutable.ImmutableArray%601> you can call <xref:System.Collections.Immutable.ImmutableArray%601.ToBuilder?displayProperty=nameWithType> to create a builder instance from the generic immutable collection.

- The <xref:System.Collections.Immutable.ImmutableHashSet%601.Builder> object can be created by calling the nongeneric <xref:System.Collections.Immutable.ImmutableHashSet.CreateBuilder%2A?displayProperty=nameWithType> function. From an <xref:System.Collections.Immutable.ImmutableHashSet%601.Builder> instance, you can call <xref:System.Collections.Immutable.ImmutableHashSet%601.Builder.ToImmutable%2A?displayProperty=nameWithType>. Likewise, from an <xref:System.Collections.Immutable.ImmutableHashSet%601> you can call <xref:System.Collections.Immutable.ImmutableHashSet%601.ToBuilder?displayProperty=nameWithType> to create a builder instance from the generic immutable collection.

- The <xref:System.Collections.Immutable.ImmutableSortedSet%601.Builder> object can be created by calling the nongeneric <xref:System.Collections.Immutable.ImmutableSortedSet.CreateBuilder%2A?displayProperty=nameWithType> function. From an <xref:System.Collections.Immutable.ImmutableSortedSet%601.Builder> instance, you can call <xref:System.Collections.Immutable.ImmutableSortedSet%601.Builder.ToImmutable%2A?displayProperty=nameWithType>. Likewise, from an <xref:System.Collections.Immutable.ImmutableSortedSet%601> you can call <xref:System.Collections.Immutable.ImmutableSortedSet%601.ToBuilder?displayProperty=nameWithType> to create a builder instance from the generic immutable collection.

- The <xref:System.Collections.Immutable.ImmutableDictionary%602.Builder> object can be created by calling the nongeneric <xref:System.Collections.Immutable.ImmutableDictionary.CreateBuilder%2A?displayProperty=nameWithType> function. From an <xref:System.Collections.Immutable.ImmutableDictionary%602.Builder> instance, you can call <xref:System.Collections.Immutable.ImmutableDictionary%602.Builder.ToImmutable%2A?displayProperty=nameWithType>. Likewise, from an <xref:System.Collections.Immutable.ImmutableDictionary%602> you can call <xref:System.Collections.Immutable.ImmutableDictionary%602.ToBuilder?displayProperty=nameWithType> to create a builder instance from the generic immutable collection.

- The <xref:System.Collections.Immutable.ImmutableSortedDictionary%602.Builder> object can be created by calling the nongeneric <xref:System.Collections.Immutable.ImmutableSortedDictionary.CreateBuilder%2A?displayProperty=nameWithType> function. From an <xref:System.Collections.Immutable.ImmutableSortedDictionary%602.Builder> instance, you can call <xref:System.Collections.Immutable.ImmutableSortedDictionary%602.Builder.ToImmutable%2A?displayProperty=nameWithType>. Likewise, from an <xref:System.Collections.Immutable.ImmutableSortedDictionary%602> you can call <xref:System.Collections.Immutable.ImmutableSortedDictionary%602.ToBuilder?displayProperty=nameWithType> to create a builder instance from the generic immutable collection.
