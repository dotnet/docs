...
Visual Studio Azure DevOps Services and Team Foundation Server support Git and Team Foundation Version Control. You can choose between them and use it for an end-to-end Microsoft experience. However, you also can manage your code in external repositories (like GitHub, on-premises Git repositories, or Subversion) and still be able to connect to it and get the code as the starting point for your DevOps CI pipeline.
...
-   A Azure DevOps Services agent that has the Docker binaries.
...
Running a Azure DevOps Services agent as a Docker container: [https://hub.docker.com/r/\
