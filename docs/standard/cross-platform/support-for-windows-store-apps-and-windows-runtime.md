...
|[Windows Runtime reference](https://docs.microsoft.com/en-us/uwp/api/)|The reference documentation for the [!INCLUDE[wrt](../../../includes/wrt-md.md)]. (In the Windows Dev Center.)|  
