...
|[Windows Runtime reference](http://msdn.microsoft.com/en-us/library/windows/apps/br211377.aspx)|The reference documentation for the [!INCLUDE[wrt](../../../includes/wrt-md.md)]. (In the Windows Dev Center.)|  
