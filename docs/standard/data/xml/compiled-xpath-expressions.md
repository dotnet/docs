...
An <xref:System.Xml.XPath.XPathExpression> object represents a compiled XPath query returned from either the static <xref:System.Xml.XPath.XPathExpression.Compile*> method of the <xref:System.Xml.XPath.XPathExpression> class or the <xref:System.Xml.XPath.XPathNavigator.Compile*> method of the <xref:System.Xml.XPath.XPathNavigator> class.
...
## The XPathExpression Class
 ...
 For example, when calling the <xref:System.Xml.XPath.XPathNavigator.Select*> method multiple times, instead of using a string representing the XPath query each time, use the <xref:System.Xml.XPath.XPathExpression.Compile*> method of the <xref:System.Xml.XPath.XPathExpression> class or the <xref:System.Xml.XPath.XPathNavigator.Compile*> method of the <xref:System.Xml.XPath.XPathNavigator> class to compile and cache the XPath query in an <xref:System.Xml.XPath.XPathExpression> object for reuse and improved performance.
...
- <xref:System.Xml.XPath.XPathNavigator.Evaluate*?displayProperty=nameWithType>

- <xref:System.Xml.XPath.XPathNavigator.Evaluate*?displayProperty=nameWithType>

- <xref:System.Xml.XPath.XPathNavigator.Matches*>

- <xref:System.Xml.XPath.XPathNavigator.Select*>

- <xref:System.Xml.XPath.XPathNavigator.SelectSingleNode*>
...
|---------------------------|------------------------------------|-----------------|-------------|
|`Node set`|<xref:System.Xml.XPath.XPathNodeIterator>|An unordered collection of nodes without duplicates created in document order.|<xref:System.Xml.XPath.XPathNavigator.Select*> or <xref:System.Xml.XPath.XPathNavigator.Evaluate*>|
|`Boolean`|<xref:System.Boolean>|A `true` or `false` value.|<xref:System.Xml.XPath.XPathNavigator.Evaluate*> or<br /><br /> <xref:System.Xml.XPath.XPathNavigator.Matches*>|
|`Number`|<xref:System.Double>|A floating-point number.|<xref:System.Xml.XPath.XPathNavigator.Evaluate*>|
|`String`|<xref:System.String>|A sequence of UCS characters.|<xref:System.Xml.XPath.XPathNavigator.Evaluate*>|

> [!NOTE]
> The <xref:System.Xml.XPath.XPathNavigator.Matches*> method accepts an XPath expression as its parameter. The <xref:System.Xml.XPath.XPathNavigator.SelectSingleNode*> method returns an <xref:System.Xml.XPath.XPathNavigator> object, not one of the W3C XPath return types.
...
- <xref:System.Xml.XPath.XPathResultType.String>
 ...
 The following example uses the <xref:System.Xml.XPath.XPathExpression> object to return a number and a node set from the `books.xml` file. The <xref:System.Xml.XPath.XPathExpression.ReturnType> property of each <xref:System.Xml.XPath.XPathExpression> object as well as the results from the <xref:System.Xml.XPath.XPathNavigator.Evaluate*> and <xref:System.Xml.XPath.XPathNavigator.Select*> methods are written to the console.
