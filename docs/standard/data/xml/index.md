...
-   **Productivity.** [LINQ to XML](https://msdn.microsoft.com/library/bb387098.aspx) makes it easier to program with XML and provides a query experience that is similar to SQL.  
...
## In This Section  
 ...
 Discusses the three models for processing XML data in-memory. [LINQ to XML](https://msdn.microsoft.com/library/bb387098.aspx), the <xref:System.Xml.XmlDocument> class (based on the W3C Document Object Model), and the <xref:System.Xml.XPath.XPathDocument> class (based on the XPath data model).  
