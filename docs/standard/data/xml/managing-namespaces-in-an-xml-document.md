...
> [!NOTE]
>  [LINQ to XML](../Topic/LINQ%20to%20XML.md) doesn't use <xref:System.Xml.XmlNamespaceManager> to manage namespaces. See [Working with XML Namespaces](../Topic/Working%20with%20XML%20Namespaces.md) in the LINQ documentation for information about managing namespaces when using LINQ to XML.  
