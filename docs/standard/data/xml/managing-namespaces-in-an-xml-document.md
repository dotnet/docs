...
> [!NOTE]
>  [LINQ to XML](https://msdn.microsoft.com/library/f0fe21e9-ee43-4a55-b91a-0800e5782c13) doesn't use <xref:System.Xml.XmlNamespaceManager> to manage namespaces. See [Working with XML Namespaces](https://docs.microsoft.com/previous-versions/bb387093(v=vs.140)) in the LINQ documentation for information about managing namespaces when using LINQ to XML.  
