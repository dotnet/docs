...
> [!NOTE]
> You cannot rely on the <xref:System.DateTime.Year*?displayProperty=nameWithType> value when the content is typed as `xs:gMonthDay`. The <xref:System.DateTime.Year*?displayProperty=nameWithType> value is always set to 1904 in this case.
