---
description: "Learn more about: XSLT Compiler (xsltc.exe)"
...
> Script blocks are supported only in .NET Framework. They are _not_ supported on .NET Core or .NET 5 or later.
 ...
 The xsltc.exe tool is included with Visual Studio. For more information, see the [Visual Studio Downloads](https://aka.ms/vsdownload?utm_medium=microsoft&utm_source=learn.microsoft.com&utm_campaign=inline+link).
