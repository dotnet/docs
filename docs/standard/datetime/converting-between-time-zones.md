...
The following example uses the [ConvertTime](xref:system.timezoneinfo.ConvertTime_System_DateTime_System_TimeZoneInfo_System_TimeZoneInfo_) method to convert from Hawaiian Standard Time to local time.
