...
The offset of the resulting <xref:System.DateTimeOffset> value depends on the <xref:System.DateTime.Kind%2A?displayProperty=fullName> property value. If its value is <xref:System.DateTimeKind.Utc?displayProperty=fullName>, the offset is set equal to <xref:System.TimeSpan.Zero?displayProperty=fullName>. If its value is either <xref:System.DateTimeKind.Local?displayProperty=fullName> or <xref:System.DateTimeKind.Unspecified?displayProperty=fullName>, the offset is set equal to that of the local time zone.
