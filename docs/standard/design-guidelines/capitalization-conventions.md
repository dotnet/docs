...
- camelCasing
 ...
 The PascalCasing convention, used for all identifiers except parameter names and local variables, capitalizes the first character of each word (including acronyms over two letters in length), as shown in the following examples:
