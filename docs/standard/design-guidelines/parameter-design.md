 ...
 **X DO NOT** use Booleans unless you are absolutely sure there will never be a need for more than two values.  
 ...
 Enums give you some room for future addition of values, but you should be aware of all the implications of adding values to enums, which are described in [Enum Design](../../../docs/standard/design-guidelines/enum-design.md).  
...
## See Also  
 [Member Design Guidelines](../../../docs/standard/design-guidelines/member-design-guidelines.md)   
