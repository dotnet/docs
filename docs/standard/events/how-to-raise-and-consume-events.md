...
description: See examples of how to raise & consume events in .NET. These examples use the EventHandler delegate, the EventHandler<TEventArgs> delegate, & a custom delegate.
ms.date: "03/30/2017"
