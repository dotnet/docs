...
description: Learn to use the try block to contain statements that might raise of throw an exception. Place statements to handle exceptions in one or more catch blocks.
ms.date: "02/06/2019"
