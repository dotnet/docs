...
Within your library or app, you write conditional code using [preprocessor directives](/dotnet/csharp/language-reference/preprocessor-directives) to compile for each target framework:
