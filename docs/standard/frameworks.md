...
| Framework                        | Can use                     |
| -------------------------------- | --------------------------- |
| uap (Universal Windows Platform) | win81<br>wpa81<br>netcore50 |
