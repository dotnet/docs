...
## The managed heap  
 ...
 To reserve memory, the garbage collector calls the Win32 [VirtualAlloc](http://msdn.microsoft.com/en-us/library/aa366887.aspx) function, and reserves one segment of memory at a time for managed applications. The garbage collector also reserves segments as needed, and releases segments back to the operating system (after clearing them of any objects) by calling the Win32 [VirtualFree](http://msdn.microsoft.com/en-us/library/aa366892.aspx) function.  
