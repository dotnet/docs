...
description: This article discusses large objects, how they are managed by the .NET garbage collector, and what kind of performance implications large objects impose.
ms.date: 05/02/2018
helpviewer_keywords:
