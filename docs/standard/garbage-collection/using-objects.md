...
description: Learn to use objects that implement the IDisposable interface in .NET. Types that use unmanaged resource implement IDisposable to allow resource reclaiming.
ms.date: 05/13/2020
