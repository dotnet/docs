...
Generics are also available at run time. This means the runtime knows what type of data structure you're using and can store it in memory more efficiently.
