...
-   `Invariance`  
 ...
 Covariant type parameters enable you to make assignments that look much like ordinary [Polymorphism](../Topic/Polymorphism%20\(C%23%20Programming%20Guide\).md), as shown in the following code.  
