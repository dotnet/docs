...
>  If a method of an interface has a parameter that is a generic delegate type, a covariant type parameter of the interface type can be used to specify a contravariant type parameter of the delegate type.  
 ...
 For information and example code, see [Variance in Generic Interfaces](https://msdn.microsoft.com/library/dd233059.aspx).  
...
## See Also  
 [Covariance and Contravariance](https://msdn.microsoft.com/library/ee207183.aspx)   
 [Variance in Delegates](https://msdn.microsoft.com/library/dd233060.aspx)
