...
* The [F# Getting Started](/dotnet/fsharp/get-started/index) tutorials provide three primary ways you can use F#: with Visual Studio, Visual Studio Code, or command-line tools.
