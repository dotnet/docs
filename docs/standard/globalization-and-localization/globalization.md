---
title: "Globalization | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   [Handling Strings](../../../docs/standard/globalization-and-localization/globalization.md#HandlingStrings)  
  
    -   [Use Unicode Internally](../../../docs/standard/globalization-and-localization/globalization.md#Strings_Unicode)  
  
    -   [Use Resource Files](../../../docs/standard/globalization-and-localization/globalization.md#Strings_Resources)  
  
    -   [Searching and Comparing Strings ](../../../docs/standard/globalization-and-localization/globalization.md#Strings_Searching)  
  
    -   [Testing Strings for Equality](../../../docs/standard/globalization-and-localization/globalization.md#Strings_Equality)  
  
    -   [Ordering and Sorting Strings ](../../../docs/standard/globalization-and-localization/globalization.md#Strings_Ordering)  
  
    -   [Avoid String Concatenation](../../../docs/standard/globalization-and-localization/globalization.md#Strings_Concat)  
  
-   [Handling Dates and Times](../../../docs/standard/globalization-and-localization/globalization.md#DatesAndTimes)  
  
    -   [Persisting Dates and Times](../../../docs/standard/globalization-and-localization/globalization.md#DatesAndTimes_Persist)  
  
    -   [Displaying Dates and Times](../../../docs/standard/globalization-and-localization/globalization.md#DatesAndTimes_Display)  
  
    -   [Serialization and Time Zone Awareness](../../../docs/standard/globalization-and-localization/globalization.md#DatesAndTimes_TimeZones)  
  
    -   [Performing Date and Time Arithmetic](../../../docs/standard/globalization-and-localization/globalization.md#DatesAndTimes_Arithmetic)  
  
-   [Handling Numeric Values](../../../docs/standard/globalization-and-localization/globalization.md#Numbers)  
  
    -   [Displaying Numeric Values](../../../docs/standard/globalization-and-localization/globalization.md#Numbers_Display)  
  
    -   [Persisting Numeric Values](../../../docs/standard/globalization-and-localization/globalization.md#Numbers_Persist)  
  
-   [Working with Culture-Specific Settings](../../../docs/standard/globalization-and-localization/globalization.md#Cultures)  
...
```  
 ...
 For more information, see [Converting Times Between Time Zones](../../../docs/standard/datetime/converting-times-between-time-zones.md).  
...
3.  If the result is a date and time value, convert it from UTC to the time in the source time zone.  
 ...
 For more information, see [Performing Arithmetic Operations with Dates and Times](../../../docs/standard/datetime/performing-arithmetic-operations-with-dates-and-times.md).  
...
## See Also  
 ...
 [Best Practices for Using Strings](../../../docs/standard/base-types/best-practices-for-using-strings.md)