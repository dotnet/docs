...
The preceding method exists as an extension method on `ReadOnlySequence<T>`. <System.Buffers.BuffersExtensions.PositionOf> can be used to simplify the preceding code:
