...
This article provides an overview of types that help you read data that runs across multiple buffers. They're primarily used to support <xref:System.IO.Pipelines.PipeReader> objects.
