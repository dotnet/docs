...
The [System.IO.WindowsRuntimeStreamExtensions](https://docs.microsoft.com/dotnet/api/system.io?view=netframework-4.7.2) class contains methods that make these conversions easy. However, underlying differences between .NET Framework and Windows Runtime streams affect the results of using these methods, as described in the following sections:

## Convert from a Windows Runtime to a .NET Framework stream
To convert from a Windows Runtime stream to a .NET Framework stream, use one of the following [System.IO.WindowsRuntimeStreamExtensions](https://msdn.microsoft.com/library/system.io.windowsruntimestreamextensions.aspx) methods:

- [System.IO.WindowsRuntimeStreamExtensions.AsStream](https://docs.microsoft.com/dotnet/api/system.io?view=netframework-4.7.2) converts a random-access stream in the Windows Runtime to a managed stream in .NET for UWP apps.
  
- [System.IO.WindowsRuntimeStreamExtensions.AsStreamForWrite](https://docs.microsoft.com/dotnet/api/system.io?view=netframework-4.7.2) converts an output stream in the Windows Runtime to a managed stream in .NET for UWP apps.
  
- [System.IO.WindowsRuntimeStreamExtensions.AsStreamForRead](https://docs.microsoft.com/dotnet/api/system.io?view=netframework-4.7.2) converts an input stream in the Windows Runtime to a managed stream in .NET for UWP apps.
...
To convert from a .NET Framework stream to a Windows Runtime stream, use one of the following [System.IO.WindowsRuntimeStreamExtensions](https://docs.microsoft.com/dotnet/api/system.io?view=netframework-4.7.2) methods:

- [System.IO.WindowsRuntimeStreamExtensions.AsInputStream](https://docs.microsoft.com/dotnet/api/system.io?view=netframework-4.7.2) converts a managed stream in .NET for UWP apps to an input stream in the Windows Runtime.
  
- [System.IO.WindowsRuntimeStreamExtensions.AsOutputStream](https://docs.microsoft.com/dotnet/api/system.io?view=netframework-4.7.2) converts a managed stream in .NET for UWP apps to an output stream in the Windows Runtime.
