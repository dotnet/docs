...
## Converting from a .NET Framework stream to a Windows Runtime stream  
 ...
 [AsRandomAccessStream](../../../docs/standard/cross-platform/windowsruntimestreamextensions-asrandomaccessstream-system-io-stream-method.md)  
...
-   Use the [AsRandomAccessStream](../../../docs/standard/cross-platform/windowsruntimestreamextensions-asrandomaccessstream-system-io-stream-method.md) method, as shown in the following example.  
