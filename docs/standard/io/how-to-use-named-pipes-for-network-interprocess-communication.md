...
description: In this article, see two examples of using named pipes for interprocess communication between a pipe server and one or more pipe clients in a network.
ms.date: "03/30/2017"
