...
The [NETStandard.Library](https://www.nuget.org/packages/NETStandard.Library) metapackage describes the set of libraries that define (in part) one or more .NET Standard versions.
