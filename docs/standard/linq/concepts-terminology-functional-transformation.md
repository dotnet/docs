...
For more information, see [Anonymous Types (C# Programming Guide)](/dotnet/csharp/fundamentals/types/anonymous-types) and [Anonymous Types (Visual Basic)](../../visual-basic/programming-guide/language-features/objects-and-classes/anonymous-types.md).
