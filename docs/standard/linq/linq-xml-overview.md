...
> [!TIP]
> The examples in this section use [Sample XML file: Typical purchase order](sample-xml-file-typical-purchase-order.md). Save the file to your project directory before running the queries.
