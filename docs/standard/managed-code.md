...
*   [.NET Framework Conceptual Overview](https://docs.microsoft.com/dotnet/framework/get-started/overview)
*   [Unsafe Code and Pointers](../../docs/csharp/programming-guide/unsafe-code-pointers/index.md)
*   [Interoperability (C# Programming guide)](https://docs.microsoft.com/dotnet/csharp/programming-guide/interop/index)
