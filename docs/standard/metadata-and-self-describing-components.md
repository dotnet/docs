...
|Title|Description|  
|-----------|-----------------|  
|[Attributes](../../docs/standard/attributes/extending-metadata-using-attributes.md)|Describes how to apply attributes, write custom attributes, and retrieve information that is stored in attributes.|