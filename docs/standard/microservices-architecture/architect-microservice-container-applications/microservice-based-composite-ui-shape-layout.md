...
description: .NET Microservices Architecture for Containerized .NET Applications | Microservices architecture is not only for the backend, get a peek view at using it in the frontend.
...
![In composite UI application, each UI sections is generated by a UI composition microservice, that acts like a mini-gateway.](./media/image21.png)
