...
Therefore, you need some kind of defense barrier so that excessive requests stop when it is not worth to keep trying. That defense barrier is precisely the circuit breaker.
