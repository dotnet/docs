...
- [Using HttpClientFactory in .NET Core](/aspnet/core/fundamentals/http-requests)
- [HttpClientFactory GitHub repo](https://github.com/aspnet/Extensions/tree/master/src/HttpClientFactory)
