...
Custom authorization rules can also be written using [authorization policies](/aspnet/core/security/authorization/policies). In this section we provide an overview. More detail is available in the online [ASP.NET Authorization Workshop](https://github.com/blowdart/AspNetAuthorizationWorkshop).
...
An example of a custom authorization requirement and handler for checking a user's age (based on a DateOfBirth claim) is available in the ASP.NET Core [authorization documentation](/aspnet/core/security/authorization/policies).

## Additional resources

-   [Introduction to Identity on ASP.NET Core](/aspnet/core/security/authentication/identity)

-   [ASP.NET Core Authorization](/aspnet/core/security/authorization/introduction)

-   [Role based Authorization](/aspnet/core/security/authorization/roles)

-   [Custom Policy-Based Authorization](/aspnet/core/security/authorization/policies)
