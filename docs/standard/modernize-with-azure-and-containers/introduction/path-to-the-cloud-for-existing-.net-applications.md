---
title: Path to the cloud for existing .NET applications | Microsoft Docs 
description: .NET Microservices Architecture for Containerized .NET Applications | Path to the cloud for existing .NET applications
