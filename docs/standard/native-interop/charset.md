...
In .NET 7+, `[LibraryImport]` is the recommendation and an in-box Roslyn Analyzer will provide user guidance. When using `[DllImport]`, this guidance must be manually followed.
