...
### Step 1: Define the Sessionful WCF service interface and implementation
 ...
 In this code, the sessionful object is marked with the `ServiceContract` attribute, which identifies it as a regular WCF service interface.  In addition, the <xref:System.ServiceModel.ServiceContractAttribute.SessionMode> property is set to indicate it will be a sessionful service.
