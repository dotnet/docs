...
> [!NOTE]
> This article describes .NET Framework COM interop guidance that uses legacy type libraries generated by tools such as Tlbexp.exe. For modern .NET, use [COM source generation](comwrappers-source-generation.md) or the <xref:System.Runtime.InteropServices.ComWrappers> API. For more information, see [COM interop](cominterop.md).
