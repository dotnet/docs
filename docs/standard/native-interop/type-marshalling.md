...
If these defaults don't do exactly what you want, you can customize how parameters are marshalled. The [parameter marshalling](/dotnet/standard/native-interop/customize-parameter-marshalling) article walks you through how to customize how different parameter types are marshalled.
...
Sometimes the default marshalling for your structure doesn't do what you need. The [Customizing structure marshalling](/dotnet/standard/native-interop/customize-struct-marshalling) article teaches you how to customize how your structure is marshalled.
