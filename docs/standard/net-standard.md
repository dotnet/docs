...
3. The column header indicates the .NET Standard version that your target supports. You may also target any lower .NET Standard. Higher .NET Standard will also support your implementation.
