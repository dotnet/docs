...
3. The column header indicates the .NET Standard version that your target supports. You may also target any lower .NET standard. Higher .NET standards will also support your implementation.
