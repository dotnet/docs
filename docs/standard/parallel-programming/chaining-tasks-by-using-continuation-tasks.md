...
:::code language="csharp" source="snippets/simple1.cs":::
...
:::code language="csharp" source="snippets/whenall1.cs":::
...
:::code language="csharp" source="snippets/result1.cs":::
...
:::code language="csharp" source="snippets/result2.cs":::
...
:::code language="csharp" source="snippets/cancellation1.cs":::
...
:::code language="csharp" source="snippets/cancellation2.cs":::
...
:::code language="csharp" source="snippets/attached1.cs":::
...
:::code language="csharp" source="snippets/detached1.cs":::
...
:::code language="csharp" source="snippets/continuationstate.cs":::
...
:::code language="csharp" source="snippets/exception1.cs":::
...
:::code language="csharp" source="snippets/exception2.cs" id="example":::
...
:::code language="csharp" source="snippets/exception2.cs" id="exception":::
