...
|[How to: Stop or Break from a Parallel.For Loop](http://msdn.microsoft.com/de52e4f1-9346-4ad5-b582-1a4d54dc7f7e)|Describes how to stop or break from a parallel loop so that all threads are informed of the action.|  
