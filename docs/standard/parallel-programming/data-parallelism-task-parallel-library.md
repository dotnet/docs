...
> [!NOTE]
>  You can also supply your own custom partitioner or scheduler. For more information, see [Custom Partitioners for PLINQ and TPL](../../../docs/standard/parallel-programming/custom-partitioners-for-plinq-and-tpl.md) and [Task Schedulers](https://msdn.microsoft.com/library/system.threading.tasks.taskscheduler(v=vs.110).aspx).  
...
|[How to: Stop or Break from a Parallel.For Loop](https://msdn.microsoft.com/library/dd460721(v=vs.110).aspx)|Describes how to stop or break from a parallel loop so that all threads are informed of the action.|  
