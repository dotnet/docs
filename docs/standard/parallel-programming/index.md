...
|[Task Schedulers](https://docs.microsoft.com/dotnet/api/system.threading.tasks.taskscheduler?view=netframework-4.7.2)|Describes how schedulers work and how the default schedulers may be configured.|
