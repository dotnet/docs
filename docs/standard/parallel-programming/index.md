...
|[Task Schedulers](https://msdn.microsoft.com/library/system.threading.tasks.taskscheduler(v=vs.110).aspx)|Describes how schedulers work and how the default schedulers may be configured.|  
