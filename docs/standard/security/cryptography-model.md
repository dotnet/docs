...
:::code language="csharp" source="snippets/csharp/encrypting-data/aes-encrypt.cs" highlight="9":::
:::code language="vb" source="snippets/vb/encrypting-data/aes-encrypt.vb" highlight="13":::
