...
> [!NOTE]
> The code in this article applies to Windows and uses features not available in .NET Core 2.2 and earlier versions. For more information, see [dotnet/corefx#23686](https://github.com/dotnet/corefx/issues/23686).
