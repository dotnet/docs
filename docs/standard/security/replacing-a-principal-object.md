...
[!code-csharp[SetCurrentPrincipal#1](./snippets/replacing-a-principal-object/csharp/program.cs#1)]
[!code-vb[SetCurrentPrincipal#1](./snippets/replacing-a-principal-object/vb/program.vb#1)]  
