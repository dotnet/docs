...
description: You can design code to work with .NET enforced permissions and other enforcement to help prevent malicious code from accessing data or performing other actions.
ms.date: "06/28/2018"
helpviewer_keywords: 
