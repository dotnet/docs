...
description: Generating code on behalf of lesser-trust code and that runs at a higher trust is a security concern, especially when a caller can influence code generation.
ms.date: "03/30/2017"
