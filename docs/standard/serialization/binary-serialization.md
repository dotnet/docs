...
- <xref:System.Colllections.Generic.NonRandomizedStringEqualityComparer?displayProperty=nameWithType> (available in .NET Core 2.0.4 and later versions)
...
- <xref:System.Diagnostics.Contract.ContractException?displayProperty=nameWithType> (available in .NET Core 2.0.4 and later versions)
...
- <xref:System.DirectoryNotFoundException?displayProperty=nameWithType> (available in .NET Core 2.0.4 and later versions)
