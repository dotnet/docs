...
- [Choosing a serializer](./choosing-a-serializer.md)
- [Migrating persisted payloads](./migrating-persisted-payloads.md)
- Migration samples
   * [DataContractSerializer](./migration-datacontractserializer.md)
   * [System.Text.Json](./migration-systemtextjson.md)
   * [Messagepack](./migration-messagepack.md)
- [WinForms applications](./winforms.md)
- [WPF applications](./wpf.md)
- [Compatibility Package](./compatibility-package.md)
- [BinaryFormatter functionality reference](./functionality-reference.md)
