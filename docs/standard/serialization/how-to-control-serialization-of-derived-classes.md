...
description: You can customize the XML stream by deriving a class from an existing class and instructing the XmlSerializer instance how to serialize the new class.
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
