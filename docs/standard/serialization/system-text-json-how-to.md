...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToString.cs?name=SnippetSerialize)]

The following example uses synchronous code to create a JSON file:

[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToFile.cs?name=SnippetSerialize)]

The following example uses asynchronous code to create a JSON file:

[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToFileAsync.cs?name=SnippetSerialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToString.cs?name=SnippetSerializeWithGenericParameter)]

### Serialization example

Here's an example class that contains collections and a nested class:

[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithPOCOs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToUtf8.cs?name=SnippetSerialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToString.cs?name=SnippetDeserialize)]

To deserialize from a file by using synchronous code, read the file into a string, as shown in the following example:

[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToFile.cs?name=SnippetDeserialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToFileAsync.cs?name=SnippetDeserialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToUtf8.cs?name=SnippetDeserialize1)]

[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToUtf8.cs?name=SnippetDeserialize2)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripToString.cs?name=SnippetSerializePrettyPrint)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithPropertyNameAttribute)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundTripCamelCasePropertyNames.cs?name=Serialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/UpperCaseNamingPolicy.cs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripPropertyNamingPolicy.cs?name=SnippetSerialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/SerializeCamelCaseDictionaryKeys.cs?name=SnippetSerialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithEnum)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripEnumAsString.cs?name=SnippetSerialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/RoundtripEnumAsString.cs?name=SnippetDeserialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithIgnoreAttribute)]
...
[!code-csharp[](./snippets/system-text-json/csharp/SerializeExcludeReadOnlyProperties.cs?name=SnippetSerialize)]

Here's an example type to serialize and JSON output:

[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithROProperty)]
...
[!code-csharp[](./snippets/system-text-json/csharp/SerializeExcludeNullValueProperties.cs?name=SnippetSerialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/SerializeCustomEncoding.cs?name=SnippetUsings)]

[!code-csharp[](./snippets/system-text-json/csharp/SerializeCustomEncoding.cs?name=SnippetLanguageSets)]
...
[!code-csharp[](./snippets/system-text-json/csharp/SerializeCustomEncoding.cs?name=SnippetSelectedCharacters)]
...
[!code-csharp[](./snippets/system-text-json/csharp/SerializeCustomEncoding.cs?name=SnippetUnsafeRelaxed)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFDerived)]

And suppose the type argument of the `Serialize` method at compile time is `WeatherForecast`:

[!code-csharp[](./snippets/system-text-json/csharp/SerializePolymorphic.cs?name=SnippetSerializeDefault)]
...
* Call an overload of <xref:System.Text.Json.JsonSerializer.Serialize%2A> that lets you specify the type at runtime:
  ...
  [!code-csharp[](./snippets/system-text-json/csharp/SerializePolymorphic.cs?name=SnippetSerializeGetType)]

* Declare the object to be serialized as `object`.

  [!code-csharp[](./snippets/system-text-json/csharp/SerializePolymorphic.cs?name=SnippetSerializeObject)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithPrevious)]

[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithPreviousAsObject)]
...
[!code-csharp[](./snippets/system-text-json/csharp/SerializePolymorphic.cs?name=SnippetSerializeSecondLevel)]
...
[!code-csharp[](./snippets/system-text-json/csharp/IForecast.cs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/SerializePolymorphic.cs?name=SnippetSerializeInterface)]
...
[!code-csharp[](./snippets/system-text-json/csharp/DeserializeCommasComments.cs?name=SnippetDeserialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/DeserializeCaseInsensitive.cs?name=SnippetDeserialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithExtensionData)]
...
[!code-csharp[](./snippets/system-text-json/csharp/DeserializeIgnoreNull.cs?name=SnippetDeserialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/JsonDocumentDataAccess.cs?name=SnippetAverageGrades1)]
...
* Counts students by incrementing a `count` variable with each iteration. An alternative is to call <xref:System.Text.Json.JsonElement.GetArrayLength%2A>, as shown in the following example:
  ...
  [!code-csharp[](./snippets/system-text-json/csharp/JsonDocumentDataAccess.cs?name=SnippetAverageGrades2)]

Here's an example of the JSON that this code processes:

[!code-json[](./snippets/system-text-json/csharp/GradesPrettyPrint.json)]

## Use JsonDocument to write JSON

The following example shows how to write JSON from a <xref:System.Text.Json.JsonDocument>:

[!code-csharp[](./snippets/system-text-json/csharp/JsonDocumentWriteJson.cs?name=SnippetSerialize)]
...
[!code-json[](./snippets/system-text-json/csharp/Grades.json)]
...
[!code-csharp[](./snippets/system-text-json/csharp/Utf8WriterToStream.cs?name=SnippetSerialize)]

## Use Utf8JsonReader

The following example shows how to use the <xref:System.Text.Json.Utf8JsonReader> class:

[!code-csharp[](./snippets/system-text-json/csharp/Utf8ReaderFromBytes.cs?name=SnippetDeserialize)]
...
[!code-csharp[](./snippets/system-text-json/csharp/Utf8ReaderFromFile.cs)]
...
[!code-json[](./snippets/system-text-json/csharp/Universities.json)]
...
[!code-csharp[](./snippets/system-text-json/csharp/Utf8ReaderPartialRead.cs)]
