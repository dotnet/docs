...
[!code-csharp[](./snippets/system-text-json/csharp/LongToStringConverter.cs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/DateTimeOffsetNullHandlingConverter.cs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecast.cs?name=SnippetWFWithDefault)]
...
[!code-csharp[](./snippets/system-text-json/csharp/ImmutablePoint.cs#ImmutablePoint)]

And here's a converter that serializes and deserializes this struct:

[!code-csharp[](./snippets/system-text-json/csharp/ImmutablePointConverter.cs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecastRequiredPropertyConverter.cs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecastRuntimeIgnoreConverter.cs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/WeatherForecastCallbacksConverter.cs)]
...
[!code-csharp[](./snippets/system-text-json/csharp/ValueTextEqualsExample.cs?name=SnippetDefineUtf8Var)]

[!code-csharp[](./snippets/system-text-json/csharp/ValueTextEqualsExample.cs?name=SnippetUseUtf8Var&highlight=11)]
