...
* The [DefaultIgnoreCondition](system-text-json-how-to.md#exclude-default-values-of-value-types) global option lets you exclude all value type properties that have default values.
