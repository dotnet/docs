...
:::code language="csharp" source="snippets/system-text-json-how-to/csharp/JsonNodeWithJsonSerializerOption.cs" :::
...
:::code language="csharp" source="snippets/system-text-json-how-to/csharp/JsonDocumentWithJsonSerializerOption.cs" :::
