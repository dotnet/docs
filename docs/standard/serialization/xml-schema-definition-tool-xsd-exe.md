...
|**/f\[ields\]**|Generates fields only. By default, [properties with backing fields](https://docs.microsoft.com/dotnet/csharp/programming-guide/classes-and-structs/properties#properties-with-backing-fields are generated.|
