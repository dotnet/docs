...
Fixed-size buffers were useful for interop scenarios with data sources from other languages or platforms. They then were replaced by safer and more convenient [inline arrays](~/_csharpstandard/standard/structs.md#inlinearray-inline-arrays).
...
A modern and a safer alternative is [inline arrays](~/_csharpstandard/standard/structs.md#inlinearray-inline-arrays):
