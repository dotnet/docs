...
# XAttribute class overview (C# and Visual Basic)
...
You can construct <xref:System.Xml.Linq.XAttribute> objects in-line with the construction of <xref:System.Xml.Linq.XElement> objects. An example of code that does this is:  
