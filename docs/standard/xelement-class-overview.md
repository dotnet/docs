...
- You can construct an XML tree in code. For more information, see [Create XML trees in C#](./create-xml-trees-csharp.md) and [Create XML trees in Visual Basic](./create-xml-trees-visual-basic.md).  
