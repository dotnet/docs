...
#### [Visual Studio 2017](core/getting-started/install/windows-vs2017.md)
#### [Visual Studio 2015 Update 3](core/getting-started/install/windows-vs2015.md)
#### [Windows with CLI Tools (VSCode)](core/getting-started/install/windows-cli.md)
#### [RHEL](core/getting-started/install/rhel.md)
#### [Ubuntu or Linux Mint](core/getting-started/install/ubuntu-mint.md)
#### [Debian](core/getting-started/install/debian.md)
#### [Fedora](core/getting-started/install/fedora.md)
#### [CentOS or Oracle](core/getting-started/install/centos-oracle.md)
#### [openSUSE](core/getting-started/install/opensuse.md)
#### [macOS](core/getting-started/install/mac.md)
#### [Docker Visual Studio 2017 RC](core/getting-started/install/docker-vs.md)
#### [Docker CLI](core/getting-started/install/docker-cli.md)
