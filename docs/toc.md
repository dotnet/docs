...
### [Building simple solutions with Visual Studio](scenarios/solution-authoring/vs-golden-path.md)
### [Building simple solutions with the .NET CLI](scenarios/solution-authoring/cli-golden-path.md)
