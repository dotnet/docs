...
# [.NET Standard](fundamentals/index.md)
## [.NET Standard Library](fundamentals/library.md)
## [Frameworks and Targets](fundamentals/frameworks.md)
## [What is "managed code"?](fundamentals/managed-code.md)
## [Common Language Runtime (CLR)](fundamentals/clr.md)
## [Language Independence](fundamentals/language-independence.md)
## [Framework Libraries](fundamentals/framework-libraries.md)
## [.NET Class libraries](fundamentals/class-libraries.md)
## [Portability Analyzer](fundamentals/portability-analyzer.md)
## [Handling and throwing exceptions](fundamentals/exceptions.md)
## [.NET Assembly File Format](fundamentals/assembly-format.md)
## [Garbage collection](fundamentals/garbagecollection/index.md)
### [Automatic memory management and garbage collection](fundamentals/garbagecollection/gc.md)
### [Fundamentals of garbage collection](fundamentals/garbagecollection/fundamentals.md)
### [Induced collections](fundamentals/garbagecollection/induced.md)
### [Latency modes](fundamentals/garbagecollection/latency.md)
### [Weak references](fundamentals/garbagecollection/weak-references.md)
### [Cleaning up unmanaged resources](fundamentals/garbagecollection/unmanaged.md)
### [Implementing a dispose method](fundamentals/garbagecollection/implementing-dispose.md)
### [Using objects that implement IDisposable](fundamentals/garbagecollection/using-objects.md)
## [Generic types](fundamentals/generics.md)
## [Working with base types](fundamentals/base-types/index.md)
### [Common type system in depth](fundamentals/base-types/common-type-system.md)
### [Type conversion](fundamentals/base-types/type-conversion.md)
#### [Type conversion tables](fundamentals/base-types/conversion-tables.md)
### [Formatting types](fundamentals/base-types/formatting-types.md)
#### [Standard numeric format strings](fundamentals/base-types/standard-numeric.md)
#### [Custom numeric format strings](fundamentals/base-types/custom-numeric.md)
#### [Standard date and time format strings](fundamentals/base-types/standard-datetime.md)
#### [Custom date and time format strings](fundamentals/base-types/custom-datetime.md)
#### [Standard TimeSpan format strings](fundamentals/base-types/standard-timespan.md)
#### [Custom TimeSpan format strings](fundamentals/base-types/custom-timespan.md)
#### [Enumeration format strings](fundamentals/base-types/enumeration-format.md)
#### [Composite formatting](fundamentals/base-types/composite-format.md)
#### [Performing formatting operations](fundamentals/base-types/performing-formatting-operations.md)
##### [How to: pad a number with leading zeros](fundamentals/base-types/pad-number.md)
##### [How to: extract the day of the week from a specific date](fundamentals/base-types/extract-day.md)
##### [How to: define and use custom numeric format providers](fundamentals/base-types/define-custom.md)
##### [How to: round-trip date and time values](fundamentals/base-types/roundtrip.md)
##### [How to: display milliseconds in date and time values](fundamentals/base-types/display-milliseconds.md)
##### [How to: display dates in non-gregorian calendars](fundamentals/base-types/display-dates.md)
### [Manipulating strings](fundamentals/base-types/manipulating-strings.md)
#### [Best practices for using strings](fundamentals/base-types/best-practices-strings.md)
#### [Basic string operations](fundamentals/base-types/basic-string-operations.md)
##### [Creating new strings](fundamentals/base-types/creating-new.md)
##### [Trimming and removing characters from strings](fundamentals/base-types/trimming.md)
##### [Padding strings](fundamentals/base-types/padding.md)
##### [Comparing strings](fundamentals/base-types/comparing.md)
##### [Changing case](fundamentals/base-types/changing-case.md)
##### [Using the StringBuilder class](fundamentals/base-types/stringbuilder.md)
##### [How to: perform basic string manipulations](fundamentals/base-types/basic-manipulations.md)
### [Regular expressions](fundamentals/base-types/regular-expressions.md)
#### [Regular expression language - quick reference](fundamentals/base-types/quick-ref.md)
##### [Character escapes](fundamentals/base-types/escapes.md)
##### [Character classes](fundamentals/base-types/classes.md)
##### [Anchors](fundamentals/base-types/anchors.md)
##### [Grouping](fundamentals/base-types/grouping.md)
##### [Quantifiers](fundamentals/base-types/quantifiers.md)
##### [Backreference constructs](fundamentals/base-types/backreference.md)
##### [Alternation constructs](fundamentals/base-types/alternation.md)
##### [Substitutions](fundamentals/base-types/substitutions.md)
##### [Regular expression options](fundamentals/base-types/options.md)
##### [Miscellaneous constructs in regular expressions](fundamentals/base-types/miscellaneous.md)
#### [Best practices for regular expressions](fundamentals/base-types/best-practices.md)
#### [The regular expression object model](fundamentals/base-types/object-model.md)
#### [Details of regular expression behavior](fundamentals/base-types/regex-behavior.md)
##### [Backtracking in regular expressions](fundamentals/base-types/backtracking.md)
##### [Compilation and reuse in regular expressions](fundamentals/base-types/compilation.md)
##### [Thread safety in regular expressions](fundamentals/base-types/thread-safety.md)
#### [Regular expression examples](fundamentals/base-types/regex-examples.md)
##### [Regular expression example: scanning for HREFs](fundamentals/base-types/scanning.md)
##### [Regular expression example: changing date formats](fundamentals/base-types/changing-formats.md)
##### [How to: extract a protocol and port number from a URL](fundamentals/base-types/extract-protocol.md)
##### [How to: strip invalid characters from a string](fundamentals/base-types/strip-characters.md)
##### [How to: verify that strings are in valid email format](fundamentals/base-types/verify-format.md)
#### [Character encoding](fundamentals/base-types/character-encoding.md)
#### [Parsing strings](fundamentals/base-types/parsing-strings.md)
##### [Parsing numeric strings](fundamentals/base-types/parsing-numeric.md)
##### [Parsing date and time strings](fundamentals/base-types/parsing-datetime.md)
##### [Parsing other strings](fundamentals/base-types/parsing-other.md)
## [Delegates and lambdas](fundamentals/delegates-lambdas.md)
## [LINQ](fundamentals/using-linq.md)
## [Common Type System & Common Language Specification](fundamentals/common-type-system.md)
## [Asynchronous programming](fundamentals/async.md)
### [Asynchronous programming in depth](fundamentals/async-in-depth.md)
## [Native interoperability](fundamentals/native-interop.md)
## [Collections and Data Structures](fundamentals/collections/index.md)
### [Selecting a Collection Class](fundamentals/collections/selecting-a-collection-class.md)
### [Commonly Used Collection Types](fundamentals/collections/commonly-used-collection-types.md)
### [When to Use Generic Collections](fundamentals/collections/when-to-use-generic-collections.md)
### [Comparisons and Sorts Within Collections](fundamentals/collections/comparisons-and-sorts-within-collections.md)
### [Sorted Collection Types](fundamentals/collections/sorted-collection-types.md)
### [Hashtable and Dictionary Collection Types](fundamentals/collections/hashtable-and-dictionary-collection-types.md)
### [Thread-Safe Collections](fundamentals/collections/threadsafe/index.md)
#### [BlockingCollection Overview](fundamentals/collections/threadsafe/blockingcollection-overview.md)
#### [When to Use a Thread-Safe Collection](fundamentals/collections/threadsafe/when-to-use-a-thread-safe-collection.md)
#### [How to: Add and Remove Items from a ConcurrentDictionary](fundamentals/collections/threadsafe/how-to-add-and-remove-items.md)
#### [How to: Add and Take Items Individually from a BlockingCollection](fundamentals/collections/threadsafe/how-to-add-and-take-items.md)
#### [How to: Add Bounding and Blocking Functionality to a Collection](fundamentals/collections/threadsafe/how-to-add-bounding-and-blocking.md)
#### [How to: Use ForEach to Remove Items in a BlockingCollection](fundamentals/collections/threadsafe/how-to-use-foreach-to-remove.md)
#### [How to: Use Arrays of Blocking Collections in a Pipeline](fundamentals/collections/threadsafe/how-to-use-arrays-of-blockingcollections.md)
#### [How to: Create an Object Pool by Using a ConcurrentBag](fundamentals/collections/threadsafe/how-to-create-an-object-pool.md)
## [Numerics in .NET Core](fundamentals/numerics.md)
## [Dates, times, and time zones](fundamentals/datetime/index.md)
### [Time zone overview](fundamentals/datetime/time-zone-overview.md)
### [Choosing between DateTime, DateTimeOffset, TimeSpan, and TimeZoneInfo](fundamentals/datetime/choosing-between-datetime.md)
### [Finding the time zones defined on a local system](fundamentals/datetime/finding-the-time-zones-on-local-system.md)
### [How to: enumerate time zones present on a computer](fundamentals/datetime/enumerate-time-zones.md)
### [How to: access the predefined UTC and local time zone objects](fundamentals/datetime/access-utc-and-local.md)
### [How to: instantiate a TimeZoneInfo object](fundamentals/datetime/instantiate-time-zone-info.md)
### [Instantiating a DateTimeOffset object](fundamentals/datetime/instantiating-a-datetimeoffset-object.md)
### [Performing arithmetic operations with dates and times](fundamentals/datetime/performing-arithmetic-operations.md)
### [How to: use time zones in date and time arithmetic](fundamentals/datetime/use-time-zones-in-arithmetic.md)
### [Converting between DateTime and DateTimeOffset](fundamentals/datetime/converting-between-datetime-and-offset.md)
### [Converting times between time zones](fundamentals/datetime/converting-between-time-zones.md)
### [How to: resolve ambiguous times](fundamentals/datetime/resolve-ambiguous-times.md)
### [How to: let users resolve ambiguous times](fundamentals/datetime/let-users-resolve-ambiguous-times.md)
