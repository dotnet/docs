...
## [Programming Concepts](visual-basic/concepts/index.md)

### [Assemblies and the Global Assembly Cache](visual-basic/concepts/assemblies-gac/index.md)
#### [Friend Assemblies](visual-basic/concepts/assemblies-gac/friend-assemblies.md)
##### [How to: Create Unsigned Friend Assemblies](visual-basic/concepts/assemblies-gac/how-to-create-unsigned-friend-assemblies.md)
##### [How to: Create Signed Friend Assemblies](visual-basic/concepts/assemblies-gac/how-to-create-signed-friend-assemblies.md)
##### [How to: Create and Use Assemblies Using the Command Line](visual-basic/concepts/assemblies-gac/how-to-create-and-use-assemblies-using-the-command-line.md)
##### [How to: Determine If a File Is an Assembly](visual-basic/concepts/assemblies-gac/how-to-determine-if-a-file-is-an-assembly.md)
##### [How to: Load and Unload Assemblies](visual-basic/concepts/assemblies-gac/how-to-load-and-unload-assemblies.md)
##### [How to: Share an Assembly with Other Applications](visual-basic/concepts/assemblies-gac/how-to-share-an-assembly-with-other-applications.md)
##### [Walkthrough: Embedding Types from Managed Assemblies](visual-basic/concepts/assemblies-gac/walkthrough-embedding-types-from-managed-assemblies-in-vs.md)
##### [Walkthrough: Embedding Type Information from Microsoft Office Assemblies](visual-basic/concepts/assemblies-gac/walkthrough-embedding-type-information-from-microsoft-office-assemblies-in-vs.md)

### [Asynchronous Programming with Async and Await](visual-basic/concepts/async/asynchronous-programming-with-async-and-await.md)
#### [Walkthrough: Accessing the Web by Using Async and Await](visual-basic/concepts/async/walkthrough-accessing-the-web-by-using-async-and-await.md)
#### [How to: Extend the Async Walkthrough by Using Task.WhenAll](visual-basic/concepts/async/how-to-extend-the-async-walkthrough-by-using-task-whenall.md)
#### [How to: Make Multiple Web Requests in Parallel by Using Async and Await](visual-basic/concepts/async/how-to-make-multiple-web-requests-in-parallel-by-using-async-and-await.md)
#### [Async Return Types](visual-basic/concepts/async/async-return-types.md)
#### [Control Flow in Async Programs](visual-basic/concepts/async/control-flow-in-async-programs.md)
#### [Fine-Tuning Your Async Application](visual-basic/concepts/async/fine-tuning-your-async-application.md)
##### [Cancel an Async Task or a List of Tasks](visual-basic/concepts/async/cancel-an-async-task-or-a-list-of-tasks.md)
##### [Cancel Async Tasks after a Period of Time](visual-basic/concepts/async/cancel-async-tasks-after-a-period-of-time.md)
##### [Cancel Remaining Async Tasks after One Is Complete](visual-basic/concepts/async/cancel-remaining-async-tasks-after-one-is-complete.md)
##### [Start Multiple Async Tasks and Process Them As They Complete](visual-basic/concepts/async/start-multiple-async-tasks-and-process-them-as-they-complete.md)
#### [Handling Reentrancy in Async Apps](visual-basic/concepts/async/handling-reentrancy-in-async-apps.md)
#### [Using Async for File Access](visual-basic/concepts/async/using-async-for-file-access.md)
#### [Attributes](visual-basic/concepts/attributes/index.md)
#### [Creating Custom Attributes](visual-basic/concepts/attributes/creating-custom-attributes.md)
##### [AttributeUsage](visual-basic/concepts/attributes/attributeusage.md)
#### [Accessing Attributes by Using Reflection](visual-basic/concepts/attributes/accessing-attributes-by-using-reflection.md)
#### [How to: Create a C/C++ Union by Using Attributes](visual-basic/concepts/attributes/how-to-create-a-c-cpp-union-by-using-attributes.md)
#### [Common Attributes](visual-basic/concepts/attributes/common-attributes.md)

### [Caller Information](visual-basic/concepts/caller-information.md)
### [Collections](visual-basic/concepts/collections.md)
### [Covariance and Contravariance](visual-basic/concepts/covariance-contravariance/covariance-and-contravariance.md)
#### [Variance in Generic Interfaces](visual-basic/concepts/covariance-contravariance/variance-in-generic-interfaces.md)
##### [Creating Variant Generic Interfaces](visual-basic/concepts/covariance-contravariance/creating-variant-generic-interfaces.md)
##### [Using Variance in Interfaces for Generic Collections](visual-basic/concepts/covariance-contravariance/using-variance-in-interfaces-for-generic-collections.md)
#### [Variance in Delegates](visual-basic/concepts/covariance-contravariance/variance-in-delegates.md)
##### [Using Variance in Delegates](visual-basic/concepts/covariance-contravariance/using-variance-in-delegates.md)
##### [Using Variance for Func and Action Generic Delegates](visual-basic/concepts/covariance-contravariance/using-variance-for-func-and-action-generic-delegates.md)
#### [Expression Trees](visual-basic/concepts/expression-trees/index.md)
#### [How to: Execute Expression Trees](visual-basic/concepts/expression-trees/how-to-execute-expression-trees.md)
#### [How to: Modify Expression Trees](visual-basic/concepts/expression-trees/how-to-modify-expression-trees.md)
#### [How to: Use Expression Trees to Build Dynamic Queries](visual-basic/concepts/expression-trees/how-to-use-expression-trees-to-build-dynamic-queries.md)
#### [Debugging Expression Trees](visual-basic/concepts/expression-trees/debugging-expression-trees-in-visual-studio.md)
### [Iterators](visual-basic/concepts/iterators.md)
...
#### [LINQ to Objects](visual-basic/concepts/linq/linq-to-objects.md)
##### [LINQ and Strings](visual-basic/concepts/linq/linq-and-strings.md)
###### [How to: Count Occurrences of a Word in a String (LINQ)](visual-basic/concepts/linq/how-to-count-occurrences-of-a-word-in-a-string-linq.md)
###### [How to: Query for Sentences that Contain a Specified Set of Words (LINQ)](visual-basic/concepts/linq/how-to-query-for-sentences-that-contain-a-specified-set-of-words.md)
###### [How to: Query for Characters in a String (LINQ)](visual-basic/concepts/linq/how-to-query-for-characters-in-a-string-linq.md)
###### [How to: Combine LINQ Queries with Regular Expressions](visual-basic/concepts/linq/how-to-combine-linq-queries-with-regular-expressions.md)
###### [How to: Find the Set Difference Between Two Lists (LINQ)](visual-basic/concepts/linq/how-to-find-the-set-difference-between-two-lists-linq.md)
###### [How to: Sort or Filter Text Data by Any Word or Field (LINQ)](visual-basic/concepts/linq/how-to-sort-or-filter-text-data-by-any-word-or-field-linq.md)
###### [How to: Reorder the Fields of a Delimited File (LINQ)](visual-basic/concepts/linq/how-to-reorder-the-fields-of-a-delimited-file.md)
###### [How to: Combine and Compare String Collections (LINQ)](visual-basic/concepts/linq/how-to-combine-and-compare-string-collections-linq.md)
###### [How to: Populate Object Collections from Multiple Sources (LINQ)](visual-basic/concepts/linq/how-to-populate-object-collections-from-multiple-sources-linq.md)
###### [How to: Split a File Into Many Files by Using Groups (LINQ)](visual-basic/concepts/linq/how-to-split-a-file-into-many-files-by-using-groups-linq.md)
###### [How to: Join Content from Dissimilar Files (LINQ)](visual-basic/concepts/linq/how-to-join-content-from-dissimilar-files-linq.md)
###### [How to: Compute Column Values in a CSV Text File (LINQ)](visual-basic/concepts/linq/how-to-compute-column-values-in-a-csv-text-file-linq.md)
##### [LINQ and Reflection](visual-basic/concepts/linq/linq-and-reflection.md)
###### [How to: Query An Assembly's Metadata with Reflection (LINQ)](visual-basic/concepts/linq/how-to-query-an-assembly-s-metadata-with-reflection-linq.md)
##### [LINQ and File Directories](visual-basic/concepts/linq/linq-and-file-directories.md)
###### [How to: Query for Files with a Specified Attribute or Name](visual-basic/concepts/linq/how-to-query-for-files-with-a-specified-attribute-or-name.md)
###### [How to: Group Files by Extension (LINQ)](visual-basic/concepts/linq/how-to-group-files-by-extension-linq.md)
###### [How to: Query for the Total Number of Bytes in a Set of Folders (LINQ)](visual-basic/concepts/linq/how-to-query-for-the-total-number-of-bytes-in-a-set-of-folders.md)
###### [How to: Compare the Contents of Two Folders (LINQ)](visual-basic/concepts/linq/how-to-compare-the-contents-of-two-folders-linq.md)
###### [How to: Query for the Largest File or Files in a Directory Tree (LINQ)](visual-basic/concepts/linq/how-to-query-for-the-largest-file-or-files-in-a-directory-tree.md)
###### [How to: Query for Duplicate Files in a Directory Tree (LINQ)](visual-basic/concepts/linq/how-to-query-for-duplicate-files-in-a-directory-tree-linq.md)
###### [How to: Query the Contents of Files in a Folder (LINQ)](visual-basic/concepts/linq/how-to-query-the-contents-of-files-in-a-folder-linq.md)
##### [How to: Query an ArrayList with LINQ](visual-basic/concepts/linq/how-to-query-an-arraylist-with-linq.md)
##### [How to: Add Custom Methods for LINQ Queries](visual-basic/concepts/linq/how-to-add-custom-methods-for-linq-queries.md)
##### [LINQ to XML](visual-basic/concepts/linq/linq-to-xml.md)
##### [Getting Started (LINQ to XML)](visual-basic/concepts/linq/getting-started-linq-to-xml.md)
###### [LINQ to XML Overview](visual-basic/concepts/linq/linq-to-xml-overview.md)
###### [LINQ to XML vs. DOM](visual-basic/concepts/linq/linq-to-xml-vs-dom.md)
###### [LINQ to XML vs. Other XML Technologies](visual-basic/concepts/linq/linq-to-xml-vs-other-xml-technologies.md)
##### [Programming Guide (LINQ to XML)](visual-basic/concepts/linq/programming-guide-linq-to-xml.md)
###### [LINQ to XML Programming Overview](visual-basic/concepts/linq/linq-to-xml-programming-overview.md)
####### [Functional vs. Procedural Programming (LINQ to XML)](visual-basic/concepts/linq/functional-vs-procedural-programming-linq-to-xml.md)
####### [LINQ to XML Classes Overview](visual-basic/concepts/linq/linq-to-xml-classes-overview.md)
####### [XElement Class Overview](visual-basic/concepts/linq/xelement-class-overview.md)
###### [XAttribute Class Overview](visual-basic/concepts/linq/xattribute-class-overview.md)
####### [XDocument Class Overview](visual-basic/concepts/linq/xdocument-class-overview.md)
####### [How to: Build LINQ to XML Examples](visual-basic/concepts/linq/how-to-build-linq-to-xml-examples.md)
###### [Creating XML Trees](visual-basic/concepts/linq/creating-xml-trees.md)
####### [Functional Construction (LINQ to XML)](visual-basic/concepts/linq/functional-construction-linq-to-xml.md)
####### [Introduction to XML Literals](visual-basic/concepts/linq/introduction-to-xml-literals.md)
####### [Cloning vs. Attaching](visual-basic/concepts/linq/cloning-vs-attaching.md)
####### [Parsing XML](visual-basic/concepts/linq/parsing-xml.md)
######## [How to: Parse a String](visual-basic/concepts/linq/how-to-parse-a-string.md)
######## [How to: Load XML from a File](visual-basic/concepts/linq/how-to-load-xml-from-a-file.md)
######## [Preserving White Space while Loading or Parsing XML](visual-basic/concepts/linq/preserving-white-space-while-loading-or-parsing-xml.md)
######## [How to: Catch Parsing Errors](visual-basic/concepts/linq/how-to-catch-parsing-errors.md)
######## [How to: Create a Tree from an XmlReader](visual-basic/concepts/linq/how-to-create-a-tree-from-an-xmlreader.md)
######## [How to: Stream XML Fragments from an XmlReader](visual-basic/concepts/linq/how-to-stream-xml-fragments-from-an-xmlreader.md)
####### [How to: Populate an XML Tree with an XmlWriter (LINQ to XML)](visual-basic/concepts/linq/how-to-populate-an-xml-tree-with-an-xmlwriter-linq-to-xml.md)
####### [How to: Validate Using XSD (LINQ to XML)](visual-basic/concepts/linq/how-to-validate-using-xsd-linq-to-xml.md)
####### [Valid Content of XElement and XDocument Objects](visual-basic/concepts/linq/valid-content-of-xelement-and-xdocument-objects.md)
###### [Working with XML Namespaces](visual-basic/concepts/linq/working-with-xml-namespaces.md)
####### [Namespaces Overview (LINQ to XML)](visual-basic/concepts/linq/namespaces-overview-linq-to-xml.md)
####### [How to: Create a Document with Namespaces (LINQ to XML)](visual-basic/concepts/linq/how-to-create-a-document-with-namespaces.md)
####### [How to: Control Namespace Prefixes (LINQ to XML)](visual-basic/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)
####### [Scope of Default Namespaces](visual-basic/concepts/linq/scope-of-default-namespaces.md)
####### [Working with Global Namespaces (LINQ to XML)](visual-basic/concepts/linq/working-with-global-namespaces-linq-to-xml.md)
####### [Namespaces (LINQ to XML)](visual-basic/concepts/linq/namespaces-linq-to-xml.md)
####### [How to: Write Queries on XML in Namespaces](visual-basic/concepts/linq/how-to-write-queries-on-xml-in-namespaces.md)
###### [Serializing XML Trees](visual-basic/concepts/linq/serializing-xml-trees.md)
####### [Preserving White Space While Serializing](visual-basic/concepts/linq/preserving-white-space-while-serializing.md)
####### [Serializing with an XML Declaration](visual-basic/concepts/linq/serializing-with-an-xml-declaration.md)
####### [Serializing to Files, TextWriters, and XmlWriters](visual-basic/concepts/linq/serializing-to-files-textwriters-and-xmlwriters.md)
####### [Serializing to an XmlReader (Invoking XSLT)](visual-basic/concepts/linq/serializing-to-an-xmlreader-invoking-xslt.md)
###### [LINQ to XML Axes](visual-basic/concepts/linq/linq-to-xml-axes.md)
####### [LINQ to XML Axes Overview](visual-basic/concepts/linq/linq-to-xml-axes-overview.md)
####### [How to: Retrieve a Collection of Elements (LINQ to XML)](visual-basic/concepts/linq/how-to-retrieve-a-collection-of-elements-linq-to-xml.md)
####### [How to: Retrieve the Value of an Element (LINQ to XML)](visual-basic/concepts/linq/how-to-retrieve-the-value-of-an-element-linq-to-xml.md)
####### [How to: Filter on Element Names (LINQ to XML)](visual-basic/concepts/linq/how-to-filter-on-element-names-linq-to-xml.md)
####### [How to: Chain Axis Method Calls (LINQ to XML)](visual-basic/concepts/linq/how-to-chain-axis-method-calls-linq-to-xml.md)
####### [How to: Retrieve a Single Child Element (LINQ to XML)](visual-basic/concepts/linq/how-to-retrieve-a-single-child-element-linq-to-xml.md)
####### [How to: Retrieve a Collection of Attributes (LINQ to XML)](visual-basic/concepts/linq/how-to-retrieve-a-collection-of-attributes-linq-to-xml.md)
####### [How to: Retrieve a Single Attribute (LINQ to XML)](visual-basic/concepts/linq/how-to-retrieve-a-single-attribute-linq-to-xml.md)
####### [How to: Retrieve the Value of an Attribute (LINQ to XML)](visual-basic/concepts/linq/how-to-retrieve-the-value-of-an-attribute-linq-to-xml.md)
####### [How to: Retrieve the Shallow Value of an Element](visual-basic/concepts/linq/how-to-retrieve-the-shallow-value-of-an-element.md)
####### [Language-Integrated Axes (LINQ to XML)](visual-basic/concepts/linq/language-integrated-axes.md)
###### [Querying XML Trees](visual-basic/concepts/linq/querying-xml-trees.md)
####### [Basic Queries (LINQ to XML)](visual-basic/concepts/linq/basic-queries-linq-to-xml.md)
######## [How to: Find an Element with a Specific Attribute](visual-basic/concepts/linq/how-to-find-an-element-with-a-specific-attribute.md)
######## [How to: Find an Element with a Specific Child Element](visual-basic/concepts/linq/how-to-find-an-element-with-a-specific-child-element.md)
######## [Querying an XDocument vs. Querying an XElement](visual-basic/concepts/linq/querying-an-xdocument-vs-querying-an-xelement.md)
######## [How to: Find Descendants with a Specific Element Name](visual-basic/concepts/linq/how-to-find-descendants-with-a-specific-element-name.md)
######## [How to: Find a Single Descendant Using the Descendants Method](visual-basic/concepts/linq/how-to-find-a-single-descendant-using-the-descendants-method.md)
######## [How to: Write Queries with Complex Filtering](visual-basic/concepts/linq/how-to-write-queries-with-complex-filtering.md)
######## [How to: Filter on an Optional Element](visual-basic/concepts/linq/how-to-filter-on-an-optional-element.md)
######## [How to: Find All Nodes in a Namespace](visual-basic/concepts/linq/how-to-find-all-nodes-in-a-namespace.md)
######## [How to: Sort Elements](visual-basic/concepts/linq/how-to-sort-elements.md)
######## [How to: Sort Elements on Multiple Keys](visual-basic/concepts/linq/how-to-sort-elements-on-multiple-keys.md)
######## [How to: Calculate Intermediate Values](visual-basic/concepts/linq/how-to-calculate-intermediate-values.md)
######## [How to: Write a Query that Finds Elements Based on Context](visual-basic/concepts/linq/how-to-write-a-query-that-finds-elements-based-on-context.md)
######## [How to: Debug Empty Query Results Sets](visual-basic/concepts/linq/how-to-debug-empty-query-results-sets.md)
####### [Projections and Transformations (LINQ to XML)](visual-basic/concepts/linq/projections-and-transformations-linq-to-xml.md)
######## [How to: Work with Dictionaries Using LINQ to XML](visual-basic/concepts/linq/how-to-work-with-dictionaries-using-linq-to-xml.md)
######## [How to: Transform the Shape of an XML Tree](visual-basic/concepts/linq/how-to-transform-the-shape-of-an-xml-tree.md)
######## [How to: Control the Type of a Projection](visual-basic/concepts/linq/how-to-control-the-type-of-a-projection.md)
######## [How to: Project a New Type (LINQ to XML)](visual-basic/concepts/linq/how-to-project-a-new-type-linq-to-xml.md)
######## [How to: Project an Object Graph](visual-basic/concepts/linq/how-to-project-an-object-graph.md)
######## [How to: Project an Anonymous Type](visual-basic/concepts/linq/how-to-project-an-anonymous-type.md)
######## [How to: Generate Text Files from XML](visual-basic/concepts/linq/how-to-generate-text-files-from-xml.md)
######## [How to: Generate XML from CSV Files](visual-basic/concepts/linq/how-to-generate-xml-from-csv-files.md)
####### [Advanced Query Techniques (LINQ to XML)](visual-basic/concepts/linq/advanced-query-techniques-linq-to-xml.md)
######## [How to: Join Two Collections (LINQ to XML)](visual-basic/concepts/linq/how-to-join-two-collections-linq-to-xml.md)
######## [How to: Create Hierarchy Using Grouping](visual-basic/concepts/linq/how-to-create-hierarchy-using-grouping.md)
######## [How to: Query LINQ to XML Using XPath](visual-basic/concepts/linq/how-to-query-linq-to-xml-using-xpath.md)
######## [How to: Write a LINQ to XML Axis Method](visual-basic/concepts/linq/how-to-write-a-linq-to-xml-axis-method.md)
######## [How to: List All Nodes in a Tree](visual-basic/concepts/linq/how-to-list-all-nodes-in-a-tree.md)
######## [How to: Retrieve Paragraphs from an Office Open XML Document](visual-basic/concepts/linq/how-to-retrieve-paragraphs-from-an-office-open-xml-document.md)
######## [How to: Modify an Office Open XML Document](visual-basic/concepts/linq/how-to-modify-an-office-open-xml-document.md)
######## [How to: Populate an XML Tree from the File System](visual-basic/concepts/linq/how-to-populate-an-xml-tree-from-the-file-system.md)
####### [LINQ to XML for XPath Users](visual-basic/concepts/linq/linq-to-xml-for-xpath-users.md)
######## [Comparison of XPath and LINQ to XML](visual-basic/concepts/linq/comparison-of-xpath-and-linq-to-xml.md)
######## [How to: Find a Child Element (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-a-child-element-xpath-linq-to-xml.md)
######## [How to: Find a List of Child Elements (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-a-list-of-child-elements-xpath-linq-to-xml.md)
######## [How to: Find the Root Element (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-the-root-element-xpath-linq-to-xml.md)
######## [How to: Find Descendant Elements (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-descendant-elements-xpath-linq-to-xml.md)
######## [How to: Filter on an Attribute (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-filter-on-an-attribute-xpath-linq-to-xml.md)
####### [How to: Find Related Elements (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-related-elements-xpath-linq-to-xml.md)
######## [How to: Find Elements in a Namespace (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-elements-in-a-namespace.md)
######## [How to: Find Preceding Siblings (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-preceding-siblings-xpath-linq-to-xml.md)
######## [How to: Find Descendants of a Child Element (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-descendants-of-a-child-element-xpath-linq-to-xml.md)
######## [How to: Find a Union of Two Location Paths (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-a-union-of-two-location-paths-xpath.md)
######## [How to: Find Sibling Nodes (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-sibling-nodes-xpath-linq-to-xml.md)
######## [How to: Find an Attribute of the Parent (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-an-attribute-of-the-parent-xpath-linq-to-xml.md)
######## [How to: Find Attributes of Siblings with a Specific Name (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-attributes-of-siblings-with-a-specific-name.md)
######## [How to: Find Elements with a Specific Attribute (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-elements-with-a-specific-attribute.md)
######## [How to: Find Child Elements Based on Position (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-child-elements-based-on-position.md)
######## [How to: Find the Immediate Preceding Sibling (XPath-LINQ to XML)](visual-basic/concepts/linq/how-to-find-the-immediate-preceding-sibling-xpath-linq-to-xml.md)
####### [Pure Functional Transformations of XML](visual-basic/concepts/linq/pure-functional-transformations-of-xml.md)
######## [Introduction to Pure Functional Transformations](visual-basic/concepts/linq/introduction-to-pure-functional-transformations.md)
######### [Concepts and Terminology (Functional Transformation)](visual-basic/concepts/linq/concepts-and-terminology-functional-transformation.md)
######### [Functional Programming vs. Imperative Programming](visual-basic/concepts/linq/functional-programming-vs-imperative-programming.md)
######### [Refactoring Into Pure Functions](visual-basic/concepts/linq/refactoring-into-pure-functions.md)
######### [Applicability of Functional Transformation](visual-basic/concepts/linq/applicability-of-functional-transformation.md)
######### [Functional Transformation of XML](visual-basic/concepts/linq/functional-transformation-of-xml.md)
######## [Tutorial: Deferred Execution](visual-basic/concepts/linq/tutorial-deferred-execution.md)
######### [Deferred Execution and Lazy Evaluation in LINQ to XML](visual-basic/concepts/linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)
######### [Deferred Execution Example](visual-basic/concepts/linq/deferred-execution-example.md)
######## [Tutorial: Manipulating Content in a WordprocessingML Document](visual-basic/concepts/linq/tutorial-manipulating-content-in-a-wordprocessingml-document.md)
######### [Shape of WordprocessingML Documents](visual-basic/concepts/linq/shape-of-wordprocessingml-documents.md)
######### [Creating the Source Office Open XML Document](visual-basic/concepts/linq/creating-the-source-office-open-xml-document.md)
######### [Finding the Default Paragraph Style](visual-basic/concepts/linq/finding-the-default-paragraph-style.md)
######### [Retrieving the Paragraphs and Their Styles](visual-basic/concepts/linq/retrieving-the-paragraphs-and-their-styles.md)
######### [Retrieving the Text of the Paragraphs](visual-basic/concepts/linq/retrieving-the-text-of-the-paragraphs.md)
######### [Refactoring Using an Extension Method](visual-basic/concepts/linq/refactoring-using-an-extension-method.md)
######### [Refactoring Using a Pure Function](visual-basic/concepts/linq/refactoring-using-a-pure-function.md)
######### [Projecting XML in a Different Shape](visual-basic/concepts/linq/projecting-xml-in-a-different-shape.md)
######### [Finding Text in Word Documents](visual-basic/concepts/linq/finding-text-in-word-documents.md)
######### [Details of Office Open XML WordprocessingML Documents](visual-basic/concepts/linq/details-of-office-open-xml-wordprocessingml-documents.md)
########## [WordprocessingML Document with Styles](visual-basic/concepts/linq/wordprocessingml-document-with-styles.md)
########## [Style Part of a WordprocessingML Document](visual-basic/concepts/linq/style-part-of-a-wordprocessingml-document.md)
########## [Example that Outputs Office Open XML Document Parts](visual-basic/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)
###### [Modifying XML Trees (LINQ to XML)](visual-basic/concepts/linq/modifying-xml-trees-linq-to-xml.md)
####### [In-Memory XML Tree Modification vs. Functional Construction (LINQ to XML)](visual-basic/concepts/linq/in-memory-xml-tree-modification-vs-functional-construction.md)
####### [Adding Elements, Attributes, and Nodes to an XML Tree](visual-basic/concepts/linq/adding-elements-attributes-and-nodes-to-an-xml-tree.md)
####### [Modifying Elements, Attributes, and Nodes in an XML Tree](visual-basic/concepts/linq/modifying-elements-attributes-and-nodes-in-an-xml-tree.md)
####### [Removing Elements, Attributes, and Nodes from an XML Tree](visual-basic/concepts/linq/removing-elements-attributes-and-nodes-from-an-xml-tree.md)
####### [Maintaining Name-Value Pairs](visual-basic/concepts/linq/maintaining-name-value-pairs.md)
####### [How to: Change the Namespace for an Entire XML Tree](visual-basic/concepts/linq/how-to-change-the-namespace-for-an-entire-xml-tree.md)
###### [Performance (LINQ to XML)](visual-basic/concepts/linq/performance-linq-to-xml.md)
####### [Performance of Chained Queries (LINQ to XML)](visual-basic/concepts/linq/performance-of-chained-queries-linq-to-xml.md)
####### [Atomized XName and XNamespace Objects (LINQ to XML)](visual-basic/concepts/linq/atomized-xname-and-xnamespace-objects-linq-to-xml.md)
####### [Pre-Atomization of XName Objects (LINQ to XML)](visual-basic/concepts/linq/pre-atomization-of-xname-objects-linq-to-xml.md)
####### [Statically Compiled Queries (LINQ to XML)](visual-basic/concepts/linq/statically-compiled-queries-linq-to-xml.md)
###### [Advanced LINQ to XML Programming](visual-basic/concepts/linq/advanced-linq-to-xml-programming.md)
####### [LINQ to XML Annotations](visual-basic/concepts/linq/linq-to-xml-annotations.md)
####### [LINQ to XML Events](visual-basic/concepts/linq/linq-to-xml-events.md)
####### [Programming with Nodes](visual-basic/concepts/linq/programming-with-nodes.md)
####### [Mixed Declarative Code-Imperative Code Bugs (LINQ to XML)](visual-basic/concepts/linq/mixed-declarative-code-imperative-code-bugs-linq-to-xml.md)
####### [How to: Stream XML Fragments with Access to Header Information](visual-basic/concepts/linq/how-to-stream-xml-fragments-with-access-to-header-information.md)
####### [How to: Perform Streaming Transform of Large XML Documents](visual-basic/concepts/linq/how-to-perform-streaming-transform-of-large-xml-documents.md)
####### [How to: Read and Write an Encoded Document](visual-basic/concepts/linq/how-to-read-and-write-an-encoded-document.md)
####### [Using XSLT to Transform an XML Tree](visual-basic/concepts/linq/using-xslt-to-transform-an-xml-tree.md)
####### [How to: Use Annotations to Transform LINQ to XML Trees in an XSLT Style](visual-basic/concepts/linq/how-to-use-annotation-trees-to-transform-linq-to-xml-trees-in-an-xslt-style.md)
####### [Serializing Object Graphs that Contain XElement Objects](visual-basic/concepts/linq/serializing-object-graphs-that-contain-xelement-objects.md)
######## [How to: Serialize Using XmlSerializer](visual-basic/concepts/linq/how-to-serialize-using-xmlserializer.md)
######## [How to: Serialize Using DataContractSerializer](visual-basic/concepts/linq/how-to-serialize-using-datacontractserializer.md)
####### [LINQ to XML Security](visual-basic/concepts/linq/linq-to-xml-security.md)
####### [Sample XML Documents (LINQ to XML)](visual-basic/concepts/linq/sample-xml-documents-linq-to-xml.md)
######## [Sample XML File: Typical Purchase Order (LINQ to XML)](visual-basic/concepts/linq/sample-xml-file-typical-purchase-order-linq-to-xml.md)
######## [Sample XML File: Typical Purchase Order in a Namespace](visual-basic/concepts/linq/sample-xml-file-typical-purchase-order-in-a-namespace.md)
######## [Sample XML File: Multiple Purchase Orders (LINQ to XML)](visual-basic/concepts/linq/sample-xml-file-multiple-purchase-orders-linq-to-xml.md)
######## [Sample XML File: Multiple Purchase Orders in a Namespace](visual-basic/concepts/linq/sample-xml-file-multiple-purchase-orders-in-a-namespace.md)
######## [Sample XML File: Test Configuration (LINQ to XML)](visual-basic/concepts/linq/sample-xml-file-test-configuration-linq-to-xml.md)
######## [Sample XML File: Test Configuration in a Namespace](visual-basic/concepts/linq/sample-xml-file-test-configuration-in-a-namespace.md)
######## [Sample XML File: Customers and Orders (LINQ to XML)](visual-basic/concepts/linq/sample-xml-file-customers-and-orders-linq-to-xml.md)
######## [Sample XSD File: Customers and Orders](visual-basic/concepts/linq/sample-xsd-file-customers-and-orders.md)
######## [Sample XML File: Customers and Orders in a Namespace](visual-basic/concepts/linq/sample-xml-file-customers-and-orders-in-a-namespace.md)
######## [Sample XML File: Numerical Data (LINQ to XML)](visual-basic/concepts/linq/sample-xml-file-numerical-data-linq-to-xml.md)
######## [Sample XML File: Numerical Data in a Namespace](visual-basic/concepts/linq/sample-xml-file-numerical-data-in-a-namespace.md)
######## [Sample XML File: Books (LINQ to XML)](visual-basic/concepts/linq/sample-xml-file-books-linq-to-xml.md)
######## [Sample XML File: Consolidated Purchase Orders](visual-basic/concepts/linq/sample-xml-file-consolidated-purchase-orders.md)
######## [Reference (LINQ to XML)](visual-basic/concepts/linq/reference-linq-to-xml.md)
####### [LINQ to ADO.NET (Portal Page)](visual-basic/concepts/linq/linq-to-adonet-portal-page.md)
####### [Enabling a Data Source for LINQ Querying](visual-basic/concepts/linq/enabling-a-data-source-for-linq-querying.md)
####### [Visual Studio IDE and Tools Support for LINQ](visual-basic/concepts/linq/visual-studio-ide-and-tools-support-for-linq.md)
#### [Object-Oriented Programming](visual-basic/concepts/object-oriented-programming.md)
### [Reflection](visual-basic/concepts/reflection.md)
#### [Serialization](visual-basic/concepts/serialization/index.md)
#### [How to: Write Object Data to an XML File](visual-basic/concepts/serialization/how-to-write-object-data-to-an-xml-file.md)
#### [How to: Read Object Data from an XML File](visual-basic/concepts/serialization/how-to-read-object-data-from-an-xml-file.md)
#### [Walkthrough: Persisting an Object](visual-basic/concepts/serialization/walkthrough-persisting-an-object-in-visual-studio.md)
#### [Threading](visual-basic/concepts/threading/index.md)
#### [Multithreaded Applications](visual-basic/concepts/threading/multithreaded-applications.md)
#### [Parameters and Return Values for Multithreaded Procedures](visual-basic/concepts/threading/parameters-and-return-values-for-multithreaded-procedures.md)
#### [Walkthrough: Multithreading with the BackgroundWorker Component](visual-basic/concepts/threading/walkthrough-multithreading-with-the-backgroundworker-component.md)
#### [Thread Synchronization](visual-basic/concepts/threading/thread-synchronization.md)
#### [Thread Timers](visual-basic/concepts/threading/thread-timers.md)
#### [Thread Pooling](visual-basic/concepts/threading/thread-pooling.md)
##### [How to: Use a Thread Pool](visual-basic/concepts/threading/how-to-use-a-thread-pool.md)

## [Program Structure and Code Conventions](visual-basic/program-structure/program-structure-and-code-conventions.md)
### [Structure of a Program](visual-basic/program-structure/structure-of-a-visual-basic-program.md)
### [Main Procedure](visual-basic/program-structure/main-procedure.md)
### [References and the Imports Statement](visual-basic/program-structure/references-and-the-imports-statement.md)
### [Namespaces](visual-basic/program-structure/namespaces.md)
### [Naming Conventions](visual-basic/program-structure/naming-conventions.md)
### [Coding Conventions](visual-basic/program-structure/coding-conventions.md)
### [Conditional Compilation](visual-basic/program-structure/conditional-compilation.md)
### [How to: Break and Combine Statements in Code](visual-basic/program-structure/how-to-break-and-combine-statements-in-code.md)
### [How to: Collapse and Hide Sections of Code](visual-basic/program-structure/how-to-collapse-and-hide-sections-of-code.md)
### [How to: Label Statements](visual-basic/program-structure/how-to-label-statements.md)
### [Special Characters in Code](visual-basic/program-structure/special-characters-in-code.md)
### [Comments in Code](visual-basic/program-structure/comments-in-code.md)
#### [Documenting Your Code with XML](visual-basic/program-structure/documenting-your-code-with-xml.md)
#### [Processing the XML File](visual-basic/program-structure/processing-the-xml-file.md)
#### [How to: Create XML Documentation](visual-basic/program-structure/how-to-create-xml-documentation.md)
### [Keywords as Element Names in Code](visual-basic/program-structure/keywords-as-element-names-in-code.md)
### [Me, My, MyBase, and MyClass](visual-basic/program-structure/me-my-mybase-and-myclass.md)
### [Limitations](visual-basic/program-structure/limitations.md)

## [Language Features](visual-basic/index.md)

### [Arrays](visual-basic/language-features/arrays/index.md)
#### [Array Dimensions](visual-basic/language-features/arrays/array-dimensions.md)
#### [How to: Initialize an Array Variable](visual-basic/language-features/arrays/how-to-initialize-an-array-variable.md)
#### [How to: Sort An Array](visual-basic/language-features/arrays/how-to-sort-an-array.md)
#### [How to: Assign One Array to Another Array](visual-basic/language-features/arrays/how-to-assign-one-array-to-another-array.md)
#### [Troubleshooting Arrays](visual-basic/language-features/arrays/troubleshooting-arrays.md)
### [Collection Initializers](visual-basic/language-features/collection-initializers/index.md)
#### [How to: Create an Add Extension Method Used by a Collection Initializer](visual-basic/language-features/collection-initializers/how-to-create-an-add-extension-method-used-by-a-collection-initializer.md)
#### [How to: Create a Collection Used by a Collection Initializer](visual-basic/language-features/collection-initializers/how-to-create-a-collection-used-by-a-collection-initializer.md)
### [Constants and Enumerations](visual-basic/language-features/constants-enums/index.md)
#### [Constants Overview](visual-basic/language-features/constants-enums/constants-overview.md)
##### [How to: Declare A Constant](visual-basic/language-features/constants-enums/how-to-declare-a-constant.md)
##### [User-Defined Constants](visual-basic/language-features/constants-enums/user-defined-constants.md)
##### [Constant and Literal Data Types](visual-basic/language-features/constants-enums/constant-and-literal-data-types.md)
##### [How to: Group Related Constant Values Together](visual-basic/language-features/constants-enums/how-to-group-related-constant-values-together.md)
#### [Enumerations Overview](visual-basic/language-features/constants-enums/enumerations-overview.md)
##### [How to: Declare Enumerations](visual-basic/language-features/constants-enums/how-to-declare-enumerations.md)
##### [How to: Refer to an Enumeration Member](visual-basic/language-features/constants-enums/how-to-refer-to-an-enumeration-member.md)
##### [Enumerations and Name Qualification](visual-basic/language-features/constants-enums/enumerations-and-name-qualification.md)
##### [How to: Iterate Through An Enumeration](visual-basic/language-features/constants-enums/how-to-iterate-through-an-enumeration.md)
##### [How to: Determine the String Associated with an Enumeration Value](visual-basic/language-features/constants-enums/how-to-determine-the-string-associated-with-an-enumeration-value.md)
##### [When to Use an Enumeration](visual-basic/language-features/constants-enums/when-to-use-an-enumeration.md)
### [Control Flow](visual-basic/language-features/control-flow/index.md)
#### [Decision Structures](visual-basic/language-features/control-flow/decision-structures.md)
#### [Loop Structures](visual-basic/language-features/control-flow/loop-structures.md)
##### [Walkthrough: Implementing IEnumerable(Of T)](visual-basic/language-features/control-flow/walkthrough-implementing-ienumerable-of-t.md)
#### [Other Control Structures](visual-basic/language-features/control-flow/other-control-structures.md)
##### [How to: Dispose of a System Resource](visual-basic/language-features/control-flow/how-to-dispose-of-a-system-resource.md)
#### [Nested Control Structures](visual-basic/language-features/control-flow/nested-control-structures.md)
### [Data Types](visual-basic/language-features/data-types/index.md)
#### [Type Characters](visual-basic/language-features/data-types/type-characters.md)
#### [Elementary Data Types](visual-basic/language-features/data-types/elementary-data-types.md)
##### [Numeric Data Types](visual-basic/language-features/data-types/numeric-data-types.md)
##### [Character Data Types](visual-basic/language-features/data-types/character-data-types.md)
##### [Miscellaneous Data Types](visual-basic/language-features/data-types/miscellaneous-data-types.md)
#### [Composite Data Types](visual-basic/language-features/data-types/composite-data-types.md)
##### [How to: Hold More Than One Value in a Variable](visual-basic/language-features/data-types/how-to-hold-more-than-one-value-in-a-variable.md)
#### [Generic Types](visual-basic/language-features/data-types/generic-types.md)
##### [How to: Define a Class That Can Provide Identical Functionality on Different Data Types](visual-basic/language-features/data-types/how-to-define-a-class-that-can-provide-identical-functionality.md)
##### [How to: Use a Generic Class](visual-basic/language-features/data-types/how-to-use-a-generic-class.md)
##### [Generic Procedures](visual-basic/language-features/data-types/generic-procedures.md)
#### [Nullable Value Types](visual-basic/language-features/data-types/nullable-value-types.md)
#### [Value Types and Reference Types](visual-basic/language-features/data-types/value-types-and-reference-types.md)
#### [Type Conversions](visual-basic/language-features/data-types/type-conversions.md)
##### [Widening and Narrowing Conversions](visual-basic/language-features/data-types/widening-and-narrowing-conversions.md)
##### [Implicit and Explicit Conversions](visual-basic/language-features/data-types/implicit-and-explicit-conversions.md)
##### [Conversions Between Strings and Other Types](visual-basic/language-features/data-types/conversions-between-strings-and-other-types.md)
##### [How to: Convert an Object to Another Type](visual-basic/language-features/data-types/how-to-convert-an-object-to-another-type.md)
##### [Array Conversions](visual-basic/language-features/data-types/array-conversions.md)
#### [Structures](visual-basic/language-features/data-types/structures.md)
##### [How to: Declare a Structure](visual-basic/language-features/data-types/how-to-declare-a-structure.md)
##### [Structure Variables](visual-basic/language-features/data-types/structure-variables.md)
##### [Structures and Other Programming Elements](visual-basic/language-features/data-types/structures-and-other-programming-elements.md)
##### [Structures and Classes](visual-basic/language-features/data-types/structures-and-classes.md)
#### [Efficient Use of Data Types](visual-basic/language-features/data-types/efficient-use-of-data-types.md)
#### [Troubleshooting Data Types](visual-basic/language-features/data-types/troubleshooting-data-types.md)
### [Declared Elements](visual-basic/language-features/declared-elements/index.md)
#### [Declared Element Names](visual-basic/language-features/declared-elements/declared-element-names.md)
#### [Declared Element Characteristics](visual-basic/language-features/declared-elements/declared-element-characteristics.md)
##### [Lifetime](visual-basic/language-features/declared-elements/lifetime.md)
##### [Scope](visual-basic/language-features/declared-elements/scope.md)
###### [How to: Control the Scope of a Variable](visual-basic/language-features/declared-elements/how-to-control-the-scope-of-a-variable.md)
###### [Type Promotion](visual-basic/language-features/declared-elements/type-promotion.md)
##### [Access Levels](visual-basic/language-features/declared-elements/access-levels.md)
###### [How to: Control the Availability of a Variable](visual-basic/language-features/declared-elements/how-to-control-the-availability-of-a-variable.md)
##### [References to Declared Elements](visual-basic/language-features/declared-elements/references-to-declared-elements.md)
##### [Shadowing](visual-basic/language-features/declared-elements/shadowing.md)
###### [Differences Between Shadowing and Overriding](visual-basic/language-features/declared-elements/differences-between-shadowing-and-overriding.md)
###### [How to: Hide a Variable with the Same Name as Your Variable](visual-basic/language-features/declared-elements/how-to-hide-a-variable-with-the-same-name-as-your-variable.md)
###### [How to: Hide an Inherited Variable](visual-basic/language-features/declared-elements/how-to-hide-an-inherited-variable.md)
###### [How to: Access a Variable Hidden by a Derived Class](visual-basic/language-features/declared-elements/how-to-access-a-variable-hidden-by-a-derived-class.md)
### [Delegates](visual-basic/language-features/delegates/delegates.md)
#### [How to: Invoke a Delegate Method](visual-basic/language-features/delegates/how-to-invoke-a-delegate-method.md)
#### [How to: Pass Procedures to Another Procedure](visual-basic/language-features/delegates/how-to-pass-procedures-to-another-procedure.md)
#### [Relaxed Delegate Conversion](visual-basic/language-features/delegates/relaxed-delegate-conversion.md)
### [Early and Late Binding](visual-basic/language-features/early-late-binding/early-and-late-binding.md)
#### [Determining Object Type](visual-basic/language-features/early-late-binding/determining-object-type.md)
#### [Calling a Property or Method Using a String Name](visual-basic/language-features/early-late-binding/calling-a-property-or-method-using-a-string-name.md)
#### [Working with Dynamic Objects](visual-basic/language-features/early-late-binding/working-with-dynamic-objects.md)
### [Error Types](visual-basic/language-features/error-types.md)
### [Events](visual-basic/language-features/events/events.md)
#### [Walkthrough: Declaring and Raising Events](visual-basic/language-features/events/walkthrough-declaring-and-raising-events.md)
#### [Walkthrough: Handling Events](visual-basic/language-features/events/walkthrough-handling-events.md)
#### [How to: Declare Custom Events To Avoid Blocking](visual-basic/language-features/events/how-to-declare-custom-events-to-avoid-blocking.md)
#### [How to: Declare Custom Events To Conserve Memory](visual-basic/language-features/events/how-to-declare-custom-events-to-conserve-memory.md)
#### [Troubleshooting Inherited Event Handlers](visual-basic/language-features/events/troubleshooting-inherited-event-handlers.md)
### [Interfaces](visual-basic/language-features/interfaces/index.md)
#### [Walkthrough: Creating and Implementing Interfaces](visual-basic/language-features/interfaces/walkthrough-creating-and-implementing-interfaces.md)
### [LINQ](visual-basic/language-features/linq/index.md)
#### [Introduction to LINQ](visual-basic/language-features/linq/introduction-to-linq.md)
#### [How to: Query a Database by Using LINQ](visual-basic/language-features/linq/how-to-query-a-database-by-using-linq.md)
#### [How to: Call a Stored Procedure by Using LINQ](visual-basic/language-features/linq/how-to-call-a-stored-procedure-by-using-linq.md)
#### [How to: Modify Data in a Database by Using LINQ](visual-basic/language-features/linq/how-to-modify-data-in-a-database-by-using-linq.md)
#### [How to: Combine Data with LINQ by Using Joins](visual-basic/language-features/linq/how-to-combine-data-with-linq-by-using-joins.md)
#### [How to: Sort Query Results by Using LINQ](visual-basic/language-features/linq/how-to-sort-query-results-by-using-linq.md)
#### [How to: Filter Query Results by Using LINQ](visual-basic/language-features/linq/how-to-filter-query-results-by-using-linq.md)
#### [How to: Count, Sum, or Average Data by Using LINQ](visual-basic/language-features/linq/how-to-count-sum-or-average-data-by-using-linq.md)
#### [How to: Find the Minimum or Maximum Value in a Query Result by Using LINQ](visual-basic/language-features/linq/how-to-find-the-minimum-or-maximum-value-in-a-query-result.md)
#### [How to: Return a LINQ Query Result as a Specific Type](visual-basic/language-features/linq/how-to-return-a-linq-query-result-as-a-specific-type.md)
### [Objects and Classes](visual-basic/language-features/objects-and-classes/index.md)
#### [Walkthrough: Defining Classes](visual-basic/language-features/objects-and-classes/walkthrough-defining-classes.md)
#### [Overloaded Properties and Methods](visual-basic/language-features/objects-and-classes/overloaded-properties-and-methods.md)
#### [Inheritance Basics](visual-basic/language-features/objects-and-classes/inheritance-basics.md)
#### [Object Lifetime: How Objects Are Created and Destroyed](visual-basic/language-features/objects-and-classes/object-lifetime-how-objects-are-created-and-destroyed.md)
#### [Object Initializers: Named and Anonymous Types](visual-basic/language-features/objects-and-classes/object-initializers-named-and-anonymous-types.md)
##### [How to: Declare an Object by Using an Object Initializer](visual-basic/language-features/objects-and-classes/how-to-declare-an-object-by-using-an-object-initializer.md)
#### [Anonymous Types](visual-basic/language-features/objects-and-classes/anonymous-types.md)
##### [How to: Infer Property Names and Types in Anonymous Type Declarations](visual-basic/language-features/objects-and-classes/how-to-infer-property-names-and-types-in-anonymous-type-declarations.md)
##### [Anonymous Type Definition](visual-basic/language-features/objects-and-classes/anonymous-type-definition.md)
### [Operators and Expressions](visual-basic/language-features/operators-and-expressions/index.md)
#### [Common Tasks Performed with Operators](visual-basic/language-features/operators-and-expressions/common-tasks-performed-with-visual-basic-operators.md)
#### [Arithmetic Operators](visual-basic/language-features/operators-and-expressions/arithmetic-operators.md)
#### [Comparison Operators](visual-basic/language-features/operators-and-expressions/comparison-operators.md)
#### [How to: Test Whether Two Objects Are the Same](visual-basic/language-features/operators-and-expressions/how-to-test-whether-two-objects-are-the-same.md)
#### [How to: Match a String against a Pattern](visual-basic/language-features/operators-and-expressions/how-to-match-a-string-against-a-pattern.md)
#### [Concatenation Operators](visual-basic/language-features/operators-and-expressions/concatenation-operators.md)
#### [Logical and Bitwise Operators](visual-basic/language-features/operators-and-expressions/logical-and-bitwise-operators.md)
#### [Efficient Combination of Operators](visual-basic/language-features/operators-and-expressions/efficient-combination-of-operators.md)
#### [How to: Calculate Numeric Values](visual-basic/language-features/operators-and-expressions/how-to-calculate-numeric-values.md)
#### [Value Comparisons](visual-basic/language-features/operators-and-expressions/value-comparisons.md)
#### [Boolean Expressions](visual-basic/language-features/operators-and-expressions/boolean-expressions.md)
#### [Procedures](visual-basic/language-features/procedures/index.md)
#### [How to: Create a Procedure](visual-basic/language-features/procedures/how-to-create-a-procedure.md)
#### [Sub Procedures](visual-basic/language-features/procedures/sub-procedures.md)
##### [How to: Call a Procedure that Does Not Return a Value](visual-basic/language-features/procedures/how-to-call-a-procedure-that-does-not-return-a-value.md)
##### [How to: Call an Event Handler](visual-basic/language-features/procedures/how-to-call-an-event-handler.md)
#### [Function Procedures](visual-basic/language-features/procedures/function-procedures.md)
##### [How to: Create a Procedure that Returns a Value](visual-basic/language-features/procedures/how-to-create-a-procedure-that-returns-a-value.md)
##### [How to: Return a Value from a Procedure](visual-basic/language-features/procedures/how-to-return-a-value-from-a-procedure.md)
##### [How to: Call a Procedure That Returns a Value](visual-basic/language-features/procedures/how-to-call-a-procedure-that-returns-a-value.md)
#### [Property Procedures](visual-basic/language-features/procedures/property-procedures.md)
##### [Auto-Implemented Properties](visual-basic/language-features/procedures/auto-implemented-properties.md)
##### [Differences Between Properties and Variables](visual-basic/language-features/procedures/differences-between-properties-and-variables.md)
##### [How to: Create a Property](visual-basic/language-features/procedures/how-to-create-a-property.md)
##### [How to: Declare a Property with Mixed Access Levels](visual-basic/language-features/procedures/how-to-declare-a-property-with-mixed-access-levels.md)
##### [How to: Call a Property Procedure](visual-basic/language-features/procedures/how-to-call-a-property-procedure.md)
##### [How to: Declare and Call a Default Property](visual-basic/language-features/procedures/how-to-declare-and-call-a-default-property.md)
##### [How to: Put a Value in a Property](visual-basic/language-features/procedures/how-to-put-a-value-in-a-property.md)
##### [How to: Get a Value from a Property](visual-basic/language-features/procedures/how-to-get-a-value-from-a-property.md)
#### [Operator Procedures](visual-basic/language-features/procedures/operator-procedures.md)
##### [How to: Define an Operator](visual-basic/language-features/procedures/how-to-define-an-operator.md)
##### [How to: Define a Conversion Operator](visual-basic/language-features/procedures/how-to-define-a-conversion-operator.md)
##### [How to: Call an Operator Procedure](visual-basic/language-features/procedures/how-to-call-an-operator-procedure.md)
##### [How to: Use a Class that Defines Operators](visual-basic/language-features/procedures/how-to-use-a-class-that-defines-operators.md)
#### [Procedure Parameters and Arguments](visual-basic/language-features/procedures/procedure-parameters-and-arguments.md)
##### [Differences Between Parameters and Arguments](visual-basic/language-features/procedures/differences-between-parameters-and-arguments.md)
##### [How to: Define a Parameter for a Procedure](visual-basic/language-features/procedures/how-to-define-a-parameter-for-a-procedure.md)
##### [How to: Pass Arguments to a Procedure](visual-basic/language-features/procedures/how-to-pass-arguments-to-a-procedure.md)
##### [Passing Arguments by Value and by Reference](visual-basic/language-features/procedures/passing-arguments-by-value-and-by-reference.md)
###### [Differences Between Modifiable and Nonmodifiable Arguments](visual-basic/language-features/procedures/differences-between-modifiable-and-nonmodifiable-arguments.md)
###### [Differences Between Passing an Argument By Value and By Reference](visual-basic/language-features/procedures/differences-between-passing-an-argument-by-value-and-by-reference.md)
###### [How to: Change the Value of a Procedure Argument](visual-basic/language-features/procedures/how-to-change-the-value-of-a-procedure-argument.md)
###### [How to: Protect a Procedure Argument Against Value Changes](visual-basic/language-features/procedures/how-to-protect-a-procedure-argument-against-value-changes.md)
###### [How to: Force an Argument to Be Passed by Value](visual-basic/language-features/procedures/how-to-force-an-argument-to-be-passed-by-value.md)
##### [Passing Arguments by Position and by Name](visual-basic/language-features/procedures/passing-arguments-by-position-and-by-name.md)
##### [Optional Parameters](visual-basic/language-features/procedures/optional-parameters.md)
##### [Parameter Arrays](visual-basic/language-features/procedures/parameter-arrays.md)
#### [Recursive Procedures](visual-basic/language-features/procedures/recursive-procedures.md)
#### [Procedure Overloading](visual-basic/language-features/procedures/procedure-overloading.md)
##### [How to: Define Multiple Versions of a Procedure](visual-basic/language-features/procedures/how-to-define-multiple-versions-of-a-procedure.md)
##### [How to: Call an Overloaded Procedure](visual-basic/language-features/procedures/how-to-call-an-overloaded-procedure.md)
##### [How to: Overload a Procedure that Takes Optional Parameters](visual-basic/language-features/procedures/how-to-overload-a-procedure-that-takes-optional-parameters.md)
##### [How to: Overload a Procedure that Takes an Indefinite Number of Parameters](visual-basic/language-features/procedures/how-to-overload-a-procedure-that-takes-an-indefinite-number-of-parameters.md)
##### [Considerations in Overloading Procedures](visual-basic/language-features/procedures/considerations-in-overloading-procedures.md)
##### [Overload Resolution](visual-basic/language-features/procedures/overload-resolution.md)
#### [Troubleshooting Procedures](visual-basic/language-features/procedures/troubleshooting-procedures.md)
#### [Extension Methods](visual-basic/language-features/procedures/extension-methods.md)
##### [How to: Write an Extension Method](visual-basic/language-features/procedures/how-to-write-an-extension-method.md)
##### [How to: Call an Extension Method](visual-basic/language-features/procedures/how-to-call-an-extension-method.md)
#### [Lambda Expressions](visual-basic/language-features/procedures/lambda-expressions.md)
##### [How to: Create a Lambda Expression](visual-basic/language-features/procedures/how-to-create-a-lambda-expression.md)
#### [Partial Methods](visual-basic/language-features/procedures/partial-methods.md)
### [Statements](visual-basic/language-features/statements.md)
### [Strings](visual-basic/language-features/strings/index.md)
#### [Introduction to Strings](visual-basic/language-features/strings/introduction-to-strings.md)
##### [String Basics](visual-basic/language-features/strings/string-basics.md)
##### [Types of String Manipulation Methods](visual-basic/language-features/strings/types-of-string-manipulation-methods.md)
##### [Nothing and Strings](visual-basic/language-features/strings/nothing-and-strings.md)
##### [How Culture Affects Strings](visual-basic/language-features/strings/how-culture-affects-strings.md)
##### [Zero-based vs. One-based String Access](visual-basic/language-features/strings/zero-based-vs-one-based-string-access.md)
#### [How to: Create Strings Using a StringBuilder](visual-basic/language-features/strings/how-to-create-strings-using-a-stringbuilder.md)
#### [How to: Search Within a String](visual-basic/language-features/strings/how-to-search-within-a-string.md)
#### [Converting Between Strings and Other Data Types](visual-basic/language-features/strings/converting-between-strings-and-other-data-types.md)
##### [How to: Convert an Array of Bytes into a String](visual-basic/language-features/strings/how-to-convert-an-array-of-bytes-into-a-string.md)
##### [How to: Convert Strings into an Array of Bytes](visual-basic/language-features/strings/how-to-convert-strings-into-an-array-of-bytes.md)
##### [How to: Create a String from An Array of Char Values](visual-basic/language-features/strings/how-to-create-a-string-from-an-array-of-char-values.md)
##### [How to: Convert Hexadecimal Strings to Numbers](visual-basic/language-features/strings/how-to-convert-hexadecimal-strings-to-numbers.md)
##### [How to: Convert a String to an Array of Characters](visual-basic/language-features/strings/how-to-convert-a-string-to-an-array-of-characters.md)
##### [How to: Access Characters in Strings](visual-basic/language-features/strings/how-to-access-characters-in-strings.md)
#### [Validating Strings](visual-basic/language-features/strings/validating-strings.md)
##### [How to: Validate File Names and Paths](visual-basic/language-features/strings/how-to-validate-file-names-and-paths.md)
##### [How to: Validate Strings That Represent Dates or Times](visual-basic/language-features/strings/how-to-validate-strings-that-represent-dates-or-times.md)
##### [Using Regular Expressions with the MaskedTextBox Control](visual-basic/language-features/strings/using-regular-expressions-with-the-maskedtextbox-control.md)
##### [Walkthrough: Validating That Passwords Are Complex](visual-basic/language-features/strings/walkthrough-validating-that-passwords-are-complex.md)
#### [Walkthrough: Encrypting and Decrypting Strings](visual-basic/language-features/strings/walkthrough-encrypting-and-decrypting-strings.md)
### [Variables](visual-basic/language-features/variables/index.md)
#### [Variable Declaration](visual-basic/language-features/variables/variable-declaration.md)
##### [How to: Create a New Variable](visual-basic/language-features/variables/how-to-create-a-new-variable.md)
##### [How to: Create a Variable that Does Not Change in Value](visual-basic/language-features/variables/how-to-create-a-variable-that-does-not-change-in-value.md)
##### [How to: Move Data Into and Out of a Variable](visual-basic/language-features/variables/how-to-move-data-into-and-out-of-a-variable.md)
#### [Object Variables](visual-basic/language-features/variables/object-variables.md)
##### [How to: Speed Up Access to an Object with a Long Qualification Path](visual-basic/language-features/variables/how-to-speed-up-access-to-an-object-with-a-long-qualification-path.md)
##### [Object Variable Declaration](visual-basic/language-features/variables/object-variable-declaration.md)
###### [How to: Access Members of an Object](visual-basic/language-features/variables/how-to-access-members-of-an-object.md)
##### [Object Variable Assignment](visual-basic/language-features/variables/object-variable-assignment.md)
###### [How to: Declare an Object Variable and Assign an Object to It](visual-basic/language-features/variables/how-to-declare-an-object-variable-and-assign-an-object-to-it.md)
###### [How to: Make an Object Variable Not Refer to Any Instance](visual-basic/language-features/variables/how-to-make-an-object-variable-not-refer-to-any-instance.md)
##### [Object Variable Values](visual-basic/language-features/variables/object-variable-values.md)
###### [How to: Refer to the Current Instance of an Object](visual-basic/language-features/variables/how-to-refer-to-the-current-instance-of-an-object.md)
###### [How to: Determine What Type an Object Variable Refers To](visual-basic/language-features/variables/how-to-determine-what-type-an-object-variable-refers-to.md)
###### [How to: Determine Whether Two Objects Are Related](visual-basic/language-features/variables/how-to-determine-whether-two-objects-are-related.md)
###### [How to: Determine Whether Two Objects Are Identical](visual-basic/language-features/variables/how-to-determine-whether-two-objects-are-identical.md)
#### [Local Type Inference](visual-basic/language-features/variables/local-type-inference.md)
#### [Troubleshooting Variables](visual-basic/language-features/variables/troubleshooting-variables.md)
### [XML](visual-basic/language-features/xml/index.md)
#### [Overview of LINQ to XML](visual-basic/language-features/xml/overview-of-linq-to-xml.md)
#### [Creating XML](visual-basic/language-features/xml/creating-xml.md)
##### [XML Literals Overview](visual-basic/language-features/xml/xml-literals-overview.md)
##### [Embedded Expressions in XML](visual-basic/language-features/xml/embedded-expressions-in-xml.md)
##### [Names of Declared XML Elements and Attributes](visual-basic/language-features/xml/names-of-declared-xml-elements-and-attributes.md)
##### [XML Literals and the XML 1.0 Specification](visual-basic/language-features/xml/xml-literals-and-the-xml-1-0-specification.md)
##### [White Space in XML Literals](visual-basic/language-features/xml/white-space-in-xml-literals.md)
##### [How to: Create XML Literals](visual-basic/language-features/xml/how-to-create-xml-literals.md)
##### [How to: Embed Expressions in XML Literals](visual-basic/language-features/xml/how-to-embed-expressions-in-xml-literals.md)
#### [Manipulating XML](visual-basic/language-features/xml/manipulating-xml.md)
##### [How to: Load XML from a File, String, or Stream](visual-basic/language-features/xml/how-to-load-xml-from-a-file-string-or-stream.md)
##### [How to: Transform XML by Using LINQ](visual-basic/language-features/xml/how-to-transform-xml-by-using-linq.md)
##### [How to: Modify XML Literals](visual-basic/language-features/xml/how-to-modify-xml-literals.md)
#### [Accessing XML](visual-basic/language-features/xml/accessing-xml.md)
##### [How to: Access XML Descendant Elements](visual-basic/language-features/xml/how-to-access-xml-descendant-elements.md)
##### [How to: Access XML Child Elements](visual-basic/language-features/xml/how-to-access-xml-child-elements.md)
##### [How to: Access XML Attributes](visual-basic/language-features/xml/how-to-access-xml-attributes.md)
##### [How to: Declare and Use XML Namespace Prefixes](visual-basic/language-features/xml/how-to-declare-and-use-xml-namespace-prefixes.md)
#### [XML IntelliSense](visual-basic/language-features/xml/xml-intellisense.md)
##### [How to: Enable XML IntelliSense](visual-basic/language-features/xml/how-to-enable-xml-intellisense.md)
##### [XML to Schema Wizard](visual-basic/language-features/xml/xml-to-schema-wizard.md)

## [COM Interop](visual-basic/com-interop/index.md)
### [Introduction to COM Interop](visual-basic/com-interop/introduction-to-com-interop.md)
### [How to: Reference COM Objects](visual-basic/com-interop/how-to-reference-com-objects.md)
### [How to: Work with ActiveX Controls](visual-basic/com-interop/how-to-work-with-activex-controls.md)
### [Walkthrough: Calling Windows APIs](visual-basic/com-interop/walkthrough-calling-windows-apis.md)
### [How to: Call Windows APIs](visual-basic/com-interop/how-to-call-windows-apis.md)
### [How to: Call a Windows Function that Takes Unsigned Types](visual-basic/com-interop/how-to-call-a-windows-function-that-takes-unsigned-types.md)
### [Walkthrough: Creating COM Objects](visual-basic/com-interop/walkthrough-creating-com-objects.md)
### [Troubleshooting Interoperability](visual-basic/com-interop/troubleshooting-interoperability.md)
### [COM Interoperability in .NET Framework Applications](visual-basic/com-interop/com-interoperability-in-net-framework-applications.md)
### [Walkthrough: Implementing Inheritance with COM Objects](visual-basic/com-interop/walkthrough-implementing-inheritance-with-com-objects.md)
