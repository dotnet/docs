...
### [Dependency management with .NET Core Tools RC4](core/preview3/tools/dependencies.md)
### [Deploying applications with .NET Core Tools RC4](core/preview3/deploying/index.md)
