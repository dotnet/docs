...
####[Query expression basics](csharp/query-expression-basics.md)
####[LINQ in C#](csharp/linq-in-csharp.md)
####[Write LINQ queries in C#](csharp/write-linq-queries.md)
####[Query a collection of objects](csharp/query-a-collection-of-objects.md)
####[Return a query from a method](csharp/return-a-query-from-a-method.md)
####[Store the results of a query in memory](csharp/store-the-results-of-a-query-in-memory.md)
####[Group query results](csharp/group-query-results.md)
####[Create a nested group](csharp/create-a-nested-group.md)
####[Perform a subquery on a grouping operation](csharp/perform-a-subquery-on-a-grouping-operation.md)
####[Group results by contiguous keys](csharp/group-results-by-contiguous-keys.md)
####[Dynamically specify predicate filters at runtime](csharp/dynamically-specify-predicate-filters-at-runtime.md)
####[Perform inner joins](csharp/perform-inner-joins.md)
####[Perform grouped joins](csharp/perform-grouped-joins.md)
####[Perform left outer joins](csharp/perform-left-outer-joins.md)
####[Order the results of a join clause](csharp/order-the-results-of-a-join-clause.md)
####[Join by using composite keys](csharp/join-by-using-composite-keys.md)
####[Perform custom join operations](csharp/perform-custom-join-operations.md)
####[Handle null values in query expressions](csharp/handle-null-values-in-query-expressions.md)
####[Handle exceptions in query expressions](csharp/handle-exceptions-in-query-expressions.md)
