...
## [Resources in .NET apps](standard/resources/index.md)
### [Create resource files](standard/resources/creating-resource-files-for-desktop-apps.md)
#### [Work with .resx files programmatically](standard/resources/working-with-resx-files-programmatically.md)
### [Create satellite assemblies](standard/resources/creating-satellite-assemblies-for-desktop-apps.md)
### [Package and deploy resources](standard/resources/packaging-and-deploying-resources-in-desktop-apps.md)
### [Retrieve resources](standard/resources/retrieving-resources-in-desktop-apps.md)
...
### [.NET Framework technologies unavailable for .NET Core](core/porting/net-framework-tech-unavailable.md)
