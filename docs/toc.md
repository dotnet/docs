...
## [Authoring Libraries for .NET Core RTM](scenarios/library-authoring/index.md)
### [How to manage package dependency versions for .NET Core RTM](scenarios/library-authoring/fastening-libraries-to-rtm.md)
