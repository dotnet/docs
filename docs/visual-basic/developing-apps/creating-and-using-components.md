...
-   If your component cannot derive from one of the base implementations due to single inheritance, implement <xref:System.ComponentModel.IComponent>.  
 ...
 For more information about design-time support, see [Design-Time Attributes for Components](http://msdn.microsoft.com/library/12050fe3-9327-4509-9e21-4ee2494b95c3) and [Extending Design-Time Support](https://msdn.microsoft.com/library/37899azc.aspx).  
...
## Related Sections  
 [Class vs. Component vs. Control](https://msdn.microsoft.com/library/0b1dk63b.aspx)  
 ...
 [Component Classes](https://msdn.microsoft.com/library/8zzftay8.aspx)  
...
## See Also  
 ...
 [How to: Extend the Appearance and Behavior of Controls in Design Mode](https://msdn.microsoft.com/library/ms171820.aspx)   
 [How to: Perform Custom Initialization for Controls in Design Mode](https://msdn.microsoft.com/library/ms171821.aspx)
