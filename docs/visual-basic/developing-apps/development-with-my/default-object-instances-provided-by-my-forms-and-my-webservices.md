...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["My.WebServices object [Visual Basic], developing applications", "My.Forms object [Visual Basic], developing applications", "rapid application development (RAD), My.Forms", "rapid application development (RAD), My.WebServices"]
