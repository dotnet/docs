...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["My.Application object [Visual Basic], developing applications", "rapid application development (RAD), My.Application", "rapid application development (RAD), My.Computer", "rapid application development (RAD), My.User", "My.Computer object [Visual Basic], developing applications", "My.User object [Visual Basic], developing applications"]
