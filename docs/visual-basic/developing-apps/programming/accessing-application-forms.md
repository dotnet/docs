...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["forms [Visual Basic], communicating between", "application forms [Visual Basic], accessing", "forms [Visual Basic], accessing one from another", "My.Forms object", "forms [Visual Basic], accessing all open"]
