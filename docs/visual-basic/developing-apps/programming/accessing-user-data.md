...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["domain names [Visual Basic], retrieving", "data [Visual Basic], accessing user data", "My.User object [Visual Basic], tasks", "user data [Visual Basic], domain", "user names [Visual Basic], retrieving", "user data [Visual Basic], accessing", "login names [Visual Basic]", "examples [Visual Basic], accessing user data"]
