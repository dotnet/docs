...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["My.Settings object, creating property grids for user settings", "user settings, creating property grids", "property grids, creating for user settings", "property grids"]
