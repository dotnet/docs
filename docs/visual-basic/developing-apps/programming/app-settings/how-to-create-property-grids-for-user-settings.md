...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["My.Settings object [Visual Basic], creating property grids for user settings", "user settings [Visual Basic], creating property grids", "property grids [Visual Basic], creating for user settings", "property grids"]
