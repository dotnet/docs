...
The <xref:Microsoft.VisualBasic.Devices.Computer.Network.IsAvailable%2A> property can be used to determine whether the computer has a working network or Internet connection.  
