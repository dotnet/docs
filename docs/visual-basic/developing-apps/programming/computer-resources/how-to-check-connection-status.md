...
The <xref:Microsoft.VisualBasic.Devices.Computer.Network.IsAvailable> property can be used to determine whether the computer has a working network or Internet connection.  
...
## See Also  
 ...
 <xref:Microsoft.VisualBasic.Devices.Computer.Network.IsAvailable>
