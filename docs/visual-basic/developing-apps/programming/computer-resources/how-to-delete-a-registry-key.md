...
dev_langs: ["VB"]
helpviewer_keywords: ["GetSetting function [VB]", "registry [VB], deleting values", "GetAllSettings function [VB]", "registry keys [VB], deleting", "registry [VB], deleting keys", "examples [VB], registry"]
