...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""downloading Internet resources [VB], files"", ""downloading files [VB]"", ""remote computers [VB], downloading from"", ""files [VB], downloading"", ""files [VB], transferring""]"]
