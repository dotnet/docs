...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["downloading Internet resources [Visual Basic], files", "downloading files [Visual Basic]", "remote computers [Visual Basic], downloading from", "files [Visual Basic], downloading", "files [Visual Basic], transferring"]
