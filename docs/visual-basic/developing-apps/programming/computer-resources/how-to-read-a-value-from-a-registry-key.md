...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["registry keys, determining if a value exists in", "My.Computer.Registry object, examples", "registry, determining if values exist", "registry keys, reading from", "registry, reading"]
