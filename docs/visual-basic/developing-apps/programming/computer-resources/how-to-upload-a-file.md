...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["networks, uploading files", "files [Visual Basic], uploading", "uploading files [Visual Basic]", "UploadFile method [Visual Basic]", "My.Computer.Network.UploadFile method"]
