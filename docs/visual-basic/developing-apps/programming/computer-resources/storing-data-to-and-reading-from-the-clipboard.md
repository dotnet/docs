...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["Clipboard [VB], storing data to (My.Computer.Clipboard)", "Clipboard [VB], reading from (My.Computer.Clipboard)", "Clipboard [VB]", "My.Computer.Clipboard object, tasks", "data [VB], Clipboard", "reading data, from Clipboard"]
