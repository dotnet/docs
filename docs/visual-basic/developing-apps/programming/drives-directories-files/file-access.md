...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["file access", "files, input and output", "file access, Visual Basic", "files, I/O", "file I/O classes", "data [Visual Basic], accessing from files", "files, accessing", "file access, using components", "My.Computer.FileSystem object, accessing files", "I/O [Visual Basic]", "sequential access"]
