...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""file access [VB]"", ""files [VB], input and output"", ""file access, Visual Basic"", ""files [VB], I/O"", ""file I/O classes [VB]"", ""data [VB], accessing from files"", ""files [VB], accessing"", ""file access, using components"", ""My.Computer.FileSystem object, accessing files"", ""I/O [VB]"", ""sequential access [VB]""]"]
