...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["binary files [Visual Basic], reading from", "I/O [Visual Basic], reading from binary files", "ReadAllBytes method [Visual Basic], reading from binary files", "My.Computer.FileSystem object, reading from binary files"]
