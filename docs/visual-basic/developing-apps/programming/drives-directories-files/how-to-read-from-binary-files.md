...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""binary files [VB], reading from"", ""I/O [VB], reading from binary files"", ""ReadAllBytes method [VB], reading from binary files"", ""My.Computer.FileSystem object, reading from binary files""]"]
