...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["files [Visual Basic], parsing", "text files [Visual Basic], tasks", "reading text files [Visual Basic], comma-delimited", "text files [Visual Basic], reading"]
