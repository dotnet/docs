...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["fixed-width text file", "reading text files [Visual Basic], fixed-width", "files [Visual Basic], parsing", "text files [Visual Basic], tasks", "text files [Visual Basic], reading"]
