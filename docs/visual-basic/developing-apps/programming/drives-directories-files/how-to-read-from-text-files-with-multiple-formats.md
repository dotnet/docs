...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["TextFieldParser object, reading from a file", "TextFieldType enumeration [VB]", "My.Computer.FileSystem.WriteAllText method, parsing structured text files", "WriteAllText method, parsing structured text files", "PeekChars method, determining format of text", "reading text files [VB], multiple formats", "I/O [VB], reading text files", "text files [VB], reading"]
