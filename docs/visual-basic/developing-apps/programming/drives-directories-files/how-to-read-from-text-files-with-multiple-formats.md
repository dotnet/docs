...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["TextFieldParser object, reading from a file", "TextFieldType enumeration", "My.Computer.FileSystem.WriteAllText method, parsing structured text files", "WriteAllText method [Visual Basic], parsing structured text files", "PeekChars method [Visual Basic], determining format of text", "reading text files [Visual Basic], multiple formats", "I/O [Visual Basic], reading text files", "text files [Visual Basic], reading"]
