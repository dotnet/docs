...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["extended characters [Visual Basic], reading", "reading text files [Visual Basic]", "reading data, text files", "examples [Visual Basic], reading text files", "text files [Visual Basic], reading"]
