...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["files [Visual Basic], writing to", "text, writing to files", "examples [Visual Basic], text files", "writing to files [Visual Basic], in My Documents"]
