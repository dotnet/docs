...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""drives [VB]"", ""drives, processing"", ""Visual Basic code, file access"", ""files [VB], processing"", ""files [VB], accessing"", ""directories [Visual Studio], processing""]"]
