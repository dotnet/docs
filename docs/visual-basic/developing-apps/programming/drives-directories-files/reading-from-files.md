...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["data [Visual Basic], reading from files", "I/O [Visual Basic], reading from files", "examples [Visual Basic], reading from files", "files [Visual Basic], reading", "reading files [Visual Basic]"]
