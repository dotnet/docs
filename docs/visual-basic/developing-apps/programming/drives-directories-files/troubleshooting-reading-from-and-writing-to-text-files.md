...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["troubleshooting file I/O", "writing text to files, troubleshooting", "troubleshooting Visual Basic, text files", "I/O [Visual Basic], troubleshooting text files", "writing to files, troubleshooting", "reading text files, troubleshooting"]
