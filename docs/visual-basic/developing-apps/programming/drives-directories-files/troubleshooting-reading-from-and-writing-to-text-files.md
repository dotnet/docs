...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["troubleshooting file I/O", "writing text to files [Visual Basic], troubleshooting", "troubleshooting Visual Basic, text files", "I/O [Visual Basic], troubleshooting text files", "writing to files [Visual Basic], troubleshooting", "reading text files [Visual Basic], troubleshooting"]
