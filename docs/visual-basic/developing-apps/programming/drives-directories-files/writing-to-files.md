...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["I/O [Visual Basic], writing to files", "files, writing to", "examples [Visual Basic], writing to files", "writing to files", "Visual Basic, writing to files"]
