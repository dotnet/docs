...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["event logs [Visual Studio], writing event information", "text files [Visual Basic], writing event information to a text file", "events [Visual Basic], writing event information to a text file"]
