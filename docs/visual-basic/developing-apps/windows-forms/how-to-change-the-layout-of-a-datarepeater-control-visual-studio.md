...
2.  In the Properties window, set the <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.LayoutStyle%2A> property to either `DataRepeaterLayoutStyles.Vertical` or `DataRepeaterLayoutStyles.Horizontal`.  
