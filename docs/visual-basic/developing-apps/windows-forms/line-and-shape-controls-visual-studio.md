...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["RectangleShape control [Visual Basic], topic list", "OvalShape control [Visual Basic], topic list", "Shape control [Visual Basic]", "Line control [Visual Basic], topic list"]
