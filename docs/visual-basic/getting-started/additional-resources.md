...
|[Visual Basic documentation samples](https://github.com/dotnet/samples/tree/master/samples/snippets/visualbasic)|Contains the samples used throughout the Visual Basic and .NET documentation.|
