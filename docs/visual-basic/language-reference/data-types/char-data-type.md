...
f1_keywords: ["vb.Char"]
dev_langs: ["VB"]
helpviewer_keywords: ["literal type characters, C", "Char data type", "C literal type character", "data types [Visual Basic], assigning", "Char data type, character literals"]
