...
f1_keywords: ["vb.Char"]
dev_langs: ["VB"]
helpviewer_keywords: ["literal type characters [Visual Basic], C", "Char data type", "C literal type character [Visual Basic]", "data types [Visual Basic], assigning", "Char data type [Visual Basic], character literals"]
