...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["Boolean data type [VB], supported types in Visual Basic", "storage [VB], order of storage", "data types [VB], Visual Basic", "Single data type [VB], supported types in Visual Basic", "notation [VB], scientific", "memory requirements, data types", "user-defined data types [VB], Visual Basic", "Date data type [VB], Visual Basic", "Visual Basic, data types", "storage [VB], allocation", "Integer data type [VB], Visual Basic data types", "storage [VB], space", "Variant data types [VB], supported types in Visual Basic", "Char data type [VB], Visual Basic data types", "intrinsic data types [VB]", "memory consumption [VB], data types", "single-precision numbers", "data types [VB], order of storage", "Long data type [VB], supported types in Visual Basic", "String data type [VB], Visual Basic data types", "storage order, data types", "StructLayoutAttribute class, Visual Basic data type storage", "scientific notation", "Double data type [VB], Visual Basic data types", "Byte data type [VB], Visual Basic data types", "Object data type [VB], supported types in Visual Basic", "data types [VB], storage allocation", "double-precision numbers", "data types [VB], summary", "dates [VB], data types", "strings [VB], data types", "memory consumption", "storage order, controlling in Visual Basic", "data types [VB], memory requirements"]
