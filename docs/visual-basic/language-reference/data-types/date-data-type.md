...
f1_keywords: ["vb.Date"]
dev_langs: ["VB"]
helpviewer_keywords: ["Date data type", "dates, Visual Basic data types", "times, Date data type", "Date literals", "data values", "times, Visual Basic data types", "dates, Date data type", "data types [Visual Basic], assigning", "literals, Date", "# specifier for Date literals"]
