...
f1_keywords: ["vb.Long"]
dev_langs: ["VB"]
helpviewer_keywords: ["identifier type characters, &", "numbers, whole", "whole numbers", "integral data types", "& identifier type character", "integer numbers", "literal type characters, L", "numbers, integer", "integers, data types", "L literal type character", "integers, types", "Long keyword", "data types [Visual Basic], integral", "data types [Visual Basic], assigning", "Long data type"]
