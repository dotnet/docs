...
dev_langs: ["VB"]
helpviewer_keywords: ["numbers, whole", "whole numbers", "integral data types", "integer numbers", "numbers, integer", "integers, data types", "integers, types", "data types [Visual Basic], integral", "S literal type character", "Short data type", "literal type characters, S"]
