...
dev_langs: ["VB"]
helpviewer_keywords: ["Single data type [VB]", "F literal type character [VB]", "trailing zeros [VB]", "real numbers [VB]", "literal type characters [VB], F", "trailing 0 characters", "identifier type characters [VB], !", "single-precision numbers [VB]", "! identifier type character", "0 characters [VB], trailing", "data types [VB], assigning", "floating-point numbers [VB], Single data type", "numbers [VB], real", "zeros [VB], trailing", "numbers [VB], floating point"]
