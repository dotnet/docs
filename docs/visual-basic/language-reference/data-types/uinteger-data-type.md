...
dev_langs: ["VB"]
helpviewer_keywords: ["numbers, whole", "UInteger data type", "literal type characters, UI", "whole numbers", "integral data types", "integer numbers", "numbers, integer", "integers, data types", "integers, types", "UI literal type characters", "data types [Visual Basic], integral"]
