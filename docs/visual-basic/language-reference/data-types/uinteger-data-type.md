...
dev_langs: ["VB"]
helpviewer_keywords: ["numbers [VB], whole", "UInteger data type [VB]", "literal type characters [VB], UI", "whole numbers [VB]", "integral data types [VB]", "integer numbers [VB]", "numbers [VB], integer", "integers [VB], data types", "integers [VB], types", "UI literal type characters [VB]", "data types [VB], integral"]
