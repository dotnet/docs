...
dev_langs: ["VB"]
helpviewer_keywords: ["[""user-defined data types [VB], Visual Basic"", ""user-defined types"", ""structures [VB], as user-defined data types"", ""user-defined types [VB], Visual Basic"", ""user-defined types [VB], structure declaration"", ""user-defined types [VB], structures in Visual Basic"", ""user-defined data types [VB], structure declaration"", ""data types [VB], assigning"", ""Structure statement [VB]"", ""data types [VB], user-defined"", ""user-defined data types [VB], structures in Visual Basic"", ""user-defined data types"", ""types [VB], user-defined""]"]
