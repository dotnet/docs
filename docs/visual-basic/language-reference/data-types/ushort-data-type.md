...
dev_langs: ["VB"]
helpviewer_keywords: ["numbers, whole", "literal type characters, US", "whole numbers", "integral data types", "integer numbers", "numbers, integer", "integers, data types", "integers, types", "data types [Visual Basic], integral", "UShort data type", "US literal type characters"]
