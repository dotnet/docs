...
dev_langs: ["VB"]
helpviewer_keywords: ["#Const directive", "conditional compilation, directives", "Const directive (#Const)", "Visual Basic compiler, compiler directives", "constants, Const directive", "constants, declaring", "Const statement [Visual Basic], directive (#Const)", "declaring constants, #const directive"]
