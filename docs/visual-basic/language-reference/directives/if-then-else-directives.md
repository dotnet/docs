...
dev_langs: ["VB"]
helpviewer_keywords: ["Visual Basic code, compiling", "#If directive [VB]", "conditional compilation [VB], directives", "#End if directive [VB]", "selective compiling [VB]", "else directive (#else)", "#Else directive [VB]"]
