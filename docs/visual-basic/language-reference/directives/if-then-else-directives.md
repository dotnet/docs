...
dev_langs: ["VB"]
helpviewer_keywords: ["Visual Basic code, compiling", "#If directive [Visual Basic]", "conditional compilation, directives", "#End if directive [Visual Basic]", "selective compiling", "else directive (#else)", "#Else directive [Visual Basic]"]
