...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["conversions, conversion functions", "conversion functions", "string conversion, conversion functions", "data types [Visual Basic], converting", "declaring functions, conversion functions", "data types [Visual Basic], assigning", "numbers, converting", "functions [Visual Basic], conversion", "dates, converting"]
