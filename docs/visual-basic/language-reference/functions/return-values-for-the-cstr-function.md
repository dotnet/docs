...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["times, CStr Function return values", "type conversion", "dates [Visual Basic], CStr Function return values", "CStr function", "strings [Visual Basic], return value", "Date data type, converting", "dates [Visual Basic]", "String data type, converting"]
