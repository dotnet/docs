...
dev_langs: ["VB"]
helpviewer_keywords: ["CDate function", "CByte function", "Integer data type [VB], converting", "string conversion [VB], conversion functions", "fractions", "data types [VB], converting", "text, converting", "CDec function", "Char data type [VB], converting", "type conversion [VB], functions for", "Single data type [VB], converting", "numbers [VB], rounding", "rounding numbers [VB], type conversion", "CUShort function", "Long data type [VB], converting", "return values [VB], data types", "single-precision numbers [VB], converting", "data type conversion [VB], functions for", "CStr function", "times [VB], converting", "CSng function", "conversions [VB], type conversion functions", "CBool function", "CDbl function", "CUInt function", "Currency data type [VB], conversion functions", "numbers [VB], converting", "Double data type [VB], converting", "CLng function", "CSByte function", "double-precision numbers", "Decimal data type [VB], converting", "Boolean data type [VB], converting", "integers [VB], type conversion functions", "dates [VB], converting", "CULng function", "CInt function", "Date data type [VB], converting", "Byte data type [VB], converting", "String data type [VB], converting", "CChar function", "banker's rounding", "Short data type [VB], converting", "rounding numbers [VB], banker's rounding", "type conversion [VB], Visual Basic vs. .NET Framework"]
