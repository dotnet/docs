...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["dates, Visual Basic data types", "dates, run-time library members", "dates, Visual Basic keywords", "times, Visual Basic", "Data data type, Visual Basic", "time, Visual Basic keywords and run-time library members", "time data types"]
