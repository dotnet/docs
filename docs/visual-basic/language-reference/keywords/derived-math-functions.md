...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["arithmetic operations, derived math functions", "cosecant function", "arcsecant function", "arccotangent function", "functions [Visual Basic], derived math functions", "inverse functions", "math functions, derived", "derived math functions", "cotangent function", "angles", "secant function", "trigonometric functions", "logarithms", "arccosecant function", "hyperbolic functions", "arcsine function", "degrees", "arccosine function"]
