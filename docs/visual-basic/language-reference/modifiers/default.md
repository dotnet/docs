...
dev_langs: ["VB"]
helpviewer_keywords: ["defaults, properties", "properties [Visual Basic], default", "default properties, in Visual Basic", "Default keyword [Visual Basic]", "default properties"]
