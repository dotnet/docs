...
dev_langs: ["VB"]
helpviewer_keywords: ["Friend keyword [VB]", "Friend access modifier", "Friend keyword [VB], syntax", "Protected Friend keyword combination", "Friend keyword [VB], and Protected"]
