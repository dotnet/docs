...
dev_langs: ["VB"]
helpviewer_keywords: ["virtual elements [Visual Basic], pure", "elements [Visual Basic], pure virtual", "properties [Visual Basic], redefining", "procedures [Visual Basic], overriding", "overriding, MustOverride keyword", "procedures [Visual Basic], redefining", "pure virtual elements [Visual Basic]", "MustOverride keyword [Visual Basic]", "properties [Visual Basic], overriding"]
