...
dev_langs: ["VB"]
helpviewer_keywords: ["virtual elements, pure", "elements, pure virtual", "properties [Visual Basic], redefining", "procedures, overriding", "overriding, MustOverride keyword", "procedures, redefining", "pure virtual elements", "MustOverride keyword", "properties [Visual Basic], overriding"]
