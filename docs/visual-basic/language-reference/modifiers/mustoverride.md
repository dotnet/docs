...
dev_langs: ["VB"]
helpviewer_keywords: ["virtual elements [VB], pure", "elements [VB], pure virtual", "properties [VB], redefining", "procedures [VB], overriding", "overriding, MustOverride keyword", "procedures [VB], redefining", "pure virtual elements [VB]", "MustOverride keyword [VB]", "properties [VB], overriding"]
