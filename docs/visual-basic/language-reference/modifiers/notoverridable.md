...
dev_langs: ["VB"]
helpviewer_keywords: ["sealed methods [VB]", "NotOverridable keyword [VB]", "properties [VB], redefining", "elements [VB], sealed", "sealed elements [VB]", "procedures [VB], overriding", "procedures [VB], redefining", "overriding [VB]", "methods [VB], sealed", "properties [VB], overriding"]
