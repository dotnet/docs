...
dev_langs: ["VB"]
helpviewer_keywords: ["elements, concrete", "properties [Visual Basic], redefining", "overriding, Overridable keyword", "elements, virtual", "virtual elements", "procedures, overriding", "concrete elements", "procedures, redefining", "Overridable keyword", "properties [Visual Basic], overriding"]
