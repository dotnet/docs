...
dev_langs: ["VB"]
helpviewer_keywords: ["[""properties [VB], redefining"", ""procedures [VB], overriding"", ""procedures [VB], redefining"", ""overriding [VB]"", ""Overrides keyword [VB]"", ""overriding [VB], Overrides keyword"", ""properties [VB], overriding""]"]
