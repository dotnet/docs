...
dev_langs: ["VB"]
helpviewer_keywords: ["properties [Visual Basic], redefining", "procedures [Visual Basic], overriding", "procedures [Visual Basic], redefining", "overriding", "Overrides keyword [Visual Basic]", "overriding, Overrides keyword", "properties [Visual Basic], overriding"]
