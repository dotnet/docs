...
dev_langs: ["VB"]
helpviewer_keywords: ["[""structures [VB], partial"", ""classes [VB]"", ""partial, types [VB]"", ""partial, structures"", ""partial, classes [VB]"", ""classes [VB], partial"", ""Partial keyword [VB]"", ""type promotion [VB]""]"]
