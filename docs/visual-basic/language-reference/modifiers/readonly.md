...
dev_langs: ["VB"]
helpviewer_keywords: ["ReadOnly keyword [Visual Basic]", "variables [Visual Basic], read-only", "ReadOnly property", "properties [Visual Basic], read-only", "read-only variables"]
