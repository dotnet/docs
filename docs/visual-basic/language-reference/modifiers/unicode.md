...
dev_langs: ["VB"]
helpviewer_keywords: ["Unicode, external references", "Declare statement [Visual Basic], marshaling strings", "Unicode keyword [Visual Basic]", "Unicode, marshaling strings"]
