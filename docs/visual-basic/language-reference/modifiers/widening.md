...
dev_langs: ["VB"]
helpviewer_keywords: ["conversions [Visual Basic], type", "type conversion [Visual Basic]", "conversions [Visual Basic], data type", "Widening keyword [Visual Basic]", "data type conversion [Visual Basic]"]
