...
> [!NOTE]
>  You can also use classes in the .NET Framework to log information from your application. For more information, see [Tracing and Instrumenting Applications](~/docs/framework/debug-trace-profile/tracing-and-instrumenting-applications.md).  
