...
## Remarks  
 The `My.Forms` object provides an instance of each form in the current project. The name of the property is the same as the name of the form that the property accesses. For information about adding forms to a project, see [How to: Add Windows Forms to a Project](http://msdn.microsoft.com/3d7bb25f-fd90-47cf-9378-fa0d764686c1).  
...
## Example  
 ...
 For this example to work, your project must have a form named `SidebarMenu`. For more information, see [How to: Add Windows Forms to a Project](http://msdn.microsoft.com/3d7bb25f-fd90-47cf-9378-fa0d764686c1).  
...
## See Also  
 ...
 [How to: Add Windows Forms to a Project](http://msdn.microsoft.com/3d7bb25f-fd90-47cf-9378-fa0d764686c1)   
