...
f1_keywords: ["vb.+="]
dev_langs: ["VB"]
helpviewer_keywords: ["+= operator [Visual Basic]", "assignment statements, compound", "statements [Visual Basic], compound assignment", "+= operator [Visual Basic], appending strings", "compound assignment statements"]
