...
f1_keywords: ["vb.+"]
dev_langs: ["VB"]
helpviewer_keywords: ["arithmetic operators [Visual Basic], addition", "+ operator", "concatenation operators [Visual Basic], syntax", "strings [Visual Basic], concatenating", "sum operator [Visual Basic]"]
