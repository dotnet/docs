...
dev_langs: ["VB"]
helpviewer_keywords: ["short-circuiting", "AndAlso operator", "operators [Visual Basic], short-circuiting", "operators [Visual Basic], conjunction", "short-circuit evaluation"]
