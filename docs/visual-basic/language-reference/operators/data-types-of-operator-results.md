...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["data types [Visual Basic], operator result data types", "result data types [Visual Basic]", "operator result data types [Visual Basic]", "operators [Visual Basic], data types", "data types [Visual Basic], ranges", "operators [Visual Basic], result data types"]
