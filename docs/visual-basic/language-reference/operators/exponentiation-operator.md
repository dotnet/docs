...
f1_keywords: ["vb.^"]
dev_langs: ["VB"]
helpviewer_keywords: ["raising numbers to powers", "^ operator [Visual Basic], exponention", "square operator", "^ operator [Visual Basic]", "exponentiation operator [Visual Basic]", "exponent", "numbers, rasing", "powers", "arithmetic operators, exponentiation"]
