...
f1_keywords: ["vb.<<="]
dev_langs: ["VB"]
helpviewer_keywords: ["operator <<=", "assignment statements [VB], compound", "<<= operator [VB]", "statements [VB], compound assignment", "operator<<=", "compound assignment statements [VB]"]
