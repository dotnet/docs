...
f1_keywords: ["vb.<<="]
dev_langs: ["VB"]
helpviewer_keywords: ["operator <<=", "assignment statements [Visual Basic], compound", "<<= operator [Visual Basic]", "statements [Visual Basic], compound assignment", "operator<<=", "compound assignment statements [Visual Basic]"]
