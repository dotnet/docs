...
f1_keywords: ["vb.Mod"]
dev_langs: ["VB"]
helpviewer_keywords: ["remainder (Mod operator)", "division operator, Mod operator", "modulus operator, Visual Basic", "Mod operator [Visual Basic]", "operators [Visual Basic], division", "arithmetic operators, Mod", "math operators"]
