...
f1_keywords: ["vb.*"]
dev_langs: ["VB"]
helpviewer_keywords: ["arithmetic operators [Visual Basic], multiplication", "operators [Visual Basic], multiplication", "* operator [Visual Basic]", "multiplication operator [Visual Basic], syntax", "math operators [Visual Basic]"]
