...
f1_keywords: ["vb.*"]
dev_langs: ["VB"]
helpviewer_keywords: ["arithmetic operators, multiplication", "operators [Visual Basic], multiplication", "* operator [Visual Basic]", "multiplication operator, syntax", "math operators"]
