...
As the preceding example shows, in the case of a type and a namespace, the produced name is usually not [fully qualified](~/_csharpstandard/standard/basic-concepts.md#fully-qualified-names).
