...
f1_keywords: ["vb.Not"]
dev_langs: ["VB"]
helpviewer_keywords: ["Boolean expressions, negating", "operators [VB], bitwise", "negation operator [VB]", "inverse bit values in variables [VB]", "bitwise operators [VB], NOT operator [VB]", "bitwise comparison [VB]", "Not operator [VB]", "logical negation [VB]", "operators [VB], negation"]
