...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["arithmetic operators, precedence", "operator precedence", "logical operators, precedence", "operators [Visual Basic], associativity", "operators [Visual Basic], resolution", "associativity of operators", "operators [Visual Basic], precedence", "precedence, of operators", "comparison operators, precedence", "math operators", "order of precedence"]
