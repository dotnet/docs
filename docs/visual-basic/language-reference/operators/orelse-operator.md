...
dev_langs: ["VB"]
helpviewer_keywords: ["short-circuiting", "operators [Visual Basic], short-circuiting", "operators [Visual Basic], disjunction", "short-circuit evaluation", "OrElse operator [Visual Basic]"]
