...
f1_keywords: ["vb.-="]
dev_langs: ["VB"]
helpviewer_keywords: ["-= operator [Visual Basic]", "assignment statements, compound", "statements [Visual Basic], compound assignment", "operator -=", "compound assignment statements"]
