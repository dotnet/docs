...
dev_langs: ["VB"]
helpviewer_keywords: ["types [Visual Basic], compatible", "comparison operators", "TypeOf...Is expression", "data types [Visual Basic], compatible", "TypeOf operator [Visual Basic]", "compatible data types"]
