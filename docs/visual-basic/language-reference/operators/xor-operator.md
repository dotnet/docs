...
f1_keywords: ["vb.Xor"]
dev_langs: ["VB"]
helpviewer_keywords: ["[""exclusive OR operator [VB]"", ""logical exclusion [VB]"", ""operators [VB], exclusive or"", ""exclusion operator [VB]"", ""operators [VB], bitwise"", ""bitwise operators [VB], XOR operator"", ""Xor operator [VB]"", ""Xor keyword [VB]"", ""bitwise comparison [VB]""]"]
