...
f1_keywords: ["vb.Xor"]
dev_langs: ["VB"]
helpviewer_keywords: ["exclusive OR operator", "logical exclusion", "operators [Visual Basic], exclusive or", "exclusion operator", "operators [Visual Basic], bitwise", "bitwise operators, XOR operator", "Xor operator [Visual Basic]", "Xor keyword", "bitwise comparison"]
