...
dev_langs: ["VB"]
helpviewer_keywords: ["run-time libraries, Visual Basic", "libraries, Visual Basic run-time", "Microsoft.VisualBasic namespace", "members [Visual Basic], Visual Basic run-time library"]
