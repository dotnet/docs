...
dev_langs: ["VB"]
helpviewer_keywords: ["[""class modules"", ""Class statement [VB]"", ""classes [VB], fields"", ""fields [VB], of classes"", ""class types [VB], class statements"", ""classes [VB], creating"", ""classes [VB], data members"", ""data members [VB], of classes""]"]
