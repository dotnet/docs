...
dev_langs: ["VB"]
helpviewer_keywords: ["class modules", "Class statement", "classes [Visual Basic], fields", "fields, of classes", "class types, class statements", "classes [Visual Basic], creating", "classes [Visual Basic], data members", "data members, of classes"]
