...
dev_langs: ["VB"]
helpviewer_keywords: ["conditional statements, Do…Loop", "while statement, Do...Loop", "execution, conditional", "Do loops", "Until keyword, Do...Loop statement", "Do...Loop statement", "instructions, repeating", "Do statement", "Exit statement, in Do...Loop statements", "loop structures, Do…Loop statements", "do-while statements", "loops, exiting", "Loop keyword, Do...Loop statement"]
