...
dev_langs: ["VB"]
helpviewer_keywords: ["execution, ending", "files, closing", "End keyword, End statements", "programs, quitting", "code, exiting", "program termination", "End statement", "execution, stopping"]
