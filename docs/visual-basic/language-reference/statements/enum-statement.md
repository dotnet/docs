...
f1_keywords: ["vb.Enum"]
dev_langs: ["VB"]
helpviewer_keywords: ["enumerated constants", "Enum statement", "Private keyword, Enum statements", "Public keyword, in Enum statement", "variables [Visual Basic], enumeration", "constants, enumerated"]
