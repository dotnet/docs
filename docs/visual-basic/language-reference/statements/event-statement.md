...
dev_langs: ["VB"]
helpviewer_keywords: ["Event statement", "declaring events, syntax", "Public keyword, Event statements", "Custom keyword", "declarations, events", "event keyword [Visual Basic]", "WithEvents keyword, Event statements", "events [Visual Basic], declaring", "ByVal keyword, Event statements", "events [Visual Basic], custom", "ByRef keyword, Event statements", "declaring user-defined events"]
