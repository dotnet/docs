...
f1_keywords: ["vb.Get"]
dev_langs: ["VB"]
helpviewer_keywords: ["Get statement [Visual Basic], syntax", "Get statement [Visual Basic]", "properties [Visual Basic], read-only", "read-only properties", "Get keyword [Visual Basic]", "property procedures [Visual Basic], Get statements"]
