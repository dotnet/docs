...
f1_keywords: ["vb.Get"]
dev_langs: ["VB"]
helpviewer_keywords: ["Get statement, syntax", "Get statement", "properties [Visual Basic], read-only", "read-only properties", "Get keyword", "property procedures, Get statements"]
