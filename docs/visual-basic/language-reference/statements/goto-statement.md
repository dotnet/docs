...
f1_keywords: ["vb.GoTo"]
dev_langs: ["VB"]
helpviewer_keywords: ["GoTo statement", "control flow, branching", "unconditional branching", "branching", "branching, unconditional", "branching, conditional", "conditional statements, GoTo statement", "GoTo statement, syntax"]
