...
dev_langs: ["VB"]
helpviewer_keywords: ["ElseIf statement [Visual Basic], If...Then...Else", "Then statement [Visual Basic], If...Then...Else", "control flow [Visual Basic], branching", "execution [Visual Basic], conditional", "TypeOf...Is expression, and If...Then...Else statements", "If...Then...Else statements", "If statement [Visual Basic], If...Then...Else", "If statement [Visual Basic]", "Is operator [Visual Basic], in If...Then...Else statements", "If Operator [Visual Basic]", "branching [Visual Basic], conditional", "If function [Visual Basic], and If...Then...Else statements", "Else statement [Visual Basic]"]
