...
dev_langs: ["VB"]
helpviewer_keywords: ["ElseIf statement, If...Then...Else", "Then statement, If...Then...Else", "control flow, branching", "execution, conditional", "TypeOf...Is expression, and If...Then...Else statements", "If...Then...Else statements", "If statement, If...Then...Else", "If statement", "Is operator [Visual Basic], in If...Then...Else statements", "If Operator [Visual Basic]", "branching, conditional", "IIf function, and If...Then...Else statements", "Else statement [Visual Basic]"]
