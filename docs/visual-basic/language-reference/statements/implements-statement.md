...
ms.topic: "article"
f1_keywords: ["vb.Implements", "Implements"]
dev_langs: ["VB"]
helpviewer_keywords: ["Implements statement [Visual Basic], syntax", "Implements statement [Visual Basic]", "interface implementation [Visual Basic], Implements statement"]
