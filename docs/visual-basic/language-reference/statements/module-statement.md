...
dev_langs: ["VB"]
helpviewer_keywords: ["modules, classes", "modules", "Module statement [Visual Basic]", "modules, declaring", "standard modules", "classes [Visual Basic], vs. modules", "declarations [Visual Basic], modules"]
