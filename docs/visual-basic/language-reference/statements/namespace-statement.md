...
dev_langs: ["VB"]
helpviewer_keywords: ["[""namespaces [VB], root"", ""Namespace statement [VB]"", ""namespaces [VB], nested"", ""declaring namespaces [VB], syntax"", ""namespaces [VB], declaring"", ""root namespaces [VB]"", ""declarations [VB], namespaces""]"]
