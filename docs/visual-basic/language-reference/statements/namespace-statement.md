...
dev_langs: ["VB"]
helpviewer_keywords: ["namespaces [Visual Basic], root", "Namespace statement [Visual Basic]", "namespaces [Visual Basic], nested", "declaring namespaces [Visual Basic], syntax", "namespaces [Visual Basic], declaring", "root namespaces", "declarations [Visual Basic], namespaces"]
