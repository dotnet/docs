...
dev_langs: ["VB"]
helpviewer_keywords: ["namespaces, root", "Namespace statement", "namespaces, nested", "declaring namespaces, syntax", "namespaces, declaring", "root namespaces", "declarations, namespaces"]
