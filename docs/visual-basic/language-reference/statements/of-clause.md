...
dev_langs: ["VB"]
helpviewer_keywords: ["Of keyword", "arguments [Visual Basic], data types", "constraints, Visual Basic generic types", "generic parameters", "generics [Visual Basic], constraints", "parameters, type", "types [Visual Basic], generic", "parameters, generic", "type parameters", "data type arguments"]
