...
dev_langs: ["VB"]
helpviewer_keywords: ["operators [Visual Basic]", "procedures, operator", "Narrowing keyword, conversion operators", "Visual Basic code, operators", "Widening keyword, conversion operators", "syntax, Operator procedures", "operators [Visual Basic], overloading", "overloaded operators", "operator overloading", "operator procedures", "Operator statement", "CType function, Operator statement"]
