...
dev_langs: ["VB"]
helpviewer_keywords: ["[""declaring variables [VB], explicit"", ""forced variable declaration in Option Explicit statement [VB]"", ""Explicit keyword [VB]"", ""explicit variable declaration [VB]"", ""Option Explicit statement [VB]""]"]
