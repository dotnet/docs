...
dev_langs: ["VB"]
helpviewer_keywords: ["declaring variables, explicit", "forced variable declaration in Option Explicit statement", "Explicit keyword", "explicit variable declaration", "Option Explicit statement"]
