...
dev_langs: ["VB"]
helpviewer_keywords: ["variables [VB], declaring", "Option Infer statement [VB]", "Infer keyword [VB]", "declaring variables [VB], inferred", "inferred variable declaration [VB]"]
