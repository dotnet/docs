...
dev_langs: ["VB"]
helpviewer_keywords: ["variables [Visual Basic], declaring", "Option Infer statement [Visual Basic]", "Infer keyword [Visual Basic]", "declaring variables [Visual Basic], inferred", "inferred variable declaration"]
