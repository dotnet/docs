...
dev_langs: ["VB"]
helpviewer_keywords: ["Strict keyword [Visual Basic]", "Option Strict statement [Visual Basic]", "conversions [Visual Basic], implicit", "late binding [Visual Basic]", "implicit conversions [Visual Basic]"]
