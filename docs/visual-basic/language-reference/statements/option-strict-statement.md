---
description: "Learn more about: Option Strict Statement"
...
- [Char Data Type](../data-types/char-data-type.md)

 When you concatenate strings by using the [& Operator](../operators/concatenation-operator.md), all conversions to the strings are considered to be widening. So these conversions do not generate an implicit narrowing conversion error, even if `Option Strict` is on.
...
- [How to: Access Members of an Object](../../programming-guide/language-features/variables/how-to-access-members-of-an-object.md)
