...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["Visual Basic code, procedures", "parameters, Visual Basic", "parameters, lists", "parameter lists", "Visual Basic code, parameter lists", "arguments [Visual Basic], Visual Basic", "procedures, parameter lists"]
