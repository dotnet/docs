...
dev_langs: ["VB"]
helpviewer_keywords: ["[""REM statement [VB]"", ""comments [VB], Visual Basic code"", ""code comments [VB], Visual Basic"", ""Visual Basic code, comments"", ""' comment marker character [VB]""]"]
