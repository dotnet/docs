...
dev_langs: ["VB"]
helpviewer_keywords: ["REM statement [Visual Basic]", "comments, Visual Basic code", "code comments, Visual Basic", "Visual Basic code, comments", "' comment marker character [Visual Basic]"]
