...
dev_langs: ["VB"]
helpviewer_keywords: ["Next statement, Resume", "Resume Next statement", "execution, resuming", "run-time errors, resuming after", "Resume statement, syntax", "errors [Visual Basic], resuming after", "Error statement, and Resume statement", "execution", "Resume statement"]
