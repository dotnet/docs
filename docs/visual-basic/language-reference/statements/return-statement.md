...
dev_langs: ["VB"]
helpviewer_keywords: ["Return statement, syntax", "control flow, returning control to expressions", "Return statement", "expressions [Visual Basic], returning control to"]
