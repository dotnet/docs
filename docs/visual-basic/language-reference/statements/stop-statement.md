...
f1_keywords: ["vb.Stop"]
dev_langs: ["VB"]
helpviewer_keywords: ["breakpoints, Stop statements", "Stop statements, syntax", "Stop statements", "execution, suspending", "processing, interrupting", "processes, interrupting", "execution, stopping"]
