...
dev_langs: ["VB"]
helpviewer_keywords: ["[""user-defined types, Structure statement"", ""compound data types [VB]"", ""Structure keyword [VB]"", ""Structure statement [VB]"", ""UDT (user-defined types)"", ""types [VB], user-defined""]"]
