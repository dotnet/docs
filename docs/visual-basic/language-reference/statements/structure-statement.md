...
dev_langs: ["VB"]
helpviewer_keywords: ["user-defined types, Structure statement", "compound data types", "Structure keyword", "Structure statement", "UDT (user-defined types)", "types [Visual Basic], user-defined"]
