...
dev_langs: ["VB"]
helpviewer_keywords: ["Try...Catch...Finally statements", "Try statement [Visual Basic]", "try-catch exception handling, Try...Catch...Finally statements", "error handling, while running code", "Try statement [Visual Basic], Try...Catch...Finally", "Finally keyword [Visual Basic], Try...Catch...Finally", "Catch statement [Visual Basic]", "When keyword [Visual Basic]", "Visual Basic code, handling errors while running", "structured exception handling, Try...Catch...Finally statements"]
