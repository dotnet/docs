...
dev_langs: ["VB"]
helpviewer_keywords: ["class constraint", "constraints, Visual Basic generic types", "generic parameters", "generics [Visual Basic], constraints", "generics [Visual Basic], type list", "structure constraint", "constraints, in type parameters", "generics [Visual Basic], generic types", "parameters [Visual Basic], type", "constraints, Structure keyword", "type parameters [Visual Basic], constraints", "types [Visual Basic], generic", "parameters [Visual Basic], generic", "generics [Visual Basic], type parameters", "type parameters", "constraints, Class keyword"]
