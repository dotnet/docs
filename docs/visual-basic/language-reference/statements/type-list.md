...
dev_langs: ["VB"]
helpviewer_keywords: ["class constraint [VB]", "constraints, Visual Basic generic types", "generic parameters [VB]", "generics [VB], constraints", "generics [VB], type list", "structure constraint [VB]", "constraints, in type parameters", "generics [VB], generic types", "parameters [VB], type", "constraints, Structure keyword", "type parameters [VB], constraints", "types [VB], generic", "parameters [VB], generic", "generics [VB], type parameters", "type parameters [VB]", "constraints, Class keyword"]
