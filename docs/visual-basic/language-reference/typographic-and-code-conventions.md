...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["coding conventions, Visual Basic", "best practices, coding conventions", "conventions, Visual Basic coding", "typographic conventions", "document conventions", "conventions, documentation", "Visual Basic code, conventions"]
