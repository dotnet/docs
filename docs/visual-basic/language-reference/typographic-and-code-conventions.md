...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["coding conventions [Visual Basic], Visual Basic", "best practices [Visual Basic], coding conventions", "conventions [Visual Basic], Visual Basic coding", "typographic conventions [Visual Basic]", "document conventions [Visual Basic]", "conventions [Visual Basic], documentation", "Visual Basic code, conventions"]
