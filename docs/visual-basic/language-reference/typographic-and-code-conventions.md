...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["coding conventions [VB], Visual Basic", "best practices, coding conventions", "conventions [VB], Visual Basic coding", "typographic conventions [VB]", "document conventions [VB]", "conventions [VB], documentation", "Visual Basic code, conventions"]
