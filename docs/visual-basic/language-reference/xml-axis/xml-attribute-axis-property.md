...
dev_langs: ["VB"]
helpviewer_keywords: ["attribute axis property [Visual Basic]", "Visual Basic code, accessing XML", "XML attribute axis property [Visual Basic]", "XML axis [Visual Basic], attribute", "XML [Visual Basic], accessing"]
