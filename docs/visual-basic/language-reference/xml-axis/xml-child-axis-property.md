...
dev_langs: ["VB"]
helpviewer_keywords: ["Visual Basic code, accessing XML", "XML axis [Visual Basic], child", "child axis property [Visual Basic]", "XML child axis property [Visual Basic]", "XML [Visual Basic], accessing"]
