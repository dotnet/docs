...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["declaring XML literals [Visual Basic]", "Visual Basic, XML literals", "Visual Basic code, XML", "XML literals [Visual Basic]", "XML literals [Visual Basic], reference", "literals [Visual Basic], XML"]
