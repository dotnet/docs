...
## See Also  
 ...
 [NOT IN BUILD: TypeName Function (Visual Basic)](https://msdn.microsoft.com/library/5422sfdf(v=vs.90).aspx)   
 [NOT IN BUILD: VarType Function (Visual Basic)](https://msdn.microsoft.com/library/9w51ee9c(v=vs.90).aspx)   
