---
description: "Learn more about: 'SyncLock' statement must end with a matching 'End SyncLock'"
...
- Make sure that `SyncLock` block ends with an `End SyncLock` construct.  
