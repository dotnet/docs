---
description: "Learn more about: '<typename>' is a type in '<containername>' and cannot be used as an expression"
...
- [Keywords as Element Names in Code](../programming-guide/program-structure/keywords-as-element-names-in-code.md)
