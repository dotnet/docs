...
- [How to: Declare an Instance of an Anonymous Type (Visual Basic)](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/bb531249(v=vs.100))
