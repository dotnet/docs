...
## See Also  
 [File Signing Tool (Signcode.exe)](https://msdn.microsoft.com/library/9sh96ycy(v=vs.100).aspx)   
 [Deployment and Authenticode Signing](https://msdn.microsoft.com/library/w9x9fdbk(v=vs.100).aspx)
