...
## See also
- [File Signing Tool (Signcode.exe)](https://docs.microsoft.com/previous-versions/9sh96ycy(v=vs.100))
- [Deployment and Authenticode Signing](https://docs.microsoft.com/previous-versions/w9x9fdbk(v=vs.100))
