...
## See Also  
 [NOT IN BUILD: Asc, AscW Functions](https://msdn.microsoft.com/library/zew1e4wc(v=vs.90).aspx)   
 [NOT IN BUILD: Val Function](https://msdn.microsoft.com/library/k7beh1x9(v=vs.90).aspx)   
