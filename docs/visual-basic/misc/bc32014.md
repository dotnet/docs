...
## See Also  
 [NOTINBUILD  an Array Variable](https://msdn.microsoft.com/library/x397t1yt(v=vs.90).aspx)   
 [NOTINBUILD Jagged Arrays in Visual Basic](https://msdn.microsoft.com/library/hkhhsz9t(v=vs.90).aspx)   
