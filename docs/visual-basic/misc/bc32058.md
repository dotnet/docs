---
description: "Learn more about: Type arguments cannot be applied to the expression '<expression>'"
...
An import alias is defined with an [Of](../language-reference/statements/of-clause.md) clause that passes type arguments to the import alias.  
