...
A generic event, property, or procedure attempts to implement a similar member defined in an interface, but they have different constraint lists on their type parameters.  
 ...
 For details on interface implementation, see [NOT IN BUILD: Implements Keyword and Implements Statement](https://msdn.microsoft.com/library/4b3c4by9(v=vs.90).aspx).  
...
## See Also  
 ...
 [NOT IN BUILD: Interface Implementation Examples in Visual Basic](https://msdn.microsoft.com/library/f6x8ydw5(v=vs.90).aspx)
