...
-   The type argument must be a value type (include the [Structure (Visual Basic)](https://msdn.microsoft.com/library/ms172929(v=vs.90).aspx) constraint)  
  
-   The type argument must be a reference type (include the [Class (Visual Basic)](https://msdn.microsoft.com/library/ms172922(v=vs.90).aspx) constraint)  
