...
A constraint list includes both the [Class (Visual Basic)](https://msdn.microsoft.com/library/ms172922(v=vs.90).aspx) constraint and the name of a defined class.  
