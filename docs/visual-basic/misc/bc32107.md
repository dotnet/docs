---
description: "Learn more about: 'Class' constraint and a specific class type constraint cannot be combined"
...
A constraint list includes both the [Class (Visual Basic)](../language-reference/statements/class-statement.md) constraint and the name of a defined class.  
