...
A constraint list includes both the [Structure (Visual Basic)](https://msdn.microsoft.com/library/ms172929(v=vs.90).aspx) constraint and the name of a defined class.  
