...
## See Also  
 ...
 [Structure (Visual Basic)](https://msdn.microsoft.com/library/ms172929(v=vs.90).aspx)   
 [Class (Visual Basic)](https://msdn.microsoft.com/library/ms172922(v=vs.90).aspx)   
