---
description: "Learn more about: Nullable types are not supported because the current version of 'mscorlib.dll' does not define the type 'Nullable(of T)'"
...
The framework version you are using does not support nullable value types.  
