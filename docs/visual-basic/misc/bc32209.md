---
title: "Project '<projectname>' requires a reference to version '<versionnumber1>' of assembly '<assemblyname>', but references version '<versionnumber2>' of assembly '<assemblyname>' - Error"
ms.date: 07/20/2015
f1_keywords: 
  - "vbc32209"
  - "bc32209"
