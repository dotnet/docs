...
The [Global - delete](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/k701czy1(v=vs.90)) keyword appears in a context other than accessing a namespace.  
