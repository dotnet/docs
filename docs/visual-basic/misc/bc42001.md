...
## See also
- [Class_Initialize Changes in Visual Basic](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/3fxtxxwa(v=vs.90))
- [Classes for Visual Basic 6.0 Users](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/7zzxk2t0(v=vs.90))
