...
## See Also  
 [Class_Initialize Changes in Visual Basic](https://msdn.microsoft.com/library/3fxtxxwa(v=vs.90).aspx)   
 [Classes for Visual Basic 6.0 Users](https://msdn.microsoft.com/library/7zzxk2t0(v=vs.90).aspx)   
