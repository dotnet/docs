...
## Understanding relaxed delegate conversion
...
1. **Assign to a variable first (preserves exact semantics):**
...
1. **Match the delegate signature exactly:**
...
1. **Use the `Handles` clause if appropriate:**
