...
## See Also  
 ...
 [Reading from and Writing to the Registry Using My (Visual Basic)](https://msdn.microsoft.com/library/ms172707(v=vs.100).aspx)   
 [Troubleshooting: Manipulating the Registry (Visual Basic)](https://msdn.microsoft.com/library/zs7t1t16(v=vs.100).aspx)
