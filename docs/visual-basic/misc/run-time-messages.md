...
This section contains the Visual Basic error messages that occur at run time.  
 ...
 [A double quote is not a valid comment token for delimited fields where EscapeQuote is set to True](../language-reference/error-messages/a-double-quote-is-not-a-valid-comment-token-for-delimited-fields.md)  
 ...
 [A property or method call cannot include a reference to a private object, either as an argument or as a return value](../language-reference/error-messages/a-property-or-method-call-cannot-include-a-reference-to-a-private-object.md)  
  
 [A startup form has not been specified](../language-reference/error-messages/a-startup-form-has-not-been-specified.md)  
 ...
 [An unexpected error has occurred because an operating system resource required for single instance startup cannot be acquired](../language-reference/error-messages/an-unexpected-error-has-occurred.md)  
 ...
 [Automation error](../language-reference/error-messages/automation-error.md)  
  
 [Automation object does not have a default value](automation-object-does-not-have-a-default-value.md)  
  
 [Bad DLL calling convention](../language-reference/error-messages/bad-dll-calling-convention.md)  
  
 [Bad file mode](../language-reference/error-messages/bad-file-mode.md)  
  
 [Bad file name or number](../language-reference/error-messages/bad-file-name-or-number.md)  
  
 [Bad record length](../language-reference/error-messages/bad-record-length.md)  
 ...
 [Cannot create ActiveX Component](../language-reference/error-messages/cannot-create-activex-component.md)  
 ...
 [Can't create necessary temporary file](../language-reference/error-messages/can-t-create-necessary-temporary-file.md)  
 ...
 [Class does not support Automation or does not support expected interface](../language-reference/error-messages/class-does-not-support-automation-or-does-not-support-expected-interface.md)  
  
 [Class not registered on local machine](class-not-registered-on-local-machine.md)  
  
 [Clipboard format is not valid](../language-reference/error-messages/clipboard-format-is-not-valid.md)  
 ...
 [Device I/O error](../language-reference/error-messages/device-i-o-error.md)  
  
 [Device unavailable](device-unavailable.md)  
  
 ['Dir' function must first be called with a 'PathName' argument](../language-reference/error-messages/dir-function-must-first-be-called-with-a-pathname-argument.md)  
 ...
 [Expression too complex](../language-reference/error-messages/expression-too-complex.md)  
 ...
 [File already open](../language-reference/error-messages/file-already-open.md)  
 ...
 [File is too large to read into a byte array](../language-reference/error-messages/file-is-too-large-to-read-into-a-byte-array.md)  
 ...
 [File not found (Visual Basic Run-Time Error)](../language-reference/error-messages/file-not-found-visual-basic-run-time-error.md)  
 ...
 [Input past end of file](../language-reference/error-messages/input-past-end-of-file.md)  
 ...
 [Internal error happened at \<location>](../language-reference/error-messages/internal-error-happened-at-location.md)  
 ...
 [Need property array index](../language-reference/error-messages/need-property-array-index.md)  
 ...
 [Object or class does not support the set of events](../language-reference/error-messages/object-or-class-does-not-support-the-set-of-events.md)  
  
 [Object required](../language-reference/error-messages/object-required.md)  
  
 [Object variable or With block variable not set](../language-reference/error-messages/object-variable-or-with-block-variable-not-set.md)  
 ...
 [Ordinal is not valid](../language-reference/error-messages/ordinal-is-not-valid.md)  
 ...
 [Overflow (Visual Basic Run-Time Error)](../language-reference/error-messages/overflow-visual-basic-run-time-error.md)  
  
 [Path '\<pathname>' not found](path-pathname-not-found.md)  
  
 [Path not found](../language-reference/error-messages/path-not-found.md)  
  
 [Path/File access error](../language-reference/error-messages/path-file-access-error.md)  
 ...
 [Property array index is not valid](../language-reference/error-messages/property-array-index-is-not-valid.md)  
  
 [Property let procedure not defined and property get procedure did not return an object](../language-reference/error-messages/property-let-procedure-not-defined-and-property-get-procedure-did-not-return.md)  
  
 [Property not found](../language-reference/error-messages/property-not-found.md)  
  
 [Property or method not found](../language-reference/error-messages/property-or-method-not-found.md)  
 ...
 [Resume without error](../language-reference/error-messages/resume-without-error.md)  
 ...
 [Some subkeys cannot be deleted](../language-reference/error-messages/some-subkeys-cannot-be-deleted.md)  
 ...
 [TextFieldParser does not support comment tokens that contain white space](textfieldparser-does-not-support-comment-tokens-that-contain-whitespace.md)  
 ...
 [TextFieldParser is unable to complete the read operation because maximum buffer size has been exceeded](../language-reference/error-messages/textfieldparser-is-unable-to-complete-read-operation.md)  
 ...
 [This key is already associated with an element of this collection](../language-reference/error-messages/this-key-is-already-associated-with-an-element-of-this-collection.md)  
 ...
 [Too many files](../language-reference/error-messages/too-many-files.md)  
 ...
 [Unable to get serial port names because of an internal system error](../language-reference/error-messages/unable-to-get-serial-port-names-because-of-an-internal-system-error.md)  
 ...
 [Variable uses an Automation type not supported in Visual Basic](../language-reference/error-messages/variable-uses-an-automation-type-not-supported.md)  
...
- [Error Messages](../language-reference/error-messages/index.md)
