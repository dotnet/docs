...
## See Also  
 ...
 [File, Directory, and Drive Properties in Visual Basic](https://msdn.microsoft.com/library/as4xcs58(v=vs.100).aspx)   
 [How to: Determine the Absolute Path of a File in Visual Basic](https://msdn.microsoft.com/library/e00wt2d8(v=vs.100).aspx)
