...
When uploading and downloading files with the <xref:My.Computer.Network>, you must specify a `connectionTimeout` greater than `0`.  
...
## See Also  
 ...
 <xref:My.Computer.Network.DownloadFile>  
