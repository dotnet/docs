...
## See Also  
 [TextFieldParser.SetDelimiters Method](https://msdn.microsoft.com/library/ms173002(v=vs.90).aspx)   
 [TextFieldParser.Delimiters Property](https://msdn.microsoft.com/library/63k8k5sx(v=vs.90).aspx)   
