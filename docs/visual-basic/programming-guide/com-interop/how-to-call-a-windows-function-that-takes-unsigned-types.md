...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["Windows functions, calling", "unsigned data types", "UShort data type, using", "functions [Visual Basic], calling Windows functions", "ULong data type, using", "UInteger data type, using", "data types [Visual Basic], using", "unsigned types", "data types [Visual Basic], unsigned", "data types [Visual Basic], numeric", "unsigned types, using"]
