...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["COM interop [Visual Basic], referencing COM objects", "referencing objects, COM objects from Visual Basic", "objects [Visual Basic], referencing", "COM objects, referencing", "interop assemblies"]
