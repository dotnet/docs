...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""COM interop [VB], referencing COM objects"", ""referencing objects, COM objects from Visual Basic"", ""objects [VB], referencing"", ""COM objects, referencing"", ""interop assemblies""]"]
