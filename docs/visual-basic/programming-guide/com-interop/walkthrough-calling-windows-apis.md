...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["DLLs, calling", "Windows API, walkthroughs", "platform invoke, walkthroughs", "API calls [Visual Basic], walkthroughs [Visual Basic]", "Windows API, calling", "walkthroughs [Visual Basic], API calls", "DllImport attribute, calling Windows API", "Declare statement [Visual Basic], declaring DLL functions"]
