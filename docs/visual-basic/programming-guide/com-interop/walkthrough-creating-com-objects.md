...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["COM interop [Visual Basic], creating COM objects", "COM objects, creating", "COM interop [Visual Basic], walkthroughs", "object creation [Visual Basic], COM objects", "COM objects, walkthroughs"]
