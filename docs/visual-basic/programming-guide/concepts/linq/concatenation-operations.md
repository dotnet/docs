...
|-----------------|-----------------|------------------------------------------|----------------------|
|Concat|Concatenates two sequences to form one sequence.|Not applicable.|<xref:System.Linq.Enumerable.Concat*?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.Concat*?displayProperty=nameWithType>|
