...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""queries [LINQ in Visual Basic], about LINQ in Visual Basic queries"", ""queries [LINQ in Visual Basic]"", ""LINQ in Visual Basic [VB]"", ""LINQ [VB]"", ""LINQ, Visual Basic""]"]
