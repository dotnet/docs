...
|-----------------|-----------------|------------------------------------------|----------------------|
|GroupBy|Groups elements that share a common attribute. Each group is represented by an <xref:System.Linq.IGrouping`2> object.|`Group … By … Into …`|<xref:System.Linq.Enumerable.GroupBy*?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.GroupBy*?displayProperty=nameWithType>|
