---
description: "Learn more about: Projection Operations (Visual Basic)"
...
|-----------------|-----------------|------------------------------------------|----------------------|
|Select|Projects values that are based on a transform function.|`Select`|<xref:System.Linq.Enumerable.Select*?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.Select*?displayProperty=nameWithType>|
|SelectMany|Projects sequences of values that are based on a transform function and then flattens them into one sequence.|Use multiple `From` clauses|<xref:System.Linq.Enumerable.SelectMany*?displayProperty=nameWithType><br /><br /> <xref:System.Linq.Queryable.SelectMany*?displayProperty=nameWithType>|
