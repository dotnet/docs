...
|Method|Description|  
|------------|-----------------|  
|<xref:System.Xml.Linq.XAttribute.Remove?displayProperty=fullName>|Removes an <xref:System.Xml.Linq.XAttribute> from its parent.|  
|<xref:System.Xml.Linq.XContainer.RemoveNodes?displayProperty=fullName>|Removes the child nodes from an <xref:System.Xml.Linq.XContainer>.|  
