---
description: "Learn more about: Troubleshooting Arrays (Visual Basic)"
...
### Specifying the Dimension
 ...
 When determining the bounds of a multidimensional array, take care how you specify the dimension. The `dimension` parameters of the <xref:System.Array.GetLowerBound*> and <xref:System.Array.GetUpperBound*> methods are 0-based, while the `Rank` parameters of the Visual Basic <xref:Microsoft.VisualBasic.Information.LBound*> and <xref:Microsoft.VisualBasic.Information.UBound*> functions are 1-based.
