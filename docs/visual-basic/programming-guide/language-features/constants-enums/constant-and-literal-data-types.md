...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["declaring constants, literal data types", "data types [Visual Basic], declaring", "constants, declaring", "explicit declarations", "literals, coercing data type", "declarations, data types"]
