...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""declarations [VB], enumerations"", ""Imports statement [VB], namespace declarations"", ""declaring namespaces [VB], enumerations"", ""name collisions [VB]"", ""ambiguous names [VB], enumerations"", ""enumerations [VB], name qualification"", ""names [VB], avoiding conflicts"", ""namespaces [VB], declaring"", ""naming conflicts, enumerations"", ""naming conflicts, qualifying names"", ""declaring enumerations [VB]"", ""references [VB], enumeration members"", ""naming conventions [VB], naming conflicts"", ""declarations [VB], namespaces""]"]
