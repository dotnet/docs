...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["declarations, enumerations", "Imports statement, namespace declarations", "declaring namespaces, enumerations", "name collisions", "ambiguous names, enumerations", "enumerations [Visual Basic], name qualification", "names, avoiding conflicts", "namespaces, declaring", "naming conflicts, enumerations", "naming conflicts, qualifying names", "declaring enumerations", "references, enumeration members", "naming conventions, naming conflicts", "declarations, namespaces"]
