...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["enumerations [Visual Basic]", "Visual Basic code, constants", "constants", "object libraries, Object Browser", "Visual Basic code, enumerations", "declaring constants, enumerations", "naming conventions, constants", "Visual Basic code, improving readability with constants"]
