...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["enumerations [Visual Basic]", "Visual Basic code, constants", "constants [Visual Basic]", "object libraries, Object Browser", "Visual Basic code, enumerations", "declaring constants [Visual Basic], enumerations", "naming conventions [Visual Basic], constants", "Visual Basic code, improving readability with constants"]
