...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["constants [VB], circular references", "Const statement [VB], user-defined constants", "user-defined constants", "scope [VB], constants", "constants [VB], user-defined", "circular references between constants [VB]"]
