...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["constants, circular references", "Const statement [Visual Basic], user-defined constants", "user-defined constants", "scope, constants", "constants, user-defined", "circular references between constants"]
