...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["statements [Visual Basic], control flow", "If statement [Visual Basic], decision structures", "If statement [Visual Basic], If...Then...Else", "control flow [Visual Basic], decision structures", "decision structures [Visual Basic]", "conditional statements [Visual Basic], decision structures"]
