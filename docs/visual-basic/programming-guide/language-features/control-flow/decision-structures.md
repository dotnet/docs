...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["statements [Visual Basic], control flow", "If statement, decision structures", "If statement, If...Then...Else", "control flow, decision structures", "decision structures", "conditional statements, decision structures"]
