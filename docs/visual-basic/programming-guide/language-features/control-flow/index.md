...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["statements [Visual Basic], control flow", "control flow [Visual Basic]", "control structures [Visual Basic]", "structures [Visual Basic], control", "conditional statements [Visual Basic], control flow"]
