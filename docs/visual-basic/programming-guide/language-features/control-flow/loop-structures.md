...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""control flow [VB], loops"", ""For keyword [VB], loop structures"", ""loops [VB]"", ""loop structures [VB]"", ""statements [VB], loop"", ""Do statement [VB], Do loops"", ""conditional statements [VB], loop structures""]"]
