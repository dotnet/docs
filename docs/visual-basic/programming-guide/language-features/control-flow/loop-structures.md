...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["control flow [Visual Basic], loops", "For keyword [Visual Basic], loop structures", "loops", "loop structures [Visual Basic]", "statements [Visual Basic], loop", "Do statement [Visual Basic], Do loops", "conditional statements [Visual Basic], loop structures"]
