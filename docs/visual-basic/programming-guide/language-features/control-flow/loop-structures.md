...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["control flow, loops", "For keyword [Visual Basic], loop structures", "loops", "loop structures", "statements [Visual Basic], loop", "Do statement, Do loops", "conditional statements, loop structures"]
