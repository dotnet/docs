---
description: "Learn more about: Array Conversions (Visual Basic)"
...
- **Element Data Type.** The data types of the elements of both arrays must be reference types. You cannot convert an `Integer` array to a `Long` array, or even to an `Object` array, because at least one value type is involved. For more information, see [Value Types and Reference Types](value-types-and-reference-types.md).  
