...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["arrays [Visual Basic], converting type", "type conversion, arrays", "conversions, type", "arrays [Visual Basic], data types", "conversions, data type", "object arrays, converting type", "data type conversion, array conversions", "conversions, array types", "object arrays"]
