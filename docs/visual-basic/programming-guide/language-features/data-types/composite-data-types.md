...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["classes [Visual Basic], composite data types", "composite types", "composite data types", "data types [Visual Basic], composite", "arrays [Visual Basic], composite data types", "structures, composite data types", "classes [Visual Basic], composite types", "types [Visual Basic], composite"]
