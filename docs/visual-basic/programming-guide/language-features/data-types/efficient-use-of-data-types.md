...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""performance, data type efficiency"", ""data types [VB], weak typing"", ""AscW function, preferred to Asc"", ""data types [VB], using efficiently"", ""optimization, data types"", ""data types [VB], strong typing"", ""strong typing [VB]"", ""typing, strong"", ""data types [VB], optimizing"", ""ChrW function, preferred to Chr""]"]
