...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["performance, data type efficiency", "data types [Visual Basic], weak typing", "AscW function, preferred to Asc", "data types [Visual Basic], using efficiently", "optimization, data types", "data types [Visual Basic], strong typing", "strong typing", "typing, strong", "data types [Visual Basic], optimizing", "ChrW function, preferred to Chr"]
