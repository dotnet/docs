...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["generic methods, type inference", "generics [Visual Basic], type inference", "procedures, generic", "generic procedures", "type inference, generics", "generic methods", "type inference", "generics [Visual Basic], procedures", "generic procedures, type inference"]
