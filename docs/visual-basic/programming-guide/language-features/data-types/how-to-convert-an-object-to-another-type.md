...
You convert an `Object` variable to another data type by using a conversion keyword such as [CType Operator](../../../language-reference/operators/ctype-operator.md).  
