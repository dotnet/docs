...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["data types [Visual Basic], declaring", "typing", "data types [Visual Basic]", "Visual Basic code, data types", "data types [Visual Basic], improving speed with"]
