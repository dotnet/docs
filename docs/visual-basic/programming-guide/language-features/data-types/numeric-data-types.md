...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""integral types, Visual Basic"", ""Short data type [VB], numeric data types"", ""Double data type [VB], numeric data types"", ""Long data type [VB], Visual Basic numeric data types"", ""numbers [VB], whole"", ""fractions [VB]"", ""numbers [VB]"", ""whole numbers [VB]"", ""integer numbers [VB]"", ""numbers [VB], integer"", ""fractional data types [VB]"", ""mantissas, of fractional numbers [VB]"", ""mantissas [VB]"", ""data types [VB], numeric"", ""Integer data type [VB], numeric data types"", ""exponent, of fractional numbers [VB]"", ""integers [VB]"", ""numeric data types, Visual Basic"", ""Single data type [VB], numeric types"", ""Decimal data type [VB], numeric data types""]"]
