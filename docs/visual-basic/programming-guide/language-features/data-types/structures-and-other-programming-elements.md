...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["structures, arrays", "procedures, structures as arguments to", "objects [Visual Basic], structure elements", "arrays [Visual Basic], structure elements", "nested structures"]
