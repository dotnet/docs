...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["structures [Visual Basic]", "user-defined data types [Visual Basic], structures", "user-defined types [Visual Basic], about user-defined types", "data types [Visual Basic], user-defined", "user-defined data types [Visual Basic], about user-defined data types", "types [Visual Basic], user-defined"]
