...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["structures", "user-defined data types, structures", "user-defined types, about user-defined types", "data types [Visual Basic], user-defined", "user-defined data types, about user-defined data types", "types [Visual Basic], user-defined"]
