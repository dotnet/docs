...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""structures [VB]"", ""user-defined data types, structures"", ""user-defined types, about user-defined types"", ""data types [VB], user-defined"", ""user-defined data types, about user-defined data types"", ""types [VB], user-defined""]"]
