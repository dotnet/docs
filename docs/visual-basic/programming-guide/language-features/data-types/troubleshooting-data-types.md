...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["Char data type, converting", "Decimal data type, conversions", "data types [Visual Basic], troubleshooting", "literals, default types", "type characters, literal", "Mod operator [Visual Basic], in floating-point operations", "troubleshooting Visual Basic, data types", "troubleshooting data types", "floating-point numbers, precision", "Boolean data type, converting", "literal types", "literal type characters", "floating-point numbers, imprecision", "String data type, converting", "floating-point numbers, comparison", "floating-point numbers"]
