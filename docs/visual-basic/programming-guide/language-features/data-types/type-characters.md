...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""&H prefix for hexadecimal values"", ""hexadecimal literals [VB]"", ""F literal type character [VB]"", ""& identifier type character"", ""type characters [VB]"", ""octal literals [VB]"", ""literals, hexadecimal"", ""&O prefix for octal values"", ""literals, default types"", ""defaults [VB]""  literal types [VB]"", ""C literal type character [VB]"", ""type characters [VB], literal"", ""$ identifier type character"", ""L literal type character [VB]"", ""UI literal type characters [VB]"", ""default literal types [VB]"", ""D literal type character [VB]"", ""literals, octal"", ""S literal type character [VB]"", ""! identifier type character"", ""US literal type characters [VB]"", ""% identifier type character"", ""data types [VB], type characters"", ""characters [VB], identifier type"", ""type characters [VB], identifier"", ""# identifier type character"", ""identifier type characters [VB]"", ""literal type characters [VB]"", ""I literal type character [VB]"", ""R literal type character [VB]"", ""@ identifier type character"", ""UL literal type characters [VB]"", ""literal types, default""]"]
