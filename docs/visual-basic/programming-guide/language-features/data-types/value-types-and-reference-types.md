...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["reference data types", "reference types", "value types", "value data types", "types [Visual Basic]", "data types [Visual Basic], value types", "data types [Visual Basic], reference types"]
