...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["widening conversions", "narrowing conversions", "conversions, type", "data types [Visual Basic], changing", "variables [Visual Basic], changing data type", "conversions, exceptions during conversion", "type conversion, exceptions during conversion", "conversions, data type", "conversions, narrowing", "type conversion, narrowing", "data type conversion, widening", "data type conversion, narrowing", "changing data types", "type conversion, widening", "data type conversion, exceptions during conversion", "conversions, widening"]
