...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["declared elements, lifetime", "access levels, declared elements", "declared elements, scope", "visibility, declared elements", "elements, programming", "scope, declared elements", "lifetime, declared elements", "declared elements, access level", "data types [Visual Basic], declared elements", "declared elements, visibility"]
