...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["declared elements, case sensitivity", "names, Visual Basic rules", "naming conventions", "element names", "declared elements, identifiers", "declarations, elements", "declared elements, valid names", "[] escape characters [Visual Basic]", "names, elements", "declaration statements, declared elements", "declaring elements", "identifiers, declared elements", "case sensitivity, declared element names", "escape characters", "names, declared elements", "declared elements, about declared elements", "escaped names", "declared elements, names", "names, naming conventions", "identifiers, elements"]
