...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["qualification [Visual Basic], of element names", "base classes [Visual Basic], accessing elements", "element names [Visual Basic], qualification", "references [Visual Basic], declared elements", "declared elements [Visual Basic], referencing", "variables [Visual Basic], accessing hidden"]
