...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["qualification, of element names", "base classes, accessing elements", "element names, qualification", "references, declared elements", "declared elements, referencing", "variables [Visual Basic], accessing hidden"]
