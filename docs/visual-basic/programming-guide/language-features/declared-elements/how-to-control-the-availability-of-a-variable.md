...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["access levels, declared elements", "Private keyword, accessing variables", "access levels, variables", "Public keyword, accessing variables", "Friend keyword, accessing variables", "variables [Visual Basic], access level", "declared elements, access level", "Protected keyword, accessing variables"]
