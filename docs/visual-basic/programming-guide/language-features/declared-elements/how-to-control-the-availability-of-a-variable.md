...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""access levels, declared elements"", ""Private keyword [VB], accessing variables"", ""access levels, variables"", ""Public keyword [VB], accessing variables"", ""Friend keyword [VB], accessing variables"", ""variables [VB], access level"", ""declared elements [VB], access level"", ""Protected keyword [VB], accessing variables""]"]
