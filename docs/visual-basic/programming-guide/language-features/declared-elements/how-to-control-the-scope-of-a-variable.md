...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["variables [Visual Basic], scope", "declared elements, scope", "visibility, declared elements", "variables [Visual Basic], visibility", "scope, declared elements", "scope, variables", "scope, Visual Basic", "declared elements, visibility", "visibility, variables"]
