...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["qualification, of element names", "declarations, elements", "element names, qualification", "references, declared elements", "declaration statements, declared elements", "declaring elements", "referencing declared elements", "declared elements, referencing", "declared elements, about declared elements"]
