...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["qualification, of element names", "declarations [VB], elements", "element names [VB], qualification", "references [VB], declared elements", "declaration statements [VB], declared elements", "declaring elements [VB]", "referencing declared elements [VB]", "declared elements [VB], referencing", "declared elements [VB], about declared elements"]
