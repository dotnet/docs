...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["qualification, of element names", "element names, qualification", "references, declared elements", "declaration statements, declared elements", "referencing declared elements", "declared elements, referencing", "declared elements, about declared elements", "variables [Visual Basic], hiding inherited"]
