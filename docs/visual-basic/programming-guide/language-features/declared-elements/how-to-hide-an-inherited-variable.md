...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["qualification [Visual Basic], of element names", "element names [Visual Basic], qualification", "references [Visual Basic], declared elements", "declaration statements [Visual Basic], declared elements", "referencing declared elements [Visual Basic]", "declared elements [Visual Basic], referencing", "declared elements [Visual Basic], about declared elements", "variables [Visual Basic], hiding inherited"]
