...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["static variables [Visual Basic], lifetime", "static variables [Visual Basic], Visual Basic", "declared elements [Visual Basic], lifetime", "Shared variable lifetime [Visual Basic]", "lifetime [Visual Basic], declared elements", "lifetime [Visual Basic], Visual Basic", "lifetime [Visual Basic]"]
