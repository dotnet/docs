...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["module scope", "scope, levels", "module level", "procedures, scope", "declared elements, scope", "namespaces, scope", "scope, declared elements", "scope, about scope", "levels of scope", "block scope", "scope, Visual Basic", "procedure scope"]
