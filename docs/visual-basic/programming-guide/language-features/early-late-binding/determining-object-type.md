...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["classes [Visual Basic], discovering which an object belongs to", "types [Visual Basic], determining Visual Basic object types", "object variables, testing values", "TypeOf...Is expression, object type at run time", "TypeName function", "objects [Visual Basic], type determining"]
