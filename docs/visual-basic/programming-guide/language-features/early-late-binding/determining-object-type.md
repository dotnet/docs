...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""classes [VB], discovering which an object belongs to"", ""types [VB], determining Visual Basic object types"", ""object variables [VB], testing values"", ""TypeOf...Is expression, object type at run time"", ""TypeName function"", ""objects [VB], type determining""]"]
