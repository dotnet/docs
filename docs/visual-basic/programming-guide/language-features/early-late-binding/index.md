...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["early binding [VB]", "objects [VB], late-bound", "objects [VB], early-bound", "objects [VB], late bound", "early binding, Visual Basic compiler", "binding, late and early", "objects [VB], early bound", "Visual Basic compiler, early and late binding", "late binding [VB]", "late binding, Visual Basic compiler"]
