...
ms.topic: "article"
helpviewer_keywords: ["exceptions, types", "errors [Visual Basic], types", "errors [Visual Basic], logic", "errors [Visual Basic], syntax", "logic errors, Visual Basic", "run-time errors, types of errors", "syntax errors, Visual Basic"]
