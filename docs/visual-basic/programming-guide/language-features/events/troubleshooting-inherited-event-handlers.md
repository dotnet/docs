...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["troubleshooting events", "inherited events", "troubleshooting Visual Basic, event handlers", "event handling, troubleshooting", "event handlers, troubleshooting"]
