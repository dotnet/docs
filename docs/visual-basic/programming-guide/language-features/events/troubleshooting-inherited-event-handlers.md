...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["troubleshooting events [Visual Basic]", "inherited events [Visual Basic]", "troubleshooting Visual Basic, event handlers", "event handling, troubleshooting", "event handlers, troubleshooting"]
