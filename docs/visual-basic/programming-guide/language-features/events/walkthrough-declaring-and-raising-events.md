...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["declarations, events", "events [Visual Basic], walkthroughs", "declaring events, walkthroughs", "events [Visual Basic], declaring", "events [Visual Basic], raising", "raising events, walkthroughs"]
