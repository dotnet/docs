...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["event handling [Visual Basic], walkthroughs", "walkthroughs [Visual Basic], event handling", "variables [Visual Basic], WithEvents", "events [Visual Basic], walkthroughs", "WithEvents keyword [Visual Basic], walkthroughs", "event handlers [Visual Basic], walkthroughs"]
