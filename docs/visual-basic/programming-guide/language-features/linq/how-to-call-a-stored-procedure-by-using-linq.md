...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["queries [LINQ in Visual Basic], stored procedure calls", "stored procedures sample [Visual Basic]", "stored procedures [LINQ to SQL]", "queries [LINQ in Visual Basic], how-to topics"]
