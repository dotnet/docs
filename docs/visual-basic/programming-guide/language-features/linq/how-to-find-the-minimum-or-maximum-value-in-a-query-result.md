...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["max operator [LINQ in Visual Basic]", "aggregate operator [LINQ in Visual Basic]", "aggregate queries", "minimum values [LINQ in Visual Basic]", "min operator [LINQ in Visual Basic]", "queries [LINQ in Visual Basic], minimum and maximum values", "Max property", "maximum values [LINQ in Visual Basic]", "Aggregate clause", "queries [LINQ in Visual Basic], aggregate queries", "queries [LINQ in Visual Basic], how-to topics"]
