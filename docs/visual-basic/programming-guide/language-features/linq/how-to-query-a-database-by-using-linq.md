...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["query samples [LINQ]", "database querying [LINQ]", "queries [LINQ in Visual Basic], database querying", "querying databases [LINQ]", "queries [LINQ in Visual Basic], how-to topics", "query samples [Visual Basic]"]
