...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["derived classes, inheritance", "MyClass keyword, using", "MyBase keyword, using", "Inherits statement, inheritance", "overriding, Overridable keyword", "MustInherit keyword, using", "Overrides keyword, using", "inheritance", "MustInherit classes", "MustOverride keyword, using", "classes [Visual Basic], derived", "NotInheritable keyword, using", "base classes, extending properties and methods", "NotOverridable keyword, using", "base classes, inheritance", "abstract classes, inheritance", "overriding, Overrides keyword"]
