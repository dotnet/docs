...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["type safety", "operators [Visual Basic], bitwise", "operators [Visual Basic], bit-shift", "bitwise operators", "bit-shift operators", "zero, division by zero", "operators [Visual Basic], arithmetic", "division, by zero", "Visual Basic code, operators", "arithmetic operators, about arithmetic operators"]
