...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["type safety", "operators [Visual Basic], bitwise", "operators [Visual Basic], bit-shift", "bitwise operators [Visual Basic]", "bit-shift operators [Visual Basic]", "zero, division by zero", "operators [Visual Basic], arithmetic", "division [Visual Basic], by zero", "Visual Basic code, operators", "arithmetic operators [Visual Basic], about arithmetic operators"]
