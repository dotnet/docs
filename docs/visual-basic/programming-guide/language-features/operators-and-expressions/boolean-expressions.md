...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["short-circuiting", "Boolean expressions", "logical operators, Boolean expressions", "expressions [Visual Basic], Boolean", "expression evaluation, Boolean expressions", "operators [Visual Basic], short-circuiting", "Visual Basic code, operators", "short-circuit evaluation", "logical operators, short-circuiting", "operators [Visual Basic], Boolean", "Visual Basic code, expressions"]
