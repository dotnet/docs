...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""operators [VB], logical"", ""operators [VB], string concatenation"", ""operators [VB], bitwise"", ""operators [VB], bit-shift"", ""operators [VB], arithmetic"", ""operators [VB], string comparison"", ""operators [VB], concatenation"", ""Visual Basic code, operators"", ""operators [VB], comparison"", ""operators [VB], short-circuiting logical""]"]
