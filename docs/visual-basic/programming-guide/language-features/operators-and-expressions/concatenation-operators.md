...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["& operator [VB], concatenation", "concatenation operators [VB]", "operators [VB], concatenation", "Visual Basic code, operators [VB]", "+ operator [VB], concatenation", "concatenation operators [VB], Visual Basic strings"]
