...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["& operator [Visual Basic], concatenation", "concatenation operators", "operators [Visual Basic], concatenation", "Visual Basic code, operators", "+ operator [Visual Basic], concatenation", "concatenation operators, Visual Basic strings"]
