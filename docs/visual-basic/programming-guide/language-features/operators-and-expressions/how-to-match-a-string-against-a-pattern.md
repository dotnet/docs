...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["comparison operators [VB], comparing strings", "pattern matching", "strings [VB], comparing", "string comparison [VB], operators", "Visual Basic code, operators", "pattern matching, string comparison", "string comparison [VB]", "Like operator [VB], pattern matching", "pattern matching, empty strings", "operators [VB], comparison"]
