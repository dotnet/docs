...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["variables [Visual Basic], reference", "Is operator [Visual Basic], comparing objects", "reference variables [Visual Basic]", "variables [Visual Basic], referring to same object", "objects [Visual Basic], variables referring to same", "Visual Basic code, operators"]
