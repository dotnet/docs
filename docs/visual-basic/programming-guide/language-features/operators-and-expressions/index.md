...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["operators [VB], operands", "operators [VB]", "operands, definition", "Visual Basic code, operators", "Visual Basic code, expressions", "operands", "expressions [VB]"]
