...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["operators [Visual Basic], operands", "operators [Visual Basic]", "operands, definition", "Visual Basic code, operators", "Visual Basic code, expressions", "operands", "expressions [Visual Basic]"]
