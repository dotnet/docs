...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["variables [VB], comparing values", "Visual Basic code, operators", "Visual Basic code, expressions", "comparison operators [VB], comparing expressions", "numeric expressions [VB]", "operators [VB], comparison", "expressions [VB], comparing"]
