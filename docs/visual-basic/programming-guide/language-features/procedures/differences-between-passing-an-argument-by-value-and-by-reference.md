...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["ByRef keyword [Visual Basic], passing arguments by reference", "Visual Basic code, procedures", "procedures [Visual Basic], passing arguments", "ByVal keyword [Visual Basic], passing arguments by value", "arguments [Visual Basic], passing by value or by reference"]
