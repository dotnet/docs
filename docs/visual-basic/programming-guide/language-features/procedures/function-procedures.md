...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""Function procedures [VB]"", ""return values [VB], function procedures"", ""Visual Basic code, procedures"", ""procedures [VB], calling"", ""procedures [VB], Function procedures"", ""syntax [VB], function procedures""]"]
