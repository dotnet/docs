...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["Visual Basic code, procedures", "Visual Basic code, properties", "procedures [Visual Basic], calling", "properties [Visual Basic], property procedures", "procedure calls [Visual Basic], property procedures"]
