...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""access levels [VB], properties"", ""procedures [VB], defining"", ""Visual Basic code, procedures"", ""mixed access levels [VB]"", ""Visual Basic code, properties"", ""properties [VB], access levels"", ""Property statement [VB], declaring mixed access levels""]"]
