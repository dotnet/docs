...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["defaults, properties", "properties [Visual Basic], default", "procedures [Visual Basic], defining", "default properties, in Visual Basic", "Visual Basic code, procedures", "Visual Basic code, properties", "default properties"]
