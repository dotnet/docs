---
description: "Learn more about: How to: Define a Parameter for a Procedure (Visual Basic)"
...
6. If the parameter is optional, precede the passing mechanism with [Optional](../../../language-reference/modifiers/optional.md) and follow the parameter data type with an equal sign (`=`) and a default value.  
