...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["procedures [VB], defining", "Visual Basic code, procedures", "operators [VB], defining", "procedures [VB], operator", "Visual Basic code, operators", "syntax [VB], Operator procedures", "operators [VB], overloading", "operator procedures [VB], about operator procedures", "return values [VB], Operator procedures", "operator overloading"]
