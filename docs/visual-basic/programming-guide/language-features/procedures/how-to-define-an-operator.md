...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["procedures, defining", "Visual Basic code, procedures", "operators [Visual Basic], defining", "procedures, operator", "Visual Basic code, operators", "syntax, Operator procedures", "operators [Visual Basic], overloading", "operator procedures, about operator procedures", "return values, Operator procedures", "operator overloading"]
