...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["procedures [Visual Basic], defining", "Visual Basic code, procedures", "procedures [Visual Basic], overloading", "procedures [Visual Basic], multiple versions", "procedure overloading, multiple versions"]
