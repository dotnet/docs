...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["operator procedures, calling", "procedures, operator", "procedures, calling", "examples [Visual Basic], CType", "syntax, Operator procedures", "operators [Visual Basic], overloading", "return values, Operator procedures", "operator overloading"]
