...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""Visual Basic code, procedures"", ""procedures [VB], operator"", ""Visual Basic code, operators"", ""syntax [VB], Operator procedures"", ""operators [VB], overloading"", ""overloaded operators [VB]"", ""operator overloading [VB]"", ""operator procedures [VB]""]"]
