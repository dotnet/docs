...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""parameters [VB], optional"", ""Visual Basic code, procedures"", ""procedures [VB], optional arguments"", ""optional arguments [VB]"", ""named arguments [VB], and optional arguments"", ""optional parameters [VB]"", ""Optional keyword [VB], optional arguments"", ""arguments [VB], optional"", ""optional arguments [VB], and named arguments""]"]
