...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["parameter arrays [Visual Basic], about parameter arrays", "ParamArray keyword [Visual Basic], parameter arrays", "Visual Basic code, procedures", "parameters [Visual Basic], parameter arrays", "arguments [Visual Basic], parameter arrays", "procedures [Visual Basic], indefinite number of argument values", "arrays [Visual Basic], parameter arrays"]
