...
dev_langs: ["VB"]
helpviewer_keywords: ["custom logic into code [Visual Basic]", "partial methods [Visual Basic]", "partial, methods [Visual Basic]", "methods [Visual Basic], partial methods", "inserting custom logic into code"]
