...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["arguments [Visual Basic], passing by name", "procedures [Visual Basic], arguments", ":= passing arguments", "procedure arguments", "Visual Basic code, procedures", "named arguments [Visual Basic], passing arguments", "arguments [Visual Basic], passing by position", "Function procedures [Visual Basic], passing arguments", "named parameters [Visual Basic], passing arguments", "named arguments", "passing parameters [Visual Basic], named parameter arguments", "passing parameters [Visual Basic], by position", "procedures [Visual Basic], calling", "named parameters", "Sub procedures [Visual Basic], passing arguments", "argument passing", "passing parameters [Visual Basic], by name", "argument passing, by position", "arguments [Visual Basic], listing by name"]
