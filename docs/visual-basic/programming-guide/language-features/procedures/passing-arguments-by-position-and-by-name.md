...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["arguments [Visual Basic], passing by name", "procedures, arguments", ":= passing arguments", "procedure arguments", "Visual Basic code, procedures", "named arguments, passing arguments", "arguments [Visual Basic], passing by position", "Function procedures, passing arguments", "named parameters, passing arguments", "named arguments", "passing parameters, named parameter arguments", "passing parameters, by position", "procedures, calling", "named parameters", "Sub procedures, passing arguments", "argument passing", "passing parameters, by name", "argument passing, by position", "arguments [Visual Basic], listing by name"]
