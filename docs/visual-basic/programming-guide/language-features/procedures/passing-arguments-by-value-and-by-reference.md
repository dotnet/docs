...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["ByRef keyword [Visual Basic], passing arguments by reference", "Visual Basic code, procedures", "passing arguments [Visual Basic], by value or by reference", "ByVal keyword [Visual Basic], passing arguments by value", "arguments [Visual Basic], passing by value or by reference", "argument passing, by value or by reference"]
