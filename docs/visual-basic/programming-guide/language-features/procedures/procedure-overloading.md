...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["signatures", "Overloads keyword", "hiding by signature", "Visual Basic code, procedures", "procedures, signatures for", "procedures, overloading", "procedures, multiple versions", "parameters, lists", "signatures, procedure", "parameter lists", "Visual Basic code, parameter lists", "Shadows keyword", "procedure overloading", "procedures, parameter lists"]
