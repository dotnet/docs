...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["signatures [VB]", "Overloads keyword [VB]", "hiding by signature [VB]", "Visual Basic code, procedures", "procedures [VB], signatures for", "procedures [VB], overloading", "procedures [VB], multiple versions", "parameters [VB], lists", "signatures, procedure", "parameter lists [VB]", "Visual Basic code, parameter lists", "Shadows keyword [VB]", "procedure overloading [VB]", "procedures [VB], parameter lists"]
