...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["procedures, arguments", "procedures, argument lists", "values, passing to procedures", "arguments [Visual Basic], passing", "procedures, parameters", "Visual Basic code, argument lists", "Visual Basic code, procedures", "parameters, Visual Basic procedures", "parameters, lists", "arguments [Visual Basic], Visual Basic procedures", "arguments [Visual Basic], procedures", "parameter lists", "Visual Basic code, parameter lists", "argument lists", "procedures, parameter lists"]
