...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["Visual Basic code, procedures", "procedures [VB], that call themselves", "procedures [VB], recursive", "procedures [VB], calling", "recursive procedures [VB]", "functions [VB], calling recursively", "recursion [VB]"]
