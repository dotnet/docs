...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["variables [Visual Basic], declaring", "colons (:)", "constants, defining", "underlines", "constants, statements", "blue underline", "procedures, statements", "variables [Visual Basic], assigning", "line breaks, in code", "executable statements", "variables [Visual Basic], defining", "statements [Visual Basic], about statements"]
