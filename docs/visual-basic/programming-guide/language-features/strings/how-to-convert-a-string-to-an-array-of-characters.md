...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""character arrays, converting strings"", ""arrays [VB], converting strings to"", ""examples [VB], string conversion"", ""strings [VB], converting to arrays"", ""string conversion [VB], arrays""]"]
