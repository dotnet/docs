...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["character arrays [Visual Basic], converting strings", "arrays [Visual Basic], converting strings to", "examples [Visual Basic], string conversion", "strings [Visual Basic], converting to arrays", "string conversion [Visual Basic], arrays"]
