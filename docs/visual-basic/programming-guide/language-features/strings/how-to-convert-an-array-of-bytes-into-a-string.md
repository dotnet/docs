...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["string conversion, arrays", "byte arrays, converting to strings", "examples [Visual Basic], strings", "arrays [Visual Basic], converting to strings"]
