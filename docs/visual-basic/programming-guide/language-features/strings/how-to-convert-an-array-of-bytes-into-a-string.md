...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["string conversion [Visual Basic], arrays", "byte arrays [Visual Basic], converting to strings", "examples [Visual Basic], strings", "arrays [Visual Basic], converting to strings"]
