...
This example converts a hexadecimal string to an integer using the <xref:System.Convert.ToInt32*?displayProperty=nameWithType> method.
...
- <xref:System.Convert.ToInt32*?displayProperty=nameWithType>
