...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["string conversion, arrays", "arrays [Visual Basic], converting strings to", "byte arrays", "examples [Visual Basic], string conversion", "arrays [Visual Basic], byte arrays"]
