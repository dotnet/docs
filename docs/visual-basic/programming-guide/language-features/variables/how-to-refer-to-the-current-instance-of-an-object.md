...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["variables [Visual Basic], object", "objects [Visual Basic], referring to current instance", "instances, referring to current", "current instance", "object variables"]
