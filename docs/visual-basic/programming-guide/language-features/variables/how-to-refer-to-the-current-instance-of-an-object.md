...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""variables [VB], object"", ""objects [VB], referring to current instance"", ""instances, referring to current"", ""current instance [VB]"", ""object variables [VB]""]"]
