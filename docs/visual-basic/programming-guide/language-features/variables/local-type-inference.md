...
dev_langs: ["VB"]
helpviewer_keywords: ["Option Infer statement", "local type inference [Visual Basic]", "implicitly-typed local variables [Visual Basic]", "variables [Visual Basic], type inference", "inference [Visual Basic]", "type inference [Visual Basic]"]
