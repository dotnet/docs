...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""early binding [VB]"", ""declarations [VB], class"", ""classes [VB], declaring"", ""binding, late and early"", ""object variables [VB], declaring"", ""variables [VB], object"", ""declaring variables [VB], object variables"", ""declaring classes [VB]"", ""late binding [VB]""]"]
