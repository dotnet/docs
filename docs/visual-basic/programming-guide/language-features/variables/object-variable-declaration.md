...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["early binding [Visual Basic]", "declarations [Visual Basic], class", "classes [Visual Basic], declaring", "binding [Visual Basic], late and early", "object variables [Visual Basic], declaring", "variables [Visual Basic], object", "declaring variables [Visual Basic], object variables", "declaring classes [Visual Basic]", "late binding [Visual Basic]"]
