...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["early binding", "declarations, class", "classes [Visual Basic], declaring", "binding, late and early", "object variables, declaring", "variables [Visual Basic], object", "declaring variables, object variables", "declaring classes", "late binding"]
