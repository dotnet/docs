...
|<xref:Microsoft.VisualBasic.Information.IsDate*>|A [Date Data Type](../../../language-reference/data-types/date-data-type.md) value, or a string that can be interpreted as a date and time value|
...
|<xref:Microsoft.VisualBasic.Information.IsNothing*>|[Nothing](../../../language-reference/nothing.md), that is, no object is currently assigned to the variable|
