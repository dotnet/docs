...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["object variables [Visual Basic], values", "values [Visual Basic], of object variables", "data types [Visual Basic], object variable", "variables [Visual Basic], object"]
