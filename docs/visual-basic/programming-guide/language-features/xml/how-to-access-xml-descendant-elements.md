...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["XML descendent axis property [Visual Basic]", "XML axis [Visual Basic], descendent", "descendent axis property [Visual Basic]", "XML [Visual Basic], accessing"]
