...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["declarations [XML in Visual Basic]", "element names [XML in Visual Basic]", "names in XML literals", "attribute names [XML in Visual Basic]", "XML literals [Visual Basic], element names"]
