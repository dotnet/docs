...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["Uncomment button", "REM statement", "comments, in code", "comments, Visual Basic code", "Comment button", "buttons, Uncomment", "buttons, Comment", "code comments, Visual Basic", "Visual Basic code, comments", "comments", "code comments"]
