...
dev_langs: ["VB"]
helpviewer_keywords: ["My object", "self-reference, Me keyword", "MyClass keyword, relationship to similar programming elements", "Me keyword, relationship to similar programming elements", "Me keyword, referring to the current instance of an object", "Me keyword", "self-reference", "current instance, Me keyword", "MyBase keyword, relationship to similar programming elements"]
