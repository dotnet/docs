...
dev_langs: ["VB"]
helpviewer_keywords: ["assemblies [VB], namespaces", "name collisions [VB]", "Global keyword [VB]", "namespace pollution [VB]", "names [VB], avoiding conflicts", "naming conflicts, namespaces", "namespaces [VB], assemblies", "Visual Basic code, namespaces", "fully qualified names [VB]", "naming conventions [VB], naming conflicts", "namespaces [VB]"]
