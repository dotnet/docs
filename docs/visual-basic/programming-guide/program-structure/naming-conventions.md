...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["names [VB], Visual Basic rules", "naming conventions [VB]", "naming conventions [VB], Visual Basic", "Visual Basic code, naming conventions", "conventions [VB], Visual Basic coding", "names [VB], naming conventions", "naming conventions [VB], classes"]
