...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["coding conventions", "Visual Basic code, coding conventions", "coding conventions [Visual Basic], Visual Basic", "programs [Visual Basic], structure", "program structure [Visual Basic]", "naming conventions [Visual Basic], Visual Basic", "best practices [Visual Basic], coding conventions", "conventions [Visual Basic], Visual Basic coding", "Visual Basic code", "programming, Visual Basic coding conventions"]
