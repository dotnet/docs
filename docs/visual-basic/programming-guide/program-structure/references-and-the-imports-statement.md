...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""assemblies [VB], namespaces"", ""references [VB], assembly"", ""namespaces [VB], assemblies"", ""referencing assemblies [VB]"", ""Imports statement [VB], referencing assemblies"", ""assemblies [VB], references""]"]
