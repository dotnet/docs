...
dev_langs: ["VB"]
helpviewer_keywords: ["special characters [Visual Basic], in code", "parentheses, using in code", "colons (:)", "period character in code", "dot operator (.)", "dictionary access operator [Visual Basic]", "concatenation operators [Visual Basic], special characters in code", "concatenation operators [Visual Basic], vs. addition operator", "! operator", "separators, using in code", "operators [Visual Basic], dictionary access", ": separator character", "member access operator [Visual Basic]", "addition operator [Visual Basic]", "operators [Visual Basic], member access", ". operator", "exclamation points", "separators", "exclamation point operator (!)", "Visual Basic code, special characters"]
