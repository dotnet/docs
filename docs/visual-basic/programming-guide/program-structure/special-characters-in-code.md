...
dev_langs: ["VB"]
helpviewer_keywords: ["[""special characters [VB], in code"", ""parentheses, using in code"", ""colons (:)"", ""period character in code [VB]"", ""dot operator (.)"", ""dictionary access operator [VB]"", ""concatenation operators [VB], special characters in code"", ""concatenation operators [VB], vs. addition operator"", ""! operator [VB]"", ""separators, using in code"", ""operators [VB], dictionary access"", "": separator character"", ""member access operator [VB]"", ""addition operator [VB]"", ""operators [VB], member access"", "". operator [VB]"", ""exclamation points [VB]"", ""separators [VB]"", ""exclamation point operator (!)"", ""Visual Basic code, special characters""]"]
