...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["conditional compilation [Visual Basic], Visual Basic", "program structure, Visual Basic", "procedures [Visual Basic], structure", "Visual Basic code, program structure"]
