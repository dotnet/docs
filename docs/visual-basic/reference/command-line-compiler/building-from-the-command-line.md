...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["builds [Visual Basic], command-line", "Visual Basic compiler, about Visual Basic compiler", "command line [Visual Basic], compilers", "command line [Visual Basic], building from", "command line [Visual Basic], builds", "compilers, invoking from command line", "command-line builds", "compiling source code", "command-line compilers, Visual Basic", "command line [Visual Basic], Visual Basic"]
