...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["-d compiler option [Visual Basic]", "/d compiler option [Visual Basic]", "-define compiler option [Visual Basic]", "d compiler option [Visual Basic]", "/define compiler option [Visual Basic]", "define compiler option [Visual Basic]"]
