...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["sections compiler option [VB]", "alignment compiler option [VB]", "-filealign compiler option [VB]", "section alignment [VB]", "/filealign compiler option [VB]", "filealign compiler option [VB]"]
