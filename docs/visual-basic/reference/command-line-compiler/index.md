...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["compilers [Visual Basic], Visual Basic options", "Visual Basic compiler", "compilers [Visual Basic]", "compiler options, Visual Basic", "Visual Basic compiler, options"]
