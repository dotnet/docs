...
## Remarks  
 ...
 See [Creating and Using Strong-Named Assemblies](../../../standard/assembly/create-and-use-strong-named-assemblies.md) for more information on signing an assembly.  
