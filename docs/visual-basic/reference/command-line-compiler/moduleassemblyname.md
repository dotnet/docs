...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["moduleassemblyname compiler option [Visual Basic]", "/moduleassemblyname compiler option [Visual Basic]", "-moduleassemblyname compiler option [Visual Basic]"]
