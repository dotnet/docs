...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["optimize compiler option [Visual Basic]", "/optimize compiler option [Visual Basic]", "optimization [Visual Basic], enabling", "-optimize compiler option [Visual Basic]"]
