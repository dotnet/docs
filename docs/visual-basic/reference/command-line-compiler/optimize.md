...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["optimize compiler option [Visual Basic]", "/optimize compiler option [Visual Basic]", "optimization, enabling", "-optimize compiler option [Visual Basic]"]
