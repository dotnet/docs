...
dev_langs: ["VB"]
helpviewer_keywords: ["/optionexplicit compiler option [Visual Basic]", "optionexplicit compiler option [Visual Basic]", "-optionexplicit compiler option [Visual Basic]"]
