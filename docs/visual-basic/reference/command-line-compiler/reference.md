...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["/reference compiler option [Visual Basic]", "r compiler option [Visual Basic]", "-reference compiler option [Visual Basic]", "/r compiler option [Visual Basic]", "reference compiler option [Visual Basic]", "-r compiler option [Visual Basic]"]
