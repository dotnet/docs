...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["/resource compiler option [Visual Basic]", "-resource compiler option [Visual Basic]", "/res compiler option [Visual Basic]", "res compiler option [Visual Basic]", "-res compiler option [Visual Basic]", "resource compiler option [Visual Basic]"]
