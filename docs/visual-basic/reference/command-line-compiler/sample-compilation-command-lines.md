...
ms.topic: "article"
dev_langs: ["VB"]
helpviewer_keywords: ["[""command line [VB], compilers"", ""compilation [VB], command-line"", ""command-line compilers [VB]"", ""compiling source code [VB],  from command line"", ""Visual Basic compiler, sample command lines""]"]
