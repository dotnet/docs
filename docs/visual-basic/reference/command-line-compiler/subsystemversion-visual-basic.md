...
> [!NOTE]
>  To specify the subsystem itself, use the [/target](../../../csharp/language-reference/compiler-options/target-csharp-compiler-options.md) compiler option.  
...
-   The default value is 6.02 if any compiler option in the following list is set:  
    ...
    -   [/target:appcontainerexe](../../../visual-basic/reference/command-line-compiler/target-visual-basic.md)  
  
    -   [/target:winmdobj](../../../visual-basic/reference/command-line-compiler/target-visual-basic.md)  
  
    -   [/platform:arm](../../../visual-basic/reference/command-line-compiler/platform-visual-basic.md)  
