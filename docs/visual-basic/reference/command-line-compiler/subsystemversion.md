...
ms.topic: "article"
helpviewer_keywords: ["/subsystemversion compiler option [Visual Basic]", "-subsystemversion compiler option [Visual Basic]", "subsystemversion compiler option [Visual Basic]"]
