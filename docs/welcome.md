...
Test link to xref constructed from URL fragment: <xref:microsoft.extensions.options.optionsbuilder-1.configure#microsoft-extensions-options-optionsbuilder-1-configure-5(system-action((-0-0-1-2-3-4)))>\
