...
- [Use HttpClientFactory to implement resilient HTTP requests](../architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests.md) - Enhance the HttpClientFactory article to include user feedback
...
- [.NET Core distribution packaging](../core/build/distribution-packaging.md) - fix: MD004/ul-style
- [.NET Core distribution packaging](../core/build/distribution-packaging.md) - Update package guidelines for .NET Core 3.0

## C# language

- [Compiler Error CS0029](../csharp/language-reference/compiler-messages/cs0029.md) - Some fixes in compiler-messages directory
- [Compiler Error CS0034](../csharp/language-reference/compiler-messages/cs0034.md) - Some fixes in compiler-messages directory
- [Compiler Error CS0103](../csharp/language-reference/compiler-messages/cs0103.md) - Some fixes in compiler-messages directory
- [Compiler Error CS0120](../csharp/language-reference/compiler-messages/cs0120.md) - Some fixes in compiler-messages directory
- [-platform (C# Compiler Options)](../csharp/language-reference/compiler-options/platform-compiler-option.md) - fix: Replace bold Note with alert style [!NOTE]
- [Compiler Error CS0072](../csharp/misc/cs0072.md) - Fix indentation in cs0072.md
- [Compiler Error CS0819](../csharp/misc/cs0819.md) - Update cs0819.md
- [How to perform streaming transformations of text to XML (C#)](../csharp/programming-guide/concepts/linq/how-to-perform-streaming-transformations-of-text-to-xml.md) - Update how-to-perform-streaming-transformations-of-text-to-xml.md
- [Hello World -- Your first program](../csharp/programming-guide/inside-a-program/hello-world-your-first-program.md) - Improve hello world
...
- [\<bypassTrustedAppStrongNames> Element](../framework/configure-apps/file-schema/runtime/bypasstrustedappstrongnames-element.md) - fix: Markdownlint
...
- [UI Automation Control Types](../framework/ui-automation/ui-automation-control-types.md) - fix: Replace bold Note with alert style [!NOTE]
...
- [Walkthrough: Creating an Accessible Windows-based Application](../framework/winforms/advanced/walkthrough-creating-an-accessible-windows-based-application.md) - Remove redundant comments, use IsNot, fix indentation
...
- [Walkthrough: Hosting Direct3D9 Content in WPF](../framework/wpf/advanced/walkthrough-hosting-direct3d9-content-in-wpf.md) - fix: MD001/heading-increment/header-increment
...
- [Load data from files and other sources](../machine-learning/how-to-guides/load-data-ml-net.md) - Add section for DB Loader
...
- [.NET for Apache Spark documentation](../spark/index.yml) - Spark Dotnet: new landing page
...
- [Set assembly attributes](../standard/assembly/set-attributes.md) - fix: Markdownlint
- [XDR Validation with XmlSchemaCollection](../standard/data/xml/xdr-validation-with-xmlschemacollection.md) - Fix indentation and modernize code
...
- [How to serialize and deserialize JSON in .NET](../standard/serialization/system-text-json-how-to.md) - Follow-up to #14208

## Visual Basic language

- [How to: Create a Registry Key and Set Its Value in Visual Basic](../visual-basic/developing-apps/programming/computer-resources/how-to-create-a-registry-key-and-set-its-value.md) - fix: MD001/heading-increment/header-increment
...
- [XML Value Property (Visual Basic)](../visual-basic/language-reference/xml-axis/xml-value-property.md) - Cleanup xml-value-property.md
- [How to: Modify Expression Trees (Visual Basic)](../visual-basic/programming-guide/concepts/expression-trees/how-to-modify-expression-trees.md) - fix: MD001/heading-increment/header-increment
...
- [How to: Filter Query Results by Using LINQ (Visual Basic)](../visual-basic/programming-guide/language-features/linq/how-to-filter-query-results-by-using-linq.md) - fix: MD001/heading-increment/header-increment
- [How to: Match a String against a Pattern (Visual Basic)](../visual-basic/programming-guide/language-features/operators-and-expressions/how-to-match-a-string-against-a-pattern.md) - fix: MD001/heading-increment/header-increment
