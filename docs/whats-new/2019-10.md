...
Welcome to what's new in .NET docs for October 2019. This article lists some of the major changes to docs during this period.
...
- [Markup Extensions for XAML Overview](../desktop-wpf/xaml-services/markup-extensions-overview.md) - Replace "default constructor" with "parameterless constructor"
...
The following people have contributed to .NET docs in October 2019. Thank you! You can learn how to contribute by following the links under "Get involved" in the [what's new landing page](index.yml).
