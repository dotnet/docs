...
Welcome to what's new in .NET docs for November 2019. This article lists some of the major changes to docs during this period.
...
The following people have contributed to .NET docs in November 2019. Thank you! You can learn how to contribute by following the links under "Get involved" in the [what's new landing page](index.yml).
