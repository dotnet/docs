...
- [Caching in a cloud-native app](../architecture/cloud-native/azure-caching.md) - Chapter 5 octupdates
- [Database-per-microservice](../architecture/cloud-native/database-per-microservice.md) - Chapter 5 octupdates
- [Elasticsearch in a cloud-native app](../architecture/cloud-native/elastic-search-in-azure.md) - Chapter 5 octupdates
...
- [Unsupported scenarios](../framework/wcf/feature-details/unsupported-scenarios.md) - Acrolinx 12/30
...
- [Firewall instructions](../framework/wcf/samples/firewall-instructions.md) - Acrolinx 12/30
- [WS-AtomicTransaction Configuration MMC snap-in](../framework/wcf/ws-atomictransaction-configuration-mmc-snap-in.md) - Acrolinx 12/30
...
- [How to migrate from Newtonsoft.Json to System.Text.Json](../standard/serialization/system-text-json-migrate-from-newtonsoft-how-to.md) - Add table of differences to Migrate from Newtonsoft.Json doc
