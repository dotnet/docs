...
- [How to: Localize an application](/dotnet/desktop/wpf/advanced/how-to-localize-an-application) - Miscellaneous fixes
...
:octocat: Want to contribute to the .NET docs? Read our [contributor guide](/contribute/dotnet/dotnet-contribute).
