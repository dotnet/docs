...
No action is necessary. However, if you want to maintain the old behavior, you can implement your own `Lerp` function that uses the previous algorithm: `value1 + (value2 - value1) * amount`.
