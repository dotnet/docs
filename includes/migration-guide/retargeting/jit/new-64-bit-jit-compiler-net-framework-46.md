...
- Under certain conditions, particularly when initializing array values, memory initialization by the <xref:System.Reflection.Emit.OpCodes.Initblk?displayProperty=fullNameWithType> IL instruction may initialize memory with an incorrect value. This can result either in an unhandled exception or incorrect output.
...
**Mitigation of known issues** <br/> If you encounter the issues listed above, you can address them by doing any of the following:
