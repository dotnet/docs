...
|Version|4.8|
|Type|Runtime|
|Affected APIs|<ul><li><xref:stem.Web.HttpRequest.Form?displayProperty=nameWithType></li><li><xref:stem.Web.HttpRequest.Files?displayProperty=nameWithType></li><li><xref:stem.Web.HttpRequest.ContentEncoding?displayProperty=nameWithType></li></ul>|
