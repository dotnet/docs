...
|Suggestion|If your app depends on the previous behavior of this method, you can add an aspnet:JavaScriptDoNotEncodeAmpersand setting to the <a href="https://msdn.microsoft.com/library/hh975440(v=vs.120).aspx">ASP.NET appSettings element</a> in your configuration file.|
|Scope|Minor|
|Version|4.5|
|Type|Runtime|
