...
|Suggestion|Any one of the following:<ol><li>Upgrade to .NET 4.7.</li><li>Install the latest servicing patch for .NET 4.6.2.</li><li>Avoid removing columns until the asynchronous response to <xref:System.Windows.Controls.DataGrid.ScrollIntoView(System.Object)> has completed.</li></ol>|
|Scope|Edge|
|Version|4.6.2|
|Type|Runtime|
