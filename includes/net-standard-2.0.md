**Available APIs:** 32,638 of 37,118
...
For more information, see [.NET Standard 2.0][1.0]. For an interactive table, see [.NET Standard versions](https://dotnet.microsoft.com/platform/dotnet-standard#versions).
