...
This sample is part of the [Organizing and testing projects with the .NET Core command line tutorial](https://docs.microsoft.com/dotnet/articles/core/tutorials/testing-with-cli) for creating .NET Core console applications. Please see the tutorial for details on the code for this sample.
