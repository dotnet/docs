...
int main()
{
   ...
   ContractReference^ myContractReference = dynamic_cast<ContractReference^>(myArrayList[ 0 ]);
   
   // Get the DefaultFileName associated with the .disco file.
   String^ myFileName = myContractRefernce->DefaultFilename;
   
   // Get the URL associated with the .disco file.
   String^ myUrl = myContractReference->Url;
   Console::WriteLine( "The DefaultFilename is: {0}", myUrl );
