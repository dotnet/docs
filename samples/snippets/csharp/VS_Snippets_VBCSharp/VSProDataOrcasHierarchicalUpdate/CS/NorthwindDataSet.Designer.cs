...
namespace HierarchicalUpdateWalkthroughCS {
    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CustomersRow AddCustomersRow(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string Region, string PostalCode, string Country, string Phone, string Fax, System.DateTime CreationDate, System.DateTime LastEditDate) {
...
namespace HierarchicalUpdateWalkthroughCS.NorthwindDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([CustomerID], [CompanyName], [ContactName], [ContactTitle], [Address], [City], [Region], [PostalCode], [Country], [Phone], [Fax], [CreationDate], [LastEditDate]) VALUES (@CustomerID, @CompanyName, @ContactName, @ContactTitle, @Address, @City, @Region, @PostalCode, @Country, @Phone, @Fax, @CreationDate, @LastEditDate);
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax, CreationDate, LastEditDate FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customers] SET [CustomerID] = @CustomerID, [CompanyName] = @Company" +
                ...
                "ry] = @Country, [Phone] = @Phone, [Fax] = @Fax, [CreationDate] = @CreationDate, " +
                "[LastEditDate] = @LastEditDate WHERE (([CustomerID] = @Original_CustomerID) AND " +
                ...
                "iginal_Fax)) AND ((@IsNull_CreationDate = 1 AND [CreationDate] IS NULL) OR ([Cre" +
                "ationDate] = @Original_CreationDate)) AND ((@IsNull_LastEditDate = 1 AND [LastEd" +
                "itDate] IS NULL) OR ([LastEditDate] = @Original_LastEditDate)));\r\nSELECT Custome" +
                "rID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, " +
                "Country, Phone, Fax, CreationDate, LastEditDate FROM Customers WHERE (CustomerID" +
                " = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HierarchicalUpdateWalkthroughCS.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        public virtual int Delete(string Original_CustomerID, string Original_CompanyName, string Original_ContactName, string Original_ContactTitle, string Original_Address, string Original_City, string Original_Region, string Original_PostalCode, string Original_Country, string Original_Phone, string Original_Fax, global::System.Nullable<global::System.DateTime> Original_CreationDate, global::System.Nullable<global::System.DateTime> Original_LastEditDate) {
            ...
            if ((Original_CreationDate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[21].Value = ((System.DateTime)(Original_CreationDate.Value));
            }
            else {
            ...
            if ((Original_LastEditDate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[23].Value = ((System.DateTime)(Original_LastEditDate.Value));
            }
            else {
        ...
        public virtual int Insert(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string Region, string PostalCode, string Country, string Phone, string Fax, global::System.Nullable<global::System.DateTime> CreationDate, global::System.Nullable<global::System.DateTime> LastEditDate) {
            if ((CustomerID == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_LastEditDate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[36].Value = ((System.DateTime)(Original_LastEditDate.Value));
            }
            else {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        private class SelfReferenceComparer : object, global::System.Collections.Generic.IComparer<global::System.Data.DataRow> {
            ...
            public int Compare(global::System.Data.DataRow row1, global::System.Data.DataRow row2) {
                ...
                if (object.ReferenceEquals(row1.GetParentRow(this._relation), row2)) {
                    return this._childFirst;
                }
                if (object.ReferenceEquals(row1.GetParentRow(this._relation, global::System.Data.DataRowVersion.Original), row2)) {
                    return this._childFirst;
                }

                // Is row2 the child of row1
                if (object.ReferenceEquals(row2.GetParentRow(this._relation), row1)) {
                    return (-1 * this._childFirst);
                }
                if (object.ReferenceEquals(row2.GetParentRow(this._relation, global::System.Data.DataRowVersion.Original), row1)) {
                    return (-1 * this._childFirst);
                }
                return 0;
            }
