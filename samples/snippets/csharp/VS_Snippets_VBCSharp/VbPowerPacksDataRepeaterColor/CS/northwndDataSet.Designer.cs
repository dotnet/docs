...
namespace RepeaterColor.northwndDataSetTableAdapters {
...
SELECT ContactID, ContactType, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Extension, Fax, HomePage, PhotoPath, Photo FROM Contacts WHERE (ContactID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RepeaterColor.Properties.Settings.Default.northwndConnectionString;
        }
        ...
        public virtual int Fill(northwndDataSet.ContactsDataTable dataTable) {
        ...
        public virtual northwndDataSet.ContactsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            northwndDataSet.ContactsDataTable dataTable = new northwndDataSet.ContactsDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(northwndDataSet.ContactsDataTable dataTable) {
