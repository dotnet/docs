...
namespace VbPowerPacksDrawLineToBitmapCS
{
    public partial class DrawLineToBitmap : Form
    {
        public DrawLineToBitmap()
        {
            InitializeComponent();
        }

        private void DrawLineToBitmap_Load(object sender, EventArgs e)
        {
            // <Snippet1>
