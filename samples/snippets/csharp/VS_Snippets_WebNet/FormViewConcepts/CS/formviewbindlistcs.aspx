...
<script runat="server">
  ...
  void ProductsGridView_OnSelectedIndexChanged(Object sender, EventArgs e)
  {
    ProductDetailsSqlDataSource.SelectParameters["ProdID"].DefaultValue = 
      ProductsGridView.SelectedValue.ToString();
    ProductFormView.DataBind();
  }

  void ProductFormView_ItemUpdated(Object sender, FormViewUpdatedEventArgs e)
  {
    ProductsGridView.DataBind();
  }
  
  void ProductFormView_ItemDeleted(Object sender, FormViewDeletedEventArgs e)
  {
    ProductsGridView.DataBind();
  }

  void ProductDetailsSqlDataSource_OnInserted(Object sender, SqlDataSourceStatusEventArgs e)
  {
