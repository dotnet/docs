// <group-results-by-contiguous-keys_1>
...
{
    // The source sequence.
    public static KeyValuePair<string, string>[] list = {
        new("A","We"),
        new("A","think"),
        new("A","that"),
        new("B","LINQ"),
    ...
    static IEnumerable<IGrouping<string, KeyValuePair<string, string>>> query =
        list.ChunkBy(p => p.Key);

    static void GroupResultByContiguousKeys()
    {
