...
//<snippet9>
    let bases = [2; 8; 10; 16]
    let (numbers:byte list) = [ Byte.MinValue; 12uy; 103uy; Byte.MaxValue ]
...
//<snippet10>
    let bases = [2; 8; 10; 16]
    let (numbers:int16 list) = [ Int16.MinValue; -13621s; -18s; 12s; 19142s; Int16.MaxValue ]
...
//<snippet11>
    let bases = [2; 8; 10; 16]
    let (numbers:int32 list) = [ Int32.MinValue; -19327543; -13621; -18; 12; 19142; Int32.MaxValue ]
...
//<snippet12>
    let bases = [2; 8; 10; 16]
    let (numbers:int64 list) = [ Int64.MinValue; -193275430L; -13621L; -18L; 12L; 1914206117L; Int64.MaxValue ]
