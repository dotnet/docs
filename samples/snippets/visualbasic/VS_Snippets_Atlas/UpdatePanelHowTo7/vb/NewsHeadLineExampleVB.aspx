...
<script runat="server">
    ...
    Private Function GetHeadlines() As SortedList
        Dim allheadlines As New SortedList()
        ...
        list = GetRandomList(5, 8)
        Dim selectedHeadlines As New SortedList()
    ...
    Private Function GetRandomList(ByVal n As Integer, ByVal max As Integer) As List(Of Integer)
        Dim list As New List(Of Integer)
        Dim r As New Random()
        For i As Integer = 0 To n - 1
            Dim curr As Integer = r.Next(1, max)
            Do While (list.Contains(curr))
                curr = r.Next(1, max)
            Loop
            list.Add(curr)
        Next
