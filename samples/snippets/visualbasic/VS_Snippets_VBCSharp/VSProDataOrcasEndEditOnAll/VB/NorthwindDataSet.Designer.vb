...
Partial Public Class NorthwindDataSet
    ...
    Partial Public Class CustomersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddCustomersRow(ByVal CustomerID As String, ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal _Region As String, ByVal PostalCode As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String, ByVal LastEditDate As Date, ByVal CreationDate As Date) As CustomersRow
            Dim rowCustomersRow As CustomersRow = CType(Me.NewRow,CustomersRow)
            Dim columnValuesArray() As Object = New Object() {CustomerID, CompanyName, ContactName, ContactTitle, Address, City, _Region, PostalCode, Country, Phone, Fax, LastEditDate, CreationDate}
    ...
    Partial Public Class CustomersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([CustomerID] = @Original_CustomerID) AND (["& _ 
                ...
                "inal_Fax)) AND ((@IsNull_LastEditDate = 1 AND [LastEditDate] IS NULL) OR ([LastE"& _ 
                "ditDate] = @Original_LastEditDate)) AND ((@IsNull_CreationDate = 1 AND [Creation"& _ 
                "Date] IS NULL) OR ([CreationDate] = @Original_CreationDate)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([CustomerID], [CompanyName], [ContactName], [Conta"& _ 
                ...
                "[LastEditDate], [CreationDate]) VALUES (@CustomerID, @CompanyName, @ContactName,"& _ 
                " @ContactTitle, @Address, @City, @Region, @PostalCode, @Country, @Phone, @Fax, @"& _ 
                "LastEditDate, @CreationDate);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, CompanyName, ContactName, Cont"& _ 
                "actTitle, Address, City, Region, PostalCode, Country, Phone, Fax, LastEditDate, "& _ 
                "CreationDate FROM Customers WHERE (CustomerID = @CustomerID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customers] SET [CustomerID] = @CustomerID, [CompanyName] = @Company"& _ 
                ...
                "ry] = @Country, [Phone] = @Phone, [Fax] = @Fax, [LastEditDate] = @LastEditDate, "& _ 
                "[CreationDate] = @CreationDate WHERE (([CustomerID] = @Original_CustomerID) AND "& _ 
                ...
                "iginal_Fax)) AND ((@IsNull_LastEditDate = 1 AND [LastEditDate] IS NULL) OR ([Las"& _ 
                "tEditDate] = @Original_LastEditDate)) AND ((@IsNull_CreationDate = 1 AND [Creati"& _ 
                "onDate] IS NULL) OR ([CreationDate] = @Original_CreationDate)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Custome"& _ 
                "rID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, "& _ 
                "Country, Phone, Fax, LastEditDate, CreationDate FROM Customers WHERE (CustomerID"& _ 
                " = @CustomerID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.EndEditOnAllBindingSourcesVB.My.MySettings.Default.NorthwindConnectionString
        End Sub
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CustomerID As String, ByVal Original_CompanyName As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_Region As String, ByVal Original_PostalCode As String, ByVal Original_Country As String, ByVal Original_Phone As String, ByVal Original_Fax As String, ByVal Original_LastEditDate As Global.System.Nullable(Of Date), ByVal Original_CreationDate As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal CustomerID As String, ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal _Region As String, ByVal PostalCode As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String, ByVal LastEditDate As Global.System.Nullable(Of Date), ByVal CreationDate As Global.System.Nullable(Of Date)) As Integer
