...
- Example: `[Chapter 1](#chapter-1)` produces [Chapter 1](#chapter-1).
...
- Example: `[Readme file](../readme.md)` produces [Readme file](../readme.md).
...
Whenever possible, use `https` for all external links.
